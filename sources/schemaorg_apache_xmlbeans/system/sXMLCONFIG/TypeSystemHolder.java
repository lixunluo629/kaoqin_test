...
/* loaded from: xmlbeans-3.1.0.jar:schemaorg_apache_xmlbeans/system/sXMLCONFIG/TypeSystemHolder.class */
public class TypeSystemHolder {
    public static final SchemaTypeSystem typeSystem = loadTypeSystem();
    static Class class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
    ...
    private static final SchemaTypeSystem loadTypeSystem() throws Throwable {
        ...
        Class clsClass$3;
        try {
            if (class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder == null) {
                clsClass$ = class$("schemaorg_apache_xmlbeans.system.sXMLCONFIG.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder = clsClass$;
            } else {
                clsClass$ = class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
            }
            ...
            if (class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder == null) {
                clsClass$3 = class$("schemaorg_apache_xmlbeans.system.sXMLCONFIG.TypeSystemHolder");
                class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder = clsClass$3;
            } else {
                clsClass$3 = class$schemaorg_apache_xmlbeans$system$sXMLCONFIG$TypeSystemHolder;
            }
            objArr[0] = clsClass$3;
