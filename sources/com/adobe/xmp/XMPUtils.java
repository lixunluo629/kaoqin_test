...
/* loaded from: xmpcore-5.1.3.jar:com/adobe/xmp/XMPUtils.class */
public class XMPUtils {
    ...
    public static boolean convertToBoolean(String str) throws XMPException {
        ...
        try {
            ...
            return "true".equals(lowerCase) || "t".equals(lowerCase) || CustomBooleanEditor.VALUE_ON.equals(lowerCase) || CustomBooleanEditor.VALUE_YES.equals(lowerCase);
        }
    }
