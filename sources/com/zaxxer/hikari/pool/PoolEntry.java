...
/* loaded from: HikariCP-3.4.5.jar:com/zaxxer/hikari/pool/PoolEntry.class */
final class PoolEntry implements ConcurrentBag.IConcurrentBagEntry {
    ...
    public String toString() {
        ...
        return this.connection + ", accessed " + ClockSource.elapsedDisplayString(this.lastAccessed, now) + " ago, " + stateToString();
    }
