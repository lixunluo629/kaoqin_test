...
/* loaded from: HikariCP-3.4.5.jar:com/zaxxer/hikari/pool/ProxyLeakTask.class */
class ProxyLeakTask implements Runnable {
    private static final Logger LOGGER = LoggerFactory.getLogger((Class<?>) ProxyLeakTask.class);
    static final ProxyLeakTask NO_LEAK = new ProxyLeakTask() { // from class: com.zaxxer.hikari.pool.ProxyLeakTask.1
        @Override // com.zaxxer.hikari.pool.ProxyLeakTask
        void schedule(ScheduledExecutorService executorService, long leakDetectionThreshold) {
        }

        @Override // com.zaxxer.hikari.pool.ProxyLeakTask, java.lang.Runnable
        public void run() {
        }
