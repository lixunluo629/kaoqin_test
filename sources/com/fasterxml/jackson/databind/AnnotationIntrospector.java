...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/AnnotationIntrospector.class */
public abstract class AnnotationIntrospector implements Versioned, Serializable {
    @Override // com.fasterxml.jackson.core.Versioned
    public abstract Version version();

    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty.class */
    public static class ReferenceProperty {
        private final Type _type;
        private final String _name;

        /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/AnnotationIntrospector$ReferenceProperty$Type.class */
        public enum Type {
            MANAGED_REFERENCE,
            BACK_REFERENCE
        }
