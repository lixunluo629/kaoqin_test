...
@JacksonStdImpl
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/EnumSerializer.class */
public class EnumSerializer extends StdScalarSerializer<Enum<?>> implements ContextualSerializer {
    ...
    public JsonNode getSchema(SerializerProvider provider, Type typeHint) {
        ...
        ObjectNode objectNode = createSchemaNode(StringProperty.TYPE, true);
        if (typeHint != null) {
