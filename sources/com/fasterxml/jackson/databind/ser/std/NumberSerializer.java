...
@JacksonStdImpl
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializer.class */
public class NumberSerializer extends StdScalarSerializer<Number> implements ContextualSerializer {
    ...
    public JsonNode getSchema(SerializerProvider provider, Type typeHint) {
        return createSchemaNode(this._isInt ? "integer" : DecimalProperty.TYPE, true);
    }
    ...
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializer$BigDecimalAsStringSerializer.class */
