...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers.class */
public class NumberSerializers {
    ...
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$Base.class */
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer.class */
    public static class ShortSerializer extends Base<Object> {
        static final ShortSerializer instance = new ShortSerializer();

        public ShortSerializer() {
            super(Short.class, JsonParser.NumberType.INT, DecimalProperty.TYPE);
        }
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntegerSerializer.class */
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer.class */
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$LongSerializer.class */
    public static class LongSerializer extends Base<Object> {
        public LongSerializer(Class<?> cls) {
            super(cls, JsonParser.NumberType.LONG, DecimalProperty.TYPE);
        }
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$FloatSerializer.class */
    public static class FloatSerializer extends Base<Object> {
        static final FloatSerializer instance = new FloatSerializer();

        public FloatSerializer() {
            super(Float.class, JsonParser.NumberType.FLOAT, DecimalProperty.TYPE);
        }
    ...
    @JacksonStdImpl
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/NumberSerializers$DoubleSerializer.class */
    public static class DoubleSerializer extends Base<Object> {
        public DoubleSerializer(Class<?> cls) {
            super(cls, JsonParser.NumberType.DOUBLE, DecimalProperty.TYPE);
        }
