...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/ser/std/DateTimeSerializerBase.class */
public abstract class DateTimeSerializerBase<T> extends StdScalarSerializer<T> implements ContextualSerializer {
    ...
    public JsonNode getSchema(SerializerProvider serializers, Type typeHint) {
        return createSchemaNode(_asTimestamp(serializers) ? DecimalProperty.TYPE : StringProperty.TYPE, true);
    }
