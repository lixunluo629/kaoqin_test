...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/deser/impl/BeanPropertyMap.class */
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
    ...
    public BeanPropertyMap(boolean caseInsensitive, Collection<SettableBeanProperty> props) {
        this(caseInsensitive, props, (Map<String, List<PropertyName>>) Collections.emptyMap(), Locale.getDefault());
    }
    ...
    public static BeanPropertyMap construct(Collection<SettableBeanProperty> props, boolean caseInsensitive) {
        return construct(props, caseInsensitive, (Map<String, List<PropertyName>>) Collections.emptyMap());
    }
