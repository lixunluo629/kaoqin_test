...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/deser/std/EnumMapDeserializer.class */
    ...
    public EnumMap<?, ?> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        switch (p.currentTokenId()) {
            ...
            case 3:
                ...
                return (EnumMap) ctxt.handleUnexpectedToken(getValueType(ctxt), JsonToken.START_ARRAY, p, (String) null, new Object[0]);
            case 4:
            default:
