...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator.class */
public class BasicPolymorphicTypeValidator extends PolymorphicTypeValidator.Base implements Serializable {
    ...
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$NameMatcher.class */
    public static abstract class NameMatcher {
        public abstract boolean match(MapperConfig<?> mapperConfig, String str);
    }

    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$TypeMatcher.class */
    public static abstract class TypeMatcher {
        public abstract boolean match(MapperConfig<?> mapperConfig, Class<?> cls);
    }

    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder.class */
