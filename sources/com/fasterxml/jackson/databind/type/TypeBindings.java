...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/type/TypeBindings.class */
public class TypeBindings implements Serializable {
    ...
    public static TypeBindings create(Class<?> erasedType, JavaType[] types) {
        ...
        if (names.length != types.length) {
            throw new IllegalArgumentException("Cannot create TypeBindings for class " + erasedType.getName() + " with " + types.length + " type parameter" + (types.length == 1 ? "" : ExcelXmlConstants.CELL_DATA_FORMAT_TAG) + ": class expects " + names.length);
        }
    ...
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/type/TypeBindings$TypeParamStash.class */
    ...
    /* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/type/TypeBindings$AsKey.class */
