...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/type/TypeFactory.class */
public class TypeFactory implements Serializable {
    ...
    protected Class<?> _findPrimitive(String className) {
        if (XmlErrorCodes.INT.equals(className)) {
            return Integer.TYPE;
        }
        if (XmlErrorCodes.LONG.equals(className)) {
            return Long.TYPE;
        }
        if (XmlErrorCodes.FLOAT.equals(className)) {
            return Float.TYPE;
        }
        if (XmlErrorCodes.DOUBLE.equals(className)) {
            return Double.TYPE;
        }
