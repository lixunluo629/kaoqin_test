...
/* loaded from: jackson-databind-2.11.2.jar:com/fasterxml/jackson/databind/util/EnumResolver.class */
public class EnumResolver implements Serializable {
    ...
    public static EnumResolver constructFor(Class<Enum<?>> enumCls, AnnotationIntrospector annotationIntrospector) {
        Enum<?>[] enumValues = enumCls.getEnumConstants();
        if (enumValues == null) {
            throw new IllegalArgumentException("No enum constants for class " + enumCls.getName());
        }
        String[] names = annotationIntrospector.findEnumValues(enumCls, enumValues, new String[enumValues.length]);
        ?? r0 = new String[names.length];
        annotationIntrospector.findEnumAliases(enumCls, enumValues, r0);
        ...
        return new EnumResolver(enumCls, enumValues, map, annotationIntrospector.findDefaultEnumValue(enumCls));
    }
    ...
    public static EnumResolver constructUsingToString(Class<Enum<?>> enumCls, AnnotationIntrospector annotationIntrospector) {
        ...
        while (true) {
            ...
            if (i >= 0) {
                ...
                return new EnumResolver(enumCls, enumConstants, map, annotationIntrospector.findDefaultEnumValue(enumCls));
            }
        }
    }
