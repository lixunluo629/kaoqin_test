...
/* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/JsonPointer.class */
public class JsonPointer {
    ...
    public static JsonPointer compile(String input) throws IllegalArgumentException {
        ...
        if (input.charAt(0) != '/') {
            throw new IllegalArgumentException("Invalid input: JSON Pointer expression must start with '/': \"" + input + SymbolConstants.QUOTES_SYMBOL);
        }
