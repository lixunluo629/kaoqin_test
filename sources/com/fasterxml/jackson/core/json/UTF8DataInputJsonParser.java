...
/* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/json/UTF8DataInputJsonParser.class */
        ...
        while (ix < byteLen) {
            ...
            if (ch3 > 127) {
                if ((ch3 & 224) == 192) {
                    ...
                    ch2 = ch3 & 15;
                    needed = 2;
                } else if ((ch3 & EscherProperties.GEOTEXT__STRETCHCHARHEIGHT) == 240) {
                    ch2 = ch3 & 7;
                    needed = 3;
                } else {
