...
/* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/base/ParserBase.class */
public abstract class ParserBase extends ParserMinimalBase {
    ...
    protected void _handleEOF() throws JsonParseException {
        if (!this._parsingContext.inRoot()) {
            String marker = this._parsingContext.inArray() ? SoapEncSchemaTypeSystem.SOAP_ARRAY : "Object";
