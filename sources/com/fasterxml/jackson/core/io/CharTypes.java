...
/* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/io/CharTypes.class */
public final class CharTypes {
    ...
    static {
        ...
        for (int c = 128; c < 256; c++) {
            if ((c & 224) == 192) {
                ...
                i = 3;
            } else if ((c & EscherProperties.GEOTEXT__STRETCHCHARHEIGHT) == 240) {
                i = 4;
            } else {
                i = -1;
            }
    ...
    /* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/io/CharTypes$AltEscapes.class */
