...
/* loaded from: jackson-core-2.11.2.jar:com/fasterxml/jackson/core/io/NumberInput.class */
    ...
    public static int parseInt(char[] ch2, int off, int len) {
        ...
        switch (len) {
            ...
            case 6:
                int i5 = off;
                off++;
                num += (ch2[i5] - '0') * BZip2Constants.BASEBLOCKSIZE;
                int i42 = off;
                off++;
                num += (ch2[i42] - '0') * 10000;
                int i222 = off;
            ...
            case 7:
                int i6 = off;
                off++;
                num += (ch2[i6] - '0') * SchemaType.SIZE_BIG_INTEGER;
                int i52 = off;
                off++;
                num += (ch2[i52] - '0') * BZip2Constants.BASEBLOCKSIZE;
                int i422 = off;
                off++;
            ...
            case 8:
                ...
                int i62 = off;
                off++;
                num += (ch2[i62] - '0') * SchemaType.SIZE_BIG_INTEGER;
                int i522 = off;
                off++;
                num += (ch2[i522] - '0') * BZip2Constants.BASEBLOCKSIZE;
                int i4222 = off;
                off++;
            ...
            case 9:
                ...
                int i622 = off;
                off++;
                num += (ch2[i622] - '0') * SchemaType.SIZE_BIG_INTEGER;
                int i5222 = off;
                off++;
                num += (ch2[i5222] - '0') * BZip2Constants.BASEBLOCKSIZE;
                int i42222 = off;
                off++;
