...
/* loaded from: jackson-annotations-2.11.2.jar:com/fasterxml/jackson/annotation/ObjectIdGenerator.class */
public abstract class ObjectIdGenerator<T> implements Serializable {
    ...
    /* loaded from: jackson-annotations-2.11.2.jar:com/fasterxml/jackson/annotation/ObjectIdGenerator$IdKey.class */
    public static final class IdKey implements Serializable {
        ...
        public String toString() {
            ...
            objArr[0] = this.key;
            objArr[1] = this.type == null ? Constants.NONE_TRANSPORT : this.type.getName();
            objArr[2] = this.scope == null ? Constants.NONE_TRANSPORT : this.scope.getName();
