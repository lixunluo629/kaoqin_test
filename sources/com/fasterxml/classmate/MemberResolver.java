...
/* loaded from: classmate-1.3.4.jar:com/fasterxml/classmate/MemberResolver.class */
public class MemberResolver implements Serializable {
    ...
    public ResolvedTypeWithMembers resolve(ResolvedType mainType, AnnotationConfiguration annotationConfig, AnnotationOverrides annotationOverrides) throws NegativeArraySizeException {
    ...
    private void _addOverrides(List<HierarchicType> typesWithOverrides, Set<ClassKey> seenTypes, Class<?> override) throws NegativeArraySizeException {
