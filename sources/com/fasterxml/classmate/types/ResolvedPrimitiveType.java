...
/* loaded from: classmate-1.3.4.jar:com/fasterxml/classmate/types/ResolvedPrimitiveType.class */
public final class ResolvedPrimitiveType extends ResolvedType {
    ...
    public static List<ResolvedPrimitiveType> all() {
        ...
        all.add(new ResolvedPrimitiveType(Integer.TYPE, 'I', XmlErrorCodes.INT));
        all.add(new ResolvedPrimitiveType(Long.TYPE, 'J', XmlErrorCodes.LONG));
        all.add(new ResolvedPrimitiveType(Float.TYPE, 'F', XmlErrorCodes.FLOAT));
        all.add(new ResolvedPrimitiveType(Double.TYPE, 'D', XmlErrorCodes.DOUBLE));
        return all;
    }
