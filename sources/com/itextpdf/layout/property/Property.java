...
/* loaded from: layout-7.1.10.jar:com/itextpdf/layout/property/Property.class */
public final class Property {
    ...
    private static final boolean[] INHERITED_PROPERTIES = new boolean[120];
    ...
    public static boolean isPropertyInherited(int property) {
        return property >= 0 && property <= 119 && INHERITED_PROPERTIES[property];
    }
}
