...
/* loaded from: layout-7.1.10.jar:com/itextpdf/layout/tagging/TableTaggingRule.class */
class TableTaggingRule implements ITaggingRule {
    ...
    public boolean onTagFinish(LayoutTaggingHelper taggingHelper, TaggingHintKey tableHintKey) {
        ...
        for (TaggingHintKey kidKey : kidKeys) {
            if (StandardRoles.TD.equals(kidKey.getAccessibleElement().getAccessibilityProperties().getRole()) || StandardRoles.TH.equals(kidKey.getAccessibleElement().getAccessibilityProperties().getRole())) {
        ...
        for (TaggingHintKey nonCellKid2 : nonCellKids) {
            String kidRole2 = nonCellKid2.getAccessibleElement().getAccessibilityProperties().getRole();
            if (StandardRoles.THEAD.equals(kidRole2)) {
        ...
        for (TaggingHintKey nonCellKid3 : nonCellKids) {
            String kidRole3 = nonCellKid3.getAccessibleElement().getAccessibilityProperties().getRole();
            if (StandardRoles.TFOOT.equals(kidRole3)) {
