...
/* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/pdf/navigation/PdfStructureDestination.class */
public class PdfStructureDestination extends PdfDestination {
    ...
    public PdfObject getDestinationPage(Map<String, PdfObject> names) {
        ...
        if (firstObj.isDictionary()) {
            PdfStructElem pdfStructElem = new PdfStructElem((PdfDictionary) firstObj);
            while (true) {
                ...
                if (firstKid instanceof PdfStructElem) {
                    pdfStructElem = (PdfStructElem) firstKid;
                } else {
                    return null;
                }
            }
