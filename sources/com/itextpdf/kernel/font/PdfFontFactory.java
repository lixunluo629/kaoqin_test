...
/* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/font/PdfFontFactory.class */
public final class PdfFontFactory {
    ...
    public static PdfFont createFont(FontProgram fontProgram, String encoding, boolean embedded) {
        ...
        if ((fontProgram instanceof CidFont) && ((CidFont) fontProgram).compatibleWith(encoding)) {
