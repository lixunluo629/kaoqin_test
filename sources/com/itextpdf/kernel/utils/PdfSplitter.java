...
/* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/utils/PdfSplitter.class */
public class PdfSplitter {
    ...
    /* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/utils/PdfSplitter$IDocumentReadyListener.class */
    ...
    public List<PdfDocument> splitBySize(long size) throws IOException {
    ...
    public List<PdfDocument> splitByPageNumbers(List<Integer> pageNumbers) {
        ...
        splitByPageNumbers(pageNumbers, new IDocumentReadyListener() { // from class: com.itextpdf.kernel.utils.PdfSplitter.1
    ...
    public void splitByPageCount(int pageCount, IDocumentReadyListener documentReady) {
        ...
        while (true) {
            int startPage = i;
            if (startPage <= this.pdfDocument.getNumberOfPages()) {
    ...
    public List<PdfDocument> splitByPageCount(int pageCount) {
        final List<PdfDocument> splitDocuments = new ArrayList<>();
        splitByPageCount(pageCount, new IDocumentReadyListener() { // from class: com.itextpdf.kernel.utils.PdfSplitter.2
            @Override // com.itextpdf.kernel.utils.PdfSplitter.IDocumentReadyListener
            public void documentReady(PdfDocument pdfDocument, PageRange pageRange) {
                splitDocuments.add(pdfDocument);
            }
    ...
    private PageRange getNextRange(int startPage, int endPage, long size) throws IOException {
