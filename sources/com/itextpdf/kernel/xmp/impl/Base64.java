...
/* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/xmp/impl/Base64.class */
public class Base64 {
    ...
    public static final byte[] encode(byte[] src, int lineFeed) {
        ...
        while (sidx + 3 <= src.length) {
            ...
            int sidx2 = sidx + 1;
            int sidx3 = sidx2 + 1;
            int bits24 = ((src[i] & 255) << 16) | ((src[sidx2] & 255) << 8);
            sidx = sidx3 + 1;
            int bits242 = bits24 | ((src[sidx3] & 255) << 0);
            int bits6 = (bits242 & 16515072) >> 18;
            int i2 = didx;
            int didx2 = didx + 1;
            dst[i2] = base64[bits6];
            int bits62 = (bits242 & 258048) >> 12;
            int didx3 = didx2 + 1;
            dst[didx2] = base64[bits62];
            int bits63 = (bits242 & 4032) >> 6;
            int didx4 = didx3 + 1;
            dst[didx3] = base64[bits63];
            int bits64 = bits242 & 63;
            didx = didx4 + 1;
        ...
        if (src.length - sidx == 2) {
            int bits243 = ((src[sidx] & 255) << 16) | ((src[sidx + 1] & 255) << 8);
            int bits65 = (bits243 & 16515072) >> 18;
            int i3 = didx;
            int didx5 = didx + 1;
            dst[i3] = base64[bits65];
            int bits66 = (bits243 & 258048) >> 12;
            int didx6 = didx5 + 1;
            dst[didx5] = base64[bits66];
            int bits67 = (bits243 & 4032) >> 6;
            int didx7 = didx6 + 1;
            dst[didx6] = base64[bits67];
            int i4 = didx7 + 1;
            dst[didx7] = 61;
        } else if (src.length - sidx == 1) {
            int bits244 = (src[sidx] & 255) << 16;
            int bits68 = (bits244 & 16515072) >> 18;
            int i5 = didx;
            int didx8 = didx + 1;
            dst[i5] = base64[bits68];
            int bits69 = (bits244 & 258048) >> 12;
            int didx9 = didx8 + 1;
