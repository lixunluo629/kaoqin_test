...
/* loaded from: kernel-7.1.10.jar:com/itextpdf/kernel/xmp/impl/XMPNodeUtils.class */
public final class XMPNodeUtils implements XMPConst {
    ...
    private static XMPNode followXPathStep(XMPNode parentNode, XMPPathSegment nextStep, boolean createNodes) throws XMPException, NumberFormatException {
        int index;
    ...
    private static int findIndexedItem(XMPNode arrayNode, String segment, boolean createNodes) throws XMPException, NumberFormatException {
        try {
