...
/* loaded from: io-7.1.10.jar:com/itextpdf/io/util/TextUtil.class */
public final class TextUtil {
    ...
    public static int convertToUtf32(char highSurrogate, char lowSurrogate) {
        return ((((highSurrogate - GeneratorBase.SURR1_FIRST) * 1024) + lowSurrogate) - GeneratorBase.SURR2_FIRST) + 65536;
    }

    public static int convertToUtf32(char[] text, int idx) {
        return ((((text[idx] - GeneratorBase.SURR1_FIRST) * 1024) + text[idx + 1]) - GeneratorBase.SURR2_FIRST) + 65536;
    }

    public static int convertToUtf32(String text, int idx) {
        return ((((text.charAt(idx) - GeneratorBase.SURR1_FIRST) * 1024) + text.charAt(idx + 1)) - GeneratorBase.SURR2_FIRST) + 65536;
    }
    ...
    public static char[] convertFromUtf32(int codePoint) {
        ...
        return new char[]{(char) ((codePoint2 / 1024) + GeneratorBase.SURR1_FIRST), (char) ((codePoint2 % 1024) + GeneratorBase.SURR2_FIRST)};
    }
    ...
    public static String charToString(char ch2) {
