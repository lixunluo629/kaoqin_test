...
/* loaded from: lombok-1.16.22.jar:com/zwitserloot/cmdreader/ParseItem.SCL.lombok */
class ParseItem {
    ...
    private List<String> TRUE_VALS = Collections.unmodifiableList(Arrays.asList("1", "true", "t", "y", CustomBooleanEditor.VALUE_YES, CustomBooleanEditor.VALUE_ON));
    private List<String> FALSE_VALS = Collections.unmodifiableList(Arrays.asList("0", "false", ExcelXmlConstants.CELL_FORMULA_TAG, "n", "no", CustomBooleanEditor.VALUE_OFF));
