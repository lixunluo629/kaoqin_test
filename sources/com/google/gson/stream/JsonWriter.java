...
/* loaded from: gson-2.8.5.jar:com/google/gson/stream/JsonWriter.class */
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter beginArray() throws IOException {
        writeDeferredName();
        return open(1, PropertyAccessor.PROPERTY_KEY_PREFIX);
    }
    ...
    */
    ...
    private void newline() throws IOException {
        ...
        this.out.write(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        int size = this.stackSize;
