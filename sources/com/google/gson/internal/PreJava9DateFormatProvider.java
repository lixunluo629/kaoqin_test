...
/* loaded from: gson-2.8.5.jar:com/google/gson/internal/PreJava9DateFormatProvider.class */
public class PreJava9DateFormatProvider {
    ...
    public static DateFormat getUSDateTimeFormat(int dateStyle, int timeStyle) {
        String pattern = getDatePartOfDateTimePattern(dateStyle) + SymbolConstants.SPACE_SYMBOL + getTimePartOfDateTimePattern(timeStyle);
