...
/* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors.class */
public final class MoreExecutors {
    ...
    @VisibleForTesting
    /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$Application.class */
    static class Application {
        ...
        final void addDelayedShutdownHook(final ExecutorService service, final long terminationTimeout, final TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread(new StringBuilder(24 + strValueOf.length()).append("DelayedShutdownHook-for-").append(strValueOf).toString(), new Runnable() { // from class: com.google.common.util.concurrent.MoreExecutors.Application.1
    ...
    /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$DirectExecutorService.class */
        ...
        */
        public boolean isTerminated() {
            /*
                ...
                r0.lock()
                r0 = r2
                boolean r0 = r0.shutdown     // Catch: java.lang.Throwable -> L28
                if (r0 == 0) goto L1b
                r0 = r2
                int r0 = r0.runningTasks     // Catch: java.lang.Throwable -> L28
                if (r0 != 0) goto L1b
                r0 = 1
                goto L1c
            L1b:
            ...
            L28:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.util.concurrent.MoreExecutors.DirectExecutorService.isTerminated():boolean");
        }
    ...
    /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$DirectExecutor.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$ListeningDecorator.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator.class */
    private static class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator$ListenableScheduledTask.class */
        ...
        /* loaded from: guava-18.0.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator$NeverSuccessfulListenableFutureTask.class */
    ...
    static <T> T invokeAnyImpl(ListeningExecutorService executorService, Collection<? extends Callable<T>> tasks, boolean timed, long nanos) throws ExecutionException, InterruptedException, TimeoutException {
        long jNanoTime;
