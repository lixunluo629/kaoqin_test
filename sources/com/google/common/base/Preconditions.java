...
@GwtCompatible
/* loaded from: guava-18.0.jar:com/google/common/base/Preconditions.class */
public final class Preconditions {
    ...
    public static int checkElementIndex(int index, int size) {
        return checkElementIndex(index, size, BeanDefinitionParserDelegate.INDEX_ATTRIBUTE);
    }
    ...
    public static int checkPositionIndex(int index, int size) {
        return checkPositionIndex(index, size, BeanDefinitionParserDelegate.INDEX_ATTRIBUTE);
    }
