...
@GwtCompatible
/* loaded from: guava-18.0.jar:com/google/common/base/Present.class */
final class Present<T> extends Optional<T> {
    ...
    public String toString() {
        String strValueOf = String.valueOf(String.valueOf(this.reference));
        return new StringBuilder(13 + strValueOf.length()).append("Optional.of(").append(strValueOf).append(")").toString();
    }
}
