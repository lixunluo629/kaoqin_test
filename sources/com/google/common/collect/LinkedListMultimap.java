...
/* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap.class */
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    public /* bridge */ /* synthetic */ Collection replaceValues(Object obj, Iterable x1) {
        return replaceValues((LinkedListMultimap<K, V>) obj, x1);
    }
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap$Node.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap$KeyList.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap$NodeIterator.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap$DistinctKeyIterator.class */
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/LinkedListMultimap$ValueForKeyIterator.class */
    ...
    public List<V> createValues() {
        return new AbstractSequentialList<V>() { // from class: com.google.common.collect.LinkedListMultimap.3
            ...
            public ListIterator<V> listIterator(int index) {
                ...
                return new TransformedListIterator<Map.Entry<K, V>, V>(nodeItr) { // from class: com.google.common.collect.LinkedListMultimap.3.1
                    /* JADX INFO: Access modifiers changed from: package-private */
