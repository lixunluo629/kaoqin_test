...
@GwtCompatible
/* loaded from: guava-18.0.jar:com/google/common/collect/ImmutableTable.class */
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> {
        ...
        switch (size) {
            ...
            default:
                ...
                for (Table.Cell<? extends R, ? extends C, ? extends V> cell : table.cellSet()) {
                    cellSetBuilder.add((ImmutableSet.Builder<Table.Cell<R, C, V>>) cellOf(cell.getRowKey(), cell.getColumnKey(), cell.getValue()));
                }
    ...
    /* loaded from: guava-18.0.jar:com/google/common/collect/ImmutableTable$Builder.class */
