...
@Beta
/* loaded from: guava-18.0.jar:com/google/common/net/InetAddresses.class */
public final class InetAddresses {
    private static final int IPV4_PART_COUNT = 4;
    private static final int IPV6_PART_COUNT = 8;
    private static final Inet4Address LOOPBACK4 = (Inet4Address) forString(NetFlags.LOOPBACK_ADDRESS);
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        String strValueOf = String.valueOf(String.valueOf(initialPart));
        String strValueOf2 = String.valueOf(String.valueOf(penultimate));
        String strValueOf3 = String.valueOf(String.valueOf(ultimate));
        return new StringBuilder(1 + strValueOf.length() + strValueOf2.length() + strValueOf3.length()).append(strValueOf).append(strValueOf2).append(":").append(strValueOf3).toString();
    }
    ...
    private static String hextetsToIPv6String(int[] hextets) {
        ...
        for (int i = 0; i < hextets.length; i++) {
            ...
            if (thisIsNumber) {
                ...
                buf.append(NetFlags.ANY_ADDR_V6);
            }
    ...
    public static String toUriString(InetAddress ip) {
        if (ip instanceof Inet6Address) {
            String strValueOf = String.valueOf(String.valueOf(toAddrString(ip)));
            return new StringBuilder(2 + strValueOf.length()).append(PropertyAccessor.PROPERTY_KEY_PREFIX).append(strValueOf).append("]").toString();
        }
    ...
    public static InetAddress forUriString(String hostAddr) {
        ...
        if (hostAddr.startsWith(PropertyAccessor.PROPERTY_KEY_PREFIX) && hostAddr.endsWith("]")) {
    ...
    @Beta
    /* loaded from: guava-18.0.jar:com/google/common/net/InetAddresses$TeredoInfo.class */
    public static final class TeredoInfo {
        ...
        public TeredoInfo(@Nullable Inet4Address server, @Nullable Inet4Address client, int port, int flags) {
            Preconditions.checkArgument(port >= 0 && port <= 65535, "port '%s' is out of range (0 <= port <= 0xffff)", Integer.valueOf(port));
            Preconditions.checkArgument(flags >= 0 && flags <= 65535, "flags '%s' is out of range (0 <= flags <= 0xffff)", Integer.valueOf(flags));
