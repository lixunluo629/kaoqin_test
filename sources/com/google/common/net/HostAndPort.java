...
@GwtCompatible
@Immutable
/* loaded from: guava-18.0.jar:com/google/common/net/HostAndPort.class */
public final class HostAndPort implements Serializable {
    ...
    public static HostAndPort fromString(String hostPortString) throws NumberFormatException {
        ...
        if (hostPortString.startsWith(PropertyAccessor.PROPERTY_KEY_PREFIX)) {
        ...
        if (!Strings.isNullOrEmpty(portString)) {
            ...
            try {
                ...
                if (strValueOf.length() != 0) {
                    strConcat = "Unparseable port number: ".concat(strValueOf);
                } else {
                    strConcat = str;
                    String str = new String("Unparseable port number: ");
                }
