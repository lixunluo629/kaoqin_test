...
/* loaded from: mysql-connector-java-5.1.48.jar:com/mysql/jdbc/SQLError.class */
public class SQLError {
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x0107 A[Catch: SQLException -> 0x0111, TRY_ENTER, TRY_LEAVE, TryCatch #1 {SQLException -> 0x0111, blocks: (B:43:0x0107, B:58:0x0107, B:5:0x000e, B:7:0x0025, B:9:0x0044, B:10:0x004e, B:12:0x0058, B:18:0x0077, B:21:0x009c, B:23:0x00a6, B:26:0x00d5, B:33:0x00ea, B:8:0x002f), top: B:69:0x0008, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:48:0x011b A[Catch: SQLException -> 0x0124, TRY_ENTER, TRY_LEAVE, TryCatch #2 {SQLException -> 0x0124, blocks: (B:48:0x011b, B:61:0x011b), top: B:70:0x0008 }] */
    /* JADX WARN: Removed duplicated region for block: B:53:0x012f  */
    /* JADX WARN: Type inference failed for: r0v30, types: [java.lang.Throwable] */
    /* JADX WARN: Type inference failed for: r0v36, types: [java.sql.SQLWarning] */
    /* JADX WARN: Type inference failed for: r0v38, types: [java.sql.SQLWarning] */
    /* JADX WARN: Type inference failed for: r0v41, types: [com.mysql.jdbc.MysqlDataTruncation, java.sql.SQLWarning] */
    /* JADX WARN: Type inference failed for: r0v43, types: [java.sql.SQLWarning] */
    /* JADX WARN: Type inference failed for: r1v0, types: [java.sql.SQLWarning] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    static java.sql.SQLWarning convertShowWarningsToSQLWarnings(com.mysql.jdbc.Connection r10, int r11, boolean r12) throws java.sql.SQLException {
        /*
            Method dump skipped, instructions count: 308
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mysql.jdbc.SQLError.convertShowWarningsToSQLWarnings(com.mysql.jdbc.Connection, int, boolean):java.sql.SQLWarning");
    }
    ...
    public static void dumpSqlStatesMappingsAsXml() throws Exception {
        ...
        for (Integer errorNumber3 : allErrorNumbers.keySet()) {
            ...
            System.out.println("   <ErrorMapping mysqlErrorNumber=\"" + errorNumber3 + "\" mysqlErrorName=\"" + mysqlErrorNumbersToNames.get(errorNumber3) + "\" legacySqlState=\"" + (oldSqlState == null ? "" : oldSqlState) + "\" sql92SqlState=\"" + (sql92State == null ? "" : sql92State) + "\"/>");
        }
        System.out.println("</ErrorMappings>");
    }
    ...
    public static SQLException createSQLException(String message, String sqlState, int vendorErrorCode, boolean isTransient, ExceptionInterceptor interceptor, Connection conn) {
        ...
        try {
            ...
            SQLException unexpectedEx = new SQLException("Unable to create correct SQLException class instance, error class/codes may be incorrect. Reason: " + Util.stackTraceToString(sqlEx2), SQL_STATE_GENERAL_ERROR);
    ...
    public static String createLinkFailureMessageBasedOnHeuristics(MySQLConnection conn, long lastPacketSentTimeMs, long lastPacketReceivedTimeMs, Exception underlyingException) throws NumberFormatException {
        ...
        if (dueToTimeout == 1 || dueToTimeout == 2) {
            ...
            exceptionMessageBuf.append((conn.getLocalSocketAddress() == null || Util.interfaceExists(conn.getLocalSocketAddress())) ? Messages.getString("CommunicationsException.TooManyClientConnections") : Messages.getString("CommunicationsException.LocalSocketAddressNotAvailable"));
        }
