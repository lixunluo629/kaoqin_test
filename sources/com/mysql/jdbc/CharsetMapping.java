...
/* loaded from: mysql-connector-java-5.1.48.jar:com/mysql/jdbc/CharsetMapping.class */
public class CharsetMapping {
    ...
    static {
        ...
        collation[209] = new Collation(org.aspectj.apache.bcel.Constants.PUTFIELD2_QUICK, "utf8_esperanto_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[210] = new Collation(org.aspectj.apache.bcel.Constants.GETSTATIC_QUICK, "utf8_hungarian_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[211] = new Collation(211, "utf8_sinhala_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[212] = new Collation(org.aspectj.apache.bcel.Constants.GETSTATIC2_QUICK, "utf8_german2_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[213] = new Collation(213, "utf8_croatian_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[214] = new Collation(org.aspectj.apache.bcel.Constants.INVOKEVIRTUAL_QUICK, "utf8_unicode_520_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[215] = new Collation(215, "utf8_vietnamese_ci", 0, MYSQL_CHARSET_NAME_utf8);
        collation[223] = new Collation(org.aspectj.apache.bcel.Constants.MULTIANEWARRAY_QUICK, "utf8_general_mysql500_ci", 0, MYSQL_CHARSET_NAME_utf8);
        ...
        collation[228] = new Collation(org.aspectj.apache.bcel.Constants.PUTFIELD_QUICK_W, "utf8mb4_slovenian_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[229] = new Collation(MergeCellsRecord.sid, "utf8mb4_polish_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        ...
        collation[233] = new Collation(UnknownRecord.BITMAP_00E9, "utf8mb4_turkish_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[234] = new Collation(234, "utf8mb4_czech_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[235] = new Collation(DrawingGroupRecord.sid, "utf8mb4_danish_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[236] = new Collation(236, "utf8mb4_lithuanian_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[237] = new Collation(DrawingSelectionRecord.sid, "utf8mb4_slovak_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[238] = new Collation(238, "utf8mb4_spanish2_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[239] = new Collation(UnknownRecord.PHONETICPR_00EF, "utf8mb4_roman_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[240] = new Collation(240, "utf8mb4_persian_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[241] = new Collation(EscherProperties.GEOTEXT__HASTEXTEFFECT, "utf8mb4_esperanto_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[242] = new Collation(EscherProperties.GEOTEXT__ROTATECHARACTERS, "utf8mb4_hungarian_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[243] = new Collation(EscherProperties.GEOTEXT__KERNCHARACTERS, "utf8mb4_sinhala_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[244] = new Collation(EscherProperties.GEOTEXT__TIGHTORTRACK, "utf8mb4_german2_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[245] = new Collation(EscherProperties.GEOTEXT__STRETCHTOFITSHAPE, "utf8mb4_croatian_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[246] = new Collation(EscherProperties.GEOTEXT__CHARBOUNDINGBOX, "utf8mb4_unicode_520_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[247] = new Collation(247, "utf8mb4_vietnamese_ci", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[248] = new Collation(EscherProperties.GEOTEXT__STRETCHCHARHEIGHT, "gb18030_chinese_ci", 1, MYSQL_CHARSET_NAME_gb18030);
        collation[249] = new Collation(EscherProperties.GEOTEXT__NOMEASUREALONGPATH, "gb18030_bin", 0, MYSQL_CHARSET_NAME_gb18030);
        collation[250] = new Collation(EscherProperties.GEOTEXT__BOLDFONT, "gb18030_unicode_520_ci", 0, MYSQL_CHARSET_NAME_gb18030);
        ...
        collation[293] = new Collation(TIFFConstants.TIFFTAG_GROUP4OPTIONS, "utf8mb4_es_trad_0900_as_cs", 0, MYSQL_CHARSET_NAME_utf8mb4);
        ...
        collation[308] = new Collation(TokenId.CONST, "utf8mb4_zh_0900_as_cs", 0, MYSQL_CHARSET_NAME_utf8mb4);
        collation[309] = new Collation(TokenId.CONTINUE, "utf8mb4_0900_bin", 0, MYSQL_CHARSET_NAME_utf8mb4);
        ...
        collation[354] = new Collation(TokenId.PLUS_E, "utf8_5624_1", 0, MYSQL_CHARSET_NAME_utf8);
        collation[355] = new Collation(TokenId.MINUS_E, "utf8_5624_2", 0, MYSQL_CHARSET_NAME_utf8);
        collation[356] = new Collation(356, "utf8_5624_3", 0, MYSQL_CHARSET_NAME_utf8);
        collation[357] = new Collation(TokenId.LE, "utf8_5624_4", 0, MYSQL_CHARSET_NAME_utf8);
        collation[358] = new Collation(TokenId.EQ, "ucs2_test_ci", 0, MYSQL_CHARSET_NAME_ucs2);
        collation[359] = new Collation(TokenId.GE, "ucs2_vn_ci", 0, MYSQL_CHARSET_NAME_ucs2);
        collation[360] = new Collation(TokenId.EXOR_E, "ucs2_5624_1", 0, MYSQL_CHARSET_NAME_ucs2);
        collation[368] = new Collation(TokenId.OROR, "utf8_5624_5", 0, MYSQL_CHARSET_NAME_utf8);
        collation[391] = new Collation(EscherProperties.FILL__BLIPFILENAME, "utf32_test_ci", 0, MYSQL_CHARSET_NAME_utf32);
        collation[2047] = new Collation(IEEEDouble.BIASED_EXPONENT_SPECIAL_VALUE, "utf8_maxuserid_ci", 0, MYSQL_CHARSET_NAME_utf8);
    ...
    static final String getCharacterEncodingForErrorMessages(ConnectionImpl conn) throws SQLException {
        ...
        String errorMessageFile = conn.getServerVariable(PdfConst.Language);
        ...
        String errorMessageEncodingMysql = ERROR_MESSAGE_FILE_TO_MYSQL_CHARSET.get(errorMessageFile.substring(lastSlashIndex + 1, endWithoutSlash));
        if (errorMessageEncodingMysql == null || (javaEncoding = getJavaEncodingForMysqlCharset(errorMessageEncodingMysql)) == null) {
            return "Cp1252";
        }
        return javaEncoding;
    }
