...
/* loaded from: mysql-connector-java-5.1.48.jar:com/mysql/jdbc/JDBC4ClientInfoProviderSP.class */
public class JDBC4ClientInfoProviderSP implements JDBC4ClientInfoProvider {
    ...
    @Override // com.mysql.jdbc.JDBC4ClientInfoProvider
    public synchronized void setClientInfo(java.sql.Connection conn, String name, String value) throws SQLException {
        try {
