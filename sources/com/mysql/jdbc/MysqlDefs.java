...
/* loaded from: mysql-connector-java-5.1.48.jar:com/mysql/jdbc/MysqlDefs.class */
public final class MysqlDefs {
    ...
    static int mysqlToJavaType(String mysqlType) {
        ...
        if (mysqlType.equalsIgnoreCase(JsonFactory.FORMAT_NAME_JSON)) {
    ...
    static {
        ...
        mysqlToJdbcTypesMap.put(JsonFactory.FORMAT_NAME_JSON, Integer.valueOf(mysqlToJavaType(245)));
    }
