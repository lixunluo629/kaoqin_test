...
/* loaded from: mysql-connector-java-5.1.48.jar:com/mysql/fabric/jdbc/FabricMySQLDriver.class */
public class FabricMySQLDriver extends NonRegisteringDriver implements Driver {
    ...
    public Connection connect(String url, Properties info) throws SQLException, NoSuchMethodException, SecurityException {
