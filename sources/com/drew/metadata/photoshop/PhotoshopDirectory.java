...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/photoshop/PhotoshopDirectory.class */
public class PhotoshopDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(1008, StandardRoles.CAPTION);
    ...
    public byte[] getThumbnailBytes() {
        byte[] storedBytes = getByteArray(1036);
        if (storedBytes == null) {
