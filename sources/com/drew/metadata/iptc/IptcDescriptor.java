...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/iptc/IptcDescriptor.class */
public class IptcDescriptor extends TagDescriptor<IptcDirectory> {
    ...
    public String getKeywordsDescription() {
        ...
        return StringUtil.join(keywords, ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
    }
