...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/iptc/Iso2022Converter.class */
public final class Iso2022Converter {
    ...
    @Nullable
    static Charset guessCharSet(@NotNull byte[] bytes) throws CharacterCodingException {
        String[] encodings = {"UTF-8", System.getProperty("file.encoding"), "ISO-8859-1"};
