...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/PanasonicRawDistortionDescriptor.class */
public class PanasonicRawDistortionDescriptor extends TagDescriptor<PanasonicRawDistortionDirectory> {
    ...
    public String getDistortionScaleDescription() {
        ...
        return Integer.toString(1 / (1 + (value.intValue() / 32768)));
    }
