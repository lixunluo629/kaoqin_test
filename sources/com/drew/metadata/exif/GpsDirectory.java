...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/GpsDirectory.class */
public class GpsDirectory extends ExifDirectoryBase {
    ...
    public Date getGpsDate() {
        ...
        String dateTime = String.format(Locale.US, "%s %02d:%02d:%02.3f UTC", date, Integer.valueOf(timeComponents[0].intValue()), Integer.valueOf(timeComponents[1].intValue()), Double.valueOf(timeComponents[2].doubleValue()));
        try {
