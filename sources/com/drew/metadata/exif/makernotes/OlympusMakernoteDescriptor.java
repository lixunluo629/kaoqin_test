...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/OlympusMakernoteDescriptor.class */
public class OlympusMakernoteDescriptor extends TagDescriptor<OlympusMakernoteDirectory> {
    ...
    public String getFlashModeCameraSettingDescription() {
        return getIndexedDescription(OlympusMakernoteDirectory.CameraSettings.TAG_FLASH_MODE, FontStretches.NORMAL, "Red-eye reduction", "Rear flash sync", "Wireless");
    }
    ...
    public String getApexFilmSpeedDescription() {
        ...
        double iso = Math.pow((value.longValue() / 8.0d) - 1.0d, 2.0d) * 3.125d;
    ...
    public String getApexShutterSpeedTimeDescription() {
        ...
        double shutterSpeed = Math.pow((49 - value.longValue()) / 8.0d, 2.0d);
        DecimalFormat format = new DecimalFormat("0.###");
        format.setRoundingMode(RoundingMode.HALF_UP);
    ...
    public String getApexApertureDescription() {
        ...
        double fStop = Math.pow((value.longValue() / 16.0d) - 0.5d, 2.0d);
    ...
    public String getExposureCompensationDescription() {
        ...
        return format.format((value.longValue() / 3.0d) - 2.0d) + " EV";
    }
    ...
    public String getFocalLengthDescription() {
        ...
        return getFocalLengthDescription(value.longValue() / 256.0d);
    }
    ...
    public String getWhiteBalanceRedDescription() {
        ...
        return format.format(value.longValue() / 256.0d);
    }
    ...
    public String getSharpnessCameraSettingDescription() {
        return getIndexedDescription(OlympusMakernoteDirectory.CameraSettings.TAG_SHARPNESS, "Hard", FontStretches.NORMAL, "Soft");
    }
    ...
    public String getFlashCompensationDescription() {
        ...
        return format.format((value.longValue() - 6) / 3.0d) + " EV";
    }
    ...
    public String getApexBrightnessDescription() {
        ...
        return format.format((value.longValue() / 8.0d) - 6.0d);
    }
    ...
    public String getSharpnessDescription() {
        return getIndexedDescription(OlympusMakernoteDirectory.TAG_SHARPNESS, FontStretches.NORMAL, "Hard", "Soft");
    }
    ...
    public String getWbModeDescription() {
        int[] obj = ((OlympusMakernoteDirectory) this._directory).getIntArray(4117);
        if (obj == null) {
            return null;
        }
    ...
    public String getRedBalanceDescription() {
        int[] values = ((OlympusMakernoteDirectory) this._directory).getIntArray(4119);
        if (values == null) {
            return null;
        }
        short value = (short) values[0];
        return String.valueOf(value / 256.0d);
    }
    ...
    public String getContrastDescription() {
        return getIndexedDescription(OlympusMakernoteDirectory.TAG_CONTRAST, "High", FontStretches.NORMAL, "Low");
    }
    ...
    public String getFocusRangeDescription() {
        return getIndexedDescription(4106, FontStretches.NORMAL, "Macro");
    }
