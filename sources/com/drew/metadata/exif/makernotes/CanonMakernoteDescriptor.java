...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDescriptor.class */
public class CanonMakernoteDescriptor extends TagDescriptor<CanonMakernoteDirectory> {
    ...
    public String getShortFocalLengthDescription() {
        ...
        return Integer.toString(value.intValue()) + SymbolConstants.SPACE_SYMBOL + units;
    }
    ...
    public String getLensTypeDescription() {
        ...
        return _lensTypeById.containsKey(value) ? _lensTypeById.get(value) : String.format("Unknown (%d)", value);
    }
    ...
    public String getMacroModeDescription() {
        return getIndexedDescription(CanonMakernoteDirectory.CameraSettings.TAG_MACRO_MODE, 1, "Macro", FontStretches.NORMAL);
    }

    @Nullable
    public String getQualityDescription() {
        return getIndexedDescription(CanonMakernoteDirectory.CameraSettings.TAG_QUALITY, 2, FontStretches.NORMAL, "Fine", null, "Superfine");
    }
    ...
    public String getDisplayApertureDescription() {
        ...
        return getFStopDescription(value.intValue() / 10.0f);
    }
    ...
    static {
        ...
        _lensTypeById.put(Integer.valueOf(Constants.PUTFIELD2_QUICK), "Canon EF 55-200mm f/4.5-5.6");
        _lensTypeById.put(Integer.valueOf(Constants.GETSTATIC_QUICK), "Canon EF 28-90mm f/4-5.6 USM");
        _lensTypeById.put(211, "Canon EF 28-200mm f/3.5-5.6 USM");
        _lensTypeById.put(Integer.valueOf(Constants.GETSTATIC2_QUICK), "Canon EF 28-105mm f/4-5.6 USM");
        _lensTypeById.put(213, "Canon EF 90-300mm f/4.5-5.6 USM or Tamron Lens");
        _lensTypeById.put(Integer.valueOf(Constants.INVOKEVIRTUAL_QUICK), "Canon EF-S 18-55mm f/3.5-5.6 USM");
        _lensTypeById.put(215, "Canon EF 55-200mm f/4.5-5.6 II USM");
        _lensTypeById.put(Integer.valueOf(Constants.INVOKESTATIC_QUICK), "Tamron AF 18-270mm f/3.5-6.3 Di II VC PZD");
        ...
        _lensTypeById.put(Integer.valueOf(Constants.PUTFIELD_QUICK_W), "Canon EF 28-105mm f/3.5-4.5 USM");
        _lensTypeById.put(Integer.valueOf(MergeCellsRecord.sid), "Canon EF 16-35mm f/2.8L");
        ...
        _lensTypeById.put(Integer.valueOf(UnknownRecord.BITMAP_00E9), "Canon EF 28-300mm f/3.5-5.6L IS");
        _lensTypeById.put(234, "Canon EF-S 17-85mm f/4-5.6 IS USM or Tokina Lens");
        _lensTypeById.put(Integer.valueOf(DrawingGroupRecord.sid), "Canon EF-S 10-22mm f/3.5-4.5 USM");
        _lensTypeById.put(236, "Canon EF-S 60mm f/2.8 Macro USM");
        _lensTypeById.put(Integer.valueOf(DrawingSelectionRecord.sid), "Canon EF 24-105mm f/4L IS");
        _lensTypeById.put(238, "Canon EF 70-300mm f/4-5.6 IS USM");
        _lensTypeById.put(Integer.valueOf(UnknownRecord.PHONETICPR_00EF), "Canon EF 85mm f/1.2L II");
        _lensTypeById.put(240, "Canon EF-S 17-55mm f/2.8 IS USM");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__HASTEXTEFFECT), "Canon EF 50mm f/1.2L");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__ROTATECHARACTERS), "Canon EF 70-200mm f/4L IS");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__KERNCHARACTERS), "Canon EF 70-200mm f/4L IS + 1.4x");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__TIGHTORTRACK), "Canon EF 70-200mm f/4L IS + 2x");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__STRETCHTOFITSHAPE), "Canon EF 70-200mm f/4L IS + 2.8x");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__CHARBOUNDINGBOX), "Canon EF 16-35mm f/2.8L II");
        _lensTypeById.put(247, "Canon EF 14mm f/2.8L II USM");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__STRETCHCHARHEIGHT), "Canon EF 200mm f/2L IS or Sigma Lens");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__NOMEASUREALONGPATH), "Canon EF 800mm f/5.6L IS");
        _lensTypeById.put(Integer.valueOf(EscherProperties.GEOTEXT__BOLDFONT), "Canon EF 24mm f/1.4L II or Sigma Lens");
        ...
        _lensTypeById.put(Integer.valueOf(UnixStat.DEFAULT_DIR_PERM), "Canon EF 500mm f/4L IS II USM or EF 24-105mm f4L IS USM");
        _lensTypeById.put(494, "Canon EF 600mm f/4.0L IS II USM");
        _lensTypeById.put(495, "Canon EF 24-70mm f/2.8L II USM");
        _lensTypeById.put(Integer.valueOf(MetaDo.META_DELETEOBJECT), "Canon EF 200-400mm f/4L IS USM");
        ...
        _lensTypeById.put(Integer.valueOf(FrameRecord.sid), "Canon EF-S 18-55mm f/3.5-5.6 IS STM");
