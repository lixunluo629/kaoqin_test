...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/NikonType2MakernoteDescriptor.class */
public class NikonType2MakernoteDescriptor extends TagDescriptor<NikonType2MakernoteDirectory> {
    ...
    public String getHighISONoiseReductionDescription() {
        return getIndexedDescription(177, "Off", "Minimal", "Low", null, FontStretches.NORMAL, null, "High");
    }
    ...
    public String getColorSpaceDescription() {
        return getIndexedDescription(30, 1, PngImageHelper.sRGB, "Adobe RGB");
    }
    ...
    private String getEVDescription(int tagType) {
        ...
        if (values == null || values.length < 2 || values.length < 3 || values[2] == 0) {
            return null;
        }
        DecimalFormat decimalFormat = new DecimalFormat("0.##");
        double ev = (values[0] * values[1]) / values[2];
