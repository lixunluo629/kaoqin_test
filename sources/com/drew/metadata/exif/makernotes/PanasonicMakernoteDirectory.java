...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/PanasonicMakernoteDirectory.class */
public class PanasonicMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(64, "Saturation");
        _tagNameMap.put(65, "Sharpness");
        ...
        _tagNameMap.put(101, StandardRoles.TITLE);
    ...
    public Face[] getRecognizedFaces() {
        ...
        try {
            ...
            for (int i = 0; i < faceCount; i++) {
                int offset = 4 + (i * 44);
                String name = reader.getString(offset, 20, NTLM.DEFAULT_CHARSET).trim();
                String age = reader.getString(offset + 28, 20, NTLM.DEFAULT_CHARSET).trim();
