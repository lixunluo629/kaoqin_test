...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/NikonType1MakernoteDescriptor.class */
public class NikonType1MakernoteDescriptor extends TagDescriptor<NikonType1MakernoteDirectory> {
    ...
    public String getImageAdjustmentDescription() {
        return getIndexedDescription(5, FontStretches.NORMAL, "Bright +", "Bright -", "Contrast +", "Contrast -");
    }
