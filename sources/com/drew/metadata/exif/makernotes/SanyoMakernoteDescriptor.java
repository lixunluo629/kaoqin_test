...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/SanyoMakernoteDescriptor.class */
public class SanyoMakernoteDescriptor extends TagDescriptor<SanyoMakernoteDirectory> {
    ...
    private String getMacroDescription() {
        return getIndexedDescription(514, FontStretches.NORMAL, "Macro", "View", "Manual");
    }
