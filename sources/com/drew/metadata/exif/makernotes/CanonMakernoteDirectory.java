...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory.class */
public class CanonMakernoteDirectory extends Directory {
    ...
    /* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$AFInfo.class */
    ...
    /* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$CameraSettings.class */
    ...
    /* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$FocalLength.class */
    ...
    /* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$Panorama.class */
    ...
    /* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$ShotInfo.class */
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_CRW_PARAM), "CRW Parameters");
            ...
            case 18:
                ...
                while (i5 < values.length) {
                    if (AFInfo.TAG_NUM_AF_POINTS + tagnumber == 53768 || AFInfo.TAG_NUM_AF_POINTS + tagnumber == 53769) {
                        ...
                        if (values.length - 1 >= i5 + pointsInFocus.length) {
