...
public class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
    ...
    private String getTransformDescription(int tag) {
        ...
        try {
            ...
            return "Unknown (" + val1 + SymbolConstants.SPACE_SYMBOL + val2 + ")";
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public String getCameraOrientationDescription() {
        return getIndexedDescription(143, FontStretches.NORMAL, "Rotate CW", "Rotate 180", "Rotate CCW", "Tilt Upwards", "Tile Downwards");
    }
    ...
    public String getRollAngleDescription() {
        ...
        return format.format(value.shortValue() / 10.0d);
    }
    ...
    public String getContrastDescription() {
        return getIndexedDescription(57, FontStretches.NORMAL);
    }
    ...
    public String getAdvancedSceneModeDescription() {
        return getIndexedDescription(61, 1, FontStretches.NORMAL, "Outdoor/Illuminations/Flower/HDR Art", "Indoor/Architecture/Objects/HDR B&W", "Creative", "Auto", null, "Expressive", "Retro", "Pure", "Elegant", null, "Monochrome", "Dynamic Art", "Silhouette");
    }
    ...
    public String getColorModeDescription() {
        return getIndexedDescription(50, FontStretches.NORMAL, "Natural", "Vivid");
    }
    ...
    private String buildFacesDescription(@Nullable Face[] faces) {
        ...
        for (int i = 0; i < faces.length; i++) {
            result.append("Face ").append(i + 1).append(": ").append(faces[i].toString()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        }
        if (result.length() > 0) {
        ...
        switch (value[0]) {
            case 0:
                switch (value[1]) {
                    ...
                    default:
                        return "Unknown (" + value[0] + SymbolConstants.SPACE_SYMBOL + value[1] + ")";
                }
            case 1:
                switch (value[1]) {
                    case 0:
    ...
    public String getQualityModeDescription() {
        return getIndexedDescription(1, 2, "High", FontStretches.NORMAL, null, null, "Very High", "Raw", null, "Motion Picture");
    }
