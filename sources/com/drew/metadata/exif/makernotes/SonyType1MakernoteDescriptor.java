...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/SonyType1MakernoteDescriptor.class */
public class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public String getColorTemperatureDescription() {
        ...
        int kelvin = ((value.intValue() & 16711680) >> 8) | ((value.intValue() & (-16777216)) >> 24);
        return String.format("%d K", Integer.valueOf(kelvin));
    }
