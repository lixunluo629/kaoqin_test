...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/makernotes/OlympusRawDevelopmentMakernoteDescriptor.class */
public class OlympusRawDevelopmentMakernoteDescriptor extends TagDescriptor<OlympusRawDevelopmentMakernoteDirectory> {
    ...
    public String getRawDevColorSpaceDescription() {
        return getIndexedDescription(264, PngImageHelper.sRGB, "Adobe RGB", "Pro Photo RGB");
    }
