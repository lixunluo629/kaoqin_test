...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/exif/ExifDirectoryBase.class */
public abstract class ExifDirectoryBase extends Directory {
    ...
    protected static void addExifTagNames(HashMap<Integer, String> map) {
        ...
        map.put(319, "Primary Chromaticities");
        map.put(322, "Tile Width");
        map.put(323, "Tile Length");
        map.put(324, "Tile Offsets");
        map.put(325, "Tile Byte Counts");
        map.put(330, "Sub IFD Pointer(s)");
        map.put(342, "Transfer Range");
        map.put(347, "JPEG Tables");
        ...
        map.put(40960, "FlashPix Version");
