...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/ico/IcoDescriptor.class */
public class IcoDescriptor extends TagDescriptor<IcoDirectory> {
    ...
    public String getColourPaletteSizeDescription() {
        ...
        return size + " colour" + (size.intValue() == 1 ? "" : ExcelXmlConstants.CELL_DATA_FORMAT_TAG);
    }
}
