...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/metadata/webp/WebpRiffHandler.class */
public class WebpRiffHandler implements RiffHandler {
    ...
    public void processChunk(@NotNull String fourCC, @NotNull byte[] payload) {
        ...
        if (fourCC.equals("VP8L") && payload.length > 4) {
            ...
            try {
                ...
                int b3 = reader2.getUInt8(3);
                int b4 = reader2.getUInt8(4);
                int widthMinusOne2 = ((b2 & 63) << 8) | b1;
                int heightMinusOne2 = ((b4 & 15) << 10) | (b3 << 2) | ((b2 & 192) >> 6);
                WebpDirectory directory2 = new WebpDirectory();
                directory2.setInt(2, widthMinusOne2 + 1);
        ...
        if (fourCC.equals("VP8 ") && payload.length > 9) {
