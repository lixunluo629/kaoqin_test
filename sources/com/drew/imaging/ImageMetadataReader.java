...
/* loaded from: metadata-extractor-2.10.1.jar:com/drew/imaging/ImageMetadataReader.class */
public class ImageMetadataReader {
    ...
    public static void main(@NotNull String[] args) throws MetadataException, IOException {
        ...
        if (argList.size() < 1) {
            ...
            objArr[0] = version == null ? "a.b.c" : version;
        ...
        for (String filePath : argList) {
            ...
            if (!markdownFormat) {
                System.out.printf("Processed %.3f MB file in %.2f ms%n%n", Double.valueOf(file.length() / 1048576.0d), Double.valueOf(took / 1000000.0d));
            }
            if (markdownFormat) {
