...
/* loaded from: easyexcel-2.1.6.jar:com/alibaba/excel/converters/floatconverter/FloatNumberConverter.class */
public class FloatNumberConverter implements Converter<Float> {
    ...
    public CellData convertToExcelData(Float value, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) {
        return new CellData(BigDecimal.valueOf(value.floatValue()));
    }
}
