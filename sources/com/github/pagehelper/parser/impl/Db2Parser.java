...
/* loaded from: pagehelper-3.7.4.jar:com/github/pagehelper/parser/impl/Db2Parser.class */
public class Db2Parser extends AbstractParser {
    ...
    public Map setPageParameter(MappedStatement ms, Object parameterObject, BoundSql boundSql, Page page) {
        ...
        paramMap.put(Constant.PAGEPARAMETER_FIRST, Integer.valueOf(page.getStartRow() + 1));
        paramMap.put(Constant.PAGEPARAMETER_SECOND, Integer.valueOf(page.getEndRow()));
        return paramMap;
    }
}
