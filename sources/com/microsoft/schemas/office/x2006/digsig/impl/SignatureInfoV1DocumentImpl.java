...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/digsig/impl/SignatureInfoV1DocumentImpl.class */
public class SignatureInfoV1DocumentImpl extends XmlComplexContentImpl implements SignatureInfoV1Document {
    ...
    public void setSignatureInfoV1(CTSignatureInfoV1 cTSignatureInfoV1) {
        synchronized (monitor()) {
            check_orphaned();
            CTSignatureInfoV1 cTSignatureInfoV12 = (CTSignatureInfoV1) get_store().find_element_user(SIGNATUREINFOV1$0, 0);
            if (cTSignatureInfoV12 == null) {
                cTSignatureInfoV12 = (CTSignatureInfoV1) get_store().add_element_user(SIGNATUREINFOV1$0);
            }
