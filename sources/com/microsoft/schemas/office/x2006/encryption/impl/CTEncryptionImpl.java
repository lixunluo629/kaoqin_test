...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/encryption/impl/CTEncryptionImpl.class */
public class CTEncryptionImpl extends XmlComplexContentImpl implements CTEncryption {
    ...
    public void setKeyData(CTKeyData cTKeyData) {
        synchronized (monitor()) {
            check_orphaned();
            CTKeyData cTKeyData2 = (CTKeyData) get_store().find_element_user(KEYDATA$0, 0);
            if (cTKeyData2 == null) {
                cTKeyData2 = (CTKeyData) get_store().add_element_user(KEYDATA$0);
            }
    ...
    public void setDataIntegrity(CTDataIntegrity cTDataIntegrity) {
        synchronized (monitor()) {
            check_orphaned();
            CTDataIntegrity cTDataIntegrity2 = (CTDataIntegrity) get_store().find_element_user(DATAINTEGRITY$2, 0);
            if (cTDataIntegrity2 == null) {
                cTDataIntegrity2 = (CTDataIntegrity) get_store().add_element_user(DATAINTEGRITY$2);
            }
    ...
    public void setKeyEncryptors(CTKeyEncryptors cTKeyEncryptors) {
        synchronized (monitor()) {
            check_orphaned();
            CTKeyEncryptors cTKeyEncryptors2 = (CTKeyEncryptors) get_store().find_element_user(KEYENCRYPTORS$4, 0);
            if (cTKeyEncryptors2 == null) {
                cTKeyEncryptors2 = (CTKeyEncryptors) get_store().add_element_user(KEYENCRYPTORS$4);
            }
