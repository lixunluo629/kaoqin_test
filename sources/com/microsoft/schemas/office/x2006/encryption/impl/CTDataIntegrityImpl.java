...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/encryption/impl/CTDataIntegrityImpl.class */
public class CTDataIntegrityImpl extends XmlComplexContentImpl implements CTDataIntegrity {
    ...
    public void xsetEncryptedHmacKey(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(ENCRYPTEDHMACKEY$0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(ENCRYPTEDHMACKEY$0);
            }
    ...
    public void xsetEncryptedHmacValue(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(ENCRYPTEDHMACVALUE$2);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(ENCRYPTEDHMACVALUE$2);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
