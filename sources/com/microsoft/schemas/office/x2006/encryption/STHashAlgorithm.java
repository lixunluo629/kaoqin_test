...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/encryption/STHashAlgorithm.class */
public interface STHashAlgorithm extends XmlToken {
    ...
    public static final Enum MD_5 = Enum.forString(MessageDigestAlgorithms.MD5);
    public static final Enum MD_4 = Enum.forString("MD4");
    public static final Enum MD_2 = Enum.forString(MessageDigestAlgorithms.MD2);
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/encryption/STHashAlgorithm$Enum.class */
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("SHA1", 1), new Enum("SHA256", 2), new Enum("SHA384", 3), new Enum("SHA512", 4), new Enum(MessageDigestAlgorithms.MD5, 5), new Enum("MD4", 6), new Enum(MessageDigestAlgorithms.MD2, 7), new Enum("RIPEMD-128", 8), new Enum("RIPEMD-160", 9), new Enum("WHIRLPOOL", 10)});
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/encryption/STHashAlgorithm$Factory.class */
    public static final class Factory {
        ...
        public static STHashAlgorithm newInstance(XmlOptions xmlOptions) {
            return (STHashAlgorithm) POIXMLTypeLoader.newInstance(STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(String str) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(str, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(str, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(File file) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(file, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(file, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(URL url) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(url, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(url, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(InputStream inputStream) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(inputStream, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(inputStream, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(Reader reader) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(reader, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(reader, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(xMLStreamReader, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(xMLStreamReader, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(Node node) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(node, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(node, STHashAlgorithm.type, xmlOptions);
        }

        public static STHashAlgorithm parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(xMLInputStream, STHashAlgorithm.type, (XmlOptions) null);
        }

        public static STHashAlgorithm parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STHashAlgorithm) POIXMLTypeLoader.parse(xMLInputStream, STHashAlgorithm.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STHashAlgorithm.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STHashAlgorithm.type, xmlOptions);
        }
