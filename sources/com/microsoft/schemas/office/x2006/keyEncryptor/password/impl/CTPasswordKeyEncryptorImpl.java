...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/x2006/keyEncryptor/password/impl/CTPasswordKeyEncryptorImpl.class */
public class CTPasswordKeyEncryptorImpl extends XmlComplexContentImpl implements CTPasswordKeyEncryptor {
    ...
    public void xsetSaltSize(STSaltSize sTSaltSize) {
        synchronized (monitor()) {
            check_orphaned();
            STSaltSize sTSaltSize2 = (STSaltSize) get_store().find_attribute_user(SALTSIZE$0);
            if (sTSaltSize2 == null) {
                sTSaltSize2 = (STSaltSize) get_store().add_attribute_user(SALTSIZE$0);
            }
    ...
    public void xsetBlockSize(STBlockSize sTBlockSize) {
        synchronized (monitor()) {
            check_orphaned();
            STBlockSize sTBlockSize2 = (STBlockSize) get_store().find_attribute_user(BLOCKSIZE$2);
            if (sTBlockSize2 == null) {
                sTBlockSize2 = (STBlockSize) get_store().add_attribute_user(BLOCKSIZE$2);
            }
    ...
    public void xsetKeyBits(STKeyBits sTKeyBits) {
        synchronized (monitor()) {
            check_orphaned();
            STKeyBits sTKeyBits2 = (STKeyBits) get_store().find_attribute_user(KEYBITS$4);
            if (sTKeyBits2 == null) {
                sTKeyBits2 = (STKeyBits) get_store().add_attribute_user(KEYBITS$4);
            }
    ...
    public void xsetHashSize(STHashSize sTHashSize) {
        synchronized (monitor()) {
            check_orphaned();
            STHashSize sTHashSize2 = (STHashSize) get_store().find_attribute_user(HASHSIZE$6);
            if (sTHashSize2 == null) {
                sTHashSize2 = (STHashSize) get_store().add_attribute_user(HASHSIZE$6);
            }
    ...
    public void xsetSaltValue(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(SALTVALUE$14);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(SALTVALUE$14);
            }
    ...
    public void xsetSpinCount(STSpinCount sTSpinCount) {
        synchronized (monitor()) {
            check_orphaned();
            STSpinCount sTSpinCount2 = (STSpinCount) get_store().find_attribute_user(SPINCOUNT$16);
            if (sTSpinCount2 == null) {
                sTSpinCount2 = (STSpinCount) get_store().add_attribute_user(SPINCOUNT$16);
            }
    ...
    public void xsetEncryptedVerifierHashInput(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public void xsetEncryptedVerifierHashValue(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public void xsetEncryptedKeyValue(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(ENCRYPTEDKEYVALUE$22);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(ENCRYPTEDKEYVALUE$22);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
