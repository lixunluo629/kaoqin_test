...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/excel/STObjectType.class */
public interface STObjectType extends XmlString {
    ...
    public static final Enum NOTE = Enum.forString(StandardRoles.NOTE);
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/excel/STObjectType$Enum.class */
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("Button", 1), new Enum("Checkbox", 2), new Enum("Dialog", 3), new Enum("Drop", 4), new Enum("Edit", 5), new Enum("GBox", 6), new Enum("Label", 7), new Enum("LineA", 8), new Enum("List", 9), new Enum("Movie", 10), new Enum(StandardRoles.NOTE, 11), new Enum("Pict", 12), new Enum("Radio", 13), new Enum("RectA", 14), new Enum("Scroll", 15), new Enum("Spin", 16), new Enum("Shape", 17), new Enum("Group", 18), new Enum("Rect", 19)});
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/excel/STObjectType$Factory.class */
    public static final class Factory {
        ...
        public static STObjectType newInstance(XmlOptions xmlOptions) {
            return (STObjectType) POIXMLTypeLoader.newInstance(STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(String str) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(str, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(str, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(File file) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(file, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(file, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(URL url) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(url, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(url, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(InputStream inputStream) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(inputStream, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(inputStream, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(Reader reader) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(reader, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STObjectType) POIXMLTypeLoader.parse(reader, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(xMLStreamReader, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(xMLStreamReader, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(Node node) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(node, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(node, STObjectType.type, xmlOptions);
        }

        public static STObjectType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(xMLInputStream, STObjectType.type, (XmlOptions) null);
        }

        public static STObjectType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STObjectType) POIXMLTypeLoader.parse(xMLInputStream, STObjectType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STObjectType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STObjectType.type, xmlOptions);
        }
