...
/* loaded from: poi-ooxml-schemas-3.17.jar:com/microsoft/schemas/office/visio/x2012/main/impl/SectionTypeImpl.class */
public class SectionTypeImpl extends XmlComplexContentImpl implements SectionType {
    ...
    public int sizeOfRowArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(ROW$4);
        }
        return iCount_elements;
    }
    ...
    public void setRowArray(int i, RowType rowType) {
        synchronized (monitor()) {
            check_orphaned();
            RowType rowType2 = (RowType) get_store().find_element_user(ROW$4, i);
            if (rowType2 == null) {
                throw new IndexOutOfBoundsException();
            }
            rowType2.set(rowType);
        }
    }
