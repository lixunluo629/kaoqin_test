...
/* loaded from: onpremise-event-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/model/SyncAccountRequest.class */
public class SyncAccountRequest implements Serializable {
    public static final IOTModelType MODEL_TYPE = IOTModelType.SYNC_ACCOUNT_REQUEST;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SyncAccountRequest)) {
            return false;
        }
        SyncAccountRequest other = (SyncAccountRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SyncAccountRequest;
    }
    ...
    public String toString() {
        return "SyncAccountRequest(lastModifyTime=" + getLastModifyTime() + ", orgId=" + getOrgId() + ")";
    }
    ...
    public SyncAccountRequest(Long lastModifyTime, Long orgId) {
        this.lastModifyTime = lastModifyTime;
        this.orgId = orgId;
    }
}
