...
@ApiModel(description = "更新考勤组设备")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/info/UpdateAttendanceGroupDeviceInfo.class */
public class UpdateAttendanceGroupDeviceInfo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAttendanceGroupDeviceInfo)) {
            return false;
        }
        UpdateAttendanceGroupDeviceInfo other = (UpdateAttendanceGroupDeviceInfo) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UpdateAttendanceGroupDeviceInfo;
    }
    ...
    public String toString() {
        return "UpdateAttendanceGroupDeviceInfo(newDevices=" + getNewDevices() + ", oldDevices=" + getOldDevices() + ")";
    }
    ...
    public UpdateAttendanceGroupDeviceInfo() {
    }

    public UpdateAttendanceGroupDeviceInfo(List<DeviceDto> newDevices, List<DeviceDto> oldDevices) {
        this.newDevices = newDevices;
        this.oldDevices = oldDevices;
    }
}
