...
@ApiModel(description = "保存餐厅信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/SaveMealCanteenRequest.class */
public class SaveMealCanteenRequest extends BaseRequest {
    private static final long serialVersionUID = -7419558514088534568L;

    @ApiModelProperty(name = "mealCanteenId", value = "餐厅id,新增时不传该参数，修改时必填")
    ...
    private List<DeviceDto> canteenDevices = new ArrayList();

    @ApiModelProperty(name = "canteenMembers", value = "餐厅就餐人员")
    private List<GroupMemberDto> canteenMembers = new ArrayList();

    @ApiModelProperty(name = "canteenTimes", value = "餐厅就餐时间")
    private List<CanteenTimeDto> canteenTimes = new ArrayList();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SaveMealCanteenRequest)) {
            return false;
        }
        SaveMealCanteenRequest other = (SaveMealCanteenRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SaveMealCanteenRequest;
    }
