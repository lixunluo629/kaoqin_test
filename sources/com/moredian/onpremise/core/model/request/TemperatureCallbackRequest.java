...
@ApiModel(description = "测温记录回调通知参数")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/TemperatureCallbackRequest.class */
public class TemperatureCallbackRequest implements Serializable {
    private static final long serialVersionUID = 6933628103177296062L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TemperatureCallbackRequest)) {
            return false;
        }
        TemperatureCallbackRequest other = (TemperatureCallbackRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TemperatureCallbackRequest;
    }
    ...
    public int hashCode() {
        ...
        return (result9 * 59) + ($healthCode == null ? 43 : $healthCode.hashCode());
    }

    public String toString() {
        return "TemperatureCallbackRequest(memberId=" + getMemberId() + ", memberName=" + getMemberName() + ", jobNum=" + getJobNum() + ", deviceSn=" + getDeviceSn() + ", deviceName=" + getDeviceName() + ", snapFaceUrl=" + getSnapFaceUrl() + ", verifyTimeMillis=" + getVerifyTimeMillis() + ", temperatureValue=" + getTemperatureValue() + ", temperatureStatus=" + getTemperatureStatus() + ", healthCode=" + getHealthCode() + ")";
    }
