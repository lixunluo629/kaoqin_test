...
@ApiModel(description = "查询考勤事件详情")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/QueryAttendanceEventRequest.class */
public class QueryAttendanceEventRequest extends BaseRequest {
    private static final long serialVersionUID = 5799831510491144196L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueryAttendanceEventRequest)) {
            return false;
        }
        QueryAttendanceEventRequest other = (QueryAttendanceEventRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof QueryAttendanceEventRequest;
    }
    ...
    public String toString() {
        return "QueryAttendanceEventRequest(attendanceEventId=" + getAttendanceEventId() + ", memberId=" + getMemberId() + ")";
    }
