...
@ApiModel(description = "访客记录明细列表查询参数")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/VisitRecordDetailListRequest.class */
public class VisitRecordDetailListRequest extends BaseRequest {
    private static final long serialVersionUID = 7006544007399058478L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VisitRecordDetailListRequest)) {
            return false;
        }
        VisitRecordDetailListRequest other = (VisitRecordDetailListRequest) o;
        ...
        return this$externalContactId == null ? other$externalContactId == null : this$externalContactId.equals(other$externalContactId);
    }

    @Override // com.moredian.onpremise.core.model.request.BaseRequest
    protected boolean canEqual(Object other) {
        return other instanceof VisitRecordDetailListRequest;
    }
    ...
    public int hashCode() {
        ...
        return (result5 * 59) + ($externalContactId == null ? 43 : $externalContactId.hashCode());
    }

    @Override // com.moredian.onpremise.core.model.request.BaseRequest
    public String toString() {
        return "VisitRecordDetailListRequest(paginator=" + getPaginator() + ", startTimestamp=" + getStartTimestamp() + ", endTimestamp=" + getEndTimestamp() + ", startDate=" + getStartDate() + ", endDate=" + getEndDate() + ", externalContactId=" + getExternalContactId() + ")";
    }
