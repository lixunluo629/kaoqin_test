...
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/UpdateAttendanceEventRequest.class */
public class UpdateAttendanceEventRequest extends BaseRequest {
    private static final long serialVersionUID = -501963929900425853L;

    @ApiModelProperty(name = "attendanceEventId", value = "考勤事件id，必填")
    private Long attendanceEventId;

    @ApiModelProperty(name = "memberId", value = "成员id，必填")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAttendanceEventRequest)) {
            return false;
        }
        UpdateAttendanceEventRequest other = (UpdateAttendanceEventRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UpdateAttendanceEventRequest;
    }
    ...
    public String toString() {
        return "UpdateAttendanceEventRequest(attendanceEventId=" + getAttendanceEventId() + ", memberId=" + getMemberId() + ", eventType=" + getEventType() + ", leave=" + getLeave() + ", businessTrip=" + getBusinessTrip() + ", businessOut=" + getBusinessOut() + ", overtime=" + getOvertime() + ", supplement=" + getSupplement() + ")";
    }
