...
@ApiModel
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/BatchInsertMemberDetailRequest.class */
public class BatchInsertMemberDetailRequest implements Serializable {
    private static final long serialVersionUID = -5421835945910070900L;

    @ApiModelProperty(name = "memberName", value = "姓名时间")
    private String memberName;

    @ApiModelProperty(name = "memberMobilePre", value = "手机号前缀")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchInsertMemberDetailRequest)) {
            return false;
        }
        BatchInsertMemberDetailRequest other = (BatchInsertMemberDetailRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BatchInsertMemberDetailRequest;
    }
    ...
    public int hashCode() {
        ...
        int result5 = (result4 * 59) + ($memberPosition == null ? 43 : $memberPosition.hashCode());
        ...
        int result10 = (result9 * 59) + ($eigenvalueValue == null ? 43 : $eigenvalueValue.hashCode());
        ...
        int result12 = (result11 * 59) + ($identityCard == null ? 43 : $identityCard.hashCode());
        Object $memberCardNum = getMemberCardNum();
        return (result12 * 59) + ($memberCardNum == null ? 43 : $memberCardNum.hashCode());
    }

    public String toString() {
        return "BatchInsertMemberDetailRequest(memberName=" + getMemberName() + ", memberMobilePre=" + getMemberMobilePre() + ", memberMobile=" + getMemberMobile() + ", deptName=" + getDeptName() + ", memberPosition=" + getMemberPosition() + ", memberJobNum=" + getMemberJobNum() + ", memberJoinTime=" + getMemberJoinTime() + ", memberEmail=" + getMemberEmail() + ", remark=" + getRemark() + ", eigenvalueValue=" + getEigenvalueValue() + ", memberGender=" + getMemberGender() + ", identityCard=" + getIdentityCard() + ", memberCardNum=" + getMemberCardNum() + ")";
    }
