...
@ApiModel(description = "删除备份数据")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/DeleteBackupsRequest.class */
public class DeleteBackupsRequest extends BaseRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBackupsRequest)) {
            return false;
        }
        DeleteBackupsRequest other = (DeleteBackupsRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeleteBackupsRequest;
    }
    ...
    public String toString() {
        return "DeleteBackupsRequest(backupsDataId=" + getBackupsDataId() + ")";
    }
