...
@ApiModel(description = "删除节假日")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/request/DeleteAttendanceHolidayRequest.class */
public class DeleteAttendanceHolidayRequest extends BaseRequest {
    private static final long serialVersionUID = 5143665100387750978L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAttendanceHolidayRequest)) {
            return false;
        }
        DeleteAttendanceHolidayRequest other = (DeleteAttendanceHolidayRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeleteAttendanceHolidayRequest;
    }
    ...
    public String toString() {
        return "DeleteAttendanceHolidayRequest(attendanceHolidayId=" + getAttendanceHolidayId() + ")";
    }
