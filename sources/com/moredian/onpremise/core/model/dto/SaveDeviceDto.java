...
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/dto/SaveDeviceDto.class */
public class SaveDeviceDto implements Serializable {
    private static final long serialVersionUID = -1440059652909184559L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SaveDeviceDto)) {
            return false;
        }
        SaveDeviceDto other = (SaveDeviceDto) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SaveDeviceDto;
    }
    ...
    public String toString() {
        return "SaveDeviceDto(deviceName=" + getDeviceName() + ", deviceSn=" + getDeviceSn() + ")";
    }
