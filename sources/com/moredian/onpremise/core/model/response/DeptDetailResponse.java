...
@ApiModel(description = "部门详情响应信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/DeptDetailResponse.class */
public class DeptDetailResponse implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeptDetailResponse)) {
            return false;
        }
        DeptDetailResponse other = (DeptDetailResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DeptDetailResponse;
    }
    ...
    public String toString() {
        return "DeptDetailResponse(deptId=" + getDeptId() + ", deptName=" + getDeptName() + ", superDeptId=" + getSuperDeptId() + ", superDeptName=" + getSuperDeptName() + ")";
    }
