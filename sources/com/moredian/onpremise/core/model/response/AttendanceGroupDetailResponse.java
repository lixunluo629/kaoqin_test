...
@ApiModel(description = "考勤组详情")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/AttendanceGroupDetailResponse.class */
public class AttendanceGroupDetailResponse implements Serializable {
    private static final long serialVersionUID = -146449212234648696L;
    ...
    @ApiModelProperty(name = "groupStartDate", value = "考勤组有效期开始日期时间戳")
    private String groupStartDate;

    @ApiModelProperty(name = "groupEndDate", value = "考勤组有效期结束日期时间戳")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttendanceGroupDetailResponse)) {
            return false;
        }
        AttendanceGroupDetailResponse other = (AttendanceGroupDetailResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AttendanceGroupDetailResponse;
    }
