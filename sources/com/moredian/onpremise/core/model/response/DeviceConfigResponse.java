...
@ApiModel(description = "设备配置响应信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/DeviceConfigResponse.class */
public class DeviceConfigResponse implements Serializable {
    private static final long serialVersionUID = -4010681000125961451L;
    ...
    @ApiModelProperty(name = "gmtModify", value = "更新时间")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeviceConfigResponse)) {
            return false;
        }
        DeviceConfigResponse other = (DeviceConfigResponse) o;
        ...
        return this$focus == null ? other$focus == null : this$focus.equals(other$focus);
    }

    protected boolean canEqual(Object other) {
        return other instanceof DeviceConfigResponse;
    }
    ...
    public int hashCode() {
        ...
        int result9 = (result8 * 59) + ($light == null ? 43 : $light.hashCode());
        Object $maskMode = getMaskMode();
        int result10 = (result9 * 59) + ($maskMode == null ? 43 : $maskMode.hashCode());
        Object $ringMode = getRingMode();
        int result11 = (result10 * 59) + ($ringMode == null ? 43 : $ringMode.hashCode());
        Object $fontSize = getFontSize();
        int result12 = (result11 * 59) + ($fontSize == null ? 43 : $fontSize.hashCode());
        Object $showTime = getShowTime();
        int result13 = (result12 * 59) + ($showTime == null ? 43 : $showTime.hashCode());
        Object $gmtModify = getGmtModify();
        int result14 = (result13 * 59) + ($gmtModify == null ? 43 : $gmtModify.hashCode());
        Object $direction = getDirection();
        int result15 = (result14 * 59) + ($direction == null ? 43 : $direction.hashCode());
        Object $focus = getFocus();
        return (result15 * 59) + ($focus == null ? 43 : $focus.hashCode());
    }

    public String toString() {
        return "DeviceConfigResponse(deviceName=" + getDeviceName() + ", deviceVoice=" + getDeviceVoice() + ", genType=" + getGenType() + ", openingTime=" + getOpeningTime() + ", identifyDistance=" + getIdentifyDistance() + ", identifyModule=" + getIdentifyModule() + ", thresholdScore=" + getThresholdScore() + ", fastMode=" + getFastMode() + ", light=" + getLight() + ", maskMode=" + getMaskMode() + ", ringMode=" + getRingMode() + ", fontSize=" + getFontSize() + ", showTime=" + getShowTime() + ", gmtModify=" + getGmtModify() + ", direction=" + getDirection() + ", focus=" + getFocus() + ")";
    }
