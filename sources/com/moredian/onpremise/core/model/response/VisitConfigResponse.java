...
@ApiModel(description = "访客配置响应信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/VisitConfigResponse.class */
public class VisitConfigResponse implements Serializable {
    private static final long serialVersionUID = 5447868467166349251L;
    ...
    @ApiModelProperty(name = "screensaverFlag", value = "屏保是否开启，1-开；0-关")
    private Integer screensaverFlag;

    @ApiModelProperty(name = "screensaverUrl", value = "屏保url,['','']")
    private List<String> screensaverUrl;

    @ApiModelProperty(name = "idCardVerify", value = "开启人证合验，1-开；0-关")
    private Integer idCardVerify;

    @ApiModelProperty(name = "inputFace", value = "开启人证录脸，1-开；0-关")
    private Integer inputFace;

    @ApiModelProperty(name = "intervieweeFlag", value = "是否填写被访者信息，1-是；0-否")
    private Integer intervieweeFlag;

    @ApiModelProperty(name = "allDayFlag", value = "是否全天，1-是；0-否")
    ...
    @ApiModelProperty(name = "cycleFlag", value = "重复每天，1-是；0-否")
    ...
    @ApiModelProperty(name = "devices", value = "设备列表，例[{\"deviceName\":\"设备1\",\"deviceSn\":\"SN-1321546546\"}]")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VisitConfigResponse)) {
            return false;
        }
        VisitConfigResponse other = (VisitConfigResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VisitConfigResponse;
    }
    ...
    public int hashCode() {
        ...
        int result4 = (result3 * 59) + ($screensaverUrl == null ? 43 : $screensaverUrl.hashCode());
        Object $idCardVerify = getIdCardVerify();
        int result5 = (result4 * 59) + ($idCardVerify == null ? 43 : $idCardVerify.hashCode());
        Object $inputFace = getInputFace();
        int result6 = (result5 * 59) + ($inputFace == null ? 43 : $inputFace.hashCode());
        Object $intervieweeFlag = getIntervieweeFlag();
        int result7 = (result6 * 59) + ($intervieweeFlag == null ? 43 : $intervieweeFlag.hashCode());
        ...
        int result9 = (result8 * 59) + ($passTimeList == null ? 43 : $passTimeList.hashCode());
        Object $cycleFlag = getCycleFlag();
        int result10 = (result9 * 59) + ($cycleFlag == null ? 43 : $cycleFlag.hashCode());
        Object $scope = getScope();
        int result11 = (result10 * 59) + ($scope == null ? 43 : $scope.hashCode());
        ...
        return (result13 * 59) + ($devices == null ? 43 : $devices.hashCode());
    }

    public String toString() {
        return "VisitConfigResponse(id=" + getId() + ", wallpaperUrl=" + getWallpaperUrl() + ", screensaverFlag=" + getScreensaverFlag() + ", screensaverUrl=" + getScreensaverUrl() + ", idCardVerify=" + getIdCardVerify() + ", inputFace=" + getInputFace() + ", intervieweeFlag=" + getIntervieweeFlag() + ", allDayFlag=" + getAllDayFlag() + ", passTimeList=" + getPassTimeList() + ", cycleFlag=" + getCycleFlag() + ", scope=" + getScope() + ", showContent=" + getShowContent() + ", speechContent=" + getSpeechContent() + ", devices=" + getDevices() + ")";
    }
