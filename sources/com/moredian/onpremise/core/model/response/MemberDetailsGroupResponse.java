...
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/MemberDetailsGroupResponse.class */
public class MemberDetailsGroupResponse implements Serializable {
    private static final long serialVersionUID = 8517368895652451365L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MemberDetailsGroupResponse)) {
            return false;
        }
        MemberDetailsGroupResponse other = (MemberDetailsGroupResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MemberDetailsGroupResponse;
    }
    ...
    public String toString() {
        return "MemberDetailsGroupResponse(groupId=" + getGroupId() + ", groupName=" + getGroupName() + ")";
    }
