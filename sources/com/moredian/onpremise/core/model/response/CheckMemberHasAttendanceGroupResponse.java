...
@ApiModel(description = "检查人员是否已经分配考勤组响应信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/CheckMemberHasAttendanceGroupResponse.class */
public class CheckMemberHasAttendanceGroupResponse implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckMemberHasAttendanceGroupResponse)) {
            return false;
        }
        CheckMemberHasAttendanceGroupResponse other = (CheckMemberHasAttendanceGroupResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CheckMemberHasAttendanceGroupResponse;
    }
    ...
    public int hashCode() {
        ...
        return (result6 * 59) + ($deptName == null ? 43 : $deptName.hashCode());
    }

    public String toString() {
        return "CheckMemberHasAttendanceGroupResponse(memberId=" + getMemberId() + ", memberName=" + getMemberName() + ", attendanceGroupId=" + getAttendanceGroupId() + ", attendanceGroupName=" + getAttendanceGroupName() + ", type=" + getType() + ", deptId=" + getDeptId() + ", deptName=" + getDeptName() + ")";
    }
