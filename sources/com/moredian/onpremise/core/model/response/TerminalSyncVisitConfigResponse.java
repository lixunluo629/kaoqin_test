...
@ApiModel(description = "终端同步访客配置响应信息")
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/TerminalSyncVisitConfigResponse.class */
public class TerminalSyncVisitConfigResponse implements Serializable {
    private static final long serialVersionUID = -1014618365086846658L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TerminalSyncVisitConfigResponse)) {
            return false;
        }
        TerminalSyncVisitConfigResponse other = (TerminalSyncVisitConfigResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TerminalSyncVisitConfigResponse;
    }
    ...
    public int hashCode() {
        ...
        int result3 = (result2 * 59) + ($wallpaperUrl == null ? 43 : $wallpaperUrl.hashCode());
        Object $screensaverFlag = getScreensaverFlag();
        int result4 = (result3 * 59) + ($screensaverFlag == null ? 43 : $screensaverFlag.hashCode());
    ...
    public String toString() {
        return "TerminalSyncVisitConfigResponse(id=" + getId() + ", orgId=" + getOrgId() + ", wallpaperUrl=" + getWallpaperUrl() + ", screensaverFlag=" + getScreensaverFlag() + ", screensaverUrl=" + getScreensaverUrl() + ", idCardVerify=" + getIdCardVerify() + ", inputFace=" + getInputFace() + ", intervieweeFlag=" + getIntervieweeFlag() + ", allDayFlag=" + getAllDayFlag() + ", passTimeList=" + getPassTimeList() + ", cycleFlag=" + getCycleFlag() + ", scope=" + getScope() + ", showContent=" + getShowContent() + ", speechContent=" + getSpeechContent() + ")";
    }
