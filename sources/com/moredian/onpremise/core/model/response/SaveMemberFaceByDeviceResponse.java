...
/* loaded from: onpremise-core-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/core/model/response/SaveMemberFaceByDeviceResponse.class */
public class SaveMemberFaceByDeviceResponse implements Serializable {
    private static final long serialVersionUID = 228043249778348258L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SaveMemberFaceByDeviceResponse)) {
            return false;
        }
        SaveMemberFaceByDeviceResponse other = (SaveMemberFaceByDeviceResponse) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SaveMemberFaceByDeviceResponse;
    }
    ...
    public String toString() {
        return "SaveMemberFaceByDeviceResponse(deptName=" + getDeptName() + ", verifyFaceUrl=" + getVerifyFaceUrl() + ", memberName=" + getMemberName() + ", memberMobile=" + getMemberMobile() + ")";
    }
