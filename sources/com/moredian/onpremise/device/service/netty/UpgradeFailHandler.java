...
import com.moredian.onpremise.model.DeviceUpgradeFailRequest;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

@Component
/* loaded from: onpremise-device-0.0.1-SNAPSHOT.jar:com/moredian/onpremise/device/service/netty/UpgradeFailHandler.class */
public class UpgradeFailHandler extends AbstractModelEventHandler<DeviceUpgradeFailRequest> {
    ...
    public void handle(DeviceUpgradeFailRequest model, IOTContext context) {
        ...
        this.upgradeRecordMapper.updateStatusByDeviceSn(deviceSn, DeviceUpgradeStatusEnum.WAITING_STATUS.getValue(), upgradeScheduleId, DeviceUpgradeStatusEnum.UPDATING_STATUS.getValue(), "设备无法连接服务端8023端口");
        UpgradeDeviceSchedule schedule = this.upgradeScheduleMapper.getOneByScheduleId(upgradeScheduleId);
        if (schedule != null && schedule.getUpgradeStatus().intValue() == UpgradeScheduleStatusEnum.WAITING.getValue()) {
