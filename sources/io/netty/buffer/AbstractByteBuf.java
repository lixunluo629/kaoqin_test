...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/buffer/AbstractByteBuf.class */
public abstract class AbstractByteBuf extends ByteBuf {
    ...
    final void checkIndex0(int index, int fieldLength) {
        if (checkBounds) {
            checkRangeBounds(BeanDefinitionParserDelegate.INDEX_ATTRIBUTE, index, fieldLength, capacity());
        }
    }
