...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/unix/NativeInetAddress.class */
public final class NativeInetAddress {
    ...
    public static InetSocketAddress address(byte[] addr, int offset, int len) throws UnknownHostException {
        InetAddress address;
