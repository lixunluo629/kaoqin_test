...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/kqueue/KQueueEventArray.class */
final class KQueueEventArray {
    ...
    void evSet(AbstractKQueueChannel ch2, short filter, short flags, int fflags) {
        ...
        evSet(getKEventOffset(r1) + this.memoryAddress, ch2.socket.intValue(), filter, flags, fflags);
    }
