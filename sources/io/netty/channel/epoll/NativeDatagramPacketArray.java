...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/epoll/NativeDatagramPacketArray.class */
final class NativeDatagramPacketArray {
    ...
    public boolean add0(ByteBuf buf, int index, int len, InetSocketAddress recipient) {
    ...
    /* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/epoll/NativeDatagramPacketArray$MyMessageProcessor.class */
    private final class MyMessageProcessor implements ChannelOutboundBuffer.MessageProcessor {
        ...
        public boolean processMessage(Object msg) {
            if (msg instanceof DatagramPacket) {
                ...
                return NativeDatagramPacketArray.this.add0(buf, buf.readerIndex(), buf.readableBytes(), packet.recipient());
            }
            if ((msg instanceof ByteBuf) && this.connected) {
                ByteBuf buf2 = (ByteBuf) msg;
                return NativeDatagramPacketArray.this.add0(buf2, buf2.readerIndex(), buf2.readableBytes(), null);
            }
            return false;
        }
    }

    /* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/epoll/NativeDatagramPacketArray$NativeDatagramPacket.class */
    final class NativeDatagramPacket {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void init(long memoryAddress, int count, InetSocketAddress recipient) {
        ...
        DatagramPacket newDatagramPacket(ByteBuf buffer, InetSocketAddress localAddress) throws UnknownHostException {
            ...
            if (this.addrLen == NativeDatagramPacketArray.this.ipv4Bytes.length) {
                ...
                address = Inet6Address.getByAddress((String) null, this.addr, this.scopeId);
            }
