...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/channel/epoll/EpollEventArray.class */
final class EpollEventArray {
    ...
    private int getInt(int index, int offset) {
        if (PlatformDependent.hasUnsafe()) {
            return PlatformDependent.getInt(this.memoryAddress + (index * EPOLL_EVENT_SIZE) + offset);
        }
