...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/ssl/JdkSslContext.class */
public class JdkSslContext extends SslContext {
    ...
    private static String[] defaultProtocols(SSLContext context, SSLEngine engine) {
        ...
        SslUtils.addIfSupported(supportedProtocolsSet, protocols, Constants.SSL_PROTO_TLSv1_2, Constants.SSL_PROTO_TLSv1_1, Constants.SSL_PROTO_TLSv1);
    ...
    private static boolean isTlsV13Supported(String[] protocols) {
        for (String protocol : protocols) {
            if (Constants.SSL_PROTO_TLSv1_3.equals(protocol)) {
                return true;
            }
        }
        return false;
