...
@Deprecated
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/ssl/JdkSslClientContext.class */
public final class JdkSslClientContext extends JdkSslContext {
    ...
    private static SSLContext newSSLContext(Provider sslContextProvider, X509Certificate[] trustCertCollection, TrustManagerFactory trustManagerFactory, X509Certificate[] keyCertChain, PrivateKey key, String keyPassword, KeyManagerFactory keyManagerFactory, long sessionCacheSize, long sessionTimeout, String keyStore) throws SSLException, KeyManagementException, IllegalArgumentException {
        ...
        SSLContext ctx = sslContextProvider == null ? SSLContext.getInstance(Constants.SSL_PROTO_TLS) : SSLContext.getInstance(Constants.SSL_PROTO_TLS, sslContextProvider);
