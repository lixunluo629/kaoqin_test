...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/socks/SocksCmdRequestDecoder.class */
public class SocksCmdRequestDecoder extends ReplayingDecoder<State> {
    private SocksCmdType cmdType;
    private SocksAddressType addressType;

    /* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/socks/SocksCmdRequestDecoder$State.class */
    enum State {
