...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/socks/SocksInitResponseDecoder.class */
public class SocksInitResponseDecoder extends ReplayingDecoder<State> {

    /* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/socks/SocksInitResponseDecoder$State.class */
    enum State {
