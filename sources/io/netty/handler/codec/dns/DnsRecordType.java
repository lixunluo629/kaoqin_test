...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/dns/DnsRecordType.class */
public class DnsRecordType implements Comparable<DnsRecordType> {
    ...
    public static final DnsRecordType RP = new DnsRecordType(17, StandardRoles.RP);
    ...
    public static final DnsRecordType TKEY = new DnsRecordType(EscherProperties.GEOTEXT__NOMEASUREALONGPATH, "TKEY");
    public static final DnsRecordType TSIG = new DnsRecordType(EscherProperties.GEOTEXT__BOLDFONT, "TSIG");
