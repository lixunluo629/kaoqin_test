...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/string/LineSeparator.class */
public final class LineSeparator {
    public static final LineSeparator DEFAULT = new LineSeparator(StringUtil.NEWLINE);
    public static final LineSeparator UNIX = new LineSeparator(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
