...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/websocketx/extensions/compression/PerMessageDeflateClientExtensionHandshaker.class */
public final class PerMessageDeflateClientExtensionHandshaker implements WebSocketClientExtensionHandshaker {
    ...
    public WebSocketExtensionData newRequestData() {
        ...
        return new WebSocketExtensionData(PerMessageDeflate.NAME, parameters);
    }

    @Override // io.netty.handler.codec.http.websocketx.extensions.WebSocketClientExtensionHandshaker
    public WebSocketClientExtension handshakeExtension(WebSocketExtensionData extensionData) throws NumberFormatException {
        if (!PerMessageDeflate.NAME.equals(extensionData.name())) {
            return null;
        }
    ...
    /* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/websocketx/extensions/compression/PerMessageDeflateClientExtensionHandshaker$PermessageDeflateExtension.class */
