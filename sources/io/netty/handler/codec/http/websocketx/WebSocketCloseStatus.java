...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/websocketx/WebSocketCloseStatus.class */
public final class WebSocketCloseStatus implements Comparable<WebSocketCloseStatus> {
    ...
    public String toString() {
        ...
        if (text == null) {
            String str = code() + SymbolConstants.SPACE_SYMBOL + reasonText();
            text = str;
            this.text = str;
        }
        return text;
