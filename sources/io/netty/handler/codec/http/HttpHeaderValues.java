...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/HttpHeaderValues.class */
public final class HttpHeaderValues {
    ...
    public static final AsciiString ATTACHMENT = AsciiString.cached(FileUploadBase.ATTACHMENT);
    ...
    public static final AsciiString FORM_DATA = AsciiString.cached(FileUploadBase.FORM_DATA);
    ...
    public static final AsciiString MULTIPART_MIXED = AsciiString.cached(FileUploadBase.MULTIPART_MIXED);
    ...
    public static final AsciiString TEXT_EVENT_STREAM = AsciiString.cached(MediaType.TEXT_EVENT_STREAM_VALUE);
    ...
    public static final AsciiString UPGRADE = AsciiString.cached(Constants.CONNECTION_HEADER_VALUE);
    public static final AsciiString WEBSOCKET = AsciiString.cached(Constants.UPGRADE_HEADER_VALUE);
