...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/HttpHeaderNames.class */
public final class HttpHeaderNames {
    ...
    public static final AsciiString SET_COOKIE = AsciiString.cached(RFC2109Spec.SET_COOKIE_KEY);
    public static final AsciiString SET_COOKIE2 = AsciiString.cached(RFC2965Spec.SET_COOKIE2_KEY);
    ...
    public static final AsciiString WARNING = AsciiString.cached(AsmRelationshipUtils.DECLARE_WARNING);
