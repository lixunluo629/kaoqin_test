...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/http/HttpResponseStatus.class */
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
    ...
    public static final HttpResponseStatus PERMANENT_REDIRECT = newStatus(TokenId.CONST, "Permanent Redirect");
    ...
    public static final HttpResponseStatus UPGRADE_REQUIRED = newStatus(UserSViewBegin.sid, "Upgrade Required");
    ...
    public static final HttpResponseStatus REQUEST_HEADER_FIELDS_TOO_LARGE = newStatus(ProtectionRev4Record.sid, "Request Header Fields Too Large");
    ...
    public static final HttpResponseStatus NOT_EXTENDED = newStatus(EscherProperties.LINESTYLE__LINEFILLSHAPE, "Not Extended");
    ...
    private static HttpResponseStatus valueOf0(int code) {
        switch (code) {
            ...
            case EscherProperties.LINESTYLE__LINEFILLSHAPE /* 510 */:
                return NOT_EXTENDED;
            case 511:
