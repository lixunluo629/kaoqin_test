...
/* loaded from: netty-all-4.1.50.Final.jar:io/netty/handler/codec/stomp/StompHeaders.class */
public interface StompHeaders extends Headers<CharSequence, CharSequence, StompHeaders> {
    ...
    public static final AsciiString MESSAGE = AsciiString.cached(ConstraintHelper.MESSAGE);
