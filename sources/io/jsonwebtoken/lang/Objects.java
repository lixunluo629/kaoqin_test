...
/* loaded from: jjwt-0.6.0.jar:io/jsonwebtoken/lang/Objects.class */
public abstract class Objects {
    ...
    public static boolean isCompatibleWithThrowsClause(Throwable ex, Class[] declaredExceptions) {
        ...
        if (declaredExceptions != null) {
            for (Class cls : declaredExceptions) {
    ...
    public static Object[] toObjectArray(Object source) {
        ...
        Object[] newArray = (Object[]) Array.newInstance((Class<?>) wrapperType, length);
    ...
    public static int nullSafeHashCode(Object[] array) {
        ...
        for (Object obj : array) {
            hash = (31 * hash) + nullSafeHashCode(obj);
        }
        return hash;
    }
    ...
    public static int hashCode(boolean bool) {
        return bool ? MysqlErrorNumbers.ER_WRONG_VALUE_FOR_VAR : MysqlErrorNumbers.ER_SLAVE_IGNORED_TABLE;
    }
    ...
    public static void nullSafeClose(Closeable... closeables) throws IOException {
        if (closeables == null) {
            return;
        }
