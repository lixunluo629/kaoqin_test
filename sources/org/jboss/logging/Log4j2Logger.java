...
/* loaded from: jboss-logging-3.3.2.Final.jar:org/jboss/logging/Log4j2Logger.class */
final class Log4j2Logger extends Logger {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: org.apache.logging.log4j.LoggingException */
    Log4j2Logger(String name) throws LoggingException {
        super(name);
        AbstractLogger logger = LogManager.getLogger(name);
