...
/* loaded from: jboss-logging-3.3.2.Final.jar:org/jboss/logging/Slf4jLogger.class */
final class Slf4jLogger extends Logger {
    ...
    /* JADX WARN: Removed duplicated region for block: B:8:0x0013 A[Catch: Throwable -> 0x009f, TryCatch #0 {Throwable -> 0x009f, blocks: (B:6:0x000d, B:9:0x001a, B:10:0x0023, B:12:0x002c, B:13:0x003c, B:15:0x0043, B:16:0x0053, B:18:0x005a, B:21:0x0071, B:23:0x0078, B:24:0x0088, B:26:0x008f, B:20:0x0061, B:8:0x0013), top: B:30:0x000d }] */
    ...
    protected void doLogf(Logger.Level level, String loggerClassName, String format, Object[] parameters, Throwable thrown) {
        if (isEnabled(level)) {
            try {
                ...
                } else if (level == Logger.Level.DEBUG || level == Logger.Level.TRACE) {
