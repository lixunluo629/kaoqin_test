...
/* loaded from: jboss-logging-3.3.2.Final.jar:org/jboss/logging/JDKLevel.class */
final class JDKLevel extends Level {
    private static final long serialVersionUID = 1;
    public static final JDKLevel FATAL = new JDKLevel("FATAL", MysqlErrorNumbers.ER_TABLE_NOT_LOCKED);
