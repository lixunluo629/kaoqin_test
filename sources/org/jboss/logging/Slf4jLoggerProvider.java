...
/* loaded from: jboss-logging-3.3.2.Final.jar:org/jboss/logging/Slf4jLoggerProvider.class */
final class Slf4jLoggerProvider extends AbstractLoggerProvider implements LoggerProvider {
    ...
    @Override // org.jboss.logging.LoggerProvider
    public Object putMdc(String key, Object value) throws IllegalArgumentException {
        try {
