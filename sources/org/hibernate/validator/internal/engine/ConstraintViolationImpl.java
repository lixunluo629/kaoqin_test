...
/* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/internal/engine/ConstraintViolationImpl.class */
public class ConstraintViolationImpl<T> implements HibernateConstraintViolation<T>, Serializable {
    ...
    public static <T> ConstraintViolation<T> forBeanValidation(String messageTemplate, Map<String, Object> expressionVariables, String interpolatedMessage, Class<T> rootBeanClass, T rootBean, Object leafBeanInstance, Object value, Path propertyPath, ConstraintDescriptor<?> constraintDescriptor, ElementType elementType, Object dynamicPayload) {
        return new ConstraintViolationImpl(messageTemplate, expressionVariables, interpolatedMessage, rootBeanClass, rootBean, leafBeanInstance, value, propertyPath, constraintDescriptor, elementType, null, null, dynamicPayload);
    }

    public static <T> ConstraintViolation<T> forParameterValidation(String messageTemplate, Map<String, Object> expressionVariables, String interpolatedMessage, Class<T> rootBeanClass, T rootBean, Object leafBeanInstance, Object value, Path propertyPath, ConstraintDescriptor<?> constraintDescriptor, ElementType elementType, Object[] executableParameters, Object dynamicPayload) {
        return new ConstraintViolationImpl(messageTemplate, expressionVariables, interpolatedMessage, rootBeanClass, rootBean, leafBeanInstance, value, propertyPath, constraintDescriptor, elementType, executableParameters, null, dynamicPayload);
    }

    public static <T> ConstraintViolation<T> forReturnValueValidation(String messageTemplate, Map<String, Object> expressionVariables, String interpolatedMessage, Class<T> rootBeanClass, T rootBean, Object leafBeanInstance, Object value, Path propertyPath, ConstraintDescriptor<?> constraintDescriptor, ElementType elementType, Object executableReturnValue, Object dynamicPayload) {
        return new ConstraintViolationImpl(messageTemplate, expressionVariables, interpolatedMessage, rootBeanClass, rootBean, leafBeanInstance, value, propertyPath, constraintDescriptor, elementType, null, executableReturnValue, dynamicPayload);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.leafBeanInstance != null) {
            if (!this.leafBeanInstance.equals(that.leafBeanInstance)) {
                return false;
            }
        ...
        if (this.rootBeanClass != null) {
            if (!this.rootBeanClass.equals(that.rootBeanClass)) {
                return false;
            }
        } else if (that.rootBeanClass != null) {
            return false;
        }
        if (this.value != null) {
    ...
    private int createHashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + (this.propertyPath != null ? this.propertyPath.hashCode() : 0))) + (this.rootBean != null ? this.rootBean.hashCode() : 0))) + (this.leafBeanInstance != null ? this.leafBeanInstance.hashCode() : 0))) + (this.value != null ? this.value.hashCode() : 0))) + (this.constraintDescriptor != null ? this.constraintDescriptor.hashCode() : 0))) + (this.messageTemplate != null ? this.messageTemplate.hashCode() : 0))) + (this.rootBeanClass != null ? this.rootBeanClass.hashCode() : 0))) + (this.elementType != null ? this.elementType.hashCode() : 0);
    }
}
