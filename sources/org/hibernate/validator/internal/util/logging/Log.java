...
/* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/internal/util/logging/Log.class */
public interface Log extends BasicLogger {
    ...
    UnexpectedTypeException getNoValidatorFoundForTypeException(String str, String str2, String str3);
    ...
    UnexpectedTypeException getConstraintValidatorExistsForWrapperAndWrappedValueException(String str, String str2, String str3);
    ...
    ValidationException getTypeAnnotationConstraintOnIterableRequiresUseOfValidAnnotationException(String str, String str2);

    @LogMessage(level = Logger.Level.DEBUG)
    @Message(id = 188, value = "Parameterized type with more than one argument is not supported: %s")
    void parameterizedTypeWithMoreThanOneTypeArgumentIsNotSupported(String str);
    ...
    ConstraintDeclarationException getInconsistentValueUnwrappingConfigurationBetweenFieldAndItsGetterException(String str, String str2);
    ...
    ValidationException validatedValueUnwrapperCannotBeCreated(String str, @Cause Exception exc);
    ...
    ValidationException getConstraintHasAlreadyBeenConfiguredViaProgrammaticApiException(String str);
