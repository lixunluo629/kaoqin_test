...
/* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/internal/util/logging/Messages_$bundle.class */
public class Messages_$bundle implements Messages, Serializable {
    ...
    public final String mustNotBeNull(String parameterName) {
        return String.format(mustNotBeNull1$str(), parameterName);
    }
    ...
    public final String parameterMustNotBeNull(String parameterName) {
        return String.format(parameterMustNotBeNull$str(), parameterName);
    }
    ...
    public final String parameterMustNotBeEmpty(String parameterName) {
        return String.format(parameterMustNotBeEmpty$str(), parameterName);
    }
    ...
    public final String unableToFindScriptEngine(String languageName) {
        return String.format(unableToFindScriptEngine$str(), languageName);
    }
    ...
    public final String constraintOnConstructorOfNonStaticInnerClass() {
        return String.format(constraintOnConstructorOfNonStaticInnerClass$str(), new Object[0]);
    }
    ...
    public final String parameterizedTypesWithMoreThanOneTypeArgument() {
        return String.format(parameterizedTypesWithMoreThanOneTypeArgument$str(), new Object[0]);
    }
    ...
    public final String unableToUseResourceBundleAggregation() {
        return String.format(unableToUseResourceBundleAggregation$str(), new Object[0]);
    }
