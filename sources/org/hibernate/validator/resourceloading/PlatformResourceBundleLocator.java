...
/* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/resourceloading/PlatformResourceBundleLocator.class */
public class PlatformResourceBundleLocator implements ResourceBundleLocator {
    ...
    private static boolean determineAvailabilityOfResourceBundleControl() {
        try {
            ResourceBundle.Control control = AggregateResourceBundle.CONTROL;
            return true;
    ...
    /* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/resourceloading/PlatformResourceBundleLocator$AggregateResourceBundle.class */
    ...
    /* loaded from: hibernate-validator-5.3.6.Final.jar:org/hibernate/validator/resourceloading/PlatformResourceBundleLocator$AggregateResourceBundleControl.class */
