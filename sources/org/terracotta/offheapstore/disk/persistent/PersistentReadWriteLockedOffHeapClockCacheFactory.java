...
/* loaded from: ehcache-3.2.3.jar:org/terracotta/offheapstore/disk/persistent/PersistentReadWriteLockedOffHeapClockCacheFactory.class */
public class PersistentReadWriteLockedOffHeapClockCacheFactory<K, V> implements Factory<PersistentReadWriteLockedOffHeapClockCache<K, V>> {
    ...
    public PersistentReadWriteLockedOffHeapClockCache<K, V> newInstance() {
        ...
        try {
            return new PersistentReadWriteLockedOffHeapClockCache<>(this.tableSource, storageEngine, this.tableSize, this.bootstrap);
