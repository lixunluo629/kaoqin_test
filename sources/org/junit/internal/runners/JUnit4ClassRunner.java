...
@Deprecated
/* loaded from: junit-4.12.jar:org/junit/internal/runners/JUnit4ClassRunner.class */
public class JUnit4ClassRunner extends Runner implements Filterable, Sortable {
    private final List<Method> testMethods = getTestMethods();
    private TestClass testClass;

    public JUnit4ClassRunner(Class<?> klass) throws SecurityException, InitializationError {
    ...
    protected void validate() throws SecurityException, InitializationError {
    ...
    protected void runMethods(RunNotifier notifier) throws StoppedByUserException {
    ...
    protected void invokeTestMethod(Method method, RunNotifier notifier) throws StoppedByUserException {
    ...
    private void testAborted(RunNotifier notifier, Description description, Throwable e) throws StoppedByUserException {
