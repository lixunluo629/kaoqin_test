...
/* loaded from: junit-4.12.jar:org/junit/internal/runners/statements/FailOnTimeout.class */
public class FailOnTimeout extends Statement {
    ...
    /* loaded from: junit-4.12.jar:org/junit/internal/runners/statements/FailOnTimeout$Builder.class */
    ...
    private Thread getStuckThread(Thread mainThread) {
        ...
        if (this.threadGroup == null || (threadsInGroup = getThreadArray(this.threadGroup)) == null) {
            return null;
        }
    ...
    /* loaded from: junit-4.12.jar:org/junit/internal/runners/statements/FailOnTimeout$CallableStatement.class */
