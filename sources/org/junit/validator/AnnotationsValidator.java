...
/* loaded from: junit-4.12.jar:org/junit/validator/AnnotationsValidator.class */
public final class AnnotationsValidator implements TestClassValidator {
    ...
    public List<Exception> validateTestClass(TestClass testClass) throws IllegalAccessException, InstantiationException {
    ...
    /* loaded from: junit-4.12.jar:org/junit/validator/AnnotationsValidator$AnnotatableValidator.class */
    private static abstract class AnnotatableValidator<T extends Annotatable> {
        ...
        private List<Exception> validateAnnotatable(T annotatable) throws IllegalAccessException, InstantiationException {
            List<Exception> validationErrors = new ArrayList<>();
    ...
    /* loaded from: junit-4.12.jar:org/junit/validator/AnnotationsValidator$ClassValidator.class */
    ...
    /* loaded from: junit-4.12.jar:org/junit/validator/AnnotationsValidator$MethodValidator.class */
    ...
    /* loaded from: junit-4.12.jar:org/junit/validator/AnnotationsValidator$FieldValidator.class */
