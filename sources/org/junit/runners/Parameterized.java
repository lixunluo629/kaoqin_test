...
/* loaded from: junit-4.12.jar:org/junit/runners/Parameterized.class */
public class Parameterized extends Suite {
    ...
    /* loaded from: junit-4.12.jar:org/junit/runners/Parameterized$Parameter.class */
    ...
    @Retention(RetentionPolicy.RUNTIME)
    /* loaded from: junit-4.12.jar:org/junit/runners/Parameterized$Parameters.class */
    ...
    @Retention(RetentionPolicy.RUNTIME)
    /* loaded from: junit-4.12.jar:org/junit/runners/Parameterized$UseParametersRunnerFactory.class */
    ...
    private ParametersRunnerFactory getParametersRunnerFactory(Class<?> klass) throws IllegalAccessException, InstantiationException {
    ...
    private static TestWithParameters createTestWithParameters(TestClass testClass, String pattern, int index, Object[] parameters) {
        ...
        return new TestWithParameters(PropertyAccessor.PROPERTY_KEY_PREFIX + name + "]", testClass, Arrays.asList(parameters));
    }
}
