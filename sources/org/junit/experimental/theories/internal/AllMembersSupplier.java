...
/* loaded from: junit-4.12.jar:org/junit/experimental/theories/internal/AllMembersSupplier.class */
public class AllMembersSupplier extends ParameterSupplier {
    private final TestClass clazz;

    /* loaded from: junit-4.12.jar:org/junit/experimental/theories/internal/AllMembersSupplier$MethodParameterValue.class */
    ...
    private void addMultiPointFields(ParameterSignature sig, List<PotentialAssignment> list) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    private void addDataPointsValues(Class<?> type, ParameterSignature sig, String name, List<PotentialAssignment> list, Object value) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (type.isArray()) {
    ...
    private void addArrayValues(ParameterSignature sig, String name, List<PotentialAssignment> list, Object array) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        for (int i = 0; i < Array.getLength(array); i++) {
            Object value = Array.get(array, i);
            if (sig.canAcceptValue(value)) {
                list.add(PotentialAssignment.forValue(name + PropertyAccessor.PROPERTY_KEY_PREFIX + i + "]", value));
            }
        }
    }
