...
/* loaded from: junit-4.12.jar:org/junit/experimental/theories/Theories.class */
public class Theories extends BlockJUnit4ClassRunner {
    ...
    protected void collectInitializationErrors(List<Throwable> errors) throws SecurityException {
    ...
    private void validateDataPointMethods(List<Throwable> errors) throws SecurityException {
    ...
    @Override // org.junit.runners.BlockJUnit4ClassRunner
    protected void validateTestMethods(List<Throwable> errors) throws SecurityException {
    ...
    private void validateParameterSupplier(Class<? extends ParameterSupplier> supplierClass, List<Throwable> errors) throws SecurityException {
    ...
    /* loaded from: junit-4.12.jar:org/junit/experimental/theories/Theories$TheoryAnchor.class */
