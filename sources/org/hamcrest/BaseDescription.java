...
/* loaded from: hamcrest-core-1.3.jar:org/hamcrest/BaseDescription.class */
public abstract class BaseDescription implements Description {
    ...
    public Description appendValue(Object value) {
        if (value == null) {
            ...
            appendValueList(PropertyAccessor.PROPERTY_KEY_PREFIX, ", ", "]", new ArrayIterator(value));
        } else {
            append('<');
            append(descriptionOf(value));
            append('>');
    ...
    private void toJavaSyntax(char ch2) {
        switch (ch2) {
            case '\t':
                append("\\t");
                break;
