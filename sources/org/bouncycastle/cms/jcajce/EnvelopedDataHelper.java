...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cms/jcajce/EnvelopedDataHelper.class */
public class EnvelopedDataHelper {
    ...
    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cms/jcajce/EnvelopedDataHelper$JCECallback.class */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v4, types: [org.bouncycastle.asn1.ASN1Encodable] */
    AlgorithmIdentifier getAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmParameters algorithmParameters) throws CMSException {
        return new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) (algorithmParameters != null ? CMSUtils.extractParameters(algorithmParameters) : DERNull.INSTANCE));
    }
    ...
    public AlgorithmIdentifier getAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmParameterSpec algorithmParameterSpec) {
        ...
        if (effectiveKeyBits != -1) {
            return new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) new RC2CBCParameter(effectiveKeyBits < 256 ? rc2Table[effectiveKeyBits] : effectiveKeyBits, rC2ParameterSpec.getIV()));
        }
    ...
    byte[] calculateDerivedKey(int i, char[] cArr, AlgorithmIdentifier algorithmIdentifier, int i2) throws CMSException {
        ...
        try {
            return (i == 0 ? this.helper.createSecretKeyFactory("PBKDF2with8BIT") : this.helper.createSecretKeyFactory((String) PBKDF2_ALG_NAMES.get(pBKDF2Params.getPrf()))).generateSecret(new PBEKeySpec(cArr, pBKDF2Params.getSalt(), pBKDF2Params.getIterationCount().intValue(), i2)).getEncoded();
        } catch (GeneralSecurityException e) {
    ...
    static {
        ...
        BASE_CIPHER_NAMES.put(CMSAlgorithm.AES128_CBC, RSAUtils.AES_KEY_ALGORITHM);
        BASE_CIPHER_NAMES.put(CMSAlgorithm.AES192_CBC, RSAUtils.AES_KEY_ALGORITHM);
        BASE_CIPHER_NAMES.put(CMSAlgorithm.AES256_CBC, RSAUtils.AES_KEY_ALGORITHM);
