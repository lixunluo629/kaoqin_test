...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cms/DefaultCMSSignatureAlgorithmNameGenerator.class */
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public DefaultCMSSignatureAlgorithmNameGenerator() {
        ...
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_224, "SHA3-224", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_256, "SHA3-256", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_384, "SHA3-384", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_512, "SHA3-512", RSAUtils.RSA_KEY_ALGORITHM);
        ...
        addEntries(OIWObjectIdentifiers.md4WithRSA, "MD4", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(OIWObjectIdentifiers.md4WithRSAEncryption, "MD4", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(OIWObjectIdentifiers.md5WithRSA, MessageDigestAlgorithms.MD5, RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(OIWObjectIdentifiers.sha1WithRSA, "SHA1", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md2WithRSAEncryption, MessageDigestAlgorithms.MD2, RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md4WithRSAEncryption, "MD4", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md5WithRSAEncryption, MessageDigestAlgorithms.MD5, RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha1WithRSAEncryption, "SHA1", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha224WithRSAEncryption, "SHA224", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha256WithRSAEncryption, "SHA256", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha384WithRSAEncryption, "SHA384", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha512WithRSAEncryption, "SHA512", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd128, "RIPEMD128", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd160, "RIPEMD160", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd256, "RIPEMD256", RSAUtils.RSA_KEY_ALGORITHM);
        ...
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_1, "SHA1", RSAUtils.RSA_KEY_ALGORITHM);
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_256, "SHA256", RSAUtils.RSA_KEY_ALGORITHM);
        ...
        this.encryptionAlgs.put(PKCSObjectIdentifiers.rsaEncryption, RSAUtils.RSA_KEY_ALGORITHM);
        this.encryptionAlgs.put(TeleTrusTObjectIdentifiers.teleTrusTRSAsignatureAlgorithm, RSAUtils.RSA_KEY_ALGORITHM);
        this.encryptionAlgs.put(X509ObjectIdentifiers.id_ea_rsa, RSAUtils.RSA_KEY_ALGORITHM);
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        return !digestAlgName.equals(algorithmIdentifier2.getAlgorithm().getId()) ? digestAlgName + JsonPOJOBuilder.DEFAULT_WITH_PREFIX + getEncryptionAlgName(algorithmIdentifier2.getAlgorithm()) : getDigestAlgName(algorithmIdentifier.getAlgorithm()) + JsonPOJOBuilder.DEFAULT_WITH_PREFIX + getEncryptionAlgName(algorithmIdentifier2.getAlgorithm());
    }
}
