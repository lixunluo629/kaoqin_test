...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cms/PasswordRecipientInfoGenerator.class */
public abstract class PasswordRecipientInfoGenerator implements RecipientInfoGenerator {
    ...
    public RecipientInfo generate(GenericKey genericKey) throws CMSException {
        ...
        DEROctetString dEROctetString = new DEROctetString(generateEncryptedBytes(new AlgorithmIdentifier(this.kekAlgorithm, (ASN1Encodable) new DEROctetString(bArr)), calculateDerivedKey(this.schemeID, this.keyDerivationAlgorithm, this.keySize), genericKey));
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add((ASN1Encodable) this.kekAlgorithm);
        aSN1EncodableVector.add((ASN1Encodable) new DEROctetString(bArr));
