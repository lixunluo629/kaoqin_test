...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/ocsp/BasicOCSPRespBuilder.class */
public class BasicOCSPRespBuilder {
    private List list = new ArrayList();
    private Extensions responseExtensions = null;
    private RespID responderID;

    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/ocsp/BasicOCSPRespBuilder$ResponseObject.class */
    private class ResponseObject {
        ...
        /* JADX WARN: Type inference failed for: r1v5, types: [org.bouncycastle.asn1.ASN1GeneralizedTime, org.bouncycastle.asn1.DERGeneralizedTime] */
        /* JADX WARN: Type inference failed for: r1v8, types: [org.bouncycastle.asn1.ASN1GeneralizedTime, org.bouncycastle.asn1.DERGeneralizedTime] */
    ...
    public BasicOCSPResp build(ContentSigner contentSigner, X509CertificateHolder[] x509CertificateHolderArr, Date date) throws OCSPException, IOException {
        ...
        while (it.hasNext()) {
            try {
                aSN1EncodableVector.add((ASN1Encodable) ((ResponseObject) it.next()).toResponse());
            } catch (Exception e) {
        ...
        try {
            ...
            if (x509CertificateHolderArr != null && x509CertificateHolderArr.length > 0) {
                ...
                for (int i = 0; i != x509CertificateHolderArr.length; i++) {
                    aSN1EncodableVector2.add((ASN1Encodable) x509CertificateHolderArr[i].toASN1Structure());
                }
