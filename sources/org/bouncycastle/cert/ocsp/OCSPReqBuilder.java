...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/ocsp/OCSPReqBuilder.class */
public class OCSPReqBuilder {
    private List list = new ArrayList();
    private GeneralName requestorName = null;
    private Extensions requestExtensions = null;

    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/ocsp/OCSPReqBuilder$RequestObject.class */
    ...
    private OCSPReq generateRequest(ContentSigner contentSigner, X509CertificateHolder[] x509CertificateHolderArr) throws OCSPException, IOException {
        ...
        while (it.hasNext()) {
            try {
                aSN1EncodableVector.add((ASN1Encodable) ((RequestObject) it.next()).toRequest());
            } catch (Exception e) {
