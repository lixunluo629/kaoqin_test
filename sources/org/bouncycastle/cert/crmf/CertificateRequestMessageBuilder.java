...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/crmf/CertificateRequestMessageBuilder.class */
public class CertificateRequestMessageBuilder {
    ...
    public CertificateRequestMessage build() throws CRMFException {
        ...
        aSN1EncodableVector3.add((ASN1Encodable) certRequest);
        if (this.popSigner != null) {
            ...
            if (certTemplate.getSubject() == null || certTemplate.getPublicKey() == null) {
                ...
                aSN1EncodableVector3.add((ASN1Encodable) new ProofOfPossession(new ProofOfPossessionSigningKeyBuilder(certRequest).build(this.popSigner)));
            }
        } else if (this.popoPrivKey != null) {
            aSN1EncodableVector3.add((ASN1Encodable) new ProofOfPossession(this.popoType, this.popoPrivKey));
        } else if (this.agreeMAC != null) {
            aSN1EncodableVector3.add((ASN1Encodable) new ProofOfPossession(3, POPOPrivKey.getInstance(new DERTaggedObject(false, 3, (ASN1Encodable) this.agreeMAC))));
