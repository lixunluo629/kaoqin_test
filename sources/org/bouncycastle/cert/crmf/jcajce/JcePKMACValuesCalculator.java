...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/crmf/jcajce/JcePKMACValuesCalculator.class */
public class JcePKMACValuesCalculator implements PKMACValuesCalculator {
    ...
    @Override // org.bouncycastle.cert.crmf.PKMACValuesCalculator
    public byte[] calculateMac(byte[] bArr, byte[] bArr2) throws CRMFException, InvalidKeyException {
        try {
