...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/crmf/jcajce/CRMFHelper.class */
class CRMFHelper {
    ...
    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/crmf/jcajce/CRMFHelper$JCECallback.class */
    ...
    static {
        ...
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes128_CBC, RSAUtils.AES_KEY_ALGORITHM);
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes192_CBC, RSAUtils.AES_KEY_ALGORITHM);
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes256_CBC, RSAUtils.AES_KEY_ALGORITHM);
        ...
        KEY_ALG_NAMES.put(PKCSObjectIdentifiers.rsaEncryption, RSAUtils.RSA_KEY_ALGORITHM);
