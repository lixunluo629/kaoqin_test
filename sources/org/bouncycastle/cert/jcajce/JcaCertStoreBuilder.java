...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/jcajce/JcaCertStoreBuilder.class */
public class JcaCertStoreBuilder {
    ...
    public CertStore build() throws GeneralSecurityException {
        ...
        return this.provider instanceof String ? CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders, (String) this.provider) : this.provider instanceof Provider ? CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders, (Provider) this.provider) : CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders);
    }
