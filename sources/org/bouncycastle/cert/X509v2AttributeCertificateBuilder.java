...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/cert/X509v2AttributeCertificateBuilder.class */
public class X509v2AttributeCertificateBuilder {
    ...
    public X509v2AttributeCertificateBuilder addAttribute(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Encodable[] aSN1EncodableArr) {
        this.acInfoGen.addAttribute(new Attribute(aSN1ObjectIdentifier, (ASN1Set) new DERSet(aSN1EncodableArr)));
        return this;
    }
    ...
    public X509v2AttributeCertificateBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z, ASN1Encodable aSN1Encodable) throws CertIOException {
        try {
            this.extGenerator = CertUtils.doReplaceExtension(this.extGenerator, new Extension(aSN1ObjectIdentifier, z, aSN1Encodable.toASN1Primitive().getEncoded("DER")));
            return this;
        } catch (IOException e) {
