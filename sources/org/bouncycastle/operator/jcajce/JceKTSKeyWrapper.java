...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/operator/jcajce/JceKTSKeyWrapper.class */
public class JceKTSKeyWrapper extends AsymmetricKeyWrapper {
    ...
    public JceKTSKeyWrapper(PublicKey publicKey, String str, int i, byte[] bArr, byte[] bArr2) {
        super(new AlgorithmIdentifier(PKCSObjectIdentifiers.id_rsa_KEM, (ASN1Encodable) new GenericHybridParameters(new AlgorithmIdentifier(ISOIECObjectIdentifiers.id_kem_rsa, (ASN1Encodable) new RsaKemParameters(new AlgorithmIdentifier(X9ObjectIdentifiers.id_kdf_kdf3, (ASN1Encodable) new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256)), (i + 7) / 8)), JceSymmetricKeyWrapper.determineKeyEncAlg(str, i))));
    ...
    public byte[] generateWrappedKey(GenericKey genericKey) throws InvalidKeyException, OperatorException, InvalidAlgorithmParameterException {
