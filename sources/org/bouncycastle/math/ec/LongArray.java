...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/LongArray.class */
class LongArray implements Cloneable {
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            int i5 = i3 >>> 8;
            i2 = i5 == 0 ? bitLengths[i3] : 8 + bitLengths[i5];
        } else {
            int i6 = i4 >>> 8;
            i2 = i6 == 0 ? 16 + bitLengths[i4] : 24 + bitLengths[i6];
        }
        return i + i2;
    }
    ...
    public BigInteger toBigInteger() {
        ...
        byte[] bArr2 = new byte[(8 * (usedLength - 1)) + i];
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        long[] jArr2 = new long[i5 << 4];
        int i6 = i5;
        iArr2[1] = i6;
        System.arraycopy(longArray3.m_ints, 0, jArr2, i6, i3);
        for (int i7 = 2; i7 < 16; i7++) {
            int i8 = i6 + i5;
            i6 = i8;
            iArr2[i7] = i8;
            if ((i7 & 1) == 0) {
                shiftUp(jArr2, i6 >>> 1, jArr2, i6, i5, 1);
            } else {
                add(jArr2, i5, jArr2, i6 - i5, jArr2, i6, i5);
            }
        }
        ...
        for (int i9 = 56; i9 >= 0; i9 -= 8) {
            for (int i10 = 1; i10 < i2; i10 += 2) {
                ...
                addBoth(jArr5, i10 - 1, jArr2, iArr2[i11 & 15], jArr3, iArr2[(i11 >>> 4) & 15], i5);
            }
            shiftUp(jArr5, 0, i4, 8);
        }
        for (int i12 = 56; i12 >= 0; i12 -= 8) {
            for (int i13 = 0; i13 < i2; i13 += 2) {
                int i14 = (int) (jArr4[i13] >>> i12);
                addBoth(jArr5, i13, jArr2, iArr2[i14 & 15], jArr3, iArr2[(i14 >>> 4) & 15], i5);
            }
            if (i12 > 0) {
                shiftUp(jArr5, 0, i4, 8);
            }
        }
        return reduceResult(jArr5, 0, i4, i, iArr);
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i9 = 0; i9 < i2; i9++) {
            ...
            while (true) {
                int i11 = i10;
                long j3 = j2 >>> 4;
                addBoth(jArr5, i11, jArr2, iArr2[((int) j2) & 15], jArr3, iArr2[((int) j3) & 15], i5);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            addShiftedUp(jArr5, length - i4, jArr5, length, i4, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        int i5 = ((iDegree2 + (64 < 64 ? 16 : 16 - 1)) + 63) >>> 6;
        int i6 = i5 * 8;
        int i7 = 4 * 8;
        int[] iArr2 = new int[1 << 4];
        iArr2[0] = i2;
        int i8 = i2 + i6;
        iArr2[1] = i8;
        ...
        long[] jArr2 = new long[i8 + i4 + 1];
        interleave(longArray2.m_ints, 0, jArr2, 0, i2, 4);
        int i10 = i2;
        System.arraycopy(longArray3.m_ints, 0, jArr2, i10, i3);
        for (int i11 = 1; i11 < 8; i11++) {
            int i12 = i10 + i5;
            i10 = i12;
            shiftUp(jArr2, i2, jArr2, i12, i5, i11);
        }
        int i13 = (1 << 4) - 1;
        int i14 = 0;
        while (true) {
            ...
            do {
                ...
                while (true) {
                    int i18 = ((int) j2) & i13;
                    if (i18 != 0) {
                        add(jArr2, i15 + iArr2[i18], jArr2, i17, i5);
                    }
                    i16++;
                    if (i16 == 8) {
                        break;
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            ...
            length = i12;
            if (i12 == 0) {
                return new LongArray(jArr5, 0, i4);
            }
            addShiftedUp(jArr5, length - i4, jArr5, length, i4, 8);
        }
    }
    ...
    private static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        int iMax = Math.max(i3, i6 + 64);
        int iMin2 = (i5 + Math.min(iMin - iMax, i3 - i7)) >> 6;
        if (iMin2 > 1) {
            int i8 = i2 - iMin2;
            reduceVectorWise(jArr, i, i2, i8, i3, iArr);
            while (i2 > i8) {
                i2--;
                jArr[i + i2] = 0;
            }
        ...
        if (iMin > iMax) {
            reduceWordWise(jArr, i, i2, iMax, i3, iArr);
            iMin = iMax;
        }
        if (iMin > i3) {
            reduceBitWise(jArr, i, iMin, i3, iArr);
        }
        return i4;
    }
    ...
    private static void reduceWord(long[] jArr, int i, int i2, long j, int i3, int[] iArr) {
        ...
        while (true) {
            ...
            flipWord(jArr, i, i4 + iArr[length], j);
        }
    }
    ...
    private static void flipVector(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        ...
        if (i6 == 0) {
            ...
            jArr[i5] = jArr[i5] ^ addShiftedDown(jArr, i5 + 1, jArr2, i2, i3, 64 - i6);
        }
    }
    ...
    public LongArray modSquare(int i, int[] iArr) {
        ...
        while (i3 < i2) {
            ...
            int i4 = i3;
            int i5 = i3 + 1;
            jArr[i4] = interleave2_32to64((int) j);
            i3 = i5 + 1;
            jArr[i5] = interleave2_32to64((int) (j >>> 32));
        }
    ...
    private static long interleave3(long j) {
        return (j & Long.MIN_VALUE) | interleave3_21to63(((int) j) & 2097151) | (interleave3_21to63(((int) (j >>> 21)) & 2097151) << 1) | (interleave3_21to63(((int) (j >>> 42)) & 2097151) << 2);
    }

    private static long interleave3_21to63(int i) {
        return ((INTERLEAVE3_TABLE[i >>> 14] & 4294967295L) << 42) | ((INTERLEAVE3_TABLE[(i >>> 7) & 127] & 4294967295L) << 21) | (INTERLEAVE3_TABLE[i & 127] & 4294967295L);
    }
    ...
    private static long interleave3_13to65(int i) {
        return ((INTERLEAVE5_TABLE[i >>> 7] & 4294967295L) << 35) | (INTERLEAVE5_TABLE[i & 127] & 4294967295L);
    }
    ...
    private static long interleave7(long j) {
        return (j & Long.MIN_VALUE) | INTERLEAVE7_TABLE[((int) j) & 511] | (INTERLEAVE7_TABLE[((int) (j >>> 9)) & 511] << 1) | (INTERLEAVE7_TABLE[((int) (j >>> 18)) & 511] << 2) | (INTERLEAVE7_TABLE[((int) (j >>> 27)) & 511] << 3) | (INTERLEAVE7_TABLE[((int) (j >>> 36)) & 511] << 4) | (INTERLEAVE7_TABLE[((int) (j >>> 45)) & 511] << 5) | (INTERLEAVE7_TABLE[((int) (j >>> 54)) & 511] << 6);
    }
    ...
    private static long interleave2_n(long j, int i) {
        while (i > 1) {
            i -= 2;
            j = interleave4_16to64(((int) j) & 65535) | (interleave4_16to64(((int) (j >>> 16)) & 65535) << 1) | (interleave4_16to64(((int) (j >>> 32)) & 65535) << 2) | (interleave4_16to64(((int) (j >>> 48)) & 65535) << 3);
        }
        if (i > 0) {
            j = interleave2_32to64((int) j) | (interleave2_32to64((int) (j >>> 32)) << 1);
        }
        return j;
    }

    private static long interleave4_16to64(int i) {
        return ((INTERLEAVE4_TABLE[i >>> 8] & 4294967295L) << 32) | (INTERLEAVE4_TABLE[i & 255] & 4294967295L);
    }

    private static long interleave2_32to64(int i) {
        return (((INTERLEAVE2_TABLE[(i >>> 16) & 255] | (INTERLEAVE2_TABLE[i >>> 24] << 16)) & 4294967295L) << 32) | ((INTERLEAVE2_TABLE[i & 255] | (INTERLEAVE2_TABLE[(i >>> 8) & 255] << 16)) & 4294967295L);
    }
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        while (true) {
            ...
            longArrayArr[i3].addShiftedByBitsSafe(longArrayArr[1 - i3], iArr2[1 - i3], i5);
            int iDegreeFrom2 = longArrayArr[i3].degreeFrom(i4);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[1 - i3];
            }
            int i6 = iArr3[1 - i3];
            longArrayArr2[i3].addShiftedByBitsSafe(longArrayArr2[1 - i3], i6, i5);
            int i7 = i6 + i5;
            if (i7 > iDegreeFrom) {
                iDegreeFrom = i7;
            } else if (i7 == iDegreeFrom) {
