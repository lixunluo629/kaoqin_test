...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT131Field.class */
public class SecT131Field {
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j4 = jArr[3];
        long j5 = jArr[4];
        long j6 = j2 ^ ((j5 << 61) ^ (j5 << 63));
        long j7 = j3 ^ ((((j5 >>> 3) ^ (j5 >>> 1)) ^ j5) ^ (j5 << 5));
        long j8 = j4 ^ (j5 >>> 59);
        long j9 = j ^ ((j8 << 61) ^ (j8 << 63));
        long j10 = j6 ^ ((((j8 >>> 3) ^ (j8 >>> 1)) ^ j8) ^ (j8 << 5));
        long j11 = j7 ^ (j8 >>> 59);
        long j12 = j11 >>> 3;
        jArr2[0] = (((j9 ^ j12) ^ (j12 << 2)) ^ (j12 << 3)) ^ (j12 << 8);
        jArr2[1] = j10 ^ (j12 >>> 56);
        jArr2[2] = j11 & M03;
    }
    ...
    public static void reduce61(long[] jArr, int i) {
        long j = jArr[i + 2];
        long j2 = j >>> 3;
        jArr[i] = jArr[i] ^ (((j2 ^ (j2 << 2)) ^ (j2 << 3)) ^ (j2 << 8));
        int i2 = i + 1;
        jArr[i2] = jArr[i2] ^ (j2 >>> 56);
        jArr[i + 2] = j & M03;
    }
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        long j27 = j24 ^ (j25 >>> 44);
        long j28 = j25 & M44;
        long j29 = (j26 >>> 1) ^ ((j28 & 1) << 43);
        long j30 = (j28 >>> 1) ^ ((j27 & 1) << 43);
        long j31 = j27 >>> 1;
        long j32 = j29 ^ (j29 << 1);
        long j33 = j32 ^ (j32 << 2);
        long j34 = j33 ^ (j33 << 4);
