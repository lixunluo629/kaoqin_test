...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT239K1Point.class */
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementMultiply = eCFieldElementDivide.square().add(eCFieldElementDivide).add(xCoord);
            if (eCFieldElementMultiply.isZero()) {
                return new SecT239K1Point(curve, eCFieldElementMultiply, curve.getB());
            }
        ...
        return new SecT239K1Point(curve, eCFieldElementMultiply, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply2});
    }
