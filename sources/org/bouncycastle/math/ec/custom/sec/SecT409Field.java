...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT409Field.class */
public class SecT409Field {
    ...
    protected static void implMulwAcc(long[] jArr, long j, long[] jArr2, int i) {
        ...
        for (int i2 = 0; i2 < 7; i2++) {
            ...
            int i6 = i + i2;
            jArr2[i6] = jArr2[i6] ^ (j4 & M59);
            int i7 = i + i2 + 1;
            jArr2[i7] = jArr2[i7] ^ ((j4 >>> 59) ^ (j3 << 5));
        }
    }
