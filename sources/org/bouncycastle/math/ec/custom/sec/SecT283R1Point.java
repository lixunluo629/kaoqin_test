...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT283R1Point.class */
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply.isZero()) {
                return new SecT283R1Point(curve, eCFieldElementMultiply, curve.getB().sqrt());
            }
        ...
        return new SecT283R1Point(curve, eCFieldElementMultiply, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply2});
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT283R1Point(curve, eCFieldElementSquare2, (zIsOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(eCFieldElementAdd, eCFieldElementMultiply).add(eCFieldElementSquare2).add(eCFieldElementMultiply2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
