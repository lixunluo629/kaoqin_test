...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP256K1Point.class */
public class SecP256K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (zIsOne) {
            ...
            iArr = iArrCreate2;
            SecP256K1Field.square(secP256K1FieldElement5.x, iArr);
            iArr2 = iArrCreate;
            SecP256K1Field.multiply(iArr, secP256K1FieldElement3.x, iArr2);
            SecP256K1Field.multiply(iArr, secP256K1FieldElement5.x, iArr);
            SecP256K1Field.multiply(iArr, secP256K1FieldElement4.x, iArr);
        }
        ...
        if (zIsOne2) {
            ...
            iArr3 = iArrCreate3;
            SecP256K1Field.square(secP256K1FieldElement6.x, iArr3);
            iArr4 = iArrCreateExt;
            SecP256K1Field.multiply(iArr3, secP256K1FieldElement.x, iArr4);
            SecP256K1Field.multiply(iArr3, secP256K1FieldElement6.x, iArr3);
            SecP256K1Field.multiply(iArr3, secP256K1FieldElement2.x, iArr3);
        }
        int[] iArrCreate4 = Nat256.create();
        SecP256K1Field.subtract(iArr4, iArr2, iArrCreate4);
        SecP256K1Field.subtract(iArr3, iArr, iArrCreate);
        ...
        SecP256K1Field.multiply(iArrCreate2, iArr4, iArrCreate2);
