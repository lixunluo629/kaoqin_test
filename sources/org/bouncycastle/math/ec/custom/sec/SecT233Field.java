...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT233Field.class */
public class SecT233Field {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return Nat.fromBigInteger64(UnknownRecord.BITMAP_00E9, bigInteger);
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            int i2 = iArr[i] >>> 6;
            int i3 = iArr[i] & 63;
            jArrCreateExt64[i2] = jArrCreateExt64[i2] ^ (j7 << i3);
            int i4 = i2 + 1;
            jArrCreateExt64[i4] = jArrCreateExt64[i4] ^ ((j6 << i3) | (j7 >>> (-i3)));
            int i5 = i2 + 2;
            jArrCreateExt64[i5] = jArrCreateExt64[i5] ^ ((j5 << i3) | (j6 >>> (-i3)));
            int i6 = i2 + 3;
            jArrCreateExt64[i6] = jArrCreateExt64[i6] ^ (j5 >>> (-i3));
        }
        reduce(jArrCreateExt64, jArr2);
        jArr2[0] = jArr2[0] ^ j;
        jArr2[1] = jArr2[1] ^ j3;
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        ...
        jArr[i] = jArr[i] ^ (j4 & M59);
        int i5 = i + 1;
        jArr[i5] = jArr[i5] ^ ((j4 >>> 59) ^ (j3 << 5));
    }
