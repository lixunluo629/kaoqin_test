...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT571R1Curve.class */
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i9 = 0; i9 < 9; i9++) {
                        ...
                        int i11 = i9;
                        jArrCreate642[i11] = jArrCreate642[i11] ^ (jArr[(i7 + 9) + i9] & j);
                    }
                    i7 += 18;
                }
