...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP224R1Field.class */
public class SecP224R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j8 = 0 + ((iArr[0] & 4294967295L) - j5);
        ...
        if (j20 != 0) {
            ...
            iArr2[1] = (int) j21;
            long j22 = (j21 >> 32) + (iArr2[2] & 4294967295L);
            iArr2[2] = (int) j22;
            j18 += j22 >> 32;
        }
        iArr2[3] = (int) j18;
