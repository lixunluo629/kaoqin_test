...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT233K1Point.class */
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply.isZero()) {
                return new SecT233K1Point(curve, eCFieldElementMultiply, curve.getB());
            }
        ...
        return new SecT233K1Point(curve, eCFieldElementMultiply, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply2});
    }
