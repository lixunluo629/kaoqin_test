...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP128R1Field.class */
public class SecP128R1Field {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if ((iArrFromBigInteger[3] >>> 1) >= 2147483646 && Nat128.gte(iArrFromBigInteger, P)) {
            Nat128.subFrom(P, iArrFromBigInteger);
        }
    ...
    public static void reduce32(int i, int[] iArr) {
        while (i != 0) {
            ...
            long j6 = j3 + (iArr[3] & 4294967295L) + (j << 1);
            iArr[3] = (int) j6;
            i = (int) (j6 >> 32);
        }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        iArr[3] = (int) (j2 + (iArr[3] & 4294967295L) + 2);
    }
