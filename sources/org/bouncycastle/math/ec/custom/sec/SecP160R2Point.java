...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP160R2Point.class */
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (zIsOne) {
            ...
            iArr = iArrCreate2;
            SecP160R2Field.square(secP160R2FieldElement5.x, iArr);
            iArr2 = iArrCreate;
            SecP160R2Field.multiply(iArr, secP160R2FieldElement3.x, iArr2);
            SecP160R2Field.multiply(iArr, secP160R2FieldElement5.x, iArr);
            SecP160R2Field.multiply(iArr, secP160R2FieldElement4.x, iArr);
        }
        ...
        if (zIsOne2) {
            ...
            iArr3 = iArrCreate3;
            SecP160R2Field.square(secP160R2FieldElement6.x, iArr3);
            iArr4 = iArrCreateExt;
            SecP160R2Field.multiply(iArr3, secP160R2FieldElement.x, iArr4);
            SecP160R2Field.multiply(iArr3, secP160R2FieldElement6.x, iArr3);
            SecP160R2Field.multiply(iArr3, secP160R2FieldElement2.x, iArr3);
        }
        int[] iArrCreate4 = Nat160.create();
        SecP160R2Field.subtract(iArr4, iArr2, iArrCreate4);
        SecP160R2Field.subtract(iArr3, iArr, iArrCreate);
        ...
        SecP160R2Field.multiply(iArrCreate2, iArr4, iArrCreate2);
        SecP160R2Field.negate(iArrCreate5, iArrCreate5);
        Nat160.mul(iArr3, iArrCreate5, iArrCreateExt);
    ...
    public ECPoint twice() {
        ...
        if (!zIsOne) {
            iArr = iArrCreate2;
            SecP160R2Field.square(secP160R2FieldElement3.x, iArr);
        }
