...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP521R1Curve.class */
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP521R1Curve.1
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i10 = 0; i10 < 17; i10++) {
                        ...
                        int i12 = i10;
                        iArrCreate2[i12] = iArrCreate2[i12] ^ (iArr[(i7 + 17) + i10] & i9);
                    }
                    i7 += 34;
                }
            ...
            public ECPoint lookupVar(int i6) {
                ...
                for (int i8 = 0; i8 < 17; i8++) {
                    int i9 = i8;
                    iArrCreate[i9] = iArrCreate[i9] ^ iArr[i7 + i8];
                    int i10 = i8;
                    iArrCreate2[i10] = iArrCreate2[i10] ^ iArr[(i7 + 17) + i8];
                }
                return createPoint(iArrCreate, iArrCreate2);
            }
