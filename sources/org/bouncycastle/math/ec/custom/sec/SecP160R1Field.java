...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecP160R1Field.class */
public class SecP160R1Field {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (iArrFromBigInteger[4] == -1 && Nat160.gte(iArrFromBigInteger, P)) {
            Nat160.subFrom(P, iArrFromBigInteger);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j6 = 0 + (iArr[0] & 4294967295L) + j + (j << 31);
        iArr2[0] = (int) j6;
        ...
        iArr2[3] = (int) j9;
        long j10 = (j9 >>> 32) + (iArr[4] & 4294967295L) + j5 + (j5 << 31);
        iArr2[4] = (int) j10;
