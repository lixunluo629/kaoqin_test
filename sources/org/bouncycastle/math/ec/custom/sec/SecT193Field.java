...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/ec/custom/sec/SecT193Field.class */
public class SecT193Field {
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j7 = jArr[6];
        long j8 = j3 ^ (j7 << 63);
        long j9 = j4 ^ ((j7 >>> M01) ^ (j7 << 14));
        long j10 = j5 ^ (j7 >>> 50);
        long j11 = j2 ^ (j6 << 63);
        long j12 = j8 ^ ((j6 >>> M01) ^ (j6 << 14));
        long j13 = j9 ^ (j6 >>> 50);
        long j14 = j ^ (j10 << 63);
        long j15 = j11 ^ ((j10 >>> M01) ^ (j10 << 14));
        long j16 = j12 ^ (j10 >>> 50);
        long j17 = j13 >>> M01;
        jArr2[0] = (j14 ^ j17) ^ (j17 << 15);
        jArr2[1] = j15 ^ (j17 >>> 49);
        jArr2[2] = j16;
        jArr2[3] = j13 & M01;
    }
    ...
    public static void reduce63(long[] jArr, int i) {
        long j = jArr[i + 3];
        long j2 = j >>> M01;
        jArr[i] = jArr[i] ^ (j2 ^ (j2 << 15));
        int i2 = i + 1;
        jArr[i2] = jArr[i2] ^ (j2 >>> 49);
        jArr[i + 3] = j & M01;
    }
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        ...
        jArr[i] = jArr[i] ^ (j4 & M49);
        int i5 = i + 1;
        jArr[i5] = jArr[i5] ^ ((j4 >>> 49) ^ (j3 << 15));
    }
