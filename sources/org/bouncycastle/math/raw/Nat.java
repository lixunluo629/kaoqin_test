...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/raw/Nat.class */
public abstract class Nat {
    ...
    public static int add(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (iArr[i2] & 4294967295L) + (iArr2[i2] & 4294967295L);
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        long j = (iArr[i3 + 0] & 4294967295L) + (i2 & 4294967295L);
        iArr[i3 + 0] = (int) j;
        long j2 = (j >>> 32) + (iArr[i3 + 1] & 4294967295L) + 1;
        iArr[i3 + 1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        long j = (iArr[i3 + i4] & 4294967295L) + (i2 & 4294967295L);
        iArr[i3 + i4] = (int) j;
        long j2 = (j >>> 32) + (iArr[i3 + i4 + 1] & 4294967295L) + 1;
        iArr[i3 + i4 + 1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (iArr[i2] & 4294967295L) + (iArr2[i2] & 4294967295L) + (iArr3[i2] & 4294967295L);
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[i3 + i5] & 4294967295L) + (iArr3[i4 + i5] & 4294967295L);
            iArr3[i4 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        long j2 = (iArr[i2 + 0] & 4294967295L) + (j & 4294967295L);
        iArr[i2 + 0] = (int) j2;
        long j3 = (j2 >>> 32) + (iArr[i2 + 1] & 4294967295L) + (j >>> 32);
        iArr[i2 + 1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        long j2 = (iArr[i2 + i3] & 4294967295L) + (j & 4294967295L);
        iArr[i2 + i3] = (int) j2;
        long j3 = (j2 >>> 32) + (iArr[i2 + i3 + 1] & 4294967295L) + (j >>> 32);
        iArr[i2 + i3 + 1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i, long j, int[] iArr) {
        ...
        iArr[0] = (int) j2;
        long j3 = (j2 >>> 32) + (iArr[1] & 4294967295L) + (j >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + (iArr[i2 + i4] & 4294967295L) + (iArr2[i3 + i4] & 4294967295L);
            iArr2[i3 + i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[i3 + i5] & 4294967295L);
            iArr2[i3 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (i2 & 4294967295L) + (iArr[i3] & 4294967295L);
        iArr[i3] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        long j = (i2 & 4294967295L) + (iArr[i3 + i4] & 4294967295L);
        iArr[i3 + i4] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i, int i2, int[] iArr) {
        long j = (i2 & 4294967295L) + (iArr[0] & 4294967295L);
        iArr[0] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static void cmov(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            int i7 = iArr2[i4 + i6];
            iArr2[i4 + i6] = i7 ^ ((i7 ^ iArr[i3 + i6]) & i5);
        }
    }
    ...
    public static boolean gte(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        for (int i4 = i - 1; i4 >= 0; i4--) {
            ...
            int i6 = iArr2[i3 + i4] ^ Integer.MIN_VALUE;
            if (i5 < i6) {
                return false;
            }
            if (i5 > i6) {
    ...
    public static void mul(int[] iArr, int i, int i2, int[] iArr2, int i3, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 1; i6 < i2; i6++) {
            iArr3[i5 + i6 + i4] = mulWordAddTo(i4, iArr[i + i6], iArr2, i3, iArr3, i5 + i6);
        }
    }
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long jMulWordAddTo = j + (mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2) & 4294967295L) + (iArr3[i2 + i] & 4294967295L);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long jMulWordAddTo = j + (mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4) & 4294967295L) + (iArr3[i4 + i] & 4294967295L);
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        int i5 = 0;
        do {
            long j4 = j + (j2 * (iArr[i5] & 4294967295L)) + (j3 * (iArr2[i5] & 4294967295L)) + (iArr3[i4 + i5] & 4294967295L);
            iArr3[i4 + i5] = (int) j4;
            j = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j + (j2 * (iArr[i3 + i5] & 4294967295L));
            iArr2[i4 + i5] = (int) j3;
            j = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j + (j2 * (iArr[i3 + i5] & 4294967295L)) + (iArr2[i4 + i5] & 4294967295L);
            iArr2[i4 + i5] = (int) j3;
            j = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        long j2 = i2 & 4294967295L;
        long j3 = 0 + (j2 * (j & 4294967295L)) + (iArr[i3 + 0] & 4294967295L);
        iArr[i3 + 0] = (int) j3;
        long j4 = (j3 >>> 32) + (j2 * (j >>> 32)) + (iArr[i3 + 1] & 4294967295L);
        iArr[i3 + 1] = (int) j4;
        long j5 = (j4 >>> 32) + (iArr[i3 + 2] & 4294967295L);
        iArr[i3 + 2] = (int) j5;
        if ((j5 >>> 32) == 0) {
            return 0;
        }
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        for (int i8 = 1; i8 < i; i8++) {
            long jSquareWordAddTo = j3 + (squareWordAddTo(iArr, i8, iArr2) & 4294967295L) + (iArr2[i7] & 4294967295L);
            int i9 = i7;
            int i10 = i7 + 1;
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i10 = 1; i10 < i; i10++) {
            long jSquareWordAddTo = j3 + (squareWordAddTo(iArr, i2, i10, iArr2, i3) & 4294967295L) + (iArr2[i9] & 4294967295L);
            int i11 = i9;
            int i12 = i9 + 1;
            iArr2[i11] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (iArr2[i12] & 4294967295L);
            i9 = i12 + 1;
            iArr2[i12] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        int i2 = 0;
        do {
            long j3 = j + (j2 * (iArr[i2] & 4294967295L)) + (iArr2[i + i2] & 4294967295L);
            iArr2[i + i2] = (int) j3;
            j = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        long j = 0;
        long j2 = iArr[i + i2] & 4294967295L;
        int i4 = 0;
        do {
            long j3 = j + (j2 * (iArr[i + i4] & 4294967295L)) + (iArr2[i2 + i3] & 4294967295L);
            iArr2[i2 + i3] = (int) j3;
            j = j3 >>> 32;
            i3++;
            i4++;
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((iArr3[i2] & 4294967295L) - (iArr[i2] & 4294967295L)) - (iArr2[i2] & 4294967295L));
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (((iArr3[i4 + i5] & 4294967295L) - (iArr[i2 + i5] & 4294967295L)) - (iArr2[i3 + i5] & 4294967295L));
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + ((iArr2[i2] & 4294967295L) - (iArr[i2] & 4294967295L));
            iArr2[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + ((iArr2[i3 + i4] & 4294967295L) - (iArr[i2 + i4] & 4294967295L));
            iArr2[i3 + i4] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
