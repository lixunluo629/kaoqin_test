...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/math/raw/Interleave.class */
public class Interleave {
    ...
    public static long expand32to64(int i) {
        ...
        return (((r0 >>> 1) & M32) << 32) | ((i7 ^ (i8 ^ (i8 << 1))) & M32);
    }
    ...
    public static int unshuffle2(int i) {
        ...
        int i4 = (i3 ^ (i3 >>> 4)) & 15728880;
        int i5 = i3 ^ (i4 ^ (i4 << 4));
        int i6 = (i5 ^ (i5 >>> 14)) & 52428;
        int i7 = i5 ^ (i6 ^ (i6 << 14));
        int i8 = (i7 ^ (i7 >>> 7)) & 11141290;
        return i7 ^ (i8 ^ (i8 << 7));
    }
}
