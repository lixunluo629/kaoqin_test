...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/est/jcajce/JcaJceUtils.class */
public class JcaJceUtils {
    ...
    public static KeyManagerFactory createKeyManagerFactory(String str, String str2, KeyStore keyStore, char[] cArr) throws NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException, NoSuchProviderException {
        KeyManagerFactory keyManagerFactory = (str == null && str2 == null) ? KeyManagerFactory.getInstance(KeyManagerFactory.getDefaultAlgorithm()) : str2 == null ? KeyManagerFactory.getInstance(str) : KeyManagerFactory.getInstance(str, str2);
