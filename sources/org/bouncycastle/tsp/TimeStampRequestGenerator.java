...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/tsp/TimeStampRequestGenerator.class */
public class TimeStampRequestGenerator {
    ...
    public TimeStampRequest generate(String str, byte[] bArr, BigInteger bigInteger) {
        ...
        Extensions extensionsGenerate = null;
        if (!this.extGenerator.isEmpty()) {
            extensionsGenerate = this.extGenerator.generate();
        }
        return bigInteger != null ? new TimeStampRequest(new TimeStampReq(messageImprint, this.reqPolicy, new ASN1Integer(bigInteger), this.certReq, extensionsGenerate)) : new TimeStampRequest(new TimeStampReq(messageImprint, this.reqPolicy, (ASN1Integer) null, this.certReq, extensionsGenerate));
    }
