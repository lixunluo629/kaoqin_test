...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/tsp/cms/CMSTimeStampedDataGenerator.class */
public class CMSTimeStampedDataGenerator extends CMSTimeStampedGenerator {
    ...
    public CMSTimeStampedData generate(TimeStampToken timeStampToken, InputStream inputStream) throws CMSException {
        ...
        return new CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData, (ASN1Encodable) new TimeStampedData(dERIA5String, this.metaData, bEROctetString, new Evidence(new TimeStampTokenEvidence(timeStampAndCRL)))));
    }
}
