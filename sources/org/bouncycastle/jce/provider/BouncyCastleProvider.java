...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/jce/provider/BouncyCastleProvider.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/BouncyCastleProvider.class */
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String[] SYMMETRIC_CIPHERS = {RSAUtils.AES_KEY_ALGORITHM, "ARC4", "Blowfish", "Camellia", "CAST5", "CAST6", "DESede", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Skipjack", "TEA", "Twofish", "VMPC", "VMPCKSA3", "XTEA"};
    ...
    public void setup() {
        ...
        put("Alg.Alias.Cipher.RSA//RAW", RSAUtils.RSA_KEY_ALGORITHM);
        put("Alg.Alias.Cipher.RSA//NOPADDING", RSAUtils.RSA_KEY_ALGORITHM);
        ...
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", RSAUtils.RSA_KEY_ALGORITHM);
        ...
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", RSAUtils.RSA_KEY_ALGORITHM);
    ...
    private void addMacAlgorithms() {
        ...
        addHMACAlgorithm(MessageDigestAlgorithms.MD5, "org.bouncycastle.jce.provider.JCEMac$MD5", "org.bouncycastle.jce.provider.JCEKeyGenerator$MD5HMAC");
        addHMACAlias(MessageDigestAlgorithms.MD5, IANAObjectIdentifiers.hmacMD5);
    ...
    private void addMessageDigestAlgorithms() {
        ...
        put("Alg.Alias.MessageDigest.SHA224", McElieceCCA2KeyGenParameterSpec.SHA224);
        put("Alg.Alias.MessageDigest." + NISTObjectIdentifiers.id_sha224, McElieceCCA2KeyGenParameterSpec.SHA224);
        ...
        put("Alg.Alias.MessageDigest." + PKCSObjectIdentifiers.md5, MessageDigestAlgorithms.MD5);
    ...
    private void addSignatureAlgorithms() {
        ...
        put("Alg.Alias.Signature.RAWRSA", RSAUtils.RSA_KEY_ALGORITHM);
        put("Alg.Alias.Signature.NONEWITHRSA", RSAUtils.RSA_KEY_ALGORITHM);
