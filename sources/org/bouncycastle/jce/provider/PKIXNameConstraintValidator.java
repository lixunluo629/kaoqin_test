...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/jce/provider/PKIXNameConstraintValidator.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/PKIXNameConstraintValidator.class */
public class PKIXNameConstraintValidator {
    ...
    private boolean emailIsConstrained(String str, String str2) {
        ...
        return str2.indexOf(64) != -1 ? str.equalsIgnoreCase(str2) : str2.charAt(0) != '.' ? strSubstring.equalsIgnoreCase(str2) : withinDomain(strSubstring, str2);
    }
    ...
    private boolean withinDomain(String str, String str2) {
        ...
        String[] strArrSplit = Strings.split(strSubstring, '.');
    ...
    private static String extractHostFromURL(String str) {
        ...
        if (strSubstring3.indexOf(47) != -1) {
            strSubstring3 = strSubstring3.substring(0, strSubstring3.indexOf(47));
        }
    ...
    private int hashCollection(Collection collection) {
        ...
        for (Object obj : collection) {
            iHashCode = obj instanceof byte[] ? iHashCode + Arrays.hashCode((byte[]) obj) : iHashCode + obj.hashCode();
        }
        return iHashCode;
    }
    ...
    private String stringifyIPCollection(Set set) {
        String strSubstring = "" + PropertyAccessor.PROPERTY_KEY_PREFIX;
        Iterator it = set.iterator();
        while (it.hasNext()) {
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesDN != null) {
            str = (str + "DN:\n") + this.permittedSubtreesDN.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (this.permittedSubtreesDNS != null) {
            str = (str + "DNS:\n") + this.permittedSubtreesDNS.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (this.permittedSubtreesEmail != null) {
            str = (str + "Email:\n") + this.permittedSubtreesEmail.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (this.permittedSubtreesURI != null) {
            str = (str + "URI:\n") + this.permittedSubtreesURI.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (this.permittedSubtreesIP != null) {
            str = (str + "IP:\n") + stringifyIPCollection(this.permittedSubtreesIP) + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        String str2 = str + "excluded:\n";
        if (!this.excludedSubtreesDN.isEmpty()) {
            str2 = (str2 + "DN:\n") + this.excludedSubtreesDN.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (!this.excludedSubtreesDNS.isEmpty()) {
            str2 = (str2 + "DNS:\n") + this.excludedSubtreesDNS.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (!this.excludedSubtreesEmail.isEmpty()) {
            str2 = (str2 + "Email:\n") + this.excludedSubtreesEmail.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (!this.excludedSubtreesURI.isEmpty()) {
            str2 = (str2 + "URI:\n") + this.excludedSubtreesURI.toString() + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        if (!this.excludedSubtreesIP.isEmpty()) {
            str2 = (str2 + "IP:\n") + stringifyIPCollection(this.excludedSubtreesIP) + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        return str2;
    }
}
