...
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory.class */
public class KeyFactory extends JDKKeyFactory {
    String algorithm;

    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$EC.class */
    ...
    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$ECDH.class */
    ...
    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$ECDHC.class */
    ...
    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$ECDSA.class */
    ...
    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$ECGOST3410.class */
    ...
    /* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/asymmetric/ec/KeyFactory$ECMQV.class */
    ...
    protected KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        if (!cls.isAssignableFrom(ECPrivateKeySpec.class) || !(key instanceof ECPrivateKey)) {
            throw new RuntimeException("not implemented yet " + key + SymbolConstants.SPACE_SYMBOL + cls);
        }
