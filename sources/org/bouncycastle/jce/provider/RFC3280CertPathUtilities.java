...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/jce/provider/RFC3280CertPathUtilities.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/jce/provider/RFC3280CertPathUtilities.class */
public class RFC3280CertPathUtilities {
                    ...
                    if (distributionPoint.getDistributionPoint() != null) {
                        ...
                        if (distributionPoint3.getType() == 1) {
                            ...
                            for (int i = 0; i < names.length; i++) {
                                Enumeration objects2 = ASN1Sequence.getInstance(names[i].getName().getDERObject()).getObjects();
    ...
    protected static Set processCRLF(X509CRL x509crl, Object obj, X509Certificate x509Certificate, PublicKey publicKey, ExtendedPKIXParameters extendedPKIXParameters, List list) throws NoSuchAlgorithmException, AnnotatedException, NoSuchProviderException {
        X509CertStoreSelector x509CertStoreSelector = new X509CertStoreSelector();
        try {
            x509CertStoreSelector.setSubject(CertPathValidatorUtilities.getIssuerPrincipal(x509crl).getEncoded());
            try {
                Collection<X509Certificate> collectionFindCertificates = CertPathValidatorUtilities.findCertificates(x509CertStoreSelector, extendedPKIXParameters.getStores());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x01f6, code lost:
        ...
        if (org.bouncycastle.jce.provider.RFC3280CertPathUtilities.ANY_POLICY.equals(r0.getPolicyIdentifier().getId()) == false) goto L126;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:60:0x0247, code lost:
        ...
        if (org.bouncycastle.jce.provider.RFC3280CertPathUtilities.ANY_POLICY.equals(r0.getValidPolicy()) == false) goto L111;
     */
    ...
    */
    protected static org.bouncycastle.jce.provider.PKIXPolicyNode prepareCertB(java.security.cert.CertPath r10, int r11, java.util.List[] r12, org.bouncycastle.jce.provider.PKIXPolicyNode r13, int r14) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            for (int i5 = i3 - 1; i5 >= 0; i5--) {
                ...
                for (int i6 = 0; i6 < list2.size(); i6++) {
                    ...
                    if (!pKIXPolicyNode4.hasChildren()) {
                        pKIXPolicyNodeRemovePolicyNode = CertPathValidatorUtilities.removePolicyNode(pKIXPolicyNodeRemovePolicyNode, listArr, pKIXPolicyNode4);
    ...
    protected static void processCertA(CertPath certPath, ExtendedPKIXParameters extendedPKIXParameters, int i, PublicKey publicKey, boolean z, X500Principal x500Principal, X509Certificate x509Certificate) throws NoSuchAlgorithmException, SignatureException, CertificateNotYetValidException, InvalidKeyException, CRLException, ExtCertPathValidatorException, NoSuchProviderException, CertificateExpiredException {
        List<? extends Certificate> certificates = certPath.getCertificates();
    ...
    */
    protected static int prepareNextCertI1(java.security.cert.CertPath r7, int r8, int r9) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            org.bouncycastle.asn1.ASN1Sequence r0 = org.bouncycastle.asn1.DERSequence.getInstance(r0)     // Catch: java.lang.Exception -> L24
            r12 = r0
            goto L35
        L24:
            r13 = move-exception
        ...
        L41:
            ...
            org.bouncycastle.asn1.ASN1TaggedObject r0 = org.bouncycastle.asn1.ASN1TaggedObject.getInstance(r0)     // Catch: java.lang.IllegalArgumentException -> L7c
            r15 = r0
            r0 = r15
            ...
            r0 = r15
            r1 = 0
            org.bouncycastle.asn1.DERInteger r0 = org.bouncycastle.asn1.DERInteger.getInstance(r0, r1)     // Catch: java.lang.IllegalArgumentException -> L7c
    ...
    */
    protected static int prepareNextCertI2(java.security.cert.CertPath r7, int r8, int r9) throws java.security.cert.CertPathValidatorException {
        ...
        L41:
            ...
            org.bouncycastle.asn1.ASN1TaggedObject r0 = org.bouncycastle.asn1.ASN1TaggedObject.getInstance(r0)     // Catch: java.lang.IllegalArgumentException -> L7d
            r15 = r0
            r0 = r15
            ...
            r0 = r15
            r1 = 0
            org.bouncycastle.asn1.DERInteger r0 = org.bouncycastle.asn1.DERInteger.getInstance(r0, r1)     // Catch: java.lang.IllegalArgumentException -> L7d
    ...
    protected static void prepareNextCertG(CertPath certPath, int i, PKIXNameConstraintValidator pKIXNameConstraintValidator) throws CertPathValidatorException {
        ...
        try {
            ...
            if (dERSequence != null) {
                nameConstraints = new NameConstraints(dERSequence);
            }
    ...
    private static void checkCRL(DistributionPoint distributionPoint, ExtendedPKIXParameters extendedPKIXParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, CertStatus certStatus, ReasonsMask reasonsMask, List list) throws NoSuchAlgorithmException, SignatureException, AnnotatedException, InvalidKeyException, CRLException, NoSuchProviderException {
        ...
        while (it.hasNext() && certStatus.getCertStatus() == 11 && !reasonsMask.isAllReasons()) {
            try {
                ...
                if (reasonsMaskProcessCRLD.hasNewReasons(reasonsMask)) {
                    PublicKey publicKeyProcessCRLG = processCRLG(x509crl, processCRLF(x509crl, x509Certificate, x509Certificate2, publicKey, extendedPKIXParameters, list));
                    X509CRL x509crlProcessCRLH = null;
                    if (extendedPKIXParameters.isUseDeltasEnabled()) {
                        x509crlProcessCRLH = processCRLH(CertPathValidatorUtilities.getDeltaCRLs(date2, extendedPKIXParameters, x509crl), publicKeyProcessCRLG);
                    }
    ...
    protected static void checkCRLs(ExtendedPKIXParameters extendedPKIXParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, List list) throws NoSuchAlgorithmException, SignatureException, AnnotatedException, InvalidKeyException, CRLException, NoSuchProviderException {
        AnnotatedException annotatedException = null;
        try {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected static org.bouncycastle.jce.provider.PKIXPolicyNode wrapupCertG(java.security.cert.CertPath r7, org.bouncycastle.x509.ExtendedPKIXParameters r8, java.util.Set r9, int r10, java.util.List[] r11, org.bouncycastle.jce.provider.PKIXPolicyNode r12, java.util.Set r13) throws java.security.cert.CertPathValidatorException {
        /*
