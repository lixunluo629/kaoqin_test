...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/asn1/RainbowPublicKey.class */
public class RainbowPublicKey extends ASN1Object {
    ...
    private RainbowPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.docLength = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(1));
    ...
    /* JADX WARN: Type inference failed for: r0v16, types: [org.bouncycastle.asn1.ASN1Primitive, org.bouncycastle.asn1.DERSequence] */
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add((ASN1Encodable) this.docLength);
        ASN1EncodableVector aSN1EncodableVector2 = new ASN1EncodableVector();
        for (int i = 0; i < this.coeffQuadratic.length; i++) {
            aSN1EncodableVector2.add((ASN1Encodable) new DEROctetString(this.coeffQuadratic[i]));
        }
        ...
        for (int i2 = 0; i2 < this.coeffSingular.length; i2++) {
            aSN1EncodableVector3.add((ASN1Encodable) new DEROctetString(this.coeffSingular[i2]));
        }
