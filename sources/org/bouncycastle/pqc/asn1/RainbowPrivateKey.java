...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/asn1/RainbowPrivateKey.class */
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
            ...
            this.oid = ASN1ObjectIdentifier.getInstance((Object) aSN1Sequence.getObjectAt(0));
        }
        ...
        for (int i9 = 0; i9 < length; i9++) {
            this.layers[i9] = new Layer(this.vi[i9], this.vi[i9 + 1], RainbowUtil.convertArray(bArr[i9]), RainbowUtil.convertArray(bArr2[i9]), RainbowUtil.convertArray(bArr3[i9]), RainbowUtil.convertArray(bArr4[i9]));
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r0v25, types: [org.bouncycastle.asn1.ASN1Primitive, org.bouncycastle.asn1.DERSequence] */
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i = 0; i < this.invA1.length; i++) {
            aSN1EncodableVector2.add((ASN1Encodable) new DEROctetString(this.invA1[i]));
        }
        ...
        for (int i2 = 0; i2 < this.invA2.length; i2++) {
            aSN1EncodableVector4.add((ASN1Encodable) new DEROctetString(this.invA2[i2]));
        }
        ...
        for (int i3 = 0; i3 < this.layers.length; i3++) {
            ...
            for (int i4 = 0; i4 < bArrConvertArray.length; i4++) {
                ...
                for (int i5 = 0; i5 < bArrConvertArray[i4].length; i5++) {
                    aSN1EncodableVector10.add((ASN1Encodable) new DEROctetString(bArrConvertArray[i4][i5]));
                }
            ...
            for (int i6 = 0; i6 < bArrConvertArray2.length; i6++) {
                ...
                for (int i7 = 0; i7 < bArrConvertArray2[i6].length; i7++) {
                    aSN1EncodableVector12.add((ASN1Encodable) new DEROctetString(bArrConvertArray2[i6][i7]));
                }
            ...
            for (byte[] bArr : bArrConvertArray3) {
                aSN1EncodableVector13.add((ASN1Encodable) new DEROctetString(bArr));
            }
            aSN1EncodableVector8.add((ASN1Encodable) new DERSequence(aSN1EncodableVector13));
            aSN1EncodableVector8.add((ASN1Encodable) new DEROctetString(RainbowUtil.convertArray(this.layers[i3].getCoeffEta())));
