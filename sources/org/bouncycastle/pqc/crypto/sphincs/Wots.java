...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/sphincs/Wots.class */
class Wots {
    ...
    static void expand_seed(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalArgumentException {
    ...
    void wots_sign(HashFunctions hashFunctions, byte[] bArr, int i, byte[] bArr2, byte[] bArr3, byte[] bArr4) throws IllegalArgumentException {
        int[] iArr = new int[67];
        int i2 = 0;
        int i3 = 0;
        while (i3 < 64) {
