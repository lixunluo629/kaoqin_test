...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/sphincs/Horst.class */
class Horst {
    ...
    static void expand_seed(byte[] bArr, byte[] bArr2) throws IllegalArgumentException {
        Seed.prg(bArr, 0, 2097152L, bArr2, 0);
    }

    static int horst_sign(HashFunctions hashFunctions, byte[] bArr, int i, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) throws IllegalArgumentException {
    ...
    static int horst_verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i14 = 0; i14 < 16; i14++) {
            hashFunctions.hash_2n_n_mask(bArr5, i14 * 32, bArr5, 2 * i14 * 32, bArr3, EscherProperties.THREEDSTYLE__YROTATIONANGLE);
        }
        ...
        for (int i17 = 0; i17 < 2; i17++) {
            hashFunctions.hash_2n_n_mask(bArr5, i17 * 32, bArr5, 2 * i17 * 32, bArr3, EscherProperties.GROUPSHAPE__SHAPENAME);
        }
