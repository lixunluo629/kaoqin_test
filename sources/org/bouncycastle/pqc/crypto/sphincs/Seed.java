...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/sphincs/Seed.class */
class Seed {
    Seed() {
    }
    ...
    static void get_seed(HashFunctions hashFunctions, byte[] bArr, int i, byte[] bArr2, Tree.leafaddr leafaddrVar) {
        ...
        Pack.longToLittleEndian(leafaddrVar.level | (leafaddrVar.subtree << 4) | (leafaddrVar.subleaf << 59), bArr3, 32);
        hashFunctions.varlen_hash(bArr, i, bArr3, bArr3.length);
    }

    static void prg(byte[] bArr, int i, long j, byte[] bArr2, int i2) throws IllegalArgumentException {
