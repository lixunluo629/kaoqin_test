...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/xmss/XMSSMTPublicKeyParameters.class */
public final class XMSSMTPublicKeyParameters extends XMSSMTKeyParameters implements XMSSStoreableObjectInterface, Encodable {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/xmss/XMSSMTPublicKeyParameters$Builder.class */
    ...
    private XMSSMTPublicKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            if (bArr.length == treeDigestSize + treeDigestSize) {
                ...
                if (bArr.length != 4 + treeDigestSize + treeDigestSize) {
