...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/xmss/WOTSPlusOid.class */
final class WOTSPlusOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-256", 32, 16, 67), new WOTSPlusOid(ResourceTableMap.MapAttr.MIN, "WOTSP_SHA2-256_W16"));
