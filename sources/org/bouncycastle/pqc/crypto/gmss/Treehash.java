...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/gmss/Treehash.class */
public class Treehash {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < 3 + this.tailLength; i2++) {
            str = getStatByte()[i2] != null ? str + new String(Hex.encode(getStatByte()[i2])) + SymbolConstants.SPACE_SYMBOL : str + "null ";
        }
