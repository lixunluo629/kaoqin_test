...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/gmss/GMSSRootCalc.class */
public class GMSSRootCalc {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < 1 + this.heightOfTree + size; i2++) {
            str = str + new String(Hex.encode(getStatByte()[i2])) + SymbolConstants.SPACE_SYMBOL;
        }
