...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/gmss/GMSSKeyPairGenerator.class */
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (i3 >= 0) {
            GMSSRootCalc gMSSRootCalcGenerateCurrentAuthpathAndRoot = i3 == this.numLayer - 1 ? generateCurrentAuthpathAndRoot(null, vectorArr[i3], bArr3[i3], i3) : generateCurrentAuthpathAndRoot(bArr[i3 + 1], vectorArr[i3], bArr3[i3], i3);
            for (int i4 = 0; i4 < this.heightOfTrees[i3]; i4++) {
                System.arraycopy(gMSSRootCalcGenerateCurrentAuthpathAndRoot.getAuthPath()[i4], 0, r0[i3][i4], 0, this.mdLength);
            }
            r05[i3] = gMSSRootCalcGenerateCurrentAuthpathAndRoot.getRetain();
            r03[i3] = gMSSRootCalcGenerateCurrentAuthpathAndRoot.getTreehash();
            System.arraycopy(gMSSRootCalcGenerateCurrentAuthpathAndRoot.getRoot(), 0, bArr[i3], 0, this.mdLength);
            i3--;
        }
        for (int i5 = this.numLayer - 2; i5 >= 0; i5--) {
            GMSSRootCalc gMSSRootCalcGenerateNextAuthpathAndRoot = generateNextAuthpathAndRoot(vectorArr2[i5], bArr3[i5 + 1], i5 + 1);
            for (int i6 = 0; i6 < this.heightOfTrees[i5 + 1]; i6++) {
                System.arraycopy(gMSSRootCalcGenerateNextAuthpathAndRoot.getAuthPath()[i6], 0, r02[i5][i6], 0, this.mdLength);
            }
            r06[i5] = gMSSRootCalcGenerateNextAuthpathAndRoot.getRetain();
            r04[i5] = gMSSRootCalcGenerateNextAuthpathAndRoot.getTreehash();
            System.arraycopy(gMSSRootCalcGenerateNextAuthpathAndRoot.getRoot(), 0, bArr2[i5], 0, this.mdLength);
