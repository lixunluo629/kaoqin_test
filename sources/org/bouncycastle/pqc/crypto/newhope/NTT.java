...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/crypto/newhope/NTT.class */
class NTT {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (true) {
                    ...
                    if (i6 < 1023) {
                        ...
                        int i8 = sArr[i6 + i2] & 65535;
                        int i9 = i4;
                        i4++;
                        short s = sArr2[i9];
                        sArr[i6] = (short) (i7 + i8);
                        sArr[i6 + i2] = Reduce.montgomery(s * ((i7 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i8));
                        i5 = i6 + (2 * i2);
                    }
                }
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (true) {
                    ...
                    if (i14 < 1023) {
                        ...
                        int i16 = sArr[i14 + i10] & 65535;
                        int i17 = i12;
                        i12++;
                        short s2 = sArr2[i17];
                        sArr[i14] = Reduce.barrett((short) (i15 + i16));
                        sArr[i14 + i10] = Reduce.montgomery(s2 * ((i15 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i16));
                        i13 = i14 + (2 * i10);
                    }
                }
            }
    ...
    static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i = 0; i < 1024; i++) {
            sArr[i] = Reduce.montgomery((sArr[i] & 65535) * (sArr2[i] & 65535));
        }
    }
}
