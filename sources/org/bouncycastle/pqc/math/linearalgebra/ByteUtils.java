...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/math/linearalgebra/ByteUtils.class */
public final class ByteUtils {
    ...
    public static int deepHashCode(byte[][] bArr) {
        int iDeepHashCode = 1;
        for (byte[] bArr2 : bArr) {
            iDeepHashCode = (31 * iDeepHashCode) + deepHashCode(bArr2);
        }
    ...
    public static byte[] fromHexString(String str) {
        ...
        for (int i4 = 0; i4 < charArray.length; i4++) {
            if (charArray[i4] >= '0' && charArray[i4] <= '9') {
                ...
                int i8 = i3 >> 1;
                bArr[i8] = (byte) (bArr[i8] | ((charArray[i4] - 'A') + 10));
            }
            i3++;
        }
        return bArr;
    ...
    public static String toBinaryString(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            if (i != bArr.length - 1) {
                str = str + SymbolConstants.SPACE_SYMBOL;
            }
        }
        return str;
    }
