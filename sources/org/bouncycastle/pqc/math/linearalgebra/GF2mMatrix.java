...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/math/linearalgebra/GF2mMatrix.class */
public class GF2mMatrix extends Matrix {
        ...
        for (int i4 = 0; i4 < this.numRows; i4++) {
            for (int i5 = 0; i5 < this.numColumns; i5++) {
                for (int i6 = 0; i6 < i; i6 += 8) {
                    int i7 = i3;
                    i3++;
                    bArr[i7] = (byte) (this.matrix[i4][i5] >>> i6);
                }
            }
        }
        return bArr;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numRows; i++) {
            ...
            str = str + ScriptUtils.FALLBACK_STATEMENT_SEPARATOR;
        }
        return str;
    }
}
