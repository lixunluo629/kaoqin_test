...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/pqc/jcajce/provider/BouncyCastlePQCProvider.class */
public class BouncyCastlePQCProvider extends Provider implements ConfigurableProvider {
    ...
    public void addAttributes(String str, Map<String, String> map) {
        for (String str2 : map.keySet()) {
            String str3 = str + SymbolConstants.SPACE_SYMBOL + str2;
            if (containsKey(str3)) {
