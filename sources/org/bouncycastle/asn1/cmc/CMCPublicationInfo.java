...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/cmc/CMCPublicationInfo.class */
public class CMCPublicationInfo extends ASN1Object {
    ...
    public byte[][] getCertHashes() {
        ?? r0 = new byte[this.certHashes.size()];
        for (int i = 0; i != r0.length; i++) {
            r0[i] = Arrays.clone(ASN1OctetString.getInstance(this.certHashes.getObjectAt(i)).getOctets());
        }
        return r0;
    }
