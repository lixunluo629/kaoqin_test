...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/cmc/GetCert.class */
public class GetCert extends ASN1Object {
    ...
    private GetCert(ASN1Sequence aSN1Sequence) {
        ...
        this.serialNumber = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(1)).getValue();
    }
