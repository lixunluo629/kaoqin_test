...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/cmc/CMCObjectIdentifiers.class */
public interface CMCObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_cmc_publishCert = id_cmc.branch(ANSIConstants.BLACK_FG);
    public static final ASN1ObjectIdentifier id_cmc_modCertTemplate = id_cmc.branch(ANSIConstants.RED_FG);
    public static final ASN1ObjectIdentifier id_cmc_controlProcessed = id_cmc.branch(ANSIConstants.GREEN_FG);
    public static final ASN1ObjectIdentifier id_cmc_identityProofV2 = id_cmc.branch(ANSIConstants.BLUE_FG);
    public static final ASN1ObjectIdentifier id_cmc_popLinkWitnessV2 = id_cmc.branch(ANSIConstants.YELLOW_FG);
}
