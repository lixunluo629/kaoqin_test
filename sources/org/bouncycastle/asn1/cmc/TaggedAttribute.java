...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/cmc/TaggedAttribute.class */
public class TaggedAttribute extends ASN1Object {
    ...
    private TaggedAttribute(ASN1Sequence aSN1Sequence) {
        ...
        this.attrType = ASN1ObjectIdentifier.getInstance((Object) aSN1Sequence.getObjectAt(1));
