...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers.class */
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier sha512WithRSAEncryption = pkcs_1.branch(Constants.WS_VERSION_HEADER_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_PBES2 = pkcs_5.branch(Constants.WS_VERSION_HEADER_VALUE);
    ...
    public static final ASN1ObjectIdentifier data = new ASN1ObjectIdentifier(Pkcs7Constants.OID_DATA);
    public static final ASN1ObjectIdentifier signedData = new ASN1ObjectIdentifier(Pkcs7Constants.OID_SIGNED_DATA);
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_signingDescription = pkcs_9.branch(Constants.WS_VERSION_HEADER_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_ct_timestampedData = id_ct.branch(ANSIConstants.RED_FG);
