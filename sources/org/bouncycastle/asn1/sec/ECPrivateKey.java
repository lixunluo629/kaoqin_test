...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/sec/ECPrivateKey.class */
public class ECPrivateKey extends ASN1Object {
    ...
    public ECPrivateKey(int i, BigInteger bigInteger) {
        ...
        aSN1EncodableVector.add((ASN1Encodable) new DEROctetString(bArrAsUnsignedByteArray));
    ...
    public ECPrivateKey(int i, BigInteger bigInteger, DERBitString dERBitString, ASN1Encodable aSN1Encodable) {
        ...
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add((ASN1Encodable) new DERTaggedObject(true, 0, aSN1Encodable));
        }
        if (dERBitString != null) {
            aSN1EncodableVector.add((ASN1Encodable) new DERTaggedObject(true, 1, (ASN1Encodable) dERBitString));
        }
        this.seq = new DERSequence(aSN1EncodableVector);
    }
