...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/x509/Extensions.class */
public class Extensions extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (enumerationElements.hasMoreElements()) {
            aSN1EncodableVector.add((ASN1Encodable) this.extensions.get((ASN1ObjectIdentifier) enumerationElements.nextElement()));
        }
