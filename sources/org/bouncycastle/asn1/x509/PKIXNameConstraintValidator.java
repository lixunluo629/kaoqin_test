...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/x509/PKIXNameConstraintValidator.class */
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private static boolean withinDNSubtree(ASN1Sequence aSN1Sequence, ASN1Sequence aSN1Sequence2) {
        ...
        for (int i2 = 0; i2 < aSN1Sequence.size(); i2++) {
            i = i2;
            if (RDN.getInstance(aSN1Sequence.getObjectAt(i2)).equals(rdn)) {
                break;
            }
        }
    ...
    private boolean emailIsConstrained(String str, String str2) {
        ...
        return str2.indexOf(64) != -1 ? str.equalsIgnoreCase(str2) || strSubstring.equalsIgnoreCase(str2.substring(1)) : str2.charAt(0) != '.' ? strSubstring.equalsIgnoreCase(str2) : withinDomain(strSubstring, str2);
    }
