...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/nsri/NSRIObjectIdentifiers.class */
public interface NSRIObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_aria256_cfb = id_sea.branch(Constants.WS_VERSION_HEADER_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_aria128_ocb2 = id_sea.branch(ANSIConstants.RED_FG);
    public static final ASN1ObjectIdentifier id_aria192_ocb2 = id_sea.branch(ANSIConstants.GREEN_FG);
    public static final ASN1ObjectIdentifier id_aria256_ocb2 = id_sea.branch(ANSIConstants.YELLOW_FG);
    public static final ASN1ObjectIdentifier id_aria128_gcm = id_sea.branch(ANSIConstants.BLUE_FG);
    public static final ASN1ObjectIdentifier id_aria192_gcm = id_sea.branch(ANSIConstants.MAGENTA_FG);
    public static final ASN1ObjectIdentifier id_aria256_gcm = id_sea.branch(ANSIConstants.CYAN_FG);
    public static final ASN1ObjectIdentifier id_aria128_ccm = id_sea.branch(ANSIConstants.WHITE_FG);
    public static final ASN1ObjectIdentifier id_aria192_ccm = id_sea.branch("38");
    public static final ASN1ObjectIdentifier id_aria256_ccm = id_sea.branch(ANSIConstants.DEFAULT_FG);
