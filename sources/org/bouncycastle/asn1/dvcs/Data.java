...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/dvcs/Data.class */
public class Data extends ASN1Object implements ASN1Choice {
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [org.bouncycastle.asn1.ASN1Primitive, org.bouncycastle.asn1.DERTaggedObject] */
    public ASN1Primitive toASN1Primitive() {
        return this.message != null ? this.message.toASN1Primitive() : this.messageImprint != null ? this.messageImprint.toASN1Primitive() : new DERTaggedObject(false, 0, (ASN1Encodable) this.certs);
    }
