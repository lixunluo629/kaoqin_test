...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/ua/DSTU4145NamedCurves.class */
public class DSTU4145NamedCurves {
    ...
    public static ECDomainParameters getByOID(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (!id.startsWith(oidBase) || (i = Integer.parseInt(id.substring(id.lastIndexOf(46) + 1))) < 0 || i >= params.length) {
            return null;
        }
        return params[i];
    }
