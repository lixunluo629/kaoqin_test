...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/ua/DSTU4145ECBinary.class */
public class DSTU4145ECBinary extends ASN1Object {
    ...
    private DSTU4145ECBinary(ASN1Sequence aSN1Sequence) {
        ...
        int i2 = i + 1;
        this.a = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(i2));
        int i3 = i2 + 1;
        this.b = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i3));
        int i4 = i3 + 1;
        this.n = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(i4));
