...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/est/AttrOrOID.class */
public class AttrOrOID extends ASN1Object implements ASN1Choice {
    ...
    public static AttrOrOID getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            if (aSN1Primitive instanceof ASN1ObjectIdentifier) {
                return new AttrOrOID(ASN1ObjectIdentifier.getInstance((Object) aSN1Primitive));
            }
    ...
    /* JADX WARN: Type inference failed for: r0v6, types: [org.bouncycastle.asn1.ASN1ObjectIdentifier, org.bouncycastle.asn1.ASN1Primitive] */
