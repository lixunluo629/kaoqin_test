...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/asn1/misc/ScryptParams.class */
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() == 5) {
            this.keyLength = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(4)).getValue();
        } else {
            this.keyLength = null;
        }
    }
