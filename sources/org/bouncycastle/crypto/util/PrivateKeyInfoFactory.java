...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/util/PrivateKeyInfoFactory.class */
public class PrivateKeyInfoFactory {
    ...
    public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter, ASN1Set aSN1Set) throws IOException {
        ...
        if (asymmetricKeyParameter instanceof RSAKeyParameters) {
            ...
            return new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.rsaEncryption, (ASN1Encodable) DERNull.INSTANCE), (ASN1Encodable) new RSAPrivateKey(rSAPrivateCrtKeyParameters.getModulus(), rSAPrivateCrtKeyParameters.getPublicExponent(), rSAPrivateCrtKeyParameters.getExponent(), rSAPrivateCrtKeyParameters.getP(), rSAPrivateCrtKeyParameters.getQ(), rSAPrivateCrtKeyParameters.getDP(), rSAPrivateCrtKeyParameters.getDQ(), rSAPrivateCrtKeyParameters.getQInv()), aSN1Set);
        }
        if (asymmetricKeyParameter instanceof DSAPrivateKeyParameters) {
            DSAPrivateKeyParameters dSAPrivateKeyParameters = (DSAPrivateKeyParameters) asymmetricKeyParameter;
            DSAParameters parameters = dSAPrivateKeyParameters.getParameters();
            return new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, (ASN1Encodable) new DSAParameter(parameters.getP(), parameters.getQ(), parameters.getG())), (ASN1Encodable) new ASN1Integer(dSAPrivateKeyParameters.getX()), aSN1Set);
        }
        ...
        if (parameters2 == null) {
            ...
            if (parameters2 instanceof ECGOST3410Parameters) {
                ...
                return new PrivateKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) gOST3410PublicKeyAlgParameters), (ASN1Encodable) new DEROctetString(bArr));
            }
        ...
        return new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable) x962Parameters), (ASN1Encodable) new ECPrivateKey(iBitLength, eCPrivateKeyParameters.getD(), new DERBitString(new FixedPointCombMultiplier().multiply(parameters2.getG(), eCPrivateKeyParameters.getD()).getEncoded(false)), x962Parameters), aSN1Set);
    }
