...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/util/SubjectPublicKeyInfoFactory.class */
    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        ...
        if (parameters2 == null) {
            ...
            if (parameters2 instanceof ECGOST3410Parameters) {
                ...
                try {
                    return new SubjectPublicKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) gOST3410PublicKeyAlgParameters), (ASN1Encodable) new DEROctetString(bArr));
                } catch (IOException e) {
                    return null;
                }
            }
        ...
        return new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable) x962Parameters), eCPublicKeyParameters.getQ().getEncoded(false));
    }
