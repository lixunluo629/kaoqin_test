...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/CryptoServicesRegistrar.class */
public final class CryptoServicesRegistrar {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/CryptoServicesRegistrar$Property.class */
    ...
    /* JADX WARN: Type inference failed for: r0v15, types: [T, org.bouncycastle.crypto.params.DSAParameters] */
    /* JADX WARN: Type inference failed for: r0v25, types: [T, org.bouncycastle.crypto.params.DHParameters] */
    public static <T> T getSizedProperty(Property property, int i) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            for (int i2 = 0; i2 != objArrLookupProperty.length; i2++) {
                ?? r0 = (T) ((DHParameters) objArrLookupProperty[i2]);
                if (r0.getP().bitLength() == i) {
                    return r0;
                }
            }
            return null;
        }
        if (!property.type.isAssignableFrom(DSAParameters.class)) {
            return null;
        }
        for (int i3 = 0; i3 != objArrLookupProperty.length; i3++) {
            ?? r02 = (T) ((DSAParameters) objArrLookupProperty[i3]);
            if (r02.getP().bitLength() == i) {
                return r02;
            }
        }
        return null;
    ...
    private static int chooseLowerBound(int i) {
        int i2 = 160;
        if (i > 1024) {
            i2 = i <= 2048 ? 224 : i <= 3072 ? 256 : i <= 7680 ? 384 : 512;
        }
        return i2;
    }
