...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/ec/CustomNamedCurves.class */
public class CustomNamedCurves {
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.crypto.ec.CustomNamedCurves.3
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurveConfigureCurveGLV, CustomNamedCurves.configureBasepoint(eCCurveConfigureCurveGLV, "043B4C382CE37AA192A4019E763036F4F5DD4D7EBB938CF935318FDCED6BC28286531733C3F03C4FEE"), eCCurveConfigureCurveGLV.getOrder(), eCCurveConfigureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.crypto.ec.CustomNamedCurves.6
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurveConfigureCurveGLV, CustomNamedCurves.configureBasepoint(eCCurveConfigureCurveGLV, "04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D"), eCCurveConfigureCurveGLV.getOrder(), eCCurveConfigureCurveGLV.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.crypto.ec.CustomNamedCurves.18
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurveConfigureCurve, CustomNamedCurves.configureBasepoint(eCCurveConfigureCurve, "0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9"), eCCurveConfigureCurve.getOrder(), eCCurveConfigureCurve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.crypto.ec.CustomNamedCurves.23
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurveConfigureCurve, CustomNamedCurves.configureBasepoint(eCCurveConfigureCurve, "04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3"), eCCurveConfigureCurve.getOrder(), eCCurveConfigureCurve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.crypto.ec.CustomNamedCurves.25
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(eCCurveConfigureCurve, CustomNamedCurves.configureBasepoint(eCCurveConfigureCurve, "0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA"), eCCurveConfigureCurve.getOrder(), eCCurveConfigureCurve.getCofactor(), (byte[]) null);
        }
    };
