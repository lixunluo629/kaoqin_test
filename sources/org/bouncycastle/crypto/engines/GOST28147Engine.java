...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/GOST28147Engine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/GOST28147Engine.class */
public class GOST28147Engine implements BlockCipher {
    ...
    private int GOST28147_mainStep(int i, int i2) {
        int i3 = i2 + i;
        int i4 = (this.S[0 + ((i3 >> 0) & 15)] << 0) + (this.S[16 + ((i3 >> 4) & 15)] << 4) + (this.S[32 + ((i3 >> 8) & 15)] << 8) + (this.S[48 + ((i3 >> 12) & 15)] << 12) + (this.S[64 + ((i3 >> 16) & 15)] << 16) + (this.S[80 + ((i3 >> 20) & 15)] << 20) + (this.S[96 + ((i3 >> 24) & 15)] << 24) + (this.S[112 + ((i3 >> 28) & 15)] << 28);
        return (i4 << 11) | (i4 >>> 21);
    }
        ...
        if (this.forEncryption) {
            for (int i3 = 0; i3 < 3; i3++) {
                for (int i4 = 0; i4 < 8; i4++) {
                    int i5 = iBytesToint;
                    iBytesToint = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i4]);
                    iBytesToint2 = i5;
                }
            }
            for (int i6 = 7; i6 > 0; i6--) {
                int i7 = iBytesToint;
                iBytesToint = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i6]);
                iBytesToint2 = i7;
            }
        } else {
            for (int i8 = 0; i8 < 8; i8++) {
                int i9 = iBytesToint;
                iBytesToint = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i8]);
                iBytesToint2 = i9;
            }
            for (int i10 = 0; i10 < 3; i10++) {
                for (int i11 = 7; i11 >= 0 && (i10 != 2 || i11 != 0); i11--) {
                    int i12 = iBytesToint;
                    iBytesToint = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i11]);
                    iBytesToint2 = i12;
                }
            }
        }
        int iGOST28147_mainStep = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[0]);
        intTobytes(iBytesToint, bArr2, i2);
        intTobytes(iGOST28147_mainStep, bArr2, i2 + 4);
    }
