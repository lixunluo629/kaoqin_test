...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/SM4Engine.class */
public class SM4Engine implements BlockCipher {
    ...
    private int tau(int i) {
        int i2 = Sbox[(i >> 24) & 255] & 255;
        int i3 = Sbox[(i >> 16) & 255] & 255;
        int i4 = Sbox[(i >> 8) & 255] & 255;
        return (i2 << 24) | (i3 << 16) | (i4 << 8) | (Sbox[i & 255] & 255);
    }
