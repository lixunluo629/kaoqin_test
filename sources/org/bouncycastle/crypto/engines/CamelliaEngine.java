...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/CamelliaEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/CamelliaEngine.class */
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i3 = ((SBOX4_4404[i2 & 255] ^ SBOX3_3033[(i2 >>> 8) & 255]) ^ SBOX2_0222[(i2 >>> 16) & 255]) ^ SBOX1_1110[(i2 >>> 24) & 255];
        int i4 = iArr[1] ^ iArr2[1 + i];
        int i5 = ((SBOX1_1110[i4 & 255] ^ SBOX4_4404[(i4 >>> 8) & 255]) ^ SBOX3_3033[(i4 >>> 16) & 255]) ^ SBOX2_0222[(i4 >>> 24) & 255];
        iArr[2] = iArr[2] ^ (i3 ^ i5);
        iArr[3] = iArr[3] ^ ((i3 ^ i5) ^ rightRotate(i3, 8));
        int i6 = iArr[2] ^ iArr2[2 + i];
        int i7 = ((SBOX4_4404[i6 & 255] ^ SBOX3_3033[(i6 >>> 8) & 255]) ^ SBOX2_0222[(i6 >>> 16) & 255]) ^ SBOX1_1110[(i6 >>> 24) & 255];
        int i8 = iArr[3] ^ iArr2[3 + i];
        int i9 = ((SBOX1_1110[i8 & 255] ^ SBOX4_4404[(i8 >>> 8) & 255]) ^ SBOX3_3033[(i8 >>> 16) & 255]) ^ SBOX2_0222[(i8 >>> 24) & 255];
        iArr[0] = iArr[0] ^ (i7 ^ i9);
        iArr[1] = iArr[1] ^ ((i7 ^ i9) ^ rightRotate(i7, 8));
    }
