...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/DESEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/DESEngine.class */
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP1 = {R.attr.transitionName, 0, 65536, R.attr.fillColor, R.attr.manageSpaceActivity, 66564, 4, 65536, 1024, R.attr.transitionName, R.attr.fillColor, 1024, 16778244, R.attr.manageSpaceActivity, 16777216, 4, 1028, 16778240, 16778240, 66560, 66560, 16842752, 16842752, 16778244, 65540, ResourceTableMap.MapAttr.OTHER, ResourceTableMap.MapAttr.OTHER, 65540, 0, 1028, 66564, 16777216, 65536, R.attr.fillColor, 4, 16842752, R.attr.transitionName, 16777216, 16777216, 1024, R.attr.manageSpaceActivity, 65536, 66560, ResourceTableMap.MapAttr.OTHER, 1024, 4, 16778244, 66564, R.attr.fillColor, 65540, 16842752, 16778244, ResourceTableMap.MapAttr.OTHER, 1028, 66564, R.attr.transitionName, 1028, 16778240, 16778240, 0, 65540, 66560, 0, R.attr.manageSpaceActivity};
    ...
    protected void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i15 = i12 ^ i14;
        int i16 = i13 ^ (i14 << 8);
        int i17 = ((i16 << 1) | ((i16 >>> 31) & 1)) & (-1);
        int i18 = (i15 ^ i17) & (-1431655766);
        int i19 = i15 ^ i18;
        int i20 = i17 ^ i18;
        int i21 = ((i19 << 1) | ((i19 >>> 31) & 1)) & (-1);
        for (int i22 = 0; i22 < 8; i22++) {
            int i23 = ((i20 << 28) | (i20 >>> 4)) ^ iArr[(i22 * 4) + 0];
            int i24 = SP7[i23 & 63] | SP5[(i23 >>> 8) & 63] | SP3[(i23 >>> 16) & 63] | SP1[(i23 >>> 24) & 63];
            int i25 = i20 ^ iArr[(i22 * 4) + 1];
            i21 ^= (((i24 | SP8[i25 & 63]) | SP6[(i25 >>> 8) & 63]) | SP4[(i25 >>> 16) & 63]) | SP2[(i25 >>> 24) & 63];
            int i26 = ((i21 << 28) | (i21 >>> 4)) ^ iArr[(i22 * 4) + 2];
            int i27 = SP7[i26 & 63] | SP5[(i26 >>> 8) & 63] | SP3[(i26 >>> 16) & 63] | SP1[(i26 >>> 24) & 63];
            int i28 = i21 ^ iArr[(i22 * 4) + 3];
            i20 ^= (((i27 | SP8[i28 & 63]) | SP6[(i28 >>> 8) & 63]) | SP4[(i28 >>> 16) & 63]) | SP2[(i28 >>> 24) & 63];
        }
        int i29 = (i20 << 31) | (i20 >>> 1);
        int i30 = (i21 ^ i29) & (-1431655766);
        int i31 = i21 ^ i30;
        int i32 = i29 ^ i30;
        int i33 = (i31 << 31) | (i31 >>> 1);
        ...
        int i44 = i41 ^ i43;
        int i45 = i42 ^ (i43 << 4);
        bArr2[i2 + 0] = (byte) ((i45 >>> 24) & 255);
        bArr2[i2 + 1] = (byte) ((i45 >>> 16) & 255);
        bArr2[i2 + 2] = (byte) ((i45 >>> 8) & 255);
        bArr2[i2 + 3] = (byte) (i45 & 255);
        bArr2[i2 + 4] = (byte) ((i44 >>> 24) & 255);
        bArr2[i2 + 5] = (byte) ((i44 >>> 16) & 255);
        bArr2[i2 + 6] = (byte) ((i44 >>> 8) & 255);
        bArr2[i2 + 7] = (byte) (i44 & 255);
    }
}
