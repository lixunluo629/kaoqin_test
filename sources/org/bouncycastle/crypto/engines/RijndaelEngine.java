...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/RijndaelEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/RijndaelEngine.class */
public class RijndaelEngine implements BlockCipher {
    ...
    private byte mul0xe(int i) {
        if (i >= 0) {
            return aLogtable[Constants.MULTIANEWARRAY_QUICK + i];
        }
        return (byte) 0;
    }
    ...
    private void MixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            jMul0x24 |= ((((mul0x2(i2) ^ mul0x3(i3)) ^ i4) ^ i5) & 255) << i;
            jMul0x23 |= ((((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i2) & 255) << i;
            jMul0x22 |= ((((mul0x2(i4) ^ mul0x3(i5)) ^ i2) ^ i3) & 255) << i;
            jMul0x2 |= ((((mul0x2(i5) ^ mul0x3(i2)) ^ i3) ^ i4) & 255) << i;
        }
        this.A0 = jMul0x24;
        this.A1 = jMul0x23;
        this.A2 = jMul0x22;
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            int i8 = i4 != 0 ? logtable[i4 & 255] & 255 : -1;
            int i9 = i5 != 0 ? logtable[i5 & 255] & 255 : -1;
            jMul0xe4 |= ((((mul0xe(i6) ^ mul0xb(i7)) ^ mul0xd(i8)) ^ mul0x9(i9)) & 255) << i;
            jMul0xe3 |= ((((mul0xe(i7) ^ mul0xb(i8)) ^ mul0xd(i9)) ^ mul0x9(i6)) & 255) << i;
            jMul0xe2 |= ((((mul0xe(i8) ^ mul0xb(i9)) ^ mul0xd(i6)) ^ mul0x9(i7)) & 255) << i;
            jMul0xe |= ((((mul0xe(i9) ^ mul0xb(i6)) ^ mul0xd(i7)) ^ mul0x9(i8)) & 255) << i;
        }
        this.A0 = jMul0xe4;
        this.A1 = jMul0xe3;
        this.A2 = jMul0xe2;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        int i6 = 0;
        int i7 = 0;
        while (i7 < i && i6 < (this.ROUNDS + 1) * (this.BC / 8)) {
            for (int i8 = 0; i8 < 4; i8++) {
                long[] jArr2 = jArr[i6 / (this.BC / 8)];
                int i9 = i8;
                jArr2[i9] = jArr2[i9] | ((bArr2[i8][i7] & 255) << ((i6 * 8) % this.BC));
            }
            i7++;
            i6++;
        }
        while (i6 < (this.ROUNDS + 1) * (this.BC / 8)) {
            ...
            int i22 = 0;
            while (i22 < i && i6 < (this.ROUNDS + 1) * (this.BC / 8)) {
                for (int i23 = 0; i23 < 4; i23++) {
                    long[] jArr3 = jArr[i6 / (this.BC / 8)];
                    int i24 = i23;
                    jArr3[i24] = jArr3[i24] | ((bArr2[i23][i22] & 255) << ((i6 * 8) % this.BC));
                }
                i22++;
                i6++;
            }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (i + (this.BC / 2) > bArr.length) {
            throw new DataLengthException("input buffer too short");
        }
        if (i2 + (this.BC / 2) > bArr2.length) {
    ...
    private void unpackBlock(byte[] bArr, int i) {
        this.A0 = bArr[i] & 255;
        this.A1 = bArr[r10] & 255;
        this.A2 = bArr[r10] & 255;
        int i2 = i + 1 + 1 + 1 + 1;
        this.A3 = bArr[r10] & 255;
        for (int i3 = 8; i3 != this.BC; i3 += 8) {
            int i4 = i2;
            this.A0 |= (bArr[i4] & 255) << i3;
            this.A1 |= (bArr[r10] & 255) << i3;
            this.A2 |= (bArr[r10] & 255) << i3;
            i2 = i2 + 1 + 1 + 1 + 1;
            this.A3 |= (bArr[r10] & 255) << i3;
        }
    }
    ...
    private void packBlock(byte[] bArr, int i) {
        ...
        for (int i3 = 0; i3 != this.BC; i3 += 8) {
            int i4 = i2;
            int i5 = i2 + 1;
            bArr[i4] = (byte) (this.A0 >> i3);
            int i6 = i5 + 1;
            bArr[i5] = (byte) (this.A1 >> i3);
            int i7 = i6 + 1;
            bArr[i6] = (byte) (this.A2 >> i3);
            i2 = i7 + 1;
            bArr[i7] = (byte) (this.A3 >> i3);
        }
    }
