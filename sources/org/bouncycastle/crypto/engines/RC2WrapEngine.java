...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/RC2WrapEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/RC2WrapEngine.class */
public class RC2WrapEngine implements Wrapper {
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        byte[] bArr4 = new byte[bArr2.length + bArrCalculateCMSKeyChecksum.length];
        System.arraycopy(bArr2, 0, bArr4, 0, bArr2.length);
        System.arraycopy(bArrCalculateCMSKeyChecksum, 0, bArr4, bArr2.length, bArrCalculateCMSKeyChecksum.length);
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (bArr6.length - (((bArr6[0] == true ? 1 : 0) & 255) + 1) > 7) {
            throw new InvalidCipherTextException("too many pad bytes (" + (bArr6.length - (((bArr6[0] == true ? 1 : 0) & 255) + 1)) + ")");
        }
