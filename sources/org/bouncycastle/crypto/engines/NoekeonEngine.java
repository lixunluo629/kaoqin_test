...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/NoekeonEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/NoekeonEngine.class */
public class NoekeonEngine implements BlockCipher {
    private static final int genericSize = 16;
    private static final int[] nullVector = {0, 0, 0, 0};
    private static final int[] roundConstants = {128, 27, 54, 108, Constants.INVOKESUPER_QUICK, 171, 77, 154, 47, 94, 188, 99, 198, 151, 53, 106, Constants.GETSTATIC2_QUICK};
