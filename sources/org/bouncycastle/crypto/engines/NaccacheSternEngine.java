...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/NaccacheSternEngine.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/engines/NaccacheSternEngine.class */
public class NaccacheSternEngine implements AsymmetricBlockCipher {
    ...
    public byte[] processBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (this.forEncryption) {
            ...
            byteArray = chineseRemainder(vector, smallPrimes).toByteArray();
        }
        return byteArray;
    }
    ...
    public byte[] processData(byte[] bArr) throws InvalidCipherTextException {
        ...
        while (length < bArr.length) {
            if (length + inputBlockSize < bArr.length) {
