...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/engines/ARIAEngine.class */
public class ARIAEngine implements BlockCipher {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        int i6 = i3;
        int i7 = i3 + 1;
        FO(bArr3, this.roundKeys[i6]);
        xor(bArr3, this.roundKeys[i7]);
        SL2(bArr3);
        xor(bArr3, this.roundKeys[i7 + 1]);
    ...
    protected static void A(byte[] bArr) {
        ...
        bArr[12] = (byte) ((((((b2 ^ b3) ^ b7) ^ b8) ^ b10) ^ b12) ^ b13);
        bArr[13] = (byte) ((((((b ^ b4) ^ b7) ^ b8) ^ b9) ^ b11) ^ b14);
