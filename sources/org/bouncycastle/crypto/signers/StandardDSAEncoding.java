...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/signers/StandardDSAEncoding.class */
public class StandardDSAEncoding implements DSAEncoding {
    ...
    protected void encodeValue(BigInteger bigInteger, ASN1EncodableVector aSN1EncodableVector, BigInteger bigInteger2) {
        aSN1EncodableVector.add((ASN1Encodable) new ASN1Integer(checkValue(bigInteger, bigInteger2)));
    }
}
