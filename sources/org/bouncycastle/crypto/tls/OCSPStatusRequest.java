...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/tls/OCSPStatusRequest.class */
public class OCSPStatusRequest {
    ...
    public void encode(OutputStream outputStream) throws IOException {
        ...
        byte[] encoded = this.requestExtensions.getEncoded("DER");
    ...
    public static OCSPStatusRequest parse(InputStream inputStream) throws IOException {
        ...
        if (uint162 > 0) {
            extensions = Extensions.getInstance(TlsUtils.readDERObject(TlsUtils.readFully(uint162, inputStream)));
        }
