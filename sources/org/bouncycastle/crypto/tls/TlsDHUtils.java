...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/tls/TlsDHUtils.class */
public class TlsDHUtils {
    ...
    public static DHPrivateKeyParameters generateEphemeralServerKeyExchange(SecureRandom secureRandom, DHParameters dHParameters, OutputStream outputStream) throws IOException {
        AsymmetricCipherKeyPair asymmetricCipherKeyPairGenerateDHKeyPair = generateDHKeyPair(secureRandom, dHParameters);
        DHPublicKeyParameters dHPublicKeyParameters = (DHPublicKeyParameters) asymmetricCipherKeyPairGenerateDHKeyPair.getPublic();
    ...
    public static DHParameters receiveDHParameters(TlsDHVerifier tlsDHVerifier, InputStream inputStream) throws IOException {
        DHParameters dHParameters = readDHParameters(inputStream);
        if (tlsDHVerifier.accept(dHParameters)) {
            return dHParameters;
        }
