...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/tls/NamedCurve.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/tls/NamedCurve.class */
public class NamedCurve {
    ...
    static ECDomainParameters getECParameters(int i) {
        ...
        int i2 = i - 1;
        if (i2 < 0 || i2 >= curveNames.length || (byName = SECNamedCurves.getByName(curveNames[i2])) == null) {
            return null;
        }
