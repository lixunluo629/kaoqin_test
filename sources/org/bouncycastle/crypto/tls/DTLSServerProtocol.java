...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/tls/DTLSServerProtocol.class */
public class DTLSServerProtocol extends DTLSProtocol {
    protected boolean verifyRequests;

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/tls/DTLSServerProtocol$ServerHandshakeState.class */
    ...
    public DTLSTransport accept(TlsServer tlsServer, DatagramTransport datagramTransport) throws IOException {
        ...
        try {
            try {
                try {
                    DTLSTransport dTLSTransportServerHandshake = serverHandshake(serverHandshakeState, dTLSRecordLayer);
                    securityParameters.clear();
                    return dTLSTransportServerHandshake;
                } catch (IOException e) {
