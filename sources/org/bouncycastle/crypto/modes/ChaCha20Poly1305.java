...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/modes/ChaCha20Poly1305.class */
public class ChaCha20Poly1305 implements AEADCipher {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/modes/ChaCha20Poly1305$State.class */
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (0 != this.state && z && Arrays.areEqual(this.nonce, iv) && (null == key || Arrays.areEqual(this.key, key.getKey()))) {
