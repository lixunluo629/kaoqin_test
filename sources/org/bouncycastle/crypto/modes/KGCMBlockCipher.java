...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/modes/KGCMBlockCipher.class */
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/modes/KGCMBlockCipher$ExposedByteArrayOutputStream.class */
    ...
    /* JADX WARN: Type inference failed for: r3v2, types: [org.bouncycastle.crypto.BlockCipher, org.bouncycastle.crypto.modes.KCTRBlockCipher] */
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            int length2 = this.iv.length - iv.length;
            Arrays.fill(this.iv, (byte) 0);
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException, DataLengthException {
        ...
        if (this.forEncryption) {
            System.arraycopy(this.macBlock, 0, bArr, i + iDoFinal, this.macSize);
            reset();
