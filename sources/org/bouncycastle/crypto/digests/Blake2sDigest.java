...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/digests/Blake2sDigest.class */
public class Blake2sDigest implements ExtendedDigest {
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < this.chainValue.length && i2 * 4 < this.digestLength; i2++) {
            byte[] bArrIntToLittleEndian = Pack.intToLittleEndian(this.chainValue[i2]);
            if (i2 * 4 < this.digestLength - 4) {
                System.arraycopy(bArrIntToLittleEndian, 0, bArr, i + (i2 * 4), 4);
            } else {
                System.arraycopy(bArrIntToLittleEndian, 0, bArr, i + (i2 * 4), this.digestLength - (i2 * 4));
            }
        }
