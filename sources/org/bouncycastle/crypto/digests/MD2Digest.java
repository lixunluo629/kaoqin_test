...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/digests/MD2Digest.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/digests/MD2Digest.class */
public class MD2Digest implements ExtendedDigest {
    ...
    protected void processCheckSum(byte[] bArr) {
        ...
        for (int i = 0; i < 16; i++) {
            byte[] bArr2 = this.C;
            int i2 = i;
            bArr2[i2] = (byte) (bArr2[i2] ^ S[(bArr[i] ^ b) & 255]);
            b = this.C[i];
        }
    }
