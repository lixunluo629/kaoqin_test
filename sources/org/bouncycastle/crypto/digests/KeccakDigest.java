...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/digests/KeccakDigest.class */
public class KeccakDigest implements ExtendedDigest {
    ...
    private void init(int i) {
        switch (i) {
            ...
            case 384:
            case 512:
                initSponge(MysqlErrorNumbers.ER_VIEW_INVALID_CREATION_CTX - (i << 1));
                return;
            default:
    ...
    private void initSponge(int i) {
        ...
        this.fixedOutputLength = (MysqlErrorNumbers.ER_VIEW_INVALID_CREATION_CTX - i) / 2;
    }
    ...
    protected void absorb(byte[] bArr, int i, int i2) {
        ...
        while (i5 < i2) {
            if (i3 != 0 || i5 > i2 - i4) {
                ...
                System.arraycopy(bArr, i + i5, this.dataQueue, i3, iMin);
                i3 += iMin;
                i5 += iMin;
                if (i3 == i4) {
    ...
    protected void squeeze(byte[] bArr, int i, long j) {
        ...
        while (true) {
            ...
            int iMin = (int) Math.min(this.bitsInQueue, j - j3);
            System.arraycopy(this.dataQueue, (this.rate - this.bitsInQueue) / 8, bArr, i + ((int) (j3 / 8)), iMin / 8);
