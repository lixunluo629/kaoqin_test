...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/digests/SHA512tDigest.class */
public class SHA512tDigest extends LongDigest {
    ...
    private static void intToBigEndian(int i, byte[] bArr, int i2, int i3) {
        ...
        while (true) {
            ...
            bArr[i2 + iMin] = (byte) (i >>> (8 * (3 - iMin)));
        }
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [org.bouncycastle.crypto.digests.SHA512tDigest, org.bouncycastle.util.Memoable] */
