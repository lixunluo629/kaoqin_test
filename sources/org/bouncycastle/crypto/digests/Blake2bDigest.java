...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/digests/Blake2bDigest.class */
public class Blake2bDigest implements ExtendedDigest {
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < this.chainValue.length && i2 * 8 < this.digestLength; i2++) {
            byte[] bArrLongToLittleEndian = Pack.longToLittleEndian(this.chainValue[i2]);
            if (i2 * 8 < this.digestLength - 8) {
                System.arraycopy(bArrLongToLittleEndian, 0, bArr, i + (i2 * 8), 8);
            } else {
                System.arraycopy(bArrLongToLittleEndian, 0, bArr, i + (i2 * 8), this.digestLength - (i2 * 8));
            }
        }
