...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/examples/JPAKEExample.class */
public class JPAKEExample {
    public static void main(String[] strArr) throws IllegalStateException, DataLengthException, CryptoException {
        ...
        System.out.println("");
        System.out.println("(Secret passwords used by Alice and Bob: \"" + NonRegisteringDriver.PASSWORD_PROPERTY_KEY + "\" and \"" + NonRegisteringDriver.PASSWORD_PROPERTY_KEY + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", NonRegisteringDriver.PASSWORD_PROPERTY_KEY.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", NonRegisteringDriver.PASSWORD_PROPERTY_KEY.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
