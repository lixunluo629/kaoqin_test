...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/macs/GOST28147Mac.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/macs/GOST28147Mac.class */
public class GOST28147Mac implements Mac {
    ...
    public void update(byte b) throws IllegalStateException {
        if (this.bufOff == this.buf.length) {
            byte[] bArrCM5func = new byte[this.buf.length];
            System.arraycopy(this.buf, 0, bArrCM5func, 0, this.mac.length);
            if (this.firstStep) {
