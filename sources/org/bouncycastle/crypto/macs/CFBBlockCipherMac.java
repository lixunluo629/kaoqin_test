...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/macs/CFBBlockCipherMac.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/macs/CFBBlockCipherMac.class */
public class CFBBlockCipherMac implements Mac {
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        if (i2 > i3) {
            ...
            int iProcessBlock = 0 + this.cipher.processBlock(this.buf, 0, this.mac, 0);
            this.bufOff = 0;
            i2 -= i3;
            int i4 = i;
            int i5 = i3;
            while (true) {
                ...
                iProcessBlock += this.cipher.processBlock(bArr, i, this.mac, 0);
                i2 -= blockSize;
                i4 = i;
                i5 = blockSize;
            }
