...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/prng/VMPCRandomGenerator.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/crypto/prng/VMPCRandomGenerator.class */
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void addSeedMaterial(long j) {
        addSeedMaterial(new byte[]{(byte) ((j & (-16777216)) >> 24), (byte) ((j & 16711680) >> 16), (byte) ((j & 65280) >> 8), (byte) (j & 255)});
    }
    ...
    public void nextBytes(byte[] bArr, int i, int i2) {
        synchronized (this.P) {
            ...
            for (int i4 = i; i4 != i3; i4++) {
                ...
                bArr[i4] = this.P[(this.P[this.P[this.s & 255] & 255] + 1) & 255];
