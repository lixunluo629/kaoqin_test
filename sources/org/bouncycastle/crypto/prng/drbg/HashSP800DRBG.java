...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/prng/drbg/HashSP800DRBG.class */
public class HashSP800DRBG implements SP80090DRBG {
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (bArr2 != null) {
            byte[] bArr3 = new byte[1 + this._V.length + bArr2.length];
            bArr3[0] = 2;
            System.arraycopy(this._V, 0, bArr3, 1, this._V.length);
            System.arraycopy(bArr2, 0, bArr3, 1 + this._V.length, bArr2.length);
    ...
    static {
        seedlens.put("SHA-1", Integers.valueOf(HyperlinkRecord.sid));
        seedlens.put(McElieceCCA2KeyGenParameterSpec.SHA224, Integers.valueOf(HyperlinkRecord.sid));
        seedlens.put("SHA-256", Integers.valueOf(HyperlinkRecord.sid));
        seedlens.put(SPHINCSKeyParameters.SHA512_256, Integers.valueOf(HyperlinkRecord.sid));
        seedlens.put("SHA-512/224", Integers.valueOf(HyperlinkRecord.sid));
