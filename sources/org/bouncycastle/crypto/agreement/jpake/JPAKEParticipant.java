...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/agreement/jpake/JPAKEParticipant.class */
public class JPAKEParticipant {
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(cArr, NonRegisteringDriver.PASSWORD_PROPERTY_KEY);
        JPAKEUtil.validateNotNull(jPAKEPrimeOrderGroup, "p");
        JPAKEUtil.validateNotNull(digest, "digest");
        JPAKEUtil.validateNotNull(secureRandom, RandomValuePropertySource.RANDOM_PROPERTY_SOURCE_NAME);
        if (cArr.length == 0) {
