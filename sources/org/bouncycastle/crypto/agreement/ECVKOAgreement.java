...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/crypto/agreement/ECVKOAgreement.class */
public class ECVKOAgreement {
    ...
    private byte[] fromPoint(ECPoint eCPoint) {
        ...
        for (int i2 = 0; i2 != i; i2++) {
            bArr[i2] = bArrAsUnsignedByteArray[(i - i2) - 1];
        }
        for (int i3 = 0; i3 != i; i3++) {
            bArr[i + i3] = bArrAsUnsignedByteArray2[(i - i3) - 1];
        }
