...
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/x509/examples/AttrCertExample.class */
public class AttrCertExample {
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        KeyFactory keyFactory = KeyFactory.getInstance(RSAUtils.RSA_KEY_ALGORITHM, "BC");
