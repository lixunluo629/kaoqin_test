...
/* JADX WARN: Classes with same name are omitted:
  bcprov-jdk15on-1.64.jar:org/bouncycastle/x509/X509AttributeCertStoreSelector.class
 */
/* loaded from: bcprov-jdk16-1.46.jar:org/bouncycastle/x509/X509AttributeCertStoreSelector.class */
    ...
    private Set extractGeneralNames(Collection collection) throws IOException {
        ...
        for (Object obj : collection) {
            if (obj instanceof GeneralName) {
                ...
                hashSet.add(GeneralName.getInstance(ASN1Object.fromByteArray((byte[]) obj)));
            }
        }
        return hashSet;
    }
