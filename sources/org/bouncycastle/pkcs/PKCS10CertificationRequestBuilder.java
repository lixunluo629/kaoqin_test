...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/pkcs/PKCS10CertificationRequestBuilder.class */
public class PKCS10CertificationRequestBuilder {
    ...
    public PKCS10CertificationRequestBuilder addAttribute(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Encodable[] aSN1EncodableArr) {
        this.attributes.add(new Attribute(aSN1ObjectIdentifier, (ASN1Set) new DERSet(aSN1EncodableArr)));
        return this;
    }
    ...
    public PKCS10CertificationRequest build(ContentSigner contentSigner) throws IOException {
        ...
        if (this.attributes.isEmpty()) {
            ...
            Iterator it = this.attributes.iterator();
            while (it.hasNext()) {
                aSN1EncodableVector.add((ASN1Encodable) Attribute.getInstance(it.next()));
            }
