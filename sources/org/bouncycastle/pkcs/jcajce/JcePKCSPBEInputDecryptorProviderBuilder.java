...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/pkcs/jcajce/JcePKCSPBEInputDecryptorProviderBuilder.class */
public class JcePKCSPBEInputDecryptorProviderBuilder {
    ...
    public InputDecryptorProvider build(final char[] cArr) {
        return new InputDecryptorProvider() { // from class: org.bouncycastle.pkcs.jcajce.JcePKCSPBEInputDecryptorProviderBuilder.1
            ...
            public InputDecryptor get(AlgorithmIdentifier algorithmIdentifier) throws InvalidKeySpecException, NoSuchAlgorithmException, OperatorCreationException, InvalidKeyException, IOException, InvalidAlgorithmParameterException {
