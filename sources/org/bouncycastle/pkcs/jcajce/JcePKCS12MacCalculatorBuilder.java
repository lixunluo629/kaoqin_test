...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/pkcs/jcajce/JcePKCS12MacCalculatorBuilder.class */
        ...
        try {
            ...
            return new MacCalculator() { // from class: org.bouncycastle.pkcs.jcajce.JcePKCS12MacCalculatorBuilder.1
                ...
                public AlgorithmIdentifier getAlgorithmIdentifier() {
                    return new AlgorithmIdentifier(JcePKCS12MacCalculatorBuilder.this.algorithm, (ASN1Encodable) new PKCS12PBEParams(bArr, JcePKCS12MacCalculatorBuilder.this.iterationCount));
                }
