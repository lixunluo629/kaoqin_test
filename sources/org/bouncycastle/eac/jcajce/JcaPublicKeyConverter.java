...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/eac/jcajce/JcaPublicKeyConverter.class */
public class JcaPublicKeyConverter {
    ...
    public PublicKey getKey(PublicKeyDataObject publicKeyDataObject) throws EACException, InvalidKeySpecException {
        ...
        try {
            return this.helper.createKeyFactory(RSAUtils.RSA_KEY_ALGORITHM).generatePublic(new RSAPublicKeySpec(rSAPublicKey.getModulus(), rSAPublicKey.getPublicExponent()));
    ...
    private ECParameterSpec getParams(ECDSAPublicKey eCDSAPublicKey) {
        ...
        org.bouncycastle.math.ec.ECPoint eCPointDecodePoint = fp.decodePoint(eCDSAPublicKey.getBasePointG());
    ...
    private static org.bouncycastle.math.ec.ECPoint convertPoint(ECCurve eCCurve, java.security.spec.ECPoint eCPoint) {
