...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/eac/operator/jcajce/JcaEACSignatureVerifierBuilder.class */
public class JcaEACSignatureVerifierBuilder {
    private EACHelper helper = new DefaultEACHelper();

    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/eac/operator/jcajce/JcaEACSignatureVerifierBuilder$SignatureOutputStream.class */
    ...
    public static byte[] derEncode(byte[] bArr) throws IOException {
        ...
        aSN1EncodableVector.add((ASN1Encodable) new ASN1Integer(new BigInteger(1, bArr2)));
        aSN1EncodableVector.add((ASN1Encodable) new ASN1Integer(new BigInteger(1, bArr3)));
