...
/* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/eac/operator/jcajce/JcaEACSignerBuilder.class */
public class JcaEACSignerBuilder {
    private static final Hashtable sigNames = new Hashtable();
    private EACHelper helper = new DefaultEACHelper();

    /* loaded from: bcpkix-jdk15on-1.64.jar:org/bouncycastle/eac/operator/jcajce/JcaEACSignerBuilder$SignatureOutputStream.class */
    ...
    public static byte[] reencode(byte[] bArr) {
        ...
        BigInteger value = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(0)).getValue();
        BigInteger value2 = ASN1Integer.getInstance((Object) aSN1Sequence.getObjectAt(1)).getValue();
        ...
        copyUnsignedInt(byteArray2, bArr2, (2 * iMax) - iUnsignedIntLength2);
        return bArr2;
    }
