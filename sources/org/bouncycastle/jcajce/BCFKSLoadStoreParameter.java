...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter.class */
public class BCFKSLoadStoreParameter extends BCLoadStoreParameter {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter$Builder.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter$CertChainValidator.class */
    public interface CertChainValidator {
        boolean isValid(X509Certificate[] x509CertificateArr);
    }

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter$EncryptionAlgorithm.class */
    public enum EncryptionAlgorithm {
        AES256_CCM,
        AES256_KWP
    }

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter$MacAlgorithm.class */
    public enum MacAlgorithm {
        HmacSHA512,
        HmacSHA3_512
    }

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/BCFKSLoadStoreParameter$SignatureAlgorithm.class */
