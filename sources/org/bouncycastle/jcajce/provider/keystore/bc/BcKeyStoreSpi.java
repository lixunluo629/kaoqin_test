...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi.class */
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$BouncyCastleStore.class */
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        public void engineLoad(InputStream inputStream, char[] cArr) throws IOException {
            ...
            CipherInputStream cipherInputStream = new CipherInputStream(dataInputStream, makePBECipher(i == 0 ? "OldPBEWithSHAAndTwofish-CBC" : BcKeyStoreSpi.STORE_CIPHER, 2, cArr, bArr, i2));
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$Std.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry.class */
    private class StoreEntry {
        ...
        StoreEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws Exception {
            ...
            int iNextInt = 1024 + (BcKeyStoreSpi.this.random.nextInt() & 1023);
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$Version1.class */
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException {
        ...
        CipherParameters cipherParametersGenerateDerivedMacParameters = i != 2 ? pKCS12ParametersGenerator.generateDerivedMacParameters(hMac.getMacSize()) : pKCS12ParametersGenerator.generateDerivedMacParameters(hMac.getMacSize() * 8);
