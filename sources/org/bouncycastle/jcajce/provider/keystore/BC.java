...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/BC.class */
public class BC {
    private static final String PREFIX = "org.bouncycastle.jcajce.provider.keystore.bc.";

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/keystore/BC$Mappings.class */
