...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher.class */
public class BaseStreamCipher extends BaseWrapCipher implements PBE {
    ...
    protected void engineSetMode(String str) throws NoSuchAlgorithmException {
        if (!str.equalsIgnoreCase("ECB") && !str.equals(Constants.NONE_TRANSPORT)) {
