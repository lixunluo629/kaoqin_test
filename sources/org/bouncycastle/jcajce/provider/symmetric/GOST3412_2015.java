...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015.class */
public class GOST3412_2015 {

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$CBC.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$CTR.class */
    public static class CTR extends BaseBlockCipher {
        /* JADX WARN: Type inference failed for: r3v0, types: [org.bouncycastle.crypto.BlockCipher, org.bouncycastle.crypto.modes.G3413CTRBlockCipher] */
        public CTR() {
            super(new BufferedBlockCipher(new G3413CTRBlockCipher(new GOST3412_2015Engine())), true, 64);
        }
    }

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$ECB.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$GCFB.class */
    public static class GCFB extends BaseBlockCipher {
        /* JADX WARN: Type inference failed for: r3v0, types: [org.bouncycastle.crypto.BlockCipher, org.bouncycastle.crypto.modes.G3413CFBBlockCipher] */
        public GCFB() {
            super(new BufferedBlockCipher(new G3413CFBBlockCipher(new GOST3412_2015Engine())), false, 128);
        }
    }

    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$GCFB8.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$KeyGen.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$Mac.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$Mappings.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/symmetric/GOST3412_2015$OFB.class */
    public static class OFB extends BaseBlockCipher {
        /* JADX WARN: Type inference failed for: r3v0, types: [org.bouncycastle.crypto.BlockCipher, org.bouncycastle.crypto.modes.G3413OFBBlockCipher] */
        public OFB() {
