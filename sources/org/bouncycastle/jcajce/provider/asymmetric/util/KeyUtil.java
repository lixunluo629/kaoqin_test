...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/util/KeyUtil.class */
public class KeyUtil {
    ...
    public static byte[] getEncodedPrivateKeyInfo(AlgorithmIdentifier algorithmIdentifier, ASN1Encodable aSN1Encodable) {
        try {
            return getEncodedPrivateKeyInfo(new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable) aSN1Encodable.toASN1Primitive()));
        } catch (Exception e) {
            return null;
        }
    }
