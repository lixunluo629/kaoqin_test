...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/util/ECUtil.class */
public class ECUtil {
    ...
    public static ECDomainParameters getDomainParameters(ProviderConfiguration providerConfiguration, X962Parameters x962Parameters) {
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            eCDomainParameters = new ECNamedDomainParameters(aSN1ObjectIdentifier, namedCurveByOid.getCurve(), namedCurveByOid.getG(), namedCurveByOid.getN(), namedCurveByOid.getH(), namedCurveByOid.getSeed());
    ...
    public static ASN1ObjectIdentifier getNamedCurveOid(String str) {
        ...
        try {
            if (strSubstring.charAt(0) >= '0' && strSubstring.charAt(0) <= '2') {
                return new ASN1ObjectIdentifier(strSubstring);
            }
        } catch (IllegalArgumentException e) {
        }
        return ECNamedCurveTable.getOID(strSubstring);
    }
