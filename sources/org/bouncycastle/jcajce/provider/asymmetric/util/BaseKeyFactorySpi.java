...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/util/BaseKeyFactorySpi.class */
public abstract class BaseKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    protected KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("not implemented yet " + key + SymbolConstants.SPACE_SYMBOL + cls);
    }
}
