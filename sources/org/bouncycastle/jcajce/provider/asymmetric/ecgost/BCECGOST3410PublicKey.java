...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey.class */
public class BCECGOST3410PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            if (subjectPublicKeyInfo.getAlgorithm().getParameters() instanceof ASN1ObjectIdentifier) {
                publicKeyParamSet = ASN1ObjectIdentifier.getInstance((Object) subjectPublicKeyInfo.getAlgorithm().getParameters());
    ...
    public byte[] getEncoded() {
        ...
        try {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new SubjectPublicKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, gostParams), (ASN1Encodable) new DEROctetString(bArr)));
        } catch (IOException e) {
            return null;
        }
    }
