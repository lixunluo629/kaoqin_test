...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi.class */
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        if (privateKeyBlob instanceof DSAPrivateKeyParameters) {
            return engineGeneratePrivate(new DSAPrivateKeySpec(((DSAPrivateKeyParameters) privateKeyBlob).getX(), ((DSAPrivateKeyParameters) privateKeyBlob).getParameters().getP(), ((DSAPrivateKeyParameters) privateKeyBlob).getParameters().getQ(), ((DSAPrivateKeyParameters) privateKeyBlob).getParameters().getG()));
        }
    ...
    protected PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        if (publicKey instanceof DSAPublicKeyParameters) {
            return engineGeneratePublic(new DSAPublicKeySpec(((DSAPublicKeyParameters) publicKey).getY(), ((DSAPublicKeyParameters) publicKey).getParameters().getP(), ((DSAPublicKeyParameters) publicKey).getParameters().getQ(), ((DSAPublicKeyParameters) publicKey).getParameters().getG()));
        }
