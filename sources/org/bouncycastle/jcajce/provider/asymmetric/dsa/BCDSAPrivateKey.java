...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey.class */
public class BCDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public String toString() {
        ...
        stringBuffer.append("DSA Private Key [").append(DSAUtil.generateKeyFingerprint(bigIntegerModPow, getParams())).append("]").append(strLineSeparator);
