...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/edec/Utils.class */
class Utils {
    Utils() {
    }
    ...
    static String keyToString(String str, String str2, AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        stringBuffer.append(str2).append(SymbolConstants.SPACE_SYMBOL).append(str).append(" [").append(generateKeyFingerprint(encoded)).append("]").append(strLineSeparator).append("    public data: ").append(Hex.toHexString(encoded)).append(strLineSeparator);
