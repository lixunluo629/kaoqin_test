...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory.class */
public class CertificateFactory extends CertificateFactorySpi {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory$ExCertificateException.class */
    ...
    public Certificate engineGenerateCertificate(InputStream inputStream) throws IOException, CertificateException {
        ...
        try {
            ...
            return i != 48 ? readPEMCertificate(byteArrayInputStream) : readDERCertificate(new ASN1InputStream(byteArrayInputStream));
        } catch (Exception e) {
    ...
    public CRL engineGenerateCRL(InputStream inputStream) throws IOException, CRLException {
        ...
        try {
            ...
            byteArrayInputStream.reset();
            return i != 48 ? readPEMCRL(byteArrayInputStream) : readDERCRL(new ASN1InputStream(byteArrayInputStream, true));
