...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey.class */
public class BCElGamalPrivateKey implements ElGamalPrivateKey, DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    BCElGamalPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.x = ASN1Integer.getInstance((Object) privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public byte[] getEncoded() {
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, (ASN1Encodable) new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), (ASN1Encodable) new ASN1Integer(getX())).getEncoded("DER");
        } catch (IOException e) {
            return null;
        }
    }
