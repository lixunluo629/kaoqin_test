...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/RSA.class */
public class RSA {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/provider/asymmetric/RSA$Mappings.class */
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.RSA//RAW", RSAUtils.RSA_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.RSA//NOPADDING", RSAUtils.RSA_KEY_ALGORITHM);
            ...
            registerOid(configurableProvider, PKCSObjectIdentifiers.rsaEncryption, RSAUtils.RSA_KEY_ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, X509ObjectIdentifiers.id_ea_rsa, RSAUtils.RSA_KEY_ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, PKCSObjectIdentifiers.id_RSAES_OAEP, RSAUtils.RSA_KEY_ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, PKCSObjectIdentifiers.id_RSASSA_PSS, RSAUtils.RSA_KEY_ALGORITHM, keyFactorySpi);
            registerOidAlgorithmParameters(configurableProvider, PKCSObjectIdentifiers.rsaEncryption, RSAUtils.RSA_KEY_ALGORITHM);
            registerOidAlgorithmParameters(configurableProvider, X509ObjectIdentifiers.id_ea_rsa, RSAUtils.RSA_KEY_ALGORITHM);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Signature.RAWRSA", RSAUtils.RSA_KEY_ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.NONEWITHRSA", RSAUtils.RSA_KEY_ALGORITHM);
