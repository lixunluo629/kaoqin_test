...
/* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/PKIXCRLStoreSelector.class */
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder.class */
    ...
    /* loaded from: bcprov-jdk15on-1.64.jar:org/bouncycastle/jcajce/PKIXCRLStoreSelector$SelectorClone.class */
    ...
    public boolean match(CRL crl) {
        ...
        try {
            ...
            if (extensionValue != null) {
                aSN1Integer = ASN1Integer.getInstance((Object) ASN1OctetString.getInstance(extensionValue).getOctets());
            }
