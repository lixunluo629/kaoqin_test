...
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/transaction/jta/JtaTransactionManager.class */
public class JtaTransactionManager extends AbstractPlatformTransactionManager implements TransactionFactory, InitializingBean, Serializable {
    ...
    public void afterPropertiesSet() throws IllegalStateException, TransactionSystemException {
    ...
    protected UserTransaction findUserTransaction() {
        try {
            ...
            if (this.logger.isDebugEnabled()) {
                this.logger.debug("No JTA UserTransaction found at default JNDI location [" + DEFAULT_USER_TRANSACTION_NAME + "]", e);
                return null;
            }
            return null;
        }
    ...
    protected TransactionManager findTransactionManager(UserTransaction ut) {
        ...
        for (String jndiName : FALLBACK_TRANSACTION_MANAGER_NAMES) {
            try {
                ...
                if (this.logger.isDebugEnabled()) {
                    this.logger.debug("No JTA TransactionManager found at fallback JNDI location [" + jndiName + "]", e);
                }
            }
        }
        return null;
    ...
    protected Object doGetTransaction() throws TransactionSystemException {
    ...
    protected void doJtaBegin(JtaTransactionObject txObject, TransactionDefinition definition) throws NotSupportedException, SystemException, InvalidIsolationLevelException {
    ...
    protected void applyIsolationLevel(JtaTransactionObject txObject, int isolationLevel) throws SystemException, InvalidIsolationLevelException {
    ...
    protected void doJtaResume(JtaTransactionObject txObject, Object suspendedTransaction) throws SystemException, InvalidTransactionException {
        if (getTransactionManager() == null) {
            throw new TransactionSuspensionNotSupportedException("JtaTransactionManager needs a JTA TransactionManager for suspending a transaction: specify the 'transactionManager' or 'transactionManagerName' property");
        }
    ...
    @Override // org.springframework.transaction.support.AbstractPlatformTransactionManager
    protected void registerAfterCompletionWithExistingTransaction(Object transaction, List<TransactionSynchronization> synchronizations) throws RollbackException {
        JtaTransactionObject txObject = (JtaTransactionObject) transaction;
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.transaction.RollbackException */
    protected void doRegisterAfterCompletionWithJtaTransaction(JtaTransactionObject txObject, List<TransactionSynchronization> synchronizations) throws SystemException, RollbackException {
        int jtaStatus = txObject.getUserTransaction().getStatus();
        if (jtaStatus == 6) {
    ...
    private void readObject(ObjectInputStream ois) throws TransactionSystemException, ClassNotFoundException, IOException {
