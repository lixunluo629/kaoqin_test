...
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/transaction/interceptor/MethodMapTransactionAttributeSource.class */
public class MethodMapTransactionAttributeSource implements TransactionAttributeSource, BeanClassLoaderAware, InitializingBean {
    ...
    public void afterPropertiesSet() throws SecurityException, IllegalArgumentException {
        initMethodMap(this.methodMap);
        this.eagerlyInitialized = true;
        this.initialized = true;
    }

    protected void initMethodMap(Map<String, TransactionAttribute> methodMap) throws SecurityException, IllegalArgumentException {
        if (methodMap != null) {
    ...
    public void addTransactionalMethod(String name, TransactionAttribute attr) throws SecurityException, IllegalArgumentException {
    ...
    public void addTransactionalMethod(Class<?> clazz, String mappedName, TransactionAttribute attr) throws SecurityException {
