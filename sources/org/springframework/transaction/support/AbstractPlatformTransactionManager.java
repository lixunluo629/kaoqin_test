...
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/transaction/support/AbstractPlatformTransactionManager.class */
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
    ...
    public final TransactionStatus getTransaction(TransactionDefinition definition) throws IllegalStateException, TransactionException {
        ...
        if (definition.getIsolationLevel() != -1 && this.logger.isWarnEnabled()) {
    ...
    private TransactionStatus handleExistingTransaction(TransactionDefinition definition, Object transaction, boolean debugEnabled) throws IllegalStateException, TransactionException {
    ...
    protected final DefaultTransactionStatus prepareTransactionStatus(TransactionDefinition definition, Object transaction, boolean newTransaction, boolean newSynchronization, boolean debug, Object suspendedResources) throws IllegalStateException {
    ...
    protected void prepareSynchronization(DefaultTransactionStatus status, TransactionDefinition definition) throws IllegalStateException {
    ...
    protected final SuspendedResourcesHolder suspend(Object transaction) throws IllegalStateException, TransactionException {
    ...
    protected final void resume(Object transaction, SuspendedResourcesHolder resourcesHolder) throws IllegalStateException, TransactionException {
    ...
    private List<TransactionSynchronization> doSuspendSynchronization() throws IllegalStateException {
    ...
    private void doResumeSynchronization(List<TransactionSynchronization> suspendedSynchronizations) throws IllegalStateException {
        TransactionSynchronizationManager.initSynchronization();
        for (TransactionSynchronization synchronization : suspendedSynchronizations) {
    ...
    @Override // org.springframework.transaction.PlatformTransactionManager
    public final void commit(TransactionStatus status) throws IllegalStateException, TransactionException {
    ...
    private void processCommit(DefaultTransactionStatus status) throws IllegalStateException, TransactionException {
        ...
        try {
            try {
                try {
                    ...
                    doRollbackOnCommitException(status, ex2);
                    throw ex2;
                }
            } catch (Error err) {
                if (!beforeCompletionInvoked) {
                ...
                throw err;
            } catch (UnexpectedRollbackException ex3) {
    ...
    @Override // org.springframework.transaction.PlatformTransactionManager
    public final void rollback(TransactionStatus status) throws IllegalStateException, TransactionException {
        if (status.isCompleted()) {
            throw new IllegalTransactionStateException("Transaction is already completed - do not call commit or rollback more than once per transaction");
        }
        DefaultTransactionStatus defStatus = (DefaultTransactionStatus) status;
    ...
    private void processRollback(DefaultTransactionStatus status) throws IllegalStateException, TransactionException {
        try {
            try {
                triggerBeforeCompletion(status);
                if (status.hasSavepoint()) {
    ...
    private void doRollbackOnCommitException(DefaultTransactionStatus status, Throwable ex) throws IllegalStateException, TransactionException {
        try {
    ...
    private void triggerAfterCompletion(DefaultTransactionStatus status, int completionStatus) throws IllegalStateException, TransactionException {
        if (status.isNewSynchronization()) {
    ...
    private void cleanupAfterCompletion(DefaultTransactionStatus status) throws IllegalStateException, TransactionException {
        status.setCompleted();
        if (status.isNewSynchronization()) {
    ...
    /* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/transaction/support/AbstractPlatformTransactionManager$SuspendedResourcesHolder.class */
