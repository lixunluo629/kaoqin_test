...
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/transaction/config/TxAdviceBeanDefinitionParser.class */
class TxAdviceBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        builder.addPropertyReference(TxUtils.DEFAULT_TRANSACTION_MANAGER, TxNamespaceHandler.getTransactionManagerName(element));
    ...
    private RootBeanDefinition parseAttributeSource(Element attrEle, ParserContext parserContext) {
        ...
        RootBeanDefinition attributeSourceDefinition = new RootBeanDefinition((Class<?>) NameMatchTransactionAttributeSource.class);
