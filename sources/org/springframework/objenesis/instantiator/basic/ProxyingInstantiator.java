...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/objenesis/instantiator/basic/ProxyingInstantiator.class */
    ...
    private static byte[] writeExtendingClass(Class<?> type, String suffix) {
        ...
        try {
            try {
                ...
                in.writeUTF("Code");
                in.writeByte(1);
                in.writeUTF(StandardRoles.L + clazz + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
                in.writeByte(1);
                in.writeUTF(clazz);
                in.writeByte(1);
