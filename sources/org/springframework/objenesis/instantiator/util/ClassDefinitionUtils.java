...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/objenesis/instantiator/util/ClassDefinitionUtils.class */
public final class ClassDefinitionUtils {
    ...
    private static final ProtectionDomain PROTECTION_DOMAIN = (ProtectionDomain) AccessController.doPrivileged(new PrivilegedAction<ProtectionDomain>() { // from class: org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.1
    ...
    public static String classNameToResource(String className) {
        return classNameToInternalClassName(className) + ClassUtils.CLASS_FILE_SUFFIX;
    }
