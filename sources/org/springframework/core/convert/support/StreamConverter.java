...
@UsesJava8
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/core/convert/support/StreamConverter.class */
class StreamConverter implements ConditionalGenericConverter {
    ...
    private Object convertFromStream(Stream<?> source, TypeDescriptor streamType, TypeDescriptor targetType) {
        List<Object> content = (List) source.collect(Collectors.toList());
