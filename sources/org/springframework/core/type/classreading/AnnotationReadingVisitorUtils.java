...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/core/type/classreading/AnnotationReadingVisitorUtils.class */
            ...
            try {
                ...
                if (value instanceof AnnotationAttributes) {
                    ...
                    for (int i2 = 0; i2 < array.length; i2++) {
                        convArray[i2] = classValuesAsString ? array[i2].getClassName() : classLoader.loadClass(array[i2].getClassName());
                    }
                    value = convArray;
