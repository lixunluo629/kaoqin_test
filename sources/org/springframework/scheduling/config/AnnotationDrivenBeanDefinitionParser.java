...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/scheduling/config/AnnotationDrivenBeanDefinitionParser.class */
public class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) throws BeanDefinitionStoreException {
        ...
        if ("aspectj".equals(mode)) {
            ...
            String exceptionHandler = element.getAttribute(JoinPoint.EXCEPTION_HANDLER);
