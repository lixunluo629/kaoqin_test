...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/scheduling/config/ScheduledTasksBeanDefinitionParser.class */
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (isScheduledElement(child, parserContext)) {
                ...
                String method = taskElement.getAttribute(JamXmlElements.METHOD);
