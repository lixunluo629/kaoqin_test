...
/* loaded from: spring-context-support-4.3.25.RELEASE.jar:org/springframework/scheduling/commonj/WorkManagerTaskExecutor.class */
public class WorkManagerTaskExecutor extends JndiLocatorSupport implements AsyncListenableTaskExecutor, SchedulingTaskExecutor, WorkManager, InitializingBean {
    ...
    public void execute(Runnable task) {
        ...
        try {
            ...
            throw new TaskRejectedException("CommonJ WorkManager did not accept task: " + task, ex2);
        }
    }
