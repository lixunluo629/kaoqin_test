...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/context/annotation/ComponentScanBeanDefinitionParser.class */
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) throws LinkageError {
        String basePackage = element.getAttribute(BASE_PACKAGE_ATTRIBUTE);
        String[] basePackages = StringUtils.tokenizeToStringArray(parserContext.getReaderContext().getEnvironment().resolvePlaceholders(basePackage), ",; \t\n");
    ...
    protected TypeFilter createTypeFilter(Element element, ClassLoader classLoader, ParserContext parserContext) throws LinkageError, ClassNotFoundException {
        ...
        if (JamXmlElements.ANNOTATION.equals(filterType)) {
    ...
    private Object instantiateUserDefinedStrategy(String className, Class<?> strategyType, ClassLoader classLoader) {
        try {
            Object result = classLoader.loadClass(className).newInstance();
