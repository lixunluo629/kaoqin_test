...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/context/annotation/ConfigurationClassUtils.class */
abstract class ConfigurationClassUtils {
    ...
    public static boolean checkConfigurationClassCandidate(BeanDefinition beanDef, MetadataReaderFactory metadataReaderFactory) throws IllegalStateException {
        ...
        if (orderAttributes != null) {
            beanDef.setAttribute(ORDER_ATTRIBUTE, orderAttributes.get("value"));
            return true;
        }
        return true;
    }
