...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/context/support/PostProcessorRegistrationDelegate.class */
class PostProcessorRegistrationDelegate {
    ...
    /* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/context/support/PostProcessorRegistrationDelegate$BeanPostProcessorChecker.class */
    private static class BeanPostProcessorChecker implements BeanPostProcessor {
        ...
        public Object postProcessAfterInitialization(Object bean, String beanName) {
            if (bean != null && !(bean instanceof BeanPostProcessor) && !isInfrastructureBean(beanName) && this.beanFactory.getBeanPostProcessorCount() < this.beanPostProcessorTargetCount && logger.isInfoEnabled()) {
        ...
        private boolean isInfrastructureBean(String beanName) throws NoSuchBeanDefinitionException {
