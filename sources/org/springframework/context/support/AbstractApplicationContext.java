...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/context/support/AbstractApplicationContext.class */
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext, DisposableBean {
    ...
    protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        if (!beanFactory.hasEmbeddedValueResolver()) {
            beanFactory.addEmbeddedValueResolver(new StringValueResolver() { // from class: org.springframework.context.support.AbstractApplicationContext.1
    ...
    public void registerShutdownHook() {
        if (this.shutdownHook == null) {
            this.shutdownHook = new Thread() { // from class: org.springframework.context.support.AbstractApplicationContext.2
