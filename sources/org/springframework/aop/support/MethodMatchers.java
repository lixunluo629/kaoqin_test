...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/MethodMatchers.class */
public abstract class MethodMatchers {
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/MethodMatchers$UnionMethodMatcher.class */
    private static class UnionMethodMatcher implements IntroductionAwareMethodMatcher, Serializable {
        ...
        public int hashCode() {
            int hashCode = (37 * 17) + this.mm1.hashCode();
            return (37 * hashCode) + this.mm2.hashCode();
        }
    }

    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/MethodMatchers$ClassFilterAwareUnionMethodMatcher.class */
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/MethodMatchers$IntersectionMethodMatcher.class */
