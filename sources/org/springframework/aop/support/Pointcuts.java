...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/Pointcuts.class */
public abstract class Pointcuts {
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/Pointcuts$SetterPointcut.class */
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/Pointcuts$GetterPointcut.class */
    private static class GetterPointcut extends StaticMethodMatcherPointcut implements Serializable {
        ...
        @Override // org.springframework.aop.MethodMatcher
        public boolean matches(Method method, Class<?> targetClass) {
            return method.getName().startsWith(BeanUtil.PREFIX_GETTER_GET) && method.getParameterTypes().length == 0;
        }
