...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/support/annotation/AnnotationClassFilter.class */
public class AnnotationClassFilter implements ClassFilter {
    ...
    public boolean matches(Class<?> clazz) {
        if (this.checkInherited) {
            return AnnotationUtils.findAnnotation(clazz, (Class) this.annotationType) != null;
        }
