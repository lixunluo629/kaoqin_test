...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/config/ConfigBeanDefinitionParser.class */
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private AbstractBeanDefinition parseDeclareParents(Element declareParentsElement, ParserContext parserContext) throws BeanDefinitionStoreException {
    ...
    private AbstractBeanDefinition parseAdvice(String aspectName, int order, Element aspectElement, Element adviceElement, ParserContext parserContext, List<BeanDefinition> beanDefinitions, List<BeanReference> beanReferences) {
        try {
            ...
            methodDefinition.getPropertyValues().add("methodName", adviceElement.getAttribute(JamXmlElements.METHOD));
