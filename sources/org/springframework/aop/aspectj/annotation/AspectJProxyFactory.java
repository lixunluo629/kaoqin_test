...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/aspectj/annotation/AspectJProxyFactory.class */
public class AspectJProxyFactory extends ProxyCreatorSupport {
    ...
    private void addAdvisorsFromAspectInstanceFactory(MetadataAwareAspectInstanceFactory instanceFactory) {
        List<Advisor> advisors = AopUtils.findAdvisorsThatCanApply(this.aspectFactory.getAdvisors(instanceFactory), getTargetClass());
            ...
            synchronized (aspectCache) {
                ...
                if (instance == null) {
                    try {
                        ...
                        throw new AopConfigException("Could not access aspect constructor: " + aspectClass.getName(), ex);
                    } catch (InstantiationException ex2) {
                        throw new AopConfigException("Unable to instantiate aspect class: " + aspectClass.getName(), ex2);
                    }
                }
            }
        }
