...
/* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/aspectj/AspectJAdviceParameterNameDiscoverer.class */
public class AspectJAdviceParameterNameDiscoverer implements ParameterNameDiscoverer {
    ...
    private void maybeBindAnnotationsFromPointcutExpression() {
        ...
        String[] tokens = StringUtils.tokenizeToStringArray(this.pointcutExpression, SymbolConstants.SPACE_SYMBOL);
        int i = 0;
    ...
    private void maybeBindThisOrTargetOrArgsFromPointcutExpression() {
        ...
        int i = 0;
        while (i < tokens.length) {
            if (tokens[i].equals(OgnlContext.THIS_CONTEXT_KEY) || tokens[i].startsWith("this(") || tokens[i].equals(DataBinder.DEFAULT_OBJECT_NAME) || tokens[i].startsWith("target(")) {
                PointcutBody body = getPointcutBody(tokens, i);
                i += body.numTokensConsumed;
                String varName = maybeExtractVariableName(body.text);
                if (varName != null) {
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/aspectj/AspectJAdviceParameterNameDiscoverer$PointcutBody.class */
    ...
    /* loaded from: spring-aop-4.3.25.RELEASE.jar:org/springframework/aop/aspectj/AspectJAdviceParameterNameDiscoverer$AmbiguousBindingException.class */
