...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/config/ResourcesBeanDefinitionParser.class */
class ResourcesBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private void registerUrlProvider(ParserContext context, Object source) throws BeanDefinitionStoreException {
    ...
    private String registerResourceHandler(ParserContext context, Element element, RuntimeBeanReference pathHelperRef, Object source) throws NoSuchBeanDefinitionException, BeanDefinitionStoreException {
    ...
    private CacheControl parseCacheControl(Element element) {
        ...
        } else if ("true".equals(element.getAttribute(HttpHeaders.Values.NO_STORE))) {
        ...
        if (element.hasAttribute(HttpHeaders.Values.S_MAXAGE)) {
            cacheControl = cacheControl.sMaxAge(Long.parseLong(element.getAttribute(HttpHeaders.Values.S_MAXAGE)), TimeUnit.SECONDS);
        }
    ...
    private void parseResourceCache(ManagedList<Object> managedList, ManagedList<Object> managedList2, Element element, Object source) {
        ...
        if ("true".equals(resourceCache)) {
            ...
            managedList.add(cachingResolverDef);
            managedList2.add(cachingTransformerDef);
        }
    }

    private void parseResourceResolversTransformers(boolean isAutoRegistration, ManagedList<Object> resourceResolvers, ManagedList<Object> resourceTransformers, ParserContext context, Element element, Object source) {
