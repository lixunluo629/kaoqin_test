...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/config/ScriptTemplateConfigurerBeanDefinitionParser.class */
public class ScriptTemplateConfigurerBeanDefinitionParser extends AbstractSimpleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        if (element.hasAttribute("content-type")) {
            builder.addPropertyValue(CMSAttributeTableGenerator.CONTENT_TYPE, element.getAttribute("content-type"));
        }
