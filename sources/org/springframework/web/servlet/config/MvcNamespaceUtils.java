...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/config/MvcNamespaceUtils.class */
public abstract class MvcNamespaceUtils {
    ...
    private static void registerBeanNameUrlHandlerMapping(ParserContext context, Object source) throws BeanDefinitionStoreException {
    ...
    private static void registerHttpRequestHandlerAdapter(ParserContext context, Object source) throws BeanDefinitionStoreException {
    ...
    private static void registerSimpleControllerHandlerAdapter(ParserContext context, Object source) throws BeanDefinitionStoreException {
    ...
    private static void registerHandlerMappingIntrospector(ParserContext parserContext, Object source) throws BeanDefinitionStoreException {
