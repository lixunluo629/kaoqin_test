...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/config/CorsBeanDefinitionParser.class */
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        if (mappings.isEmpty()) {
            ...
            for (Element mapping : mappings) {
                ...
                corsConfigurations.put(mapping.getAttribute(Cookie2.PATH), config.applyPermitDefaultValues());
            }
        }
