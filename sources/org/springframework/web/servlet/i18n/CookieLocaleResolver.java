...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/i18n/CookieLocaleResolver.class */
                ...
                try {
                    ...
                    if (request.getAttribute("javax.servlet.error.exception") != null) {
                        if (this.logger.isDebugEnabled()) {
                            this.logger.debug("Ignoring invalid locale cookie '" + getCookieName() + "' with value [" + value + "] due to error dispatch: " + ex.getMessage());
                        }
                    } else {
                        throw new IllegalStateException("Invalid locale cookie '" + getCookieName() + "' with value [" + value + "]: " + ex.getMessage());
                    }
                }
                if (this.logger.isDebugEnabled()) {
