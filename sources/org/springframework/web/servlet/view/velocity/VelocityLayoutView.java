...
@Deprecated
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/view/velocity/VelocityLayoutView.class */
public class VelocityLayoutView extends VelocityToolboxView {
    ...
    public boolean checkResource(Locale locale) throws Exception {
        ...
        try {
            ...
            throw new NestedIOException("Could not load Velocity template for URL [" + this.layoutUrl + "]", ex2);
        }
    }
