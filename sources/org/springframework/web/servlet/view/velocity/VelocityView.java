...
@Deprecated
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/view/velocity/VelocityView.class */
public class VelocityView extends AbstractTemplateView {
    ...
    protected VelocityEngine autodetectVelocityEngine() throws BeansException {
        try {
            VelocityConfig velocityConfig = (VelocityConfig) BeanFactoryUtils.beanOfTypeIncludingAncestors(getApplicationContext(), VelocityConfig.class, true, false);
    ...
    protected Template getTemplate(String name) throws Exception {
        if (getEncoding() != null) {
            return getVelocityEngine().getTemplate(name, getEncoding());
        }
    ...
    protected void mergeTemplate(Template template, Context context, HttpServletResponse response) throws Exception {
        try {
            ...
            throw new NestedServletException("Method invocation failed during rendering of Velocity view with name '" + getBeanName() + "': " + e.getMessage() + "; reference [" + e.getReferenceName() + "], method '" + e.getMethodName() + "'", cause == null ? e : cause);
        }
    }

    /* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/view/velocity/VelocityView$LocaleAwareDateTool.class */
    ...
    /* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/view/velocity/VelocityView$LocaleAwareNumberTool.class */
