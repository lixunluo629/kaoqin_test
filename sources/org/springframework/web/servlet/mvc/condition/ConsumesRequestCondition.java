...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/mvc/condition/ConsumesRequestCondition.class */
public final class ConsumesRequestCondition extends AbstractRequestCondition<ConsumesRequestCondition> {
    ...
    public ConsumesRequestCondition getMatchingCondition(HttpServletRequest request) {
        ...
        try {
            ...
            Iterator<ConsumeMediaTypeExpression> iterator = result.iterator();
    ...
    /* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/mvc/condition/ConsumesRequestCondition$ConsumeMediaTypeExpression.class */
