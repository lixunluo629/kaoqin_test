...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/mvc/method/annotation/StreamingResponseBodyReturnValueHandler.class */
public class StreamingResponseBodyReturnValueHandler implements HandlerMethodReturnValueHandler {
    ...
    public boolean supportsReturnType(MethodParameter returnType) {
        ...
        return ResponseEntity.class.isAssignableFrom(returnType.getParameterType()) && (bodyType = ResolvableType.forMethodParameter(returnType).getGeneric(0).resolve()) != null && StreamingResponseBody.class.isAssignableFrom(bodyType);
    }
    ...
    /* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/mvc/method/annotation/StreamingResponseBodyReturnValueHandler$StreamingResponseBodyTask.class */
