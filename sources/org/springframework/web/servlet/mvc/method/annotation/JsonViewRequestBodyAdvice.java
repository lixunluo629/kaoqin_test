...
/* loaded from: spring-webmvc-4.3.25.RELEASE.jar:org/springframework/web/servlet/mvc/method/annotation/JsonViewRequestBodyAdvice.class */
public class JsonViewRequestBodyAdvice extends RequestBodyAdviceAdapter {
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter methodParameter, Type targetType, Class<? extends HttpMessageConverter<?>> selectedConverterType) throws IOException {
        JsonView annotation = (JsonView) methodParameter.getParameterAnnotation(JsonView.class);
