...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/filter/AbstractRequestLoggingFilter.class */
public abstract class AbstractRequestLoggingFilter extends OncePerRequestFilter {
    ...
    protected String createMessage(HttpServletRequest request, String prefix, String suffix) {
        ...
        if (isIncludePayload() && (wrapper = (ContentCachingRequestWrapper) WebUtils.getNativeRequest(request, ContentCachingRequestWrapper.class)) != null) {
