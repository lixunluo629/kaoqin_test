...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/bind/EscapedErrors.class */
public class EscapedErrors implements Errors {
    ...
    private <T extends ObjectError> T escapeObjectError(T t) {
        if (t == null) {
            return null;
        }
        if (t instanceof FieldError) {
            ...
            return new FieldError(fieldError.getObjectName(), fieldError.getField(), rejectedValue, fieldError.isBindingFailure(), fieldError.getCodes(), fieldError.getArguments(), HtmlUtils.htmlEscape(fieldError.getDefaultMessage()));
        }
        return (T) new ObjectError(t.getObjectName(), t.getCodes(), t.getArguments(), HtmlUtils.htmlEscape(t.getDefaultMessage()));
    }
