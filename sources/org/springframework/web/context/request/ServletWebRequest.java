...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/request/ServletWebRequest.class */
public class ServletWebRequest extends ServletRequestAttributes implements NativeWebRequest {
    ...
    public boolean checkNotModified(String etag, long lastModifiedTimestamp) {
        ...
        if (isHttpGetOrHead) {
            if (lastModifiedTimestamp > 0 && isHeaderAbsent(response, "Last-Modified")) {
    ...
    private boolean isStatusOK(HttpServletResponse response) {
        return response == null || !servlet3Present || response.getStatus() == 200;
    }

    private boolean isHeaderAbsent(HttpServletResponse response, String header) {
        return response == null || !servlet3Present || response.getHeader(header) == null;
    }
        ...
        try {
            ...
            while (ifNoneMatch.hasMoreElements()) {
                ...
                while (true) {
                    ...
                    if (StringUtils.hasLength(etagMatcher.group()) && etag2.replaceFirst("^W/", "").equals(etagMatcher.group(3))) {
    ...
    private String padEtagIfNecessary(String etag) {
        ...
        if ((etag.startsWith(SymbolConstants.QUOTES_SYMBOL) || etag.startsWith("W/\"")) && etag.endsWith(SymbolConstants.QUOTES_SYMBOL)) {
            return etag;
        }
        return SymbolConstants.QUOTES_SYMBOL + etag + SymbolConstants.QUOTES_SYMBOL;
    }
