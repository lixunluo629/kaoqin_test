...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/ServletContextResourcePatternResolver.class */
            ...
            try {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (getPathMatcher().match(entryPattern, entryPath)) {
                        result.add(new UrlResource("jar", ResourceUtils.FILE_URL_PREFIX + jarFilePath + ResourceUtils.JAR_URL_SEPARATOR + entryPath));
                    }
                }
                jarFile.close();
            } catch (Throwable th) {
