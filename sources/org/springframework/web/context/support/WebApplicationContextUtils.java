...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils.class */
public abstract class WebApplicationContextUtils {
    ...
    public static void initServletPropertySources(MutablePropertySources propertySources, ServletContext servletContext, ServletConfig servletConfig) {
        ...
        if (servletContext != null && propertySources.contains(StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME) && (propertySources.get(StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME) instanceof PropertySource.StubPropertySource)) {
        ...
        if (servletConfig != null && propertySources.contains(StandardServletEnvironment.SERVLET_CONFIG_PROPERTY_SOURCE_NAME) && (propertySources.get(StandardServletEnvironment.SERVLET_CONFIG_PROPERTY_SOURCE_NAME) instanceof PropertySource.StubPropertySource)) {
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils$RequestObjectFactory.class */
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils$ResponseObjectFactory.class */
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils$SessionObjectFactory.class */
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils$WebRequestObjectFactory.class */
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/context/support/WebApplicationContextUtils$FacesDependencyRegistrar.class */
