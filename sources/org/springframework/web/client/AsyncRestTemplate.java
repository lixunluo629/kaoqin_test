...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/client/AsyncRestTemplate.class */
public class AsyncRestTemplate extends InterceptingAsyncHttpAccessor implements AsyncRestOperations {
    ...
    public void setDefaultUriVariables(Map<String, ?> defaultUriVariables) {
        ...
        Assert.isInstanceOf(AbstractUriTemplateHandler.class, handler, "Can only use this property in conjunction with a DefaultUriTemplateHandler");
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/client/AsyncRestTemplate$ResponseExtractorFuture.class */
    ...
    /* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/web/client/AsyncRestTemplate$AsyncRequestCallbackAdapter.class */
