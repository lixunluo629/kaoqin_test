...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/asm/Frame.class */
class Frame {
    ...
    final boolean merge(ClassWriter cw, Frame frame, int edge) {
        ...
        int i = 0;
        while (i < nLocal) {
            if (this.outputLocals == null || i >= this.outputLocals.length || (s = this.outputLocals[i]) == 0) {
                ...
                if (kind == 16777216) {
                    ...
                    if (kind == 33554432) {
                        t2 = dim + this.inputLocals[s & 8388607];
                    } else {
                        t2 = dim + this.inputStack[nStack - (s & 8388607)];
                    }
                    if ((s & 8388608) != 0 && (t2 == 16777220 || t2 == 16777219)) {
                        t2 = 16777216;
                    }
                }
            }
        ...
        for (int i4 = 0; i4 < this.outputStackTop; i4++) {
            ...
            if (kind2 == 16777216) {
                ...
                if (kind2 == 33554432) {
                    t = dim2 + this.inputLocals[s2 & 8388607];
                } else {
                    t = dim2 + this.inputStack[nStack - (s2 & 8388607)];
                }
                if ((s2 & 8388608) != 0 && (t == 16777220 || t == 16777219)) {
                    t = 16777216;
                }
            }
            if (this.initializations != null) {
        ...
        if ((u & BASE_KIND) == OBJECT || (u & (-268435456)) != 0) {
            ...
            if ((t & (-1048576)) == (u & (-1048576))) {
                if ((u & BASE_KIND) == OBJECT) {
                    v = (t & (-268435456)) | OBJECT | cw.getMergedType(t & 1048575, u & 1048575);
                } else {
