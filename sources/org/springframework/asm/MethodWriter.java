...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/asm/MethodWriter.class */
class MethodWriter extends MethodVisitor {
        ...
        while (true) {
            ...
            switch (this.descriptor.charAt(i2)) {
                ...
                case 'L':
                    ...
                    int i8 = i;
                    i++;
                    this.frame[i7] = 24117248 | this.cw.addType(this.descriptor.substring(j + 1, i8));
                    break;
                case '[':
                    while (this.descriptor.charAt(i) == '[') {
                        i++;
                    ...
                    frameIndex++;
                    i++;
                    this.frame[i9] = 24117248 | this.cw.addType(this.descriptor.substring(j, i));
                    break;
            }
        }
    }
    ...
    final int getSize() {
        ...
        if (this.code.length > 0) {
            ...
            if (this.stackMap != null) {
                ...
                this.cw.newUTF8(zip ? StackMapTable.tag : StackMap.tag);
    ...
    final void put(ByteVector out) {
        ...
        if (this.code.length > 0) {
            ...
            if (this.localVar != null) {
                out.putShort(this.cw.newUTF8(LocalVariableAttribute.tag));
            ...
            if (this.lineNumber != null) {
                out.putShort(this.cw.newUTF8(LineNumberAttribute.tag));
            ...
            if (this.stackMap != null) {
                boolean zip = (this.cw.version & 65535) >= 50;
                out.putShort(this.cw.newUTF8(zip ? StackMapTable.tag : StackMap.tag));
                out.putInt(this.stackMap.length + 2).putShort(this.frameCount);
                out.putByteArray(this.stackMap.data, 0, this.stackMap.length);
            }
            if (this.ctanns != null) {
                out.putShort(this.cw.newUTF8(TypeAnnotationsAttribute.visibleTag));
                this.ctanns.put(out);
            }
            if (this.ictanns != null) {
                out.putShort(this.cw.newUTF8(TypeAnnotationsAttribute.invisibleTag));
        ...
        if (this.exceptionCount > 0) {
            out.putShort(this.cw.newUTF8(ExceptionsAttribute.tag)).putInt((2 * this.exceptionCount) + 2);
        ...
        if ((this.access & 4096) != 0 && ((this.cw.version & 65535) < 49 || (this.access & 262144) != 0)) {
            out.putShort(this.cw.newUTF8(SyntheticAttribute.tag)).putInt(0);
        }
        if ((this.access & 131072) != 0) {
            out.putShort(this.cw.newUTF8(DeprecatedAttribute.tag)).putInt(0);
        }
        if (this.signature != null) {
            out.putShort(this.cw.newUTF8(SignatureAttribute.tag)).putInt(2).putShort(this.cw.newUTF8(this.signature));
        }
        if (this.methodParameters != null) {
            out.putShort(this.cw.newUTF8(MethodParametersAttribute.tag));
        ...
        if (this.annd != null) {
            out.putShort(this.cw.newUTF8(AnnotationDefaultAttribute.tag));
            out.putInt(this.annd.length);
            out.putByteArray(this.annd.data, 0, this.annd.length);
        }
        if (this.anns != null) {
            out.putShort(this.cw.newUTF8(AnnotationsAttribute.visibleTag));
            this.anns.put(out);
        }
        if (this.ianns != null) {
            out.putShort(this.cw.newUTF8(AnnotationsAttribute.invisibleTag));
            this.ianns.put(out);
        }
        if (this.tanns != null) {
            out.putShort(this.cw.newUTF8(TypeAnnotationsAttribute.visibleTag));
        ...
        if (this.panns != null) {
            out.putShort(this.cw.newUTF8(ParameterAnnotationsAttribute.visibleTag));
            AnnotationWriter.put(this.panns, this.synthetics, out);
        }
        if (this.ipanns != null) {
            out.putShort(this.cw.newUTF8(ParameterAnnotationsAttribute.invisibleTag));
