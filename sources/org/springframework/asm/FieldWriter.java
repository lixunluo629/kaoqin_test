...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/asm/FieldWriter.class */
final class FieldWriter extends FieldVisitor {
    ...
    void put(ByteVector out) {
        ...
        if (this.value != 0) {
            out.putShort(this.cw.newUTF8(ConstantAttribute.tag));
        ...
        if (this.signature != 0) {
            out.putShort(this.cw.newUTF8(SignatureAttribute.tag));
