...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/StopWatch.class */
public class StopWatch {
    ...
    public String prettyPrint() {
        ...
        if (!this.keepTaskList) {
            ...
            for (TaskInfo task : getTaskInfo()) {
                ...
                sb.append(task.getTaskName()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
            }
        }
        return sb.toString();
    }
    ...
    /* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/StopWatch$TaskInfo.class */
