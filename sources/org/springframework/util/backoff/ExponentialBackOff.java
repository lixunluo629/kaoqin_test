...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/backoff/ExponentialBackOff.class */
public class ExponentialBackOff implements BackOff {
    ...
    private void checkMultiplier(double multiplier) {
        if (multiplier < 1.0d) {
            throw new IllegalArgumentException("Invalid multiplier '" + multiplier + "'. Should be equalor higher than 1. A multiplier of 1 is equivalent to a fixed interval");
        }
    }

    /* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/backoff/ExponentialBackOff$ExponentialBackOffExecution.class */
