...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/xml/StaxEventXMLReader.class */
class StaxEventXMLReader extends AbstractStaxXMLReader {
    ...
    protected void parseInternal() throws XMLStreamException, SAXException {
        ...
        if (hasNamespacePrefixesFeature()) {
            ...
            while (i2.hasNext()) {
                ...
                if (StringUtils.hasLength(prefix)) {
                    qName = Sax2Dom.XMLNS_STRING + prefix;
                } else {
                    qName = "xmlns";
                }
