...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/ResourceUtils.class */
public abstract class ResourceUtils {
    ...
    public static boolean isJarURL(URL url) {
        String protocol = url.getProtocol();
        return "jar".equals(protocol) || URL_PROTOCOL_WAR.equals(protocol) || "zip".equals(protocol) || URL_PROTOCOL_VFSZIP.equals(protocol) || URL_PROTOCOL_WSJAR.equals(protocol);
    }
    ...
    public static URI toURI(String location) throws URISyntaxException {
        return new URI(StringUtils.replace(location, SymbolConstants.SPACE_SYMBOL, "%20"));
    }
