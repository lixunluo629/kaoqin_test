...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/MimeType.class */
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    private void checkToken(String token) {
        for (int i = 0; i < token.length(); i++) {
            ...
            if (!TOKEN.get(ch2)) {
                throw new IllegalArgumentException("Invalid token character '" + ch2 + "' in token \"" + token + SymbolConstants.QUOTES_SYMBOL);
            }
        }
    }
    ...
    private boolean isQuotedString(String s) {
        ...
        return (s.startsWith(SymbolConstants.QUOTES_SYMBOL) && s.endsWith(SymbolConstants.QUOTES_SYMBOL)) || (s.startsWith("'") && s.endsWith("'"));
    }
    ...
    /* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/util/MimeType$SpecificityComparator.class */
