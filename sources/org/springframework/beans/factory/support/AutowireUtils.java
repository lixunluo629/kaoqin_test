...
/* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/support/AutowireUtils.class */
abstract class AutowireUtils {
    AutowireUtils() {
    }

    public static void sortConstructors(Constructor<?>[] constructors) {
        Arrays.sort(constructors, new Comparator<Constructor<?>>() { // from class: org.springframework.beans.factory.support.AutowireUtils.1
    ...
    public static void sortFactoryMethods(Method[] factoryMethods) {
        Arrays.sort(factoryMethods, new Comparator<Method>() { // from class: org.springframework.beans.factory.support.AutowireUtils.2
            @Override // java.util.Comparator
            ...
            for (int i2 = 0; i2 < methodParameterTypes.length; i2++) {
                ...
                if (methodParameterType.equals(genericReturnType)) {
                    if (arg instanceof TypedStringValue) {
                        ...
                        try {
                            return typedValue2.resolveTargetType(classLoader);
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/support/AutowireUtils$ObjectFactoryDelegatingInvocationHandler.class */
