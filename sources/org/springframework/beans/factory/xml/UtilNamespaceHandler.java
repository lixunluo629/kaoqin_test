...
/* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler.class */
public class UtilNamespaceHandler extends NamespaceHandlerSupport {
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$ConstantBeanDefinitionParser.class */
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$PropertyPathBeanDefinitionParser.class */
    private static class PropertyPathBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
            String path = element.getAttribute(Cookie2.PATH);
        ...
        protected String resolveId(Element element, AbstractBeanDefinition definition, ParserContext parserContext) {
            String id = super.resolveId(element, definition, parserContext);
            if (!StringUtils.hasText(id)) {
                id = element.getAttribute(Cookie2.PATH);
            }
            return id;
        }
    }

    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$ListBeanDefinitionParser.class */
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$SetBeanDefinitionParser.class */
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$MapBeanDefinitionParser.class */
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/factory/xml/UtilNamespaceHandler$PropertiesBeanDefinitionParser.class */
