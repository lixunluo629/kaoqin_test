...
/* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/PropertyAccessorUtils.class */
        ...
        while (searchIndex != -1) {
            ...
            if (keyStart != -1) {
                ...
                if (keyEnd != -1) {
                    ...
                    if ((key.startsWith("'") && key.endsWith("'")) || (key.startsWith(SymbolConstants.QUOTES_SYMBOL) && key.endsWith(SymbolConstants.QUOTES_SYMBOL))) {
