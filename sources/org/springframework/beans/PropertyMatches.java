...
/* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/PropertyMatches.class */
public abstract class PropertyMatches {
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/PropertyMatches$BeanPropertyMatches.class */
    ...
    /* loaded from: spring-beans-4.3.25.RELEASE.jar:org/springframework/beans/PropertyMatches$FieldPropertyMatches.class */
    private static class FieldPropertyMatches extends PropertyMatches {
        ...
        private static String[] calculateMatches(final String name, Class<?> clazz, final int maxDistance) throws IllegalArgumentException {
            final List<String> candidates = new ArrayList<>();
            ReflectionUtils.doWithFields(clazz, new ReflectionUtils.FieldCallback() { // from class: org.springframework.beans.PropertyMatches.FieldPropertyMatches.1
