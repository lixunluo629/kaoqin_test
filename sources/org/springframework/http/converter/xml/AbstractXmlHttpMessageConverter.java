...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/http/converter/xml/AbstractXmlHttpMessageConverter.class */
public abstract class AbstractXmlHttpMessageConverter<T> extends AbstractHttpMessageConverter<T> {
    private final TransformerFactory transformerFactory;

    protected abstract T readFromSource(Class<? extends T> cls, HttpHeaders httpHeaders, Source source) throws IOException, HttpMessageNotReadableException;

    protected abstract void writeToResult(T t, HttpHeaders httpHeaders, Result result) throws IOException, HttpMessageNotWritableException;
