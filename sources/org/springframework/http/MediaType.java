...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/http/MediaType.class */
public class MediaType extends MimeType implements Serializable {
    ...
    public static final Comparator<MediaType> QUALITY_VALUE_COMPARATOR = new Comparator<MediaType>() { // from class: org.springframework.http.MediaType.1
    ...
    public static final Comparator<MediaType> SPECIFICITY_COMPARATOR = new MimeType.SpecificityComparator<MediaType>() { // from class: org.springframework.http.MediaType.2
    ...
    protected void checkParameters(String attribute, String value) throws NumberFormatException {
