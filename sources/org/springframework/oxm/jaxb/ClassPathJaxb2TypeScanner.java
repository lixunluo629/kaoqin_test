...
/* loaded from: spring-oxm-4.3.25.RELEASE.jar:org/springframework/oxm/jaxb/ClassPathJaxb2TypeScanner.class */
class ClassPathJaxb2TypeScanner {
    ...
    public Class<?>[] scanPackages() throws ClassNotFoundException, UncategorizedMappingException {
        try {
            ...
            throw new UncategorizedMappingException("Failed to load annotated classes from classpath", ex2);
        }
    }
