...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/cache/annotation/SpringCacheAnnotationParser.class */
public class SpringCacheAnnotationParser implements CacheAnnotationParser, Serializable {
    ...
    Collection<CacheOperation> parseCachingAnnotation(AnnotatedElement ae, DefaultCacheConfig defaultConfig, Caching caching) {
        ...
        if (!ObjectUtils.isEmpty((Object[]) cacheEvicts)) {
            ops = lazyInit(ops);
        ...
        if (!ObjectUtils.isEmpty((Object[]) cachePuts)) {
            ops = lazyInit(ops);
    ...
    /* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/cache/annotation/SpringCacheAnnotationParser$DefaultCacheConfig.class */
