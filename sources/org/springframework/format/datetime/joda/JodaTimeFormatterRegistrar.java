...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/format/datetime/joda/JodaTimeFormatterRegistrar.class */
public class JodaTimeFormatterRegistrar implements FormatterRegistrar {
    private static final boolean jodaTime2Available = ClassUtils.isPresent("org.joda.time.YearMonth", JodaTimeFormatterRegistrar.class.getClassLoader());
    ...
    /* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/format/datetime/joda/JodaTimeFormatterRegistrar$Type.class */
    private enum Type {
        DATE,
        TIME,
        DATE_TIME
    ...
    /* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/format/datetime/joda/JodaTimeFormatterRegistrar$JodaTime2Delegate.class */
    private static class JodaTime2Delegate {
        private JodaTime2Delegate() {
        }
