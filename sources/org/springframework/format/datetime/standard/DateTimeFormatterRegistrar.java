...
@UsesJava8
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/format/datetime/standard/DateTimeFormatterRegistrar.class */
public class DateTimeFormatterRegistrar implements FormatterRegistrar {
    ...
    /* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/format/datetime/standard/DateTimeFormatterRegistrar$Type.class */
    private enum Type {
        DATE,
        TIME,
        DATE_TIME
