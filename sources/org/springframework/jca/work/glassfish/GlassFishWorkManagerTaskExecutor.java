...
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/jca/work/glassfish/GlassFishWorkManagerTaskExecutor.class */
public class GlassFishWorkManagerTaskExecutor extends WorkManagerTaskExecutor {
    ...
    public GlassFishWorkManagerTaskExecutor() throws ClassNotFoundException {
        try {
    ...
    protected WorkManager getDefaultWorkManager() {
        return (WorkManager) ReflectionUtils.invokeMethod(this.getWorkManagerMethod, null, null);
    }
}
