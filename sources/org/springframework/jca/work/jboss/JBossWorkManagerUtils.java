...
@Deprecated
/* loaded from: spring-tx-4.3.25.RELEASE.jar:org/springframework/jca/work/jboss/JBossWorkManagerUtils.class */
public abstract class JBossWorkManagerUtils {
    ...
    public static WorkManager getWorkManager(String mbeanName) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
