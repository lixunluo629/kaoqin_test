...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/scripting/config/ScriptBeanDefinitionParser.class */
class ScriptBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) throws NoSuchBeanDefinitionException, BeanDefinitionStoreException {
        ...
        String dependencyCheck = element.getAttribute("dependency-check");
