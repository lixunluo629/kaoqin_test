...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/MethodReference.class */
public class MethodReference extends SpelNodeImpl {
    ...
    public TypedValue getValueInternal(EvaluationContext evaluationContext, Object value, TypeDescriptor targetType, Object[] arguments) throws SpelEvaluationException {
    ...
    public void generateCode(MethodVisitor mv, CodeFlow cf) {
        ...
        if (Modifier.isPublic(method.getDeclaringClass().getModifiers())) {
            strReplace = method.getDeclaringClass().getName().replace('.', '/');
        } else {
            strReplace = methodExecutor.getPublicDeclaringClass().getName().replace('.', '/');
        }
        String classDesc = strReplace;
        if (!isStaticMethod && (descriptor == null || !descriptor.substring(1).equals(classDesc))) {
            CodeFlow.insertCheckCast(mv, StandardRoles.L + classDesc);
        }
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/MethodReference$MethodValueRef.class */
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/MethodReference$CachedMethodExecutor.class */
