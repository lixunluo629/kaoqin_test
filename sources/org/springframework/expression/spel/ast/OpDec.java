...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/OpDec.class */
public class OpDec extends Operator {
    private final boolean postfix;

    public OpDec(int pos, boolean postfix, SpelNodeImpl... operands) {
        super(ScriptUtils.DEFAULT_COMMENT_PREFIX, pos, operands);
    ...
    public String toStringAST() {
        return getLeftOperand().toStringAST() + ScriptUtils.DEFAULT_COMMENT_PREFIX;
    }
