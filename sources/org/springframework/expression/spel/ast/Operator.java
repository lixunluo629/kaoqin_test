...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/Operator.class */
public abstract class Operator extends SpelNodeImpl {
    ...
    public String toStringAST() {
        ...
        for (int i = 1; i < getChildCount(); i++) {
            sb.append(SymbolConstants.SPACE_SYMBOL).append(getOperatorName()).append(SymbolConstants.SPACE_SYMBOL);
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/Operator$DescriptorComparison.class */
