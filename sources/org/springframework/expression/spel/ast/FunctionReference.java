...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/ast/FunctionReference.class */
public class FunctionReference extends SpelNodeImpl {
    ...
    private TypedValue executeFunctionJLRMethod(ExpressionState state, Method method) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, EvaluationException, NegativeArraySizeException {
        ...
        if (!method.isVarArgs() && (declaredParamCount = method.getParameterTypes().length) != functionArgs.length) {
