...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/SpelMessage.class */
public enum SpelMessage {
    ...
    METHOD_NOT_FOUND(Kind.ERROR, MysqlErrorNumbers.ER_CANT_CREATE_FILE, "Method call: Method {0} cannot be found on type {1}"),
    ...
    ARGLIST_SHOULD_NOT_BE_EVALUATED(Kind.ERROR, MysqlErrorNumbers.ER_CHECKREAD, "The argument list of a lambda expression should never have getValue() called upon it"),
    ...
    INVALID_SECOND_OPERAND_FOR_MATCHES_OPERATOR(Kind.ERROR, MysqlErrorNumbers.ER_OUT_OF_SORTMEMORY, "Second operand to matches operator must be a string. ''{0}'' is not"),
    ...
    UNABLE_TO_DYNAMICALLY_CREATE_OBJECT(Kind.ERROR, MysqlErrorNumbers.ER_WRONG_GROUP_FIELD, "Unable to dynamically create instance of ''{0}'' to replace a null value"),
    ...
    MISSING_ARRAY_DIMENSION(Kind.ERROR, MysqlErrorNumbers.ER_WRONG_FIELD_SPEC, "A required array dimension has not been specified"),
    ...
    NOT_ASSIGNABLE(Kind.ERROR, MysqlErrorNumbers.ER_MULTIPLE_PRI_KEY, "The expression component ''{0}'' is not assignable"),
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/SpelMessage$Kind.class */
    public enum Kind {
        INFO,
        WARNING,
        ERROR
