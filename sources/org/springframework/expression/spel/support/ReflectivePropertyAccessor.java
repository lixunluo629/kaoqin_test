...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor.class */
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public boolean canRead(EvaluationContext context, Object target, String name) throws SecurityException, AccessException {
        if (target == null) {
            return false;
        }
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public TypedValue read(EvaluationContext context, Object target, String name) throws IllegalAccessException, SecurityException, IllegalArgumentException, AccessException, InvocationTargetException {
        if (target == null) {
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public boolean canWrite(EvaluationContext context, Object target, String name) throws SecurityException, AccessException {
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public void write(EvaluationContext context, Object target, String name, Object newValue) throws IllegalAccessException, SecurityException, IllegalArgumentException, AccessException, InvocationTargetException {
        if (!this.allowWrite) {
    ...
    private Method findGetterForProperty(String propertyName, Class<?> clazz, Object target) throws SecurityException {
    ...
    protected Method findGetterForProperty(String propertyName, Class<?> clazz, boolean mustBeStatic) throws SecurityException {
    ...
    private Method findMethodForProperty(String[] methodSuffixes, String prefix, Class<?> clazz, boolean mustBeStatic, int numberOfParams, Set<Class<?>> requiredReturnTypes) throws SecurityException {
        Method[] methods = getSortedMethods(clazz);
        for (String methodSuffix : methodSuffixes) {
            for (Method method : methods) {
                if (isCandidateForProperty(method, clazz) && method.getName().equals(prefix + methodSuffix) && method.getParameterTypes().length == numberOfParams && ((!mustBeStatic || Modifier.isStatic(method.getModifiers())) && (requiredReturnTypes.isEmpty() || requiredReturnTypes.contains(method.getReturnType())))) {
                    return method;
                }
            }
        }
    ...
    private Method[] getSortedMethods(Class<?> clazz) throws SecurityException {
    ...
    public PropertyAccessor createOptimalAccessor(EvaluationContext context, Object target, String name) throws SecurityException {
        if (target == null) {
            return this;
        }
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$InvokerPair.class */
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$PropertyCacheKey.class */
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$OptimalPropertyAccessor.class */
    public static class OptimalPropertyAccessor implements CompilablePropertyAccessor {
        ...
        @Override // org.springframework.expression.PropertyAccessor
        public TypedValue read(EvaluationContext context, Object target, String name) throws IllegalAccessException, IllegalArgumentException, AccessException, InvocationTargetException {
            if (this.member instanceof Method) {
                Method method = (Method) this.member;
                try {
