...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/SimpleEvaluationContext.class */
public class SimpleEvaluationContext implements EvaluationContext {
    private static final TypeLocator typeNotFoundTypeLocator = new TypeLocator() { // from class: org.springframework.expression.spel.support.SimpleEvaluationContext.1
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/SimpleEvaluationContext$Builder.class */
