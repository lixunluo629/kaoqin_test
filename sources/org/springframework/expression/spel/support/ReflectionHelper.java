...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectionHelper.class */
public class ReflectionHelper {

    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectionHelper$ArgumentsMatchKind.class */
    ...
    public static boolean convertAllArguments(TypeConverter converter, Object[] arguments, Method method) throws SpelEvaluationException {
        Integer varargsPosition = method.isVarArgs() ? Integer.valueOf(method.getParameterTypes().length - 1) : null;
    ...
    static boolean convertArguments(TypeConverter converter, Object[] arguments, Object methodOrCtor, Integer varargsPosition) throws EvaluationException {
        ...
        if (varargsPosition == null) {
            ...
            for (int i2 = 0; i2 < varargsPosition.intValue(); i2++) {
                TypeDescriptor targetType2 = new TypeDescriptor(MethodParameter.forMethodOrConstructor(methodOrCtor, i2));
            ...
            MethodParameter methodParam = MethodParameter.forMethodOrConstructor(methodOrCtor, varargsPosition.intValue());
    ...
    private static boolean isFirstEntryInArray(Object value, Object possibleArray) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    /* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectionHelper$ArgumentsMatchInfo.class */
