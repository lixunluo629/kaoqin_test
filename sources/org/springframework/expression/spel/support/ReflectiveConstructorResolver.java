...
/* loaded from: spring-expression-4.3.25.RELEASE.jar:org/springframework/expression/spel/support/ReflectiveConstructorResolver.class */
public class ReflectiveConstructorResolver implements ConstructorResolver {
    ...
    public ConstructorExecutor resolve(EvaluationContext context, String typeName, List<TypeDescriptor> argumentTypes) throws SecurityException, AccessException {
        try {
            ...
            Arrays.sort(ctors, new Comparator<Constructor<?>>() { // from class: org.springframework.expression.spel.support.ReflectiveConstructorResolver.1
