...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/core/TypeUtils.class */
public class TypeUtils {
    ...
    public static Type getType(String className) {
        return Type.getType(StandardRoles.L + className.replace('.', '/') + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
    }
    ...
    public static Type fromInternalName(String name) {
        return Type.getType(StandardRoles.L + name + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
    }
