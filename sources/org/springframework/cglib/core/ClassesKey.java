...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/core/ClassesKey.class */
public class ClassesKey {
    private static final Key FACTORY = (Key) KeyFactory.create(Key.class);

    /* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/core/ClassesKey$Key.class */
    interface Key {
