...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/core/Constants.class */
public interface Constants extends Opcodes {
    ...
    public static final Type TYPE_SYSTEM = TypeUtils.parseType(EventLog.SYSTEM);
