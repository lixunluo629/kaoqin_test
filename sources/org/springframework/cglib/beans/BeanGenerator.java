...
/* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/beans/BeanGenerator.class */
public class BeanGenerator extends AbstractClassGenerator {
    ...
    /* loaded from: spring-core-4.3.25.RELEASE.jar:org/springframework/cglib/beans/BeanGenerator$BeanGeneratorKey.class */
    ...
    public void addProperty(String name, Class type) {
        if (this.props.containsKey(name)) {
            throw new IllegalArgumentException("Duplicate property name \"" + name + SymbolConstants.QUOTES_SYMBOL);
        }
