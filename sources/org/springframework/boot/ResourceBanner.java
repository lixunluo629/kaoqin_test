...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/ResourceBanner.class */
public class ResourceBanner implements Banner {
    ...
    public void printBanner(Environment environment, Class<?> sourceClass, PrintStream out) {
        try {
            String banner = StreamUtils.copyToString(this.resource.getInputStream(), (Charset) environment.getProperty("banner.charset", Charset.class, Charset.forName("UTF-8")));
