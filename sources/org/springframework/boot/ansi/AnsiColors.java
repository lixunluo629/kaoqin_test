...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/ansi/AnsiColors.class */
public final class AnsiColors {
    ...
    /* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/ansi/AnsiColors$LabColor.class */
    private static final class LabColor {
        ...
        LabColor(Integer rgb) {
            this(rgb != null ? new Color(rgb.intValue()) : (Color) null);
        }
