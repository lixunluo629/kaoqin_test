...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/jdbc/JndiDataSourceAutoConfiguration.class */
public class JndiDataSourceAutoConfiguration {
    ...
    @Bean(destroyMethod = "")
    public DataSource dataSource(DataSourceProperties properties) throws DataSourceLookupFailureException {
