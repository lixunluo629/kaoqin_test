...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/data/redis/RedisAutoConfiguration.class */
public class RedisAutoConfiguration {

    @Configuration
    @ConditionalOnClass({GenericObjectPool.class})
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/data/redis/RedisAutoConfiguration$RedisConnectionConfiguration.class */
    ...
    @Configuration
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/data/redis/RedisAutoConfiguration$RedisConfiguration.class */
