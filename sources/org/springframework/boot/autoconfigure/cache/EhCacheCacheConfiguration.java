...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/EhCacheCacheConfiguration.class */
class EhCacheCacheConfiguration {
    ...
    public EhCacheCacheManager cacheManager(net.sf.ehcache.CacheManager ehCacheCacheManager) {
        return (EhCacheCacheManager) this.customizers.customize(new EhCacheCacheManager(ehCacheCacheManager));
    }
    ...
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/EhCacheCacheConfiguration$ConfigAvailableCondition.class */
