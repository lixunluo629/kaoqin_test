...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/JCacheCacheConfiguration.class */
class JCacheCacheConfiguration implements BeanClassLoaderAware {
    ...
    public JCacheCacheManager cacheManager(javax.cache.CacheManager jCacheCacheManager) {
        ...
        return (JCacheCacheManager) this.customizers.customize(cacheManager);
    }
    ...
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/JCacheCacheConfiguration$JCacheAvailableCondition.class */
    static class JCacheAvailableCondition extends AnyNestedCondition {
        ...
        /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/JCacheCacheConfiguration$JCacheAvailableCondition$JCacheProvider.class */
        ...
        /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/JCacheCacheConfiguration$JCacheAvailableCondition$CustomJCacheCacheManager.class */
    ...
    @Order(Integer.MAX_VALUE)
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/cache/JCacheCacheConfiguration$JCacheProviderAvailableCondition.class */
    static class JCacheProviderAvailableCondition extends SpringBootCondition {
        ...
        public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
            ...
            RelaxedPropertyResolver resolver = new RelaxedPropertyResolver(context.getEnvironment(), "spring.cache.jcache.");
