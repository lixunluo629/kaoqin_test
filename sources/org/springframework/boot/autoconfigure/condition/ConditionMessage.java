...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage.class */
public final class ConditionMessage {
    ...
    public ConditionMessage append(String message) {
        ...
        return new ConditionMessage(this.message + SymbolConstants.SPACE_SYMBOL + message);
    }
    ...
    public Builder andCondition(String condition, Object... details) {
        Assert.notNull(condition, "Condition must not be null");
        String detail = StringUtils.arrayToDelimitedString(details, SymbolConstants.SPACE_SYMBOL);
        if (StringUtils.hasLength(detail)) {
            return new Builder(condition + SymbolConstants.SPACE_SYMBOL + detail);
        }
    ...
    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$Builder.class */
    public final class Builder {
        ...
        public ConditionMessage because(String reason) {
            ...
            return new ConditionMessage(this.condition + (StringUtils.isEmpty(this.condition) ? "" : SymbolConstants.SPACE_SYMBOL) + reason);
        }
    }

    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$ItemsBuilder.class */
    public final class ItemsBuilder {
        ...
        public ConditionMessage items(Style style, Collection<?> items) {
            ...
            if ((this.condition == null || items2.size() <= 1) && StringUtils.hasLength(this.singular)) {
                message.append(SymbolConstants.SPACE_SYMBOL + this.singular);
            } else if (StringUtils.hasLength(this.plural)) {
                message.append(SymbolConstants.SPACE_SYMBOL + this.plural);
            }
            if (items2 != null && !items2.isEmpty()) {
                message.append(SymbolConstants.SPACE_SYMBOL + StringUtils.collectionToDelimitedString(items2, ", "));
            }
            return this.condition.because(message.toString());
        }
    }

    /* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$Style.class */
    public enum Style {
