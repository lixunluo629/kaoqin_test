...
/* loaded from: spring-boot-autoconfigure-1.5.22.RELEASE.jar:org/springframework/boot/autoconfigure/web/HttpMessageConverters.class */
public class HttpMessageConverters implements Iterable<HttpMessageConverter<?>> {
    ...
    private List<HttpMessageConverter<?>> getDefaultConverters() {
        ...
        if (ClassUtils.isPresent("org.springframework.web.servlet.config.annotation.WebMvcConfigurationSupport", null)) {
            converters.addAll(new WebMvcConfigurationSupport() { // from class: org.springframework.boot.autoconfigure.web.HttpMessageConverters.1
