...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/admin/SpringApplicationAdminMXBeanRegistrar.class */
public class SpringApplicationAdminMXBeanRegistrar implements ApplicationContextAware, EnvironmentAware, InitializingBean, DisposableBean, ApplicationListener<ApplicationReadyEvent> {
    ...
    /* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/admin/SpringApplicationAdminMXBeanRegistrar$SpringApplicationAdmin.class */
