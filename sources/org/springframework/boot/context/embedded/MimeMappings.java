...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/context/embedded/MimeMappings.class */
public final class MimeMappings implements Iterable<Mapping> {
    ...
    static {
        ...
        mappings.add(ArchiveStreamFactory.CPIO, "application/x-cpio");
        ...
        mappings.add(ContentTypes.EXTENSION_GIF, "image/gif");
        mappings.add("gtar", "application/x-gtar");
        mappings.add(CompressorStreamFactory.GZIP, "application/x-gzip");
        ...
        mappings.add(ContentTypes.EXTENSION_JPG_2, "image/jpeg");
        mappings.add(ContentTypes.EXTENSION_JPG_1, "image/jpeg");
        mappings.add("js", MappingJackson2JsonView.DEFAULT_JSONP_CONTENT_TYPE);
        ...
        mappings.add("pct", ContentTypes.IMAGE_PICT);
        mappings.add("pdf", MediaType.APPLICATION_PDF_VALUE);
        mappings.add("pgm", "image/x-portable-graymap");
        mappings.add("pic", ContentTypes.IMAGE_PICT);
        mappings.add("pict", ContentTypes.IMAGE_PICT);
        mappings.add("pls", "audio/x-scpls");
        mappings.add(ContentTypes.EXTENSION_PNG, "image/png");
        ...
        mappings.add(ArchiveStreamFactory.TAR, "application/x-tar");
        ...
        mappings.add("tif", ContentTypes.IMAGE_TIFF);
        mappings.add("tiff", ContentTypes.IMAGE_TIFF);
        ...
        mappings.add(CompressorStreamFactory.Z, "application/x-compress");
    ...
    /* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/context/embedded/MimeMappings$Mapping.class */
