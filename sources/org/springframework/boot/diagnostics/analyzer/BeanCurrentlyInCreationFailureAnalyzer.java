...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/diagnostics/analyzer/BeanCurrentlyInCreationFailureAnalyzer.class */
class BeanCurrentlyInCreationFailureAnalyzer extends AbstractFailureAnalyzer<BeanCurrentlyInCreationException> {
    ...
    private String buildMessage(DependencyCycle dependencyCycle) {
        ...
        while (i < beansInCycle.size()) {
            ...
            if (i == cycleStart) {
                ...
                String leftSide = i < cycleStart ? SymbolConstants.SPACE_SYMBOL : "↑";
                message.append(String.format("%s     ↓%n", leftSide));
            }
            String leftSide2 = i < cycleStart ? SymbolConstants.SPACE_SYMBOL : "|";
    ...
    /* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/diagnostics/analyzer/BeanCurrentlyInCreationFailureAnalyzer$DependencyCycle.class */
    ...
    /* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/diagnostics/analyzer/BeanCurrentlyInCreationFailureAnalyzer$BeanInCycle.class */
