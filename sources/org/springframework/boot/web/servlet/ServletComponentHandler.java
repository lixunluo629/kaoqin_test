...
/* loaded from: spring-boot-1.5.22.RELEASE.jar:org/springframework/boot/web/servlet/ServletComponentHandler.class */
abstract class ServletComponentHandler {
    private final Class<? extends Annotation> annotationType;
    private final TypeFilter typeFilter;

    protected abstract void doHandle(Map<String, Object> map, ScannedGenericBeanDefinition scannedGenericBeanDefinition, BeanDefinitionRegistry beanDefinitionRegistry);
