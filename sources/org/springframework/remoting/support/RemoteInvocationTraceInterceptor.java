...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/remoting/support/RemoteInvocationTraceInterceptor.class */
public class RemoteInvocationTraceInterceptor implements MethodInterceptor {
    ...
    public RemoteInvocationTraceInterceptor(String exporterName) {
        this.exporterNameClause = exporterName + SymbolConstants.SPACE_SYMBOL;
    }
