...
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/remoting/httpinvoker/HttpComponentsHttpInvokerRequestExecutor.class */
public class HttpComponentsHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
    ...
    static {
        try {
            abstractHttpClientClass = ClassUtils.forName("org.apache.http.impl.client.AbstractHttpClient", HttpComponentsHttpInvokerRequestExecutor.class.getClassLoader());
