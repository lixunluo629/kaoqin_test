...
@UsesSunHttpServer
/* loaded from: spring-web-4.3.25.RELEASE.jar:org/springframework/remoting/caucho/SimpleHessianServiceExporter.class */
public class SimpleHessianServiceExporter extends HessianExporter implements HttpHandler {
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            exchange.getResponseHeaders().set("Content-Type", HessianExporter.CONTENT_TYPE_HESSIAN);
