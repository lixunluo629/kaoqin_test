...
/* loaded from: spring-context-4.3.25.RELEASE.jar:org/springframework/remoting/rmi/RmiServiceExporter.class */
public class RmiServiceExporter extends RmiBasedExporter implements InitializingBean, DisposableBean {
    ...
    private void unexportObjectSilently() {
        try {
            ...
            if (this.logger.isWarnEnabled()) {
                this.logger.warn("RMI object for service '" + this.serviceName + "' is not exported anymore", e);
            }
        }
    }
}
