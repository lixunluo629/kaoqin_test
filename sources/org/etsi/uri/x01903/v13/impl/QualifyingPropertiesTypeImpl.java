...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/etsi/uri/x01903/v13/impl/QualifyingPropertiesTypeImpl.class */
public class QualifyingPropertiesTypeImpl extends XmlComplexContentImpl implements QualifyingPropertiesType {
    ...
    public void setSignedProperties(SignedPropertiesType signedPropertiesType) {
        synchronized (monitor()) {
            check_orphaned();
            SignedPropertiesType signedPropertiesType2 = (SignedPropertiesType) get_store().find_element_user(SIGNEDPROPERTIES$0, 0);
            if (signedPropertiesType2 == null) {
                signedPropertiesType2 = (SignedPropertiesType) get_store().add_element_user(SIGNEDPROPERTIES$0);
            }
    ...
    public void setUnsignedProperties(UnsignedPropertiesType unsignedPropertiesType) {
        synchronized (monitor()) {
            check_orphaned();
            UnsignedPropertiesType unsignedPropertiesType2 = (UnsignedPropertiesType) get_store().find_element_user(UNSIGNEDPROPERTIES$2, 0);
            if (unsignedPropertiesType2 == null) {
                unsignedPropertiesType2 = (UnsignedPropertiesType) get_store().add_element_user(UNSIGNEDPROPERTIES$2);
            }
    ...
    public void xsetTarget(XmlAnyURI xmlAnyURI) {
        synchronized (monitor()) {
            check_orphaned();
            XmlAnyURI xmlAnyURI2 = (XmlAnyURI) get_store().find_attribute_user(TARGET$4);
            if (xmlAnyURI2 == null) {
                xmlAnyURI2 = (XmlAnyURI) get_store().add_attribute_user(TARGET$4);
            }
