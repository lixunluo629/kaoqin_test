...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/etsi/uri/x01903/v13/impl/CertIDTypeImpl.class */
public class CertIDTypeImpl extends XmlComplexContentImpl implements CertIDType {
    ...
    public void setCertDigest(DigestAlgAndValueType digestAlgAndValueType) {
        synchronized (monitor()) {
            check_orphaned();
            DigestAlgAndValueType digestAlgAndValueType2 = (DigestAlgAndValueType) get_store().find_element_user(CERTDIGEST$0, 0);
            if (digestAlgAndValueType2 == null) {
                digestAlgAndValueType2 = (DigestAlgAndValueType) get_store().add_element_user(CERTDIGEST$0);
            }
    ...
    public void setIssuerSerial(X509IssuerSerialType x509IssuerSerialType) {
        synchronized (monitor()) {
            check_orphaned();
            X509IssuerSerialType x509IssuerSerialType2 = (X509IssuerSerialType) get_store().find_element_user(ISSUERSERIAL$2, 0);
            if (x509IssuerSerialType2 == null) {
                x509IssuerSerialType2 = (X509IssuerSerialType) get_store().add_element_user(ISSUERSERIAL$2);
            }
