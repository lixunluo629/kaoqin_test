...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/etsi/uri/x01903/v13/impl/OCSPIdentifierTypeImpl.class */
public class OCSPIdentifierTypeImpl extends XmlComplexContentImpl implements OCSPIdentifierType {
    ...
    public void setResponderID(ResponderIDType responderIDType) {
        synchronized (monitor()) {
            check_orphaned();
            ResponderIDType responderIDType2 = (ResponderIDType) get_store().find_element_user(RESPONDERID$0, 0);
            if (responderIDType2 == null) {
                responderIDType2 = (ResponderIDType) get_store().add_element_user(RESPONDERID$0);
            }
    ...
    public void xsetProducedAt(XmlDateTime xmlDateTime) {
        synchronized (monitor()) {
            check_orphaned();
            XmlDateTime xmlDateTime2 = (XmlDateTime) get_store().find_element_user(PRODUCEDAT$2, 0);
            if (xmlDateTime2 == null) {
                xmlDateTime2 = (XmlDateTime) get_store().add_element_user(PRODUCEDAT$2);
            }
