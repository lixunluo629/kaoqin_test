...
/* loaded from: ehcache-3.2.3.jar:org/ehcache/impl/internal/store/disk/EhcachePersistentConcurrentOffHeapClockCache.class */
public class EhcachePersistentConcurrentOffHeapClockCache<K, V> extends AbstractPersistentConcurrentOffHeapCache<K, V> implements EhcacheOffHeapBackingMap<K, V> {
    ...
    public V compute(K key, final BiFunction<K, V, V> mappingFunction, final boolean pin) {
        MetadataTuple<V> result = computeWithMetadata(key, new org.terracotta.offheapstore.jdk8.BiFunction<K, MetadataTuple<V>, MetadataTuple<V>>() { // from class: org.ehcache.impl.internal.store.disk.EhcachePersistentConcurrentOffHeapClockCache.1
            ...
            public MetadataTuple<V> apply(K k, MetadataTuple<V> current) {
                ...
                return MetadataTuple.metadataTuple(objApply, (pin ? 1073741824 : 0) | (EhcachePersistentConcurrentOffHeapClockCache.this.evictionAdvisor.adviseAgainstEviction(k, objApply) ? 536870912 : 0));
            }
        });
        if (result == null) {
            return null;
    ...
    public V computeIfPresent(K key, final BiFunction<K, V, V> mappingFunction) {
        MetadataTuple<V> result = computeIfPresentWithMetadata(key, new org.terracotta.offheapstore.jdk8.BiFunction<K, MetadataTuple<V>, MetadataTuple<V>>() { // from class: org.ehcache.impl.internal.store.disk.EhcachePersistentConcurrentOffHeapClockCache.2
            @Override // org.terracotta.offheapstore.jdk8.BiFunction
            public /* bridge */ /* synthetic */ Object apply(Object x0, Object x1) {
            ...
            public MetadataTuple<V> apply(K k, MetadataTuple<V> current) {
                ...
                return MetadataTuple.metadataTuple(objApply, EhcachePersistentConcurrentOffHeapClockCache.this.evictionAdvisor.adviseAgainstEviction(k, objApply) ? 536870912 : 0);
            }
        });
        if (result == null) {
            return null;
    ...
    public V computeIfPresentAndPin(K key, final BiFunction<K, V, V> mappingFunction) {
        MetadataTuple<V> result = computeIfPresentWithMetadata(key, new org.terracotta.offheapstore.jdk8.BiFunction<K, MetadataTuple<V>, MetadataTuple<V>>() { // from class: org.ehcache.impl.internal.store.disk.EhcachePersistentConcurrentOffHeapClockCache.3
            @Override // org.terracotta.offheapstore.jdk8.BiFunction
            public /* bridge */ /* synthetic */ Object apply(Object x0, Object x1) {
            ...
            public MetadataTuple<V> apply(K k, MetadataTuple<V> current) {
                ...
                return MetadataTuple.metadataTuple(objApply, 1073741824 | (EhcachePersistentConcurrentOffHeapClockCache.this.evictionAdvisor.adviseAgainstEviction(k, objApply) ? 536870912 : 0));
            }
        });
        if (result == null) {
            return null;
    ...
    public boolean computeIfPinned(K key, final BiFunction<K, V, V> remappingFunction, final Function<V, Boolean> unpinFunction) {
        ...
        computeIfPresentWithMetadata(key, new org.terracotta.offheapstore.jdk8.BiFunction<K, MetadataTuple<V>, MetadataTuple<V>>() { // from class: org.ehcache.impl.internal.store.disk.EhcachePersistentConcurrentOffHeapClockCache.4
            @Override // org.terracotta.offheapstore.jdk8.BiFunction
            public /* bridge */ /* synthetic */ Object apply(Object x0, Object x1) {
