...
/* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/external/com/google/gdata/util/common/base/PercentEscaper.class */
public class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String safeChars, boolean plusForSpace) {
        ...
        if (plusForSpace && safeChars.contains(SymbolConstants.SPACE_SYMBOL)) {
