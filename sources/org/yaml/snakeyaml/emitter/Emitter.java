...
/* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter.class */
public final class Emitter implements Emitable {
    ...
    static {
        ...
        ESCAPE_REPLACEMENTS.put((char) 11, ExcelXmlConstants.CELL_VALUE_TAG);
        ESCAPE_REPLACEMENTS.put('\f', ExcelXmlConstants.CELL_FORMULA_TAG);
        ESCAPE_REPLACEMENTS.put('\r', ExcelXmlConstants.POSITION);
        ...
        ESCAPE_REPLACEMENTS.put((char) 8232, StandardRoles.L);
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectStreamStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectNothing.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstDocumentStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentEnd.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentRoot.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstFlowSequenceItem.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowSequenceItem.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstFlowMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingSimpleValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstBlockSequenceItem.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockSequenceItem.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstBlockMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingSimpleValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingValue.class */
    ...
    private ScalarAnalysis analyzeScalar(String scalar) {
        ...
        while (index < scalar.length()) {
            ...
            if (index == 0) {
                ...
                if (ch2 == '#' && preceededByWhitespace) {
                    flowIndicators = true;
                    blockIndicators = true;
                }
            }
            boolean isLineBreak = Constant.LINEBR.has(ch2);
            if (isLineBreak) {
                lineBreaks = true;
            }
            if (ch2 != '\n' && ((' ' > ch2 || ch2 > '~') && ((ch2 != 133 && ((160 > ch2 || ch2 > 55295) && (57344 > ch2 || ch2 > 65533))) || ch2 == 65279 || !this.allowUnicode))) {
            ...
            index++;
            preceededByWhitespace = Constant.NULL_BL_T.has(ch2) || isLineBreak;
    ...
    private void writeDoubleQuoted(String text, boolean split) throws IOException {
        String data;
        String data2;
        writeIndicator(SymbolConstants.QUOTES_SYMBOL, true, false, false);
        int start = 0;
        int end = 0;
        ...
        writeIndicator(SymbolConstants.QUOTES_SYMBOL, false, false, false);
    }

    private String determineBlockHints(String text) {
        StringBuilder hints = new StringBuilder();
        if (Constant.LINEBR.has(text.charAt(0), SymbolConstants.SPACE_SYMBOL)) {
