...
/* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl.class */
public class ParserImpl implements Parser {
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseStreamStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseImplicitDocumentStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentStart.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentEnd.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentContent.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockNode.class */
    ...
    public Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        if (this.scanner.checkToken(Token.ID.Alias)) {
            ...
            if (indentlessSequence && this.scanner.checkToken(Token.ID.BlockEntry)) {
                ...
                event = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark2, Boolean.FALSE);
                ...
                event = new ScalarEvent(anchor, tag, implicitValues, token4.getValue(), startMark, endMark3, Character.valueOf(token4.getStyle()));
                this.state = this.states.pop();
            } else if (this.scanner.checkToken(Token.ID.FlowSequenceStart)) {
                Mark endMark4 = this.scanner.peekToken().getEndMark();
                event = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark4, Boolean.TRUE);
                ...
                event = new MappingStartEvent(anchor, tag, implicit, startMark, endMark5, Boolean.TRUE);
                ...
                event = new SequenceStartEvent(anchor, tag, implicit, startMark, endMark6, Boolean.FALSE);
                ...
                event = new MappingStartEvent(anchor, tag, implicit, startMark, endMark7, Boolean.FALSE);
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockSequenceFirstEntry.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockSequenceEntry.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseIndentlessSequenceEntry.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingFirstKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceFirstEntry.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntry.class */
    private class ParseFlowSequenceEntry implements Production {
        ...
        public Event produce() {
            if (!ParserImpl.this.scanner.checkToken(Token.ID.FlowSequenceEnd)) {
                ...
                if (ParserImpl.this.scanner.checkToken(Token.ID.Key)) {
                    Token token2 = ParserImpl.this.scanner.peekToken();
                    Event event = new MappingStartEvent(null, null, true, token2.getStartMark(), token2.getEndMark(), Boolean.TRUE);
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingEnd.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingFirstKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingKey.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingValue.class */
    ...
    /* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingEmptyValue.class */
