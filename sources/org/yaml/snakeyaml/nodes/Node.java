...
/* loaded from: snakeyaml-1.17.jar:org/yaml/snakeyaml/nodes/Node.class */
public abstract class Node {
    ...
    public boolean useClassConstructor() {
        if (this.useClassConstructor == null) {
            if ((!this.tag.isSecondary() && isResolved() && !Object.class.equals(this.type) && !this.tag.equals(Tag.NULL)) || this.tag.isCompatible(getType())) {
                return true;
            }
            return false;
        }
