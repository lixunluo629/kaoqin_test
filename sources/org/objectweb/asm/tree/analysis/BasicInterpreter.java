...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/tree/analysis/BasicInterpreter.SCL.lombok */
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes {
    ...
    public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 189:
                return newValue(Type.getType(PropertyAccessor.PROPERTY_KEY_PREFIX + Type.getObjectType(((TypeInsnNode) insn).desc)));
            case 190:
                return BasicValue.INT_VALUE;
            case 191:
                return null;
