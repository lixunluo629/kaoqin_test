...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/tree/analysis/SimpleVerifier.SCL.lombok */
public class SimpleVerifier extends BasicVerifier {
    ...
    public SimpleVerifier(Type currentClass, Type currentSuperClass, List<Type> currentClassInterfaces, boolean isInterface) {
        this(393216, currentClass, currentSuperClass, currentClassInterfaces, isInterface);
    ...
    private BasicValue newValue(Type type, int dimensions) {
        if (dimensions == 0) {
    ...
    protected boolean isAssignableFrom(Type type1, Type type2) {
        ...
        if (this.currentClass != null && type1.equals(this.currentClass)) {
        ...
        if (this.currentClass != null && type2.equals(this.currentClass)) {
            ...
            if (this.currentClassInterfaces != null) {
                for (int i = 0; i < this.currentClassInterfaces.size(); i++) {
                    Type currentClassInterface = this.currentClassInterfaces.get(i);
