...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/SymbolTable.SCL.lombok */
final class SymbolTable {
    ...
    /* loaded from: lombok-1.16.22.jar:org/objectweb/asm/SymbolTable$Entry.SCL.lombok */
        ...
        while (true) {
            ...
            if (itemIndex < this.constantPoolCount) {
                ...
                switch (b) {
                    ...
                    case 3:
                    case 4:
                        addConstantInteger(itemIndex, b, classReader.readInt(itemOffset));
                        break;
                    case 5:
                    case 6:
                        addConstantLong(itemIndex, b, classReader.readLong(itemOffset));
                        break;
                    case 7:
                    case 8:
                    case 16:
                ...
                if (this.bootstrapMethodCount > 0) {
                    ...
                    for (int i3 = 0; i3 < this.bootstrapMethodCount; i3++) {
                        ...
                        add(new Entry(i3, 64, offset, hashCode & Integer.MAX_VALUE));
                    }
                    return;
                }
                return;
    ...
    Symbol addConstantInteger(int value) {
        return addConstantInteger(3, value);
    }

    Symbol addConstantFloat(float value) {
        return addConstantInteger(4, Float.floatToRawIntBits(value));
    }

    private Symbol addConstantInteger(int tag, int value) {
    ...
    private void addConstantInteger(int index, int tag, int value) {
        add(new Entry(index, tag, value, hash(tag, value)));
    }

    Symbol addConstantLong(long value) {
        return addConstantLong(5, value);
    }

    Symbol addConstantDouble(double value) {
        return addConstantLong(6, Double.doubleToRawLongBits(value));
    }

    private Symbol addConstantLong(int tag, long value) {
        int hashCode = hash(tag, value);
        Entry entry = get(hashCode);
        while (true) {
            Entry entry2 = entry;
    ...
    private void addConstantLong(int index, int tag, long value) {
        add(new Entry(index, tag, value, hash(tag, value)));
    }
    ...
    int addType(String value) {
        ...
        while (true) {
            ...
            if (entry2 != null) {
                ...
                return addType(new Entry(this.typeCount, 128, value, hashCode));
            }
        }
    }
    ...
    int addUninitializedType(String value, int bytecodeOffset) {
        ...
        while (true) {
            ...
            if (entry2 != null) {
                ...
                return addType(new Entry(this.typeCount, 129, value, bytecodeOffset, hashCode));
            }
        }
    }
