...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/commons/AnalyzerAdapter.SCL.lombok */
public class AnalyzerAdapter extends MethodVisitor {
    ...
    public AnalyzerAdapter(String owner, int access, String name, String descriptor, MethodVisitor methodVisitor) {
        this(393216, owner, access, name, descriptor, methodVisitor);
    ...
    private void execute(int opcode, int intArg, String stringArg) {
        ...
        switch (opcode) {
            ...
            case 189:
                pop();
                pushDescriptor(PropertyAccessor.PROPERTY_KEY_PREFIX + Type.getObjectType(stringArg));
                break;
            case 192:
                pop();
