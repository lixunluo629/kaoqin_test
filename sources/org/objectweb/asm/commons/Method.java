...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/commons/Method.SCL.lombok */
public class Method {
    ...
    static {
        ...
        descriptors.put(XmlErrorCodes.DOUBLE, "D");
        descriptors.put(XmlErrorCodes.FLOAT, "F");
        descriptors.put(XmlErrorCodes.INT, "I");
        descriptors.put(XmlErrorCodes.LONG, "J");
    ...
    public static Method getMethod(String method, boolean defaultPackage) {
        ...
        do {
            ...
            if (currentArgumentEndIndex == -1) {
                argumentDescriptor = getDescriptor(method.substring(currentArgumentStartIndex, endIndex).trim(), defaultPackage);
            } else {
                argumentDescriptor = getDescriptor(method.substring(currentArgumentStartIndex, currentArgumentEndIndex).trim(), defaultPackage);
