...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/commons/JSRInlinerAdapter.SCL.lombok */
public class JSRInlinerAdapter extends MethodNode implements Opcodes {
    ...
    public JSRInlinerAdapter(MethodVisitor methodVisitor, int access, String name, String descriptor, String signature, String[] exceptions) {
        this(393216, methodVisitor, access, name, descriptor, signature, exceptions);
    ...
    /* loaded from: lombok-1.16.22.jar:org/objectweb/asm/commons/JSRInlinerAdapter$Instantiation.SCL.lombok */
