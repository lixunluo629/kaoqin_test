...
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/commons/GeneratorAdapter.SCL.lombok */
public class GeneratorAdapter extends LocalVariablesSorter {
    ...
    public void valueOf(Type type) {
        ...
        if (type == Type.VOID_TYPE) {
            ...
            Type boxedType = getBoxedType(type);
            invokeStatic(boxedType, new Method(CoreConstants.VALUE_OF, boxedType, new Type[]{type}));
        }
    }
