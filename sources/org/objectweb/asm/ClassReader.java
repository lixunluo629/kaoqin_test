...
/* JADX WARN: Classes with same name are omitted:
  asm-4.2.jar:org/objectweb/asm/ClassReader.class
 */
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/ClassReader.SCL.lombok */
public class ClassReader {
    ...
    ClassReader(byte[] classFileBuffer, int classFileOffset, boolean checkClassVersion) {
        ...
        if (checkClassVersion && readShort(classFileOffset + 6) > 55) {
        ...
        this.cpInfoValues = new Object[constantPoolCount];
        ...
        for (int i2 = readUnsignedShort(currentAttributeOffset - 2); i2 > 0; i2--) {
            String attributeName = readUTF8(currentAttributeOffset, new char[this.maxStringLength]);
            int attributeLength = readInt(currentAttributeOffset + 2);
            int currentAttributeOffset2 = currentAttributeOffset + 6;
            if (BootstrapMethodsAttribute.tag.equals(attributeName)) {
                currentBootstrapMethodOffsets = new int[readUnsignedShort(currentAttributeOffset2)];
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
        ...
        for (int i2 = readUnsignedShort(currentAttributeOffset - 2); i2 > 0; i2--) {
            ...
            int attributeLength = readInt(currentAttributeOffset + 2);
            int currentAttributeOffset2 = currentAttributeOffset + 6;
            if (SourceFileAttribute.tag.equals(attributeName)) {
                sourceFile = readUTF8(currentAttributeOffset2, charBuffer);
            } else if (InnerClassesAttribute.tag.equals(attributeName)) {
                innerClassesOffset = currentAttributeOffset2;
            } else if (EnclosingMethodAttribute.tag.equals(attributeName)) {
            ...
            } else if (SignatureAttribute.tag.equals(attributeName)) {
                signature = readUTF8(currentAttributeOffset2, charBuffer);
            } else if (AnnotationsAttribute.visibleTag.equals(attributeName)) {
            ...
            } else if (DeprecatedAttribute.tag.equals(attributeName)) {
                accessFlags |= 131072;
            } else if (SyntheticAttribute.tag.equals(attributeName)) {
                accessFlags |= 4096;
            ...
            } else if (AnnotationsAttribute.invisibleTag.equals(attributeName)) {
            ...
            } else if (!BootstrapMethodsAttribute.tag.equals(attributeName)) {
    ...
    private void readModule(ClassVisitor classVisitor, Context context, int moduleOffset, int modulePackagesOffset, String moduleMainClass) {
    ...
    private int readField(ClassVisitor classVisitor, Context context, int fieldInfoOffset) {
        ...
        while (true) {
            ...
            if (ConstantAttribute.tag.equals(attributeName)) {
    ...
    private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
        ...
        while (true) {
            ...
            if ("Code".equals(attributeName)) {
            ...
            } else if (ExceptionsAttribute.tag.equals(attributeName)) {
                ...
                runtimeVisibleTypeAnnotationsOffset = currentOffset3;
            } else if (AnnotationDefaultAttribute.tag.equals(attributeName)) {
                ...
                runtimeInvisibleTypeAnnotationsOffset = currentOffset3;
            } else if (ParameterAnnotationsAttribute.visibleTag.equals(attributeName)) {
                runtimeVisibleParameterAnnotationsOffset = currentOffset3;
            } else if (ParameterAnnotationsAttribute.invisibleTag.equals(attributeName)) {
        ...
        if (methodVisitor instanceof MethodWriter) {
            ...
            if (methodWriter.canCopyMethodAttributes(this, methodInfoOffset, currentOffset2 - methodInfoOffset, synthetic, (context.currentMethodAccessFlags & 131072) != 0, signatureIndex, exceptionsOffset)) {
                return currentOffset2;
            }
        }
    ...
    private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
        ...
        while (currentOffset < bytecodeEndOffset) {
            ...
            switch (classFileBuffer[currentOffset] & 255) {
                ...
                case 207:
                case 208:
                case org.aspectj.apache.bcel.Constants.PUTFIELD2_QUICK /* 209 */:
                case org.aspectj.apache.bcel.Constants.GETSTATIC_QUICK /* 210 */:
                case 211:
                case org.aspectj.apache.bcel.Constants.GETSTATIC2_QUICK /* 212 */:
                case 213:
                case org.aspectj.apache.bcel.Constants.INVOKEVIRTUAL_QUICK /* 214 */:
                case 215:
                case org.aspectj.apache.bcel.Constants.INVOKESUPER_QUICK /* 216 */:
                case org.aspectj.apache.bcel.Constants.INVOKESTATIC_QUICK /* 217 */:
                case 218:
                case org.aspectj.apache.bcel.Constants.INVOKEVIRTUALOBJECT_QUICK /* 219 */:
            ...
            if (i3 > 0) {
                ...
                while (true) {
                    ...
                    if (i4 > 0) {
                        ...
                        if (LocalVariableAttribute.tag.equals(attributeName)) {
                        ...
                        } else if (LineNumberAttribute.tag.equals(attributeName)) {
                            if ((context.parsingOptions & 2) == 0) {
                        ...
                        if (visibleTypeAnnotationOffsets != null) {
                            for (int i12 = 0; i12 < visibleTypeAnnotationOffsets.length; i12++) {
                                int targetType = readByte(visibleTypeAnnotationOffsets[i12]);
                                if (targetType == 64 || targetType == 65) {
                                    int currentOffset11 = readTypeAnnotationTarget(context, visibleTypeAnnotationOffsets[i12]);
                        ...
                        if (invisibleTypeAnnotationOffsets != null) {
                            for (int i13 = 0; i13 < invisibleTypeAnnotationOffsets.length; i13++) {
                                int targetType2 = readByte(invisibleTypeAnnotationOffsets[i13]);
                                if (targetType2 == 64 || targetType2 == 65) {
                                    int currentOffset12 = readTypeAnnotationTarget(context, invisibleTypeAnnotationOffsets[i13]);
    ...
    private int readTypeAnnotationTarget(Context context, int typeAnnotationOffset) {
        ...
        switch (targetType2 >>> 24) {
            ...
            case 1:
            case 22:
                targetType = targetType2 & Opcodes.V_PREVIEW_EXPERIMENTAL;
    ...
    final String readUTF(int constantPoolEntryIndex, char[] charBuffer) {
        String value = (String) this.cpInfoValues[constantPoolEntryIndex];
        if (value != null) {
            return value;
        }
        int cpInfoOffset = this.cpInfoOffsets[constantPoolEntryIndex];
        String value2 = readUTF(cpInfoOffset + 2, readUnsignedShort(cpInfoOffset), charBuffer);
        this.cpInfoValues[constantPoolEntryIndex] = value2;
        return value2;
    }
    ...
    private ConstantDynamic readConstantDynamic(int constantPoolEntryIndex, char[] charBuffer) {
        ConstantDynamic constantDynamic = (ConstantDynamic) this.cpInfoValues[constantPoolEntryIndex];
        ...
        this.cpInfoValues[constantPoolEntryIndex] = constantDynamic2;
