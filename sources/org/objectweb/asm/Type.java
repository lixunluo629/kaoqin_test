...
/* JADX WARN: Classes with same name are omitted:
  asm-4.2.jar:org/objectweb/asm/Type.class
 */
/* loaded from: lombok-1.16.22.jar:org/objectweb/asm/Type.SCL.lombok */
public class Type {
    ...
    public static Type[] getArgumentTypes(String methodDescriptor) {
        ...
        while (methodDescriptor.charAt(currentOffset) != ')') {
            ...
            currentOffset++;
            if (methodDescriptor.charAt(i3) == 'L') {
                do {
                    i2 = currentOffset;
                    currentOffset++;
                } while (methodDescriptor.charAt(i2) != ';');
            }
            numArgumentTypes++;
        }
        ...
        while (methodDescriptor.charAt(currentOffset2) != ')') {
            ...
            int i4 = currentOffset2;
            currentOffset2++;
            if (methodDescriptor.charAt(i4) == 'L') {
                do {
                    i = currentOffset2;
                    currentOffset2++;
                } while (methodDescriptor.charAt(i) != ';');
            }
            int i5 = currentArgumentTypeIndex;
            currentArgumentTypeIndex++;
            argumentTypes[i5] = getType(methodDescriptor, currentArgumentTypeOffset, currentOffset2);
        }
    ...
    private static Type getType(String descriptorBuffer, int descriptorBegin, int descriptorEnd) {
    ...
    public Type getElementType() {
        ...
        return getType(this.valueBuffer, this.valueBegin + numDimensions, this.valueEnd);
    }
    ...
    public static String getConstructorDescriptor(Constructor<?> constructor) {
        ...
        for (Class<?> cls : parameters) {
            appendDescriptor(stringBuilder, cls);
        }
