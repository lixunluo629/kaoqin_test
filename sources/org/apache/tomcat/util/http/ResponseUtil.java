...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/ResponseUtil.class */
public class ResponseUtil {
    private static final String VARY_HEADER = "vary";
    private static final String VARY_ALL = "*";

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/ResponseUtil$Adapter.class */
    ...
    private static void addVaryFieldName(Adapter adapter, String name) {
        ...
        while (i$.hasNext()) {
            StringReader input = new StringReader(i$.next());
            try {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/ResponseUtil$HeaderAdapter.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/ResponseUtil$ResponseAdapter.class */
