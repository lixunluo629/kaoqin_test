...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/parser/MediaType.class */
public class MediaType {
    ...
    public static MediaType parseMediaType(StringReader input) throws IOException {
        ...
        SkipResult lookForSemiColon = HttpParser.skipConstant(input, ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
        ...
        while (lookForSemiColon == SkipResult.FOUND) {
            ...
            lookForSemiColon = HttpParser.skipConstant(input, ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
            if (lookForSemiColon == SkipResult.NOT_FOUND) {
                return null;
            }
        }
