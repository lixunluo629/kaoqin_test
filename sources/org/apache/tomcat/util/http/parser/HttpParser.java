...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/parser/HttpParser.class */
public class HttpParser {
    ...
    private static final boolean[] REQUEST_TARGET_ALLOW = new boolean[128];
    ...
    static {
        ...
        if (prop != null) {
            for (int i2 = 0; i2 < prop.length(); i2++) {
                char c = prop.charAt(i2);
                if (c == '{' || c == '}' || c == '|') {
    ...
    */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/parser/HttpParser$DomainParseState.class */
