...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/http/LegacyCookieProcessor.class */
public final class LegacyCookieProcessor extends CookieProcessorBase {
    ...
    public LegacyCookieProcessor() {
        ...
        char[] arr$2 = separators.toCharArray();
        for (char ch2 : arr$2) {
    ...
    public void parseCookieHeader(MimeHeaders headers, ServerCookies serverCookies) {
        ...
        int iFindHeader = headers.findHeader("Cookie", 0);
        while (true) {
            int pos = iFindHeader;
            if (pos >= 0) {
                ...
                iFindHeader = headers.findHeader("Cookie", pos + 1);
            } else {
                return;
            }
        }
