...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/security/ConcurrentMessageDigest.class */
public class ConcurrentMessageDigest {
    ...
    public static byte[] digest(String algorithm, int rounds, byte[]... input) throws NoSuchAlgorithmException {
