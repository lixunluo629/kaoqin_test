...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint.class */
public abstract class AbstractEndpoint<S> {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint$BindState.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint$Handler.class */
    public interface Handler<S> {

        /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint$Handler$SocketState.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint$Acceptor.class */
    public static abstract class Acceptor implements Runnable {
        protected volatile AcceptorState state = AcceptorState.NEW;
        private String threadName;

        /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/AbstractEndpoint$Acceptor$AcceptorState.class */
    ...
    public boolean setProperty(String name, String value) {
        ...
        try {
            ...
            getLog().error("Unable to set attribute \"" + name + "\" to \"" + value + SymbolConstants.QUOTES_SYMBOL, x);
            return false;
        }
    }
    ...
    protected void unlockAccept() {
        ...
        Acceptor[] arr$ = this.acceptors;
        for (Acceptor acceptor : arr$) {
        ...
        try {
            ...
            long waitLeft = 1000;
            Acceptor[] arr$2 = this.acceptors;
            for (Acceptor acceptor2 : arr$2) {
    ...
    public void init() throws Exception {
        ...
        if (this.domain != null) {
            this.oname = new ObjectName(this.domain + ":type=ThreadPool,name=\"" + getName() + SymbolConstants.QUOTES_SYMBOL);
            Registry.getRegistry(null, null).registerComponent(this, this.oname, (String) null);
            ObjectName socketPropertiesOname = new ObjectName(this.domain + ":type=ThreadPool,name=\"" + getName() + "\",subType=SocketProperties");
            ...
            for (SSLHostConfig sslHostConfig : arr$) {
                registerJmx(sslHostConfig);
            }
        }
    }
    ...
    protected final void startAcceptorThreads() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Thread t = new Thread(this.acceptors[i], threadName);
