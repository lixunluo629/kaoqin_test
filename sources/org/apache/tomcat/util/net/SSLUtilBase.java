...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/SSLUtilBase.class */
public abstract class SSLUtilBase implements SSLUtil {
            ...
            try {
                try {
                    ...
                    if ("DKS".equalsIgnoreCase(type)) {
                        ...
                        if ((!"PKCS11".equalsIgnoreCase(type) && !"".equalsIgnoreCase(path)) || org.apache.catalina.realm.Constants.NONE_TRANSPORT.equalsIgnoreCase(path)) {
    ...
    protected Collection<? extends CRL> getCRLs(String crlf) throws IOException, CertificateException, CRLException {
        try {
