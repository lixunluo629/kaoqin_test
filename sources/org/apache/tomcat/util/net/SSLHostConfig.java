...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/SSLHostConfig.class */
public class SSLHostConfig implements Serializable {
    ...
    private int sessionTimeout = DateUtil.SECONDS_PER_DAY;
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/SSLHostConfig$Type.class */
    public enum Type {
        JSSE,
        OPENSSL
    }
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/SSLHostConfig$CertificateVerification.class */
