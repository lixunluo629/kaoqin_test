...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector.class */
public class NioBlockingSelector {
    ...
    public void open(Selector selector) {
        ...
        StringBuilder sbAppend = new StringBuilder().append("NioBlockingSelector.BlockPoller-");
        int i = threadCounter + 1;
        threadCounter = i;
        blockPoller.setName(sbAppend.append(i).toString());
        this.poller.start();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x008b A[EXC_TOP_SPLITTER, PHI: r13
  0x008b: PHI (r13v2 'written' int) = (r13v1 'written' int), (r13v4 'written' int) binds: [B:15:0x005f, B:21:0x0080] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    /*
    ...
    */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller.class */
    protected static class BlockPoller extends Thread {
        ...
        /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableAdd.class */
        private class RunnableAdd implements Runnable {

            /* renamed from: ch, reason: collision with root package name */
            private final SocketChannel f10ch;
            ...
            public void run() {
                SelectionKey sk = this.f10ch.keyFor(BlockPoller.this.selector);
                try {
                    if (sk == null) {
                        sk = this.f10ch.register(BlockPoller.this.selector, this.ops, this.key);
                        this.ref.key = sk;
                    } else if (!sk.isValid()) {
        ...
        /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove.class */
        private class RunnableRemove implements Runnable {

            /* renamed from: ch, reason: collision with root package name */
            private final SocketChannel f11ch;
            private final NioEndpoint.NioSocketWrapper key;
            private final int ops;
            ...
            @Override // java.lang.Runnable
            public void run() {
                SelectionKey sk = this.f11ch.keyFor(BlockPoller.this.selector);
                try {
                    if (sk == null) {
                        if (4 == (this.ops & 4)) {
        ...
        /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableCancel.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/NioBlockingSelector$KeyReference.class */
