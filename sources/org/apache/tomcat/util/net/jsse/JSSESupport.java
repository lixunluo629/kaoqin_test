...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/net/jsse/JSSESupport.class */
public class JSSESupport implements SSLSupport, SSLSessionManager {
    ...
    @Override // org.apache.tomcat.util.net.SSLSupport
    public X509Certificate[] getPeerCertificateChain() throws IOException, CertificateException {
        if (this.session == null) {
            return null;
        }
        try {
