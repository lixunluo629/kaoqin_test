...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/descriptor/web/SecurityConstraint.class */
public class SecurityConstraint extends XmlEncodingBase implements Serializable {
    ...
    private String userConstraint = org.apache.catalina.realm.Constants.NONE_TRANSPORT;
    ...
    private boolean matchPattern(String path, String pattern) {
        ...
        if (pattern.startsWith("/") && pattern.endsWith(ScriptUtils.DEFAULT_BLOCK_COMMENT_START_DELIMITER)) {
