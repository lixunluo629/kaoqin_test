...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/descriptor/web/ContextResource.class */
public class ContextResource extends ResourceBase {
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * result) + (this.auth == null ? 0 : this.auth.hashCode()))) + (this.closeMethod == null ? 0 : this.closeMethod.hashCode()))) + (this.scope == null ? 0 : this.scope.hashCode()))) + (this.singleton ? MysqlErrorNumbers.ER_WRONG_VALUE_FOR_VAR : MysqlErrorNumbers.ER_SLAVE_IGNORED_TABLE);
    }
