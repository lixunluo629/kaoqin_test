...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/Diagnostics.class */
public class Diagnostics {
    ...
    private static String getThreadDumpHeader(ThreadInfo ti) {
        StringBuilder sb = new StringBuilder(SymbolConstants.QUOTES_SYMBOL + ti.getThreadName() + SymbolConstants.QUOTES_SYMBOL);
    ...
    private static String getThreadDump(ThreadInfo ti) {
        ...
        LockInfo[] arr$ = ti.getLockedSynchronizers();
        for (LockInfo li : arr$) {
    ...
    public static String getThreadDump(StringManager requestedSm) {
        ...
        if (vminfo != null) {
            sb.append(SymbolConstants.SPACE_SYMBOL + vminfo);
        }
        sb.append("):\r\n");
        sb.append("\r\n");
