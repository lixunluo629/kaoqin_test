...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/scan/StandardJarScanner.class */
public class StandardJarScanner implements JarScanner {
    ...
    private void processManifest(Jar jar, boolean isWebapp, Deque<URL> classPathUrlsToProcess) throws URISyntaxException, IOException {
        ...
        if (!isWebapp && classPathUrlsToProcess != null && (manifest = jar.getManifest()) != null) {
            ...
            String[] classPathEntries = classPathAttribute.split(SymbolConstants.SPACE_SYMBOL);
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/scan/StandardJarScanner$ClassPathEntry.class */
