...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/buf/UEncoder.class */
public final class UEncoder {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/buf/UEncoder$SafeCharsSet.class */
    public enum SafeCharsSet {
        ...
        SafeCharsSet(String additionalSafeChars) {
            char[] arr$ = additionalSafeChars.toCharArray();
            for (char c : arr$) {
