...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/buf/ByteChunk.class */
public final class ByteChunk extends AbstractChunk {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/buf/ByteChunk$ByteInputChannel.class */
    public interface ByteInputChannel {
        int realReadBytes() throws IOException;
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/buf/ByteChunk$ByteOutputChannel.class */
    ...
    public void flushBuffer() throws IOException {
        if (this.out == null) {
            throw new IOException("Buffer overflow, no sink " + getLimit() + SymbolConstants.SPACE_SYMBOL + this.buff.length);
        }
