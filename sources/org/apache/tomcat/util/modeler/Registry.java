...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/modeler/Registry.class */
public class Registry implements RegistryMBean, MBeanRegistration {
        ...
        for (ObjectName current : mbeans) {
            if (current != null) {
                try {
                    ...
                    log.info("Error initializing " + current + SymbolConstants.SPACE_SYMBOL + t.toString());
                }
            }
        }
    }
    ...
    public String getType(ObjectName oname, String attName) {
        try {
            MBeanInfo info = this.server.getMBeanInfo(oname);
    ...
    public Object convertValue(String type, String value) throws NumberFormatException {
        ...
        } else if ("java.lang.Integer".equals(type) || XmlErrorCodes.INT.equals(type)) {
            objValue = Integer.valueOf(value);
        } else if ("java.lang.Long".equals(type) || XmlErrorCodes.LONG.equals(type)) {
    ...
    public List<ObjectName> load(String sourceType, Object source, String param) throws Exception {
        ...
        if (source instanceof URL) {
            ...
            type = param;
            if (sourceType == null && location2.endsWith(".xml")) {
                sourceType = "MbeansDescriptorsDigesterSource";
            }
