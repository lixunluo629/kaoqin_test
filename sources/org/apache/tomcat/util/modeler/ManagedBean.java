...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/modeler/ManagedBean.class */
public class ManagedBean implements Serializable {
    ...
    Method getGetter(String aname, BaseModelMBean mbean, Object resource) throws AttributeNotFoundException, NoSuchMethodException, SecurityException, ReflectionException {
        Method m = null;
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.management.AttributeNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.management.ReflectionException */
    public Method getSetter(String aname, BaseModelMBean bean, Object resource) throws AttributeNotFoundException, NoSuchMethodException, SecurityException, ReflectionException {
        Method m = null;
        AttributeInfo attrInfo = this.attributes.get(aname);
        if (attrInfo == null) {
        ...
        if (exception != null) {
            throw new ReflectionException(exception, "Cannot find setter method " + setMethod + SymbolConstants.SPACE_SYMBOL + resource);
        }
        return m;
    }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.management.ReflectionException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.management.RuntimeOperationsException */
    public Method getInvoke(String aname, Object[] params, String[] signature, BaseModelMBean bean, Object resource) throws MBeanException, NoSuchMethodException, SecurityException, ReflectionException, RuntimeOperationsException {
        Method method = null;
        if (params == null) {
            params = new Object[0];
        }
    ...
    private String createOperationKey(OperationInfo operation) {
        ...
        key.append('(');
        StringUtils.join((Object[]) operation.getSignature(), ',', (StringUtils.Function) new StringUtils.Function<ParameterInfo>() { // from class: org.apache.tomcat.util.modeler.ManagedBean.1
