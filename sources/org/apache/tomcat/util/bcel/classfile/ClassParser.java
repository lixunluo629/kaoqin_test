...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/bcel/classfile/ClassParser.class */
public final class ClassParser {
    ...
    private void readAttributes() throws ClassFormatException, IOException {
        ...
        for (int i = 0; i < attributes_count; i++) {
            ...
            if (name.equals(AnnotationsAttribute.visibleTag)) {
