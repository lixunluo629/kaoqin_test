...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/digester/ObjectCreateRule.class */
public class ObjectCreateRule extends Rule {
    ...
    public void begin(String namespace, String name, Attributes attributes) throws Exception {
        ...
        if (realClassName == null) {
            throw new NullPointerException("No class name specified for " + namespace + SymbolConstants.SPACE_SYMBOL + name);
        }
