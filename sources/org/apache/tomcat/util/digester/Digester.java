...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/digester/Digester.class */
public class Digester extends DefaultHandler2 {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/tomcat/util/digester/Digester$SystemPropertySource.class */
    private class SystemPropertySource implements IntrospectionUtils.PropertySource {
        ...
        public String getProperty(String key) {
            Object classLoader = Digester.this.getClassLoader();
    ...
    private Attributes updateAttributes(Attributes list) {
        ...
        for (int i = 0; i < nAttributes; i++) {
            ...
            try {
                newAttrs.setValue(i, IntrospectionUtils.replaceProperties(value, null, this.source).intern());
            } catch (Exception e) {
