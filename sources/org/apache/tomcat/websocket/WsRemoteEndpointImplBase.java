...
/* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase.class */
public abstract class WsRemoteEndpointImplBase implements RemoteEndpoint {
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$State.class */
    private enum State {
        OPEN,
        STREAM_WRITING,
        WRITER_WRITING,
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$EndMessageHandler.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$IntermediateMessageHandler.class */
    ...
    public Future<Void> sendObjectByFuture(Object obj) throws IOException, EncodeException {
        FutureToSendHandler f2sh = new FutureToSendHandler(this.wsSession);
        sendObjectByCompletion(obj, f2sh);
        return f2sh;
    }

    public void sendObjectByCompletion(Object obj, SendHandler completion) throws IOException, EncodeException {
        if (obj == null) {
            throw new IllegalArgumentException(sm.getString("wsRemoteEndpoint.nullData"));
        }
        if (completion == null) {
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$TextMessageSendHandler.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$OutputBufferSendHandler.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$OutputBufferFlushSendHandler.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$WsOutputStream.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$WsWriter.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$EncoderEntry.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$StateMachine.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$StateUpdateSendHandler.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsRemoteEndpointImplBase$BlockingSendHandler.class */
