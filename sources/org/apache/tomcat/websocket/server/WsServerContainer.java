...
/* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/server/WsServerContainer.class */
public class WsServerContainer extends WsWebSocketContainer implements ServerContainer {
    ...
    WsServerContainer(ServletContext servletContext) {
        ...
        fr.addMappingForUrlPatterns(types, true, ScriptUtils.DEFAULT_BLOCK_COMMENT_START_DELIMITER);
    }
    ...
    public WsMappingResult findMapping(String path) {
        ...
        try {
            ...
            Iterator i$ = templateMatches.values().iterator();
            while (true) {
                if (!i$.hasNext()) {
                    break;
                }
                TemplatePathMatch templateMatch = i$.next();
    ...
    private static void validateEncoders(Class<? extends Encoder>[] encoders) throws IllegalAccessException, InstantiationException, IllegalArgumentException, DeploymentException, InvocationTargetException {
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/server/WsServerContainer$TemplatePathMatch.class */
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/server/WsServerContainer$ExactPathMatch.class */
