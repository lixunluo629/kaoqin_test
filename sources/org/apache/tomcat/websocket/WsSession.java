...
/* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsSession.class */
public class WsSession implements Session {
    ...
    /* loaded from: tomcat-embed-websocket-8.5.43.jar:org/apache/tomcat/websocket/WsSession$State.class */
    private enum State {
        OPEN,
        OUTPUT_CLOSED,
        CLOSED
    ...
    private void fireEndpointOnClose(CloseReason closeReason) {
        ...
        InstanceManager throwable2 = this.webSocketContainer.getInstanceManager();
        if (throwable2 == null) {
            throwable2 = InstanceManagerBindings.get(this.applicationClassLoader);
        }
        ...
        try {
            try {
                ...
                if (throwable2 != null) {
                    try {
                        throwable2.destroyInstance(this.localEndpoint);
                    } catch (Throwable t2) {
            ...
            if (throwable2 != null) {
                fireEndpointOnError(throwable2);
            }
        } finally {
            if (throwable2 != null) {
                try {
