...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/juli/logging/DirectJDKLog.class */
class DirectJDKLog implements Log {
    ...
    static {
        if (System.getProperty("java.util.logging.config.class") == null && System.getProperty("java.util.logging.config.file") == null) {
            try {
                Class.forName(SIMPLE_CFG).getConstructor(new Class[0]).newInstance(new Object[0]);
            } catch (Throwable th) {
            }
            try {
