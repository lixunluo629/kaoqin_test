...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer.class */
public final class BiffViewer {
    ...
    private static final POILogger logger = POILogFactory.getLogger((Class<?>) BiffViewer.class);
    private static final char[] COLUMN_SEPARATOR = " | ".toCharArray();

    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer$IBiffRecordListener.class */
    ...
    public static Record[] createRecords(InputStream is, PrintWriter ps, BiffRecordListener recListener, boolean dumpInterpretedRecords) throws RecordInputStream.LeftoverDataException, RecordFormatException {
        boolean hasNext;
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer$CommandArgs.class */
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer$CommandParseException.class */
    ...
    public static void main(String[] args) throws CommandParseException, IOException {
        PrintWriter pw;
    ...
    protected static InputStream getPOIFSInputStream(NPOIFSFileSystem fs) throws IOException {
        String workbookName = HSSFWorkbook.getWorkbookDirEntryName(fs.getRoot());
        return fs.createDocumentInputStream(workbookName);
    }

    protected static void runBiffViewer(PrintWriter pw, InputStream is, boolean dumpInterpretedRecords, boolean dumpHex, boolean zeroAlignHexDump, boolean suppressHeader) throws RecordInputStream.LeftoverDataException, RecordFormatException {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer$BiffRecordListener.class */
    private static final class BiffRecordListener implements IBiffRecordListener {
        ...
        public void processRecord(int globalOffset, int recordCounter, int sid, int dataSize, byte[] data) throws IOException {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/dev/BiffViewer$BiffDumpingStream.class */
    private static final class BiffDumpingStream extends InputStream {
        ...
        private void formatBufferIfAtEndOfRec() {
            ...
            int sid = LittleEndian.getShort(this._data, 0);
    ...
    static void hexDumpAligned(Writer w, byte[] data, int dumpLen, int globalOffset, boolean zeroAlignEachRecord) throws IOException {
        int startLineAddr;
        int endLineAddr;
    ...
    private static void hexDumpLine(Writer w, byte[] data, int lineStartAddress, int lineDataOffset, int startDelta, int endDelta) throws IOException {
        ...
        try {
            ...
            int idx = arraycopy(COLUMN_SEPARATOR, buf, 0 + 8);
            for (int i = 0; i < 16; i++) {
                if (i > 0) {
                    int i2 = idx;
                    idx++;
            ...
            int idx2 = arraycopy(COLUMN_SEPARATOR, buf, idx);
            for (int i3 = 0; i3 < 16; i3++) {
                char ch2 = ' ';
                if (i3 >= startDelta && i3 < endDelta) {
                    ch2 = getPrintableChar(data[lineDataOffset + i3]);
                }
                int i4 = idx2;
                idx2++;
                buf[i4] = ch2;
