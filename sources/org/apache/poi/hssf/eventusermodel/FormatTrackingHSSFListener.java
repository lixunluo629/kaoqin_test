...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/eventusermodel/FormatTrackingHSSFListener.class */
public class FormatTrackingHSSFListener implements HSSFListener {
    ...
    public int getFormatIndex(CellValueRecordInterface cell) {
        ...
        if (xfr == null) {
            logger.log(7, "Cell " + cell.getRow() + "," + ((int) cell.getColumn()) + " uses XF with index " + ((int) cell.getXFIndex()) + ", but we don't have that");
            return -1;
        }
