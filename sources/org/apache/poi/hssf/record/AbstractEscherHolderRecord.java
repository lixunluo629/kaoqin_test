...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/AbstractEscherHolderRecord.class */
public abstract class AbstractEscherHolderRecord extends Record implements Cloneable {
    ...
    public AbstractEscherHolderRecord(RecordInputStream in) throws RecordFormatException {
        if (!DESERIALISE) {
