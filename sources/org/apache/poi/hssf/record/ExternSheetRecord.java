...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/ExternSheetRecord.class */
public class ExternSheetRecord extends StandardRecord {
    public static final short sid = 23;
    private final List<RefSubRecord> _list = new ArrayList();

    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/ExternSheetRecord$RefSubRecord.class */
    ...
    public ExternSheetRecord(RecordInputStream in) throws RecordFormatException {
    ...
    public String toString() {
        ...
        sb.append("   numOfRefs     = ").append(nItems).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        for (int i = 0; i < nItems; i++) {
