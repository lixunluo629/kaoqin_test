...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/cf/PatternFormatting.class */
public final class PatternFormatting implements Cloneable {
    ...
    public String toString() {
        ...
        buffer.append("          .fillpattern= ").append(Integer.toHexString(getFillPattern())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .fgcoloridx= ").append(Integer.toHexString(getFillForegroundColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .bgcoloridx= ").append(Integer.toHexString(getFillBackgroundColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("    [/Pattern Formatting]\n");
