...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/cf/ColorGradientFormatting.class */
public final class ColorGradientFormatting implements Cloneable {
    ...
    public String toString() {
        ...
        buffer.append("          .clamp     = ").append(isClampToCurve()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .background= ").append(isAppliesToBackground()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
