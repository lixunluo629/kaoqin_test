...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/cf/BorderFormatting.class */
public final class BorderFormatting implements Cloneable {
    ...
    public String toString() {
        ...
        buffer.append("          .leftborder= ").append(Integer.toHexString(getLeftBorderColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .rghtborder= ").append(Integer.toHexString(getRightBorderColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .topborder= ").append(Integer.toHexString(getTopBorderColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .bottomborder= ").append(Integer.toHexString(getBottomBorderColor())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .fwdiag= ").append(isForwardDiagonalOn()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .bwdiag= ").append(isBackwardDiagonalOn()).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("    [/Border Formatting]\n");
        return buffer.toString();
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public BorderFormatting m3385clone() {
