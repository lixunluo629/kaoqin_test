...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/common/ExtendedColor.class */
public final class ExtendedColor implements Cloneable {
    ...
    public String toString() {
        ...
        buffer.append("          .type  = ").append(this.type).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .tint  = ").append(this.tint).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .c_idx = ").append(this.colorIndex).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .rgba  = ").append(HexDump.toHex(this.rgba)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("          .t_idx = ").append(this.themeIndex).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        buffer.append("    [/Extended Color]\n");
        return buffer.toString();
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public ExtendedColor m3412clone() {
