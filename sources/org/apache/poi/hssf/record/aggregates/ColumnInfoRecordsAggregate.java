...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/aggregates/ColumnInfoRecordsAggregate.class */
public final class ColumnInfoRecordsAggregate extends RecordAggregate implements Cloneable {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/aggregates/ColumnInfoRecordsAggregate$CIRComparator.class */
    ...
    public ColumnInfoRecordsAggregate(RecordStream rs) {
        ...
        while (true) {
            ColumnInfoRecord cirPrev = columnInfoRecord;
            if (rs.peekNextClass() != ColumnInfoRecord.class) {
                break;
            }
    ...
    public ColumnInfoRecordsAggregate m3380clone() {
