...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/SelectionRecord.class */
public final class SelectionRecord extends StandardRecord {
    ...
    public SelectionRecord(RecordInputStream in) throws RecordFormatException {
    ...
    public String toString() {
        ...
        sb.append("[SELECTION]\n");
        sb.append("    .pane            = ").append(HexDump.byteToHex(getPane())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .activecellrow   = ").append(HexDump.shortToHex(getActiveCellRow())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .activecellcol   = ").append(HexDump.shortToHex(getActiveCellCol())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .activecellref   = ").append(HexDump.shortToHex(getActiveCellRef())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .numrefs         = ").append(HexDump.shortToHex(this.field_6_refs.length)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("[/SELECTION]\n");
        return sb.toString();
    }
    ...
    public void serialize(LittleEndianOutput out) {
        ...
        for (CellRangeAddress8Bit field_6_ref : arr$) {
