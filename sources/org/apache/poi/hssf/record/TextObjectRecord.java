...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/TextObjectRecord.class */
public final class TextObjectRecord extends ContinuableRecord {
    ...
    public TextObjectRecord(RecordInputStream in) throws RecordFormatException {
        String text;
    ...
    private static String readRawString(RecordInputStream in, int textLength) throws RecordFormatException {
    ...
    private static void processFontRuns(RecordInputStream in, HSSFRichTextString str, int formattingRunDataLength) throws RecordFormatException {
    ...
    public String toString() {
        ...
        sb.append("[TXO]\n");
        sb.append("    .options        = ").append(HexDump.shortToHex(this.field_1_options)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        ...
        sb.append("    .textOrientation= ").append(HexDump.shortToHex(getTextOrientation())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .reserved4      = ").append(HexDump.shortToHex(this.field_3_reserved4)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .reserved5      = ").append(HexDump.shortToHex(this.field_4_reserved5)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .reserved6      = ").append(HexDump.shortToHex(this.field_5_reserved6)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .textLength     = ").append(HexDump.shortToHex(this._text.length())).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        sb.append("    .reserved7      = ").append(HexDump.intToHex(this.field_8_reserved7)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
