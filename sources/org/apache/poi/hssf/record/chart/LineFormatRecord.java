...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/record/chart/LineFormatRecord.class */
public final class LineFormatRecord extends StandardRecord implements Cloneable {
    ...
    public String toString() {
        ...
        buffer.append("    .linePattern          = ").append("0x").append(HexDump.toHex(getLinePattern())).append(" (").append((int) getLinePattern()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .weight               = ").append("0x").append(HexDump.toHex(getWeight())).append(" (").append((int) getWeight()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .format               = ").append("0x").append(HexDump.toHex(getFormat())).append(" (").append((int) getFormat()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append("    .colourPaletteIndex   = ").append("0x").append(HexDump.toHex(getColourPaletteIndex())).append(" (").append((int) getColourPaletteIndex()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("[/LINEFORMAT]\n");
