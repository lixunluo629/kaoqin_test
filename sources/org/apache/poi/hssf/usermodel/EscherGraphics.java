...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/usermodel/EscherGraphics.class */
public class EscherGraphics extends Graphics {
    ...
    public void drawString(String str, int x, int y) throws NumberFormatException {
        Font excelFont;
        ...
        int y2 = (int) (y - ((this.font.getSize() / this.verticalPixelsPerPoint) + (2.0f * this.verticalPixelsPerPoint)));
