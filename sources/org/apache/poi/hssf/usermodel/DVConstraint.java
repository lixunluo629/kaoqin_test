...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/usermodel/DVConstraint.class */
public class DVConstraint implements DataValidationConstraint {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/usermodel/DVConstraint$FormulaPair.class */
        ...
        switch (dvRecord.getDataType()) {
            ...
            case 3:
                if (dvRecord.getListExplicitFormula()) {
                    ...
                    if (values.startsWith(SymbolConstants.QUOTES_SYMBOL)) {
                        values = values.substring(1);
                    }
                    if (values.endsWith(SymbolConstants.QUOTES_SYMBOL)) {
                        values = values.substring(0, values.length() - 1);
                    }
                    String[] explicitListValues = values.split(Pattern.quote(ThumbnailParameter.DETERMINE_FORMAT));
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/usermodel/DVConstraint$FormulaValuePair.class */
