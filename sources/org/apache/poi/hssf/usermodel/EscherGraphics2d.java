...
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/usermodel/EscherGraphics2d.class */
public final class EscherGraphics2d extends Graphics2D {
    ...
    public void draw(Shape shape) {
        if (shape instanceof Line2D) {
            ...
            if (this._stroke != null && (this._stroke instanceof BasicStroke)) {
                width = ((int) this._stroke.getLineWidth()) * 12700;
            }
    ...
    public void drawString(String string, float x, float y) throws NumberFormatException {
        getEscherGraphics().drawString(string, (int) x, (int) y);
    }

    public void drawString(String string, int x, int y) throws NumberFormatException {
