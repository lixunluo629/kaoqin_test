...
@Internal
/* loaded from: poi-3.17.jar:org/apache/poi/hssf/model/InternalSheet.class */
public final class InternalSheet {
    ...
    private InternalSheet(RecordStream rs) {
        ...
        if (bof.getType() != 16 && bof.getType() != 32 && bof.getType() != 64) {
            while (rs.hasNext() && !(rs.getNext() instanceof EOFRecord)) {
            }
    ...
    private static void spillAggregate(RecordAggregate ra, final List<RecordBase> recs) {
        ra.visitContainedRecords(new RecordAggregate.RecordVisitor() { // from class: org.apache.poi.hssf.model.InternalSheet.1
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/model/InternalSheet$UnsupportedBOFType.class */
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/hssf/model/InternalSheet$RecordCloner.class */
    ...
    private InternalSheet() {
        ...
        records.add(windowTwoRecordCreateWindowTwo);
    ...
    public void setDimensions(int firstrow, short firstcol, int lastrow, short lastcol) {
        if (log.check(1)) {
            ...
            log.log(1, new StringBuffer("firstrow").append(firstrow).append("firstcol").append((int) firstcol).append("lastrow").append(lastrow).append("lastcol").append((int) lastcol).toString());
        }
    ...
    public void setSCLRecord(SCLRecord sclRecord) {
        ...
        if (oldRecordLoc == -1) {
            int windowRecordLoc = findFirstRecordLocBySid((short) 574);
    ...
    public int aggregateDrawingRecords(DrawingManager2 drawingManager, boolean createIfMissing) {
        ...
        if (noDrawingRecordsFound) {
            ...
            int loc2 = findFirstRecordLocBySid((short) 9876);
            if (loc2 == -1) {
                loc2 = findFirstRecordLocBySid((short) 574);
            } else {
