...
/* loaded from: poi-3.17.jar:org/apache/poi/sl/usermodel/PresetColor.class */
public enum PresetColor {
    ...
    Red(Integer.valueOf(Opcodes.V_PREVIEW_EXPERIMENTAL), 141, "red"),
    ...
    public static PresetColor valueOfNativeId(int nativeId) {
        ...
        if (0 >= nativeId || nativeId > vals.length) {
            return null;
        }
