...
/* loaded from: poi-3.17.jar:org/apache/poi/poifs/crypt/CipherAlgorithm.class */
public enum CipherAlgorithm {
    rc4(CipherProvider.rc4, "RC4", 26625, 64, new int[]{40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128}, -1, 20, "RC4", false),
    aes128(CipherProvider.aes, RSAUtils.AES_KEY_ALGORITHM, 26126, 128, new int[]{128}, 16, 32, RSAUtils.AES_KEY_ALGORITHM, false),
    aes192(CipherProvider.aes, RSAUtils.AES_KEY_ALGORITHM, 26127, 192, new int[]{192}, 16, 32, RSAUtils.AES_KEY_ALGORITHM, false),
    aes256(CipherProvider.aes, RSAUtils.AES_KEY_ALGORITHM, 26128, 256, new int[]{256}, 16, 32, RSAUtils.AES_KEY_ALGORITHM, false),
    ...
    rsa(null, RSAUtils.RSA_KEY_ALGORITHM, -1, 1024, new int[]{1024, 2048, 3072, 4096}, -1, -1, "", false);
