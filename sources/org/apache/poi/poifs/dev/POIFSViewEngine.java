...
/* loaded from: poi-3.17.jar:org/apache/poi/poifs/dev/POIFSViewEngine.class */
public class POIFSViewEngine {
        ...
        if (viewable instanceof POIFSViewable) {
            ...
            if (drilldown) {
                if (inspected.preferArray()) {
                    ...
                    for (Object obj : data) {
                        objects.addAll(inspectViewable(obj, drilldown, indentLevel + 1, indentString));
                    }
                } else {
    ...
    private static String indent(int indentLevel, String indentString, String data) throws IOException {
