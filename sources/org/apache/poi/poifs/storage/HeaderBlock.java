...
/* loaded from: poi-3.17.jar:org/apache/poi/poifs/storage/HeaderBlock.class */
public final class HeaderBlock implements HeaderBlockConstants {
    ...
    private HeaderBlock(byte[] data) throws IOException, CloneNotSupportedException {
    ...
    private static IOException alertShortRead(int pRead, int expectedReadSize) {
        ...
        String type = " byte" + (read == 1 ? "" : ExcelXmlConstants.CELL_DATA_FORMAT_TAG);
