...
/* loaded from: poi-ooxml-3.17.jar:org/apache/poi/xwpf/usermodel/XWPFRelation.class */
public final class XWPFRelation extends POIXMLRelation {
    ...
    public static final XWPFRelation IMAGE_PNG = new XWPFRelation("image/png", PackageRelationshipTypes.IMAGE_PART, "/word/media/image#.png", XWPFPictureData.class);
    ...
    public static final XWPFRelation IMAGE_GIF = new XWPFRelation("image/gif", PackageRelationshipTypes.IMAGE_PART, "/word/media/image#.gif", XWPFPictureData.class);
