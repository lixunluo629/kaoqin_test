...
/* loaded from: poi-3.17.jar:org/apache/poi/ss/formula/functions/Address.class */
public class Address implements Function {
    ...
    public ValueEval evaluate(ValueEval[] args, int srcRowIndex, int srcColumnIndex) throws EvaluationException {
        int refType;
        boolean pAbsRow;
        boolean pAbsCol;
        String sheetName;
