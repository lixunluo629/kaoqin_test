...
/* loaded from: poi-3.17.jar:org/apache/poi/ss/formula/atp/DateParser.class */
public class DateParser {
    private DateParser() {
    }

    public static Calendar parseDate(String strVal) throws NumberFormatException, EvaluationException {
