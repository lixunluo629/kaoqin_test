...
/* loaded from: poi-3.17.jar:org/apache/poi/ss/formula/eval/FunctionEval.class */
public final class FunctionEval {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/ss/formula/eval/FunctionEval$FunctionID.class */
    ...
    private static Function[] produceFunctions() {
        FunctionMetadata fm;
        Function[] retval = new Function[TokenId.OROR];
        retval[0] = new Count();
        retval[1] = new IfFunc();
