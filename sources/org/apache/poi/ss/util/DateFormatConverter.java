...
/* loaded from: poi-3.17.jar:org/apache/poi/ss/util/DateFormatConverter.class */
public class DateFormatConverter {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/ss/util/DateFormatConverter$DateFormatTokenizer.class */
        ...
        public String toString() {
            ...
            while (true) {
                ...
                if (token != null) {
                    ...
                    result.append(PropertyAccessor.PROPERTY_KEY_PREFIX).append(token).append("]");
                } else {
    ...
    private static Map<String, String> prepareTokenConversions() {
        ...
        result.put("EEE", "ddd");
        result.put("EE", "ddd");
        result.put("E", DateTokenConverter.CONVERTER_KEY);
        result.put("Z", "");
        result.put(CompressorStreamFactory.Z, "");
        result.put("a", "am/pm");
        result.put("A", "AM/PM");
        result.put("K", StandardRoles.H);
        result.put("KK", "HH");
        result.put("k", "h");
        result.put("kk", "hh");
        result.put("S", "0");
    ...
    private static Map<String, String> prepareLocalePrefixes() {
        ...
        result.put(InsertFromJNDIAction.AS_ATTR, "[$-44D]");
        ...
        result.put("hy", "[$-42B]");
        result.put("id", "[$-0421]");
        result.put(BeanUtil.PREFIX_GETTER_IS, "[$-40F]");
        ...
        result.put("zu", "[$-0435]");
        result.put(ArchiveStreamFactory.AR, "[$-0401]");
        result.put("bn", "[$-0845]");
        result.put("de", "[$-0407]");
        result.put("en", "[$-0409]");
        result.put("es", "[$-40A]");
    ...
    public static String convert(Locale locale, String format) {
        ...
        while (true) {
            ...
            if (token != null) {
                if (token.startsWith("'")) {
                    result.append(token.replaceAll("'", SymbolConstants.QUOTES_SYMBOL));
