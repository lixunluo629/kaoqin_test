...
/* loaded from: poi-3.17.jar:org/apache/poi/ss/util/MutableFPNumber.class */
final class MutableFPNumber {
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/ss/util/MutableFPNumber$Rounder.class */
    ...
    /* loaded from: poi-3.17.jar:org/apache/poi/ss/util/MutableFPNumber$TenPower.class */
    private static final class TenPower {
        private static final BigInteger FIVE = new BigInteger("5");
        private static final TenPower[] _cache = new TenPower[TokenId.NEQ];
