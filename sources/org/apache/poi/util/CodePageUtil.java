...
/* loaded from: poi-3.17.jar:org/apache/poi/util/CodePageUtil.class */
    ...
    public static String codepageToEncoding(int codepage, boolean javaLangFormat) throws UnsupportedEncodingException {
        ...
        switch (codepage) {
            ...
            case CP_SJIS /* 932 */:
                return "SJIS";
            case CP_GBK /* 936 */:
                return HttpUtils.URL_PARAM_DECODECHARSET_GBK;
            case CP_MS949 /* 949 */:
                return "ms949";
            case 1200:
                return "UTF-16LE";
