...
/* loaded from: poi-ooxml-3.17.jar:org/apache/poi/xssf/model/ThemesTable.class */
public class ThemesTable extends POIXMLDocumentPart {
    private IndexedColorMap colorMap;
    private ThemeDocument theme;

    /* loaded from: poi-ooxml-3.17.jar:org/apache/poi/xssf/model/ThemesTable$ThemeElement.class */
    public enum ThemeElement {
        ...
        public static ThemeElement byId(int idx) {
            return (idx >= values().length || idx < 0) ? UNKNOWN : values()[idx];
        }
