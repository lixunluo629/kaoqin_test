...
/* loaded from: poi-ooxml-3.17.jar:org/apache/poi/xdgf/util/VsdxToPng.class */
public class VsdxToPng {
    ...
    public static void renderToPngDir(XDGFPage page, File outDir, double scale, ShapeRenderer renderer) throws IOException {
        File pageFile = new File(outDir, TagUtils.SCOPE_PAGE + page.getPageNumber() + "-" + Util.sanitizeFilename(page.getName()) + ".png");
