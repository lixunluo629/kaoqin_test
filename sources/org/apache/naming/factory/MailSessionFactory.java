...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/naming/factory/MailSessionFactory.class */
            ...
            public Session run() {
                ...
                while (attrs.hasMoreElements()) {
                    ...
                    if (!Constants.FACTORY.equals(attr.getType())) {
                        if (NonRegisteringDriver.PASSWORD_PROPERTY_KEY.equals(attr.getType())) {
