...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/naming/NamingContext.class */
public class NamingContext implements Context {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    protected Object lookup(Name name, boolean resolveLinks) throws NamingException, NameNotFoundException {
        while (!name.isEmpty() && name.get(0).length() == 0) {
            name = name.getSuffix(1);
        }
        if (name.isEmpty()) {
