...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlLong.class */
public interface XmlLong extends XmlInteger {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlLong$Factory.class */
    public static final class Factory {
        ...
        public static XmlLong parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (XmlLong) XmlBeans.getContextTypeLoader().parse(xis, XmlLong.type, (XmlOptions) null);
        }

        public static XmlLong parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
