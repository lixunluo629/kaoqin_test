...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xmlconfig/JavaName.class */
public interface JavaName extends XmlToken {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xmlconfig/JavaName$Factory.class */
    public static final class Factory {
        ...
        public static JavaName parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (JavaName) XmlBeans.getContextTypeLoader().parse(xis, JavaName.type, (XmlOptions) null);
        }

        public static JavaName parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
