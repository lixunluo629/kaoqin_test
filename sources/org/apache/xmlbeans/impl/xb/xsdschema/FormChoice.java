...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/FormChoice.class */
public interface FormChoice extends XmlNMTOKEN {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/FormChoice$Enum.class */
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/FormChoice$Factory.class */
    public static final class Factory {
        ...
        public static FormChoice parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (FormChoice) XmlBeans.getContextTypeLoader().parse(xis, FormChoice.type, (XmlOptions) null);
        }

        public static FormChoice parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
