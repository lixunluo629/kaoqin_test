...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TotalDigitsDocument.class */
public interface TotalDigitsDocument extends XmlObject {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TotalDigitsDocument$TotalDigits.class */
    public interface TotalDigits extends NumFacet {
        ...
        /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TotalDigitsDocument$TotalDigits$Factory.class */
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TotalDigitsDocument$Factory.class */
    public static final class Factory {
        ...
        public static TotalDigitsDocument parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (TotalDigitsDocument) XmlBeans.getContextTypeLoader().parse(xis, TotalDigitsDocument.type, (XmlOptions) null);
        }

        public static TotalDigitsDocument parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
