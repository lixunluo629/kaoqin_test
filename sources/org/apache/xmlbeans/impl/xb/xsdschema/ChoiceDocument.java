...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/ChoiceDocument.class */
public interface ChoiceDocument extends XmlObject {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/ChoiceDocument$Factory.class */
    public static final class Factory {
        ...
        public static ChoiceDocument parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (ChoiceDocument) XmlBeans.getContextTypeLoader().parse(xis, ChoiceDocument.type, (XmlOptions) null);
        }

        public static ChoiceDocument parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
