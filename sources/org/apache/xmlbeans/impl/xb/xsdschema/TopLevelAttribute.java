...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TopLevelAttribute.class */
public interface TopLevelAttribute extends Attribute {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/xb/xsdschema/TopLevelAttribute$Factory.class */
    public static final class Factory {
        ...
        public static TopLevelAttribute parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (TopLevelAttribute) XmlBeans.getContextTypeLoader().parse(xis, TopLevelAttribute.type, (XmlOptions) null);
        }

        public static TopLevelAttribute parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
