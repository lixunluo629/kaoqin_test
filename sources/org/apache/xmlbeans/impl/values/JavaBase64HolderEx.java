...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/values/JavaBase64HolderEx.class */
public abstract class JavaBase64HolderEx extends JavaBase64Holder {
    ...
    public static void validateValue(byte[] v, SchemaType sType, ValidationContext context) {
        ...
        if (o != null && (i3 = ((XmlObjectBase) o).bigIntegerValue().intValue()) != v.length) {
            context.invalid(XmlErrorCodes.DATATYPE_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(v.length), new Integer(i3), QNameHelper.readable(sType)});
        }
        XmlObject o2 = sType.getFacet(1);
        if (o2 != null && (i2 = ((XmlObjectBase) o2).bigIntegerValue().intValue()) > v.length) {
            context.invalid(XmlErrorCodes.DATATYPE_MIN_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(v.length), new Integer(i2), QNameHelper.readable(sType)});
        }
        XmlObject o3 = sType.getFacet(2);
        if (o3 != null && (i = ((XmlObjectBase) o3).bigIntegerValue().intValue()) < v.length) {
            context.invalid(XmlErrorCodes.DATATYPE_MAX_LENGTH_VALID$BINARY, new Object[]{XmlErrorCodes.BASE64BINARY, new Integer(v.length), new Integer(i), QNameHelper.readable(sType)});
        }
