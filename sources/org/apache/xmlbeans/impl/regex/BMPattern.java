...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/regex/BMPattern.class */
public class BMPattern {
    ...
    public int matches(CharacterIterator iterator, int start, int limit) {
        ...
        while (index <= limit) {
            ...
            do {
                index--;
                ch2 = iterator.setIndex(index);
                pindex--;
                if (ch2 != this.pattern[pindex]) {
                    break;
                }
                if (pindex == 0) {
                    return index;
            ...
            index += this.shiftTable[ch2 % this.shiftTable.length] + 1;
            if (index < nindex) {
                index = nindex;
            }
        }
