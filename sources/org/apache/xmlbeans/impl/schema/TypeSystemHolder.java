...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/schema/TypeSystemHolder.template */
    ...
    private static final SchemaTypeSystem loadTypeSystem() throws Throwable {
        ...
        try {
            if (class$org$apache$xmlbeans$impl$schema$TypeSystemHolder == null) {
                clsClass$ = class$("org.apache.xmlbeans.impl.schema.TypeSystemHolder");
                class$org$apache$xmlbeans$impl$schema$TypeSystemHolder = clsClass$;
            } else {
                clsClass$ = class$org$apache$xmlbeans$impl$schema$TypeSystemHolder;
            }
            ...
            if (class$org$apache$xmlbeans$impl$schema$TypeSystemHolder == null) {
                clsClass$3 = class$("org.apache.xmlbeans.impl.schema.TypeSystemHolder");
                class$org$apache$xmlbeans$impl$schema$TypeSystemHolder = clsClass$3;
            } else {
                clsClass$3 = class$org$apache$xmlbeans$impl$schema$TypeSystemHolder;
            }
            objArr[0] = clsClass$3;
