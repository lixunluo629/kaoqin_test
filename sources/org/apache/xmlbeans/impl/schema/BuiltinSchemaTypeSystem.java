...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem.class */
public class BuiltinSchemaTypeSystem extends SchemaTypeLoaderBase implements SchemaTypeSystem {
    ...
    static {
        $assertionsDisabled = !BuiltinSchemaTypeSystem.class.desiredAssertionStatus();
        ...
        _global = new BuiltinSchemaTypeSystem();
    ...
    private BuiltinSchemaTypeSystem() {
        ...
        setupBuiltin(12, StringProperty.TYPE, "org.apache.xmlbeans.XmlString");
        setupBuiltin(13, XmlErrorCodes.DURATION, "org.apache.xmlbeans.XmlDuration");
        ...
        setupBuiltin(39, PdfConst.Language, "org.apache.xmlbeans.XmlLanguage");
