...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/tool/XMLBean.class */
public class XMLBean extends MatchingTask {
    ...
    public void execute() throws BuildException {
        ...
        if (this.schema != null) {
            if (this.schema.isDirectory()) {
                ...
                processPaths(new String[]{this.schema.getName()}, theBasedir);
            }
        }
        ...
        while (si.hasNext()) {
            ...
            DirectoryScanner directoryScanner2 = fs.getDirectoryScanner(this.project);
            File basedir = directoryScanner2.getBasedir();
            processPaths(directoryScanner2.getIncludedFiles(), basedir);
        }
        ...
        try {
            ...
            if (success && !this.srconly) {
                ...
                if (!this.quiet) {
                    log("Time to compile code: " + ((finish - start) / 1000.0d) + " seconds");
                }
            ...
            log("Exception while building schemas: " + e2.getMessage(), 0);
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/tool/XMLBean$ErrorLogger.class */
