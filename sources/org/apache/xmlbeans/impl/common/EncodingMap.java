...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/impl/common/EncodingMap.class */
public class EncodingMap {
    ...
    static {
        ...
        addMapping(NTLM.DEFAULT_CHARSET, "ANSI_X3.4-1986", false);
        addMapping(NTLM.DEFAULT_CHARSET, NTLM.DEFAULT_CHARSET, true);
        addMapping(NTLM.DEFAULT_CHARSET, "CP367", false);
        addMapping(NTLM.DEFAULT_CHARSET, "CSASCII", false);
        addMapping(NTLM.DEFAULT_CHARSET, "IBM-367", false);
        addMapping(NTLM.DEFAULT_CHARSET, "IBM367", false);
        addMapping(NTLM.DEFAULT_CHARSET, "ISO-IR-6", false);
        addMapping(NTLM.DEFAULT_CHARSET, "ISO646-US", false);
        addMapping(NTLM.DEFAULT_CHARSET, "ISO_646.IRV:1991", false);
        addMapping(NTLM.DEFAULT_CHARSET, "US", false);
        addMapping(NTLM.DEFAULT_CHARSET, "US-ASCII", false);
        ...
        addMapping("CP936", HttpUtils.URL_PARAM_DECODECHARSET_GBK, true);
        ...
        if (!$assertionsDisabled && !completeMappings()) {
    ...
    private static final void addMapping(String java, String iana, boolean isDefault) {
        if (!$assertionsDisabled && _iana_to_java.containsKey(iana)) {
            throw new AssertionError();
        }
        if (!$assertionsDisabled && !java.toUpperCase().equals(java)) {
            throw new AssertionError();
        }
        if (!$assertionsDisabled && !iana.toUpperCase().equals(iana)) {
            throw new AssertionError();
        }
        _iana_to_java.put(iana, java);
        if (isDefault) {
            if (!$assertionsDisabled && _java_to_iana.containsKey(java)) {
                throw new AssertionError();
            }
    ...
    private static final boolean completeMappings() {
        ...
        for (Object k : m.keySet()) {
            if (!$assertionsDisabled && !_java_to_iana.containsKey(k)) {
