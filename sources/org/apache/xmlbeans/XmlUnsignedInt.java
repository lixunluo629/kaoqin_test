...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlUnsignedInt.class */
public interface XmlUnsignedInt extends XmlUnsignedLong {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlUnsignedInt$Factory.class */
    public static final class Factory {
        ...
        public static XmlUnsignedInt parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (XmlUnsignedInt) XmlBeans.getContextTypeLoader().parse(xis, XmlUnsignedInt.type, (XmlOptions) null);
        }

        public static XmlUnsignedInt parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
