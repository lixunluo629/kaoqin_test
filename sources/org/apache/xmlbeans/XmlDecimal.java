...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlDecimal.class */
public interface XmlDecimal extends XmlAnySimpleType {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlDecimal$Factory.class */
    public static final class Factory {
        ...
        public static XmlDecimal parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (XmlDecimal) XmlBeans.getContextTypeLoader().parse(xis, XmlDecimal.type, (XmlOptions) null);
        }

        public static XmlDecimal parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
