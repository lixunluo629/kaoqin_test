...
/* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlDateTime.class */
public interface XmlDateTime extends XmlAnySimpleType {
    ...
    /* loaded from: xmlbeans-3.1.0.jar:org/apache/xmlbeans/XmlDateTime$Factory.class */
    public static final class Factory {
        ...
        public static XmlDateTime parse(XMLInputStream xis) throws XMLStreamException, XmlException {
            return (XmlDateTime) XmlBeans.getContextTypeLoader().parse(xis, XmlDateTime.type, (XmlOptions) null);
        }

        public static XmlDateTime parse(XMLInputStream xis, XmlOptions options) throws XMLStreamException, XmlException {
