...
/* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/binary/BaseNCodec.class */
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    /* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/binary/BaseNCodec$Context.class */
    ...
    public boolean isInAlphabet(byte[] arrayOctet, boolean allowWSPad) {
        for (int i = 0; i < arrayOctet.length; i++) {
            if (!isInAlphabet(arrayOctet[i])) {
                ...
                if (arrayOctet[i] != this.pad && !isWhiteSpace(arrayOctet[i])) {
                    return false;
                }
            }
        }
