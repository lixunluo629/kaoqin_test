...
/* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/language/bm/PhoneticEngine.class */
public class PhoneticEngine {
    ...
    /* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/language/bm/PhoneticEngine$PhonemeBuilder.class */
    ...
    /* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/language/bm/PhoneticEngine$RulesApplication.class */
    ...
    public String encode(String input, Languages.LanguageSet languageSet) {
        ...
        Map<String, List<Rule>> finalRules1 = Rule.getInstanceMap(this.nameType, this.ruleType, Constants.AccessLog.COMMON_ALIAS);
        ...
        if (this.nameType == NameType.GENERIC) {
            ...
            for (String l : NAME_PREFIXES.get(this.nameType)) {
                if (input3.startsWith(l + SymbolConstants.SPACE_SYMBOL)) {
        ...
        if (this.concat) {
            input2 = join(words2, SymbolConstants.SPACE_SYMBOL);
