...
/* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/language/DoubleMetaphone.class */
public class DoubleMetaphone implements StringEncoder {
    private static final String VOWELS = "AEIOUY";
    private static final String[] SILENT_START = {"GN", "KN", "PN", "WR", "PS"};
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {StandardRoles.L, "R", "N", "M", "B", StandardRoles.H, "F", "V", "W", SymbolConstants.SPACE_SYMBOL};
    private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = {"ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER"};
    private static final String[] L_T_K_S_N_M_B_Z = {StandardRoles.L, "T", "K", "S", "N", "M", "B", "Z"};
    ...
    private int handleCC(String value, DoubleMetaphoneResult result, int index) {
        int index2;
        if (contains(value, index + 2, 1, "I", "E", StandardRoles.H) && !contains(value, index + 2, 2, "HU")) {
    ...
    private int handleG(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if (charAt(value, index + 1) == 'H') {
            ...
            index2 = index + 2;
        } else if (contains(value, index + 1, 2, StandardRoles.LI) && !slavoGermanic) {
            result.append("KL", StandardRoles.L);
            index2 = index + 2;
    ...
    private int handleGH(String value, DoubleMetaphoneResult result, int index) {
        ...
        if (index > 0 && !isVowel(charAt(value, index - 1))) {
            ...
            index2 = index + 2;
        } else if ((index > 1 && contains(value, index - 2, 1, "B", StandardRoles.H, "D")) || ((index > 2 && contains(value, index - 3, 1, "B", StandardRoles.H, "D")) || (index > 3 && contains(value, index - 4, 1, "B", StandardRoles.H)))) {
            index2 = index + 2;
        } else {
            if (index > 2 && charAt(value, index - 1) == 'U' && contains(value, index - 3, 1, "C", "G", StandardRoles.L, "R", "T")) {
                result.append('F');
    ...
    private int handleJ(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if (contains(value, index, 4, "JOSE") || contains(value, 0, 4, "SAN ")) {
            ...
            if (index == 0 && !contains(value, index, 4, "JOSE")) {
                ...
                result.append('J', ' ');
            } else if (!contains(value, index + 1, 1, L_T_K_S_N_M_B_Z) && !contains(value, index - 1, 1, "S", "K", StandardRoles.L)) {
                result.append('J');
            }
    ...
    private int handleS(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if (contains(value, index - 1, 3, "ISL", "YSL")) {
            ...
            index2 = index + 3;
        } else if ((index == 0 && contains(value, index + 1, 1, "M", "N", StandardRoles.L, "W")) || contains(value, index + 1, 1, "Z")) {
            result.append('S', 'X');
    ...
    private int handleT(String value, DoubleMetaphoneResult result, int index) {
        ...
        if (contains(value, index, 4, "TION") || contains(value, index, 3, "TIA", "TCH")) {
            result.append('X');
            index2 = index + 3;
        } else if (contains(value, index, 2, StandardRoles.TH) || contains(value, index, 3, "TTH")) {
    ...
    /* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/language/DoubleMetaphone$DoubleMetaphoneResult.class */
