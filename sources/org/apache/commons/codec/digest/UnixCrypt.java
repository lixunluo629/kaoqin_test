...
/* loaded from: commons-codec-1.10.jar:org/apache/commons/codec/digest/UnixCrypt.class */
public class UnixCrypt {
    ...
    private static int[] desSetKey(byte[] key) {
        ...
        for (int i4 = 0; i4 < 16; i4++) {
            ...
            int s2 = (s >>> 16) | (t & Opcodes.V_PREVIEW_EXPERIMENTAL);
            j = j2 + 1;
