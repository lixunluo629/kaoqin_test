...
/* loaded from: commons-httpclient-3.1.jar:org/apache/commons/httpclient/NTCredentials.class */
public class NTCredentials extends UsernamePasswordCredentials {
    ...
    public int hashCode() {
        ...
        return LangUtils.hashCode(LangUtils.hashCode(hash, this.host), this.domain);
    }
