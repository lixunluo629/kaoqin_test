...
/* loaded from: commons-httpclient-3.1.jar:org/apache/commons/httpclient/HttpURL.class */
public class HttpURL extends URI {
    ...
    public void setRawUserinfo(char[] escapedUser, char[] escapedPassword) throws URIException {
        ...
        String userinfo = new StringBuffer().append(username).append(password == null ? "" : new StringBuffer().append(":").append(password).toString()).toString();
        String hostname = new String(getRawHost());
        String hostport = this._port == -1 ? hostname : new StringBuffer().append(hostname).append(":").append(this._port).toString();
        String authority = new StringBuffer().append(userinfo).append("@").append(hostport).toString();
