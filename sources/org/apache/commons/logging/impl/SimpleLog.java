...
/* JADX WARN: Classes with same name are omitted:
  commons-logging-1.0.4.jar:org/apache/commons/logging/impl/SimpleLog.class
 */
/* loaded from: jcl-over-slf4j-1.7.26.jar:org/apache/commons/logging/impl/SimpleLog.class */
public class SimpleLog implements Log, Serializable {
    ...
    public SimpleLog(String name) {
        ...
        int iLastIndexOf = String.valueOf(name).lastIndexOf(".");
        while (true) {
            int i = iLastIndexOf;
            if (null != lvl || i <= -1) {
                break;
            ...
            iLastIndexOf = String.valueOf(name).lastIndexOf(".");
        }
        ...
        if (Protocol.CLUSTER_INFO.equalsIgnoreCase(lvl)) {
            setLevel(3);
            return;
        }
        ...
        if (AsmRelationshipUtils.DECLARE_ERROR.equalsIgnoreCase(lvl)) {
            setLevel(5);
        } else if ("fatal".equalsIgnoreCase(lvl)) {
            setLevel(6);
        } else if (CustomBooleanEditor.VALUE_OFF.equalsIgnoreCase(lvl)) {
            setLevel(7);
        }
    }
    ...
    private static InputStream getResourceAsStream(final String name) {
        return (InputStream) AccessController.doPrivileged(new PrivilegedAction<InputStream>() { // from class: org.apache.commons.logging.impl.SimpleLog.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.security.PrivilegedAction
            public InputStream run() throws NoSuchMethodException, SecurityException {
