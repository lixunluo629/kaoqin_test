...
/* loaded from: commons-lang-2.6.jar:org/apache/commons/lang/time/DurationFormatUtils.class */
public class DurationFormatUtils {
    public static final String ISO_EXTENDED_FORMAT_PATTERN = "'P'yyyy'Y'M'M'd'DT'H'H'm'M's.S'S'";
    static final Object y = "y";
    static final Object M = "M";
    static final Object d = DateTokenConverter.CONVERTER_KEY;
    static final Object H = StandardRoles.H;
    static final Object m = ANSIConstants.ESC_END;
    static final Object s = ExcelXmlConstants.CELL_DATA_FORMAT_TAG;
    ...
    public static String formatDurationWords(long durationMillis, boolean suppressLeadingZeroElements, boolean suppressTrailingZeroElements) {
        ...
        if (suppressLeadingZeroElements) {
            duration = new StringBuffer().append(SymbolConstants.SPACE_SYMBOL).append(duration).toString();
        ...
        return StringUtils.replaceOnce(StringUtils.replaceOnce(StringUtils.replaceOnce(StringUtils.replaceOnce(new StringBuffer().append(SymbolConstants.SPACE_SYMBOL).append(duration).toString(), " 1 seconds", " 1 second"), " 1 minutes", " 1 minute"), " 1 hours", " 1 hour"), " 1 days", " 1 day").trim();
    }
    ...
    /* loaded from: commons-lang-2.6.jar:org/apache/commons/lang/time/DurationFormatUtils$Token.class */
    static class Token {
