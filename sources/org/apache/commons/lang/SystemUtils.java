...
/* loaded from: commons-lang-2.6.jar:org/apache/commons/lang/SystemUtils.class */
public class SystemUtils {
    ...
    static {
        ...
        IS_JAVA_1_2 = getJavaVersionMatches(Constants.RUNTIME_LEVEL_12);
        ...
        IS_OS_AIX = getOSMatchesName(OperatingSystem.NAME_AIX);
        IS_OS_HP_UX = getOSMatchesName("HP-UX");
        IS_OS_IRIX = getOSMatchesName("Irix");
        IS_OS_LINUX = getOSMatchesName(OperatingSystem.NAME_LINUX) || getOSMatchesName("LINUX");
        IS_OS_MAC = getOSMatchesName("Mac");
        IS_OS_MAC_OSX = getOSMatchesName("Mac OS X");
        IS_OS_OS2 = getOSMatchesName("OS/2");
        IS_OS_SOLARIS = getOSMatchesName(OperatingSystem.NAME_SOLARIS);
    ...
    private static String getJavaVersionTrimmed() {
        if (JAVA_VERSION != null) {
            for (int i = 0; i < JAVA_VERSION.length(); i++) {
                char ch2 = JAVA_VERSION.charAt(i);
                if (ch2 >= '0' && ch2 <= '9') {
