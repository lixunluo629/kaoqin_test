...
/* loaded from: commons-compress-1.19.jar:org/apache/commons/compress/compressors/CompressorStreamFactory.class */
public class CompressorStreamFactory implements CompressorStreamProvider {
    ...
    public static String detect(InputStream in) throws CompressorException, IOException {
        if (in == null) {
