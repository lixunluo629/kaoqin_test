...
/* loaded from: commons-compress-1.19.jar:org/apache/commons/compress/archivers/cpio/CpioArchiveEntry.class */
public class CpioArchiveEntry implements CpioConstants, ArchiveEntry {
    ...
    public long getMode() {
        return (this.mode != 0 || CpioConstants.CPIO_TRAILER.equals(this.name)) ? this.mode : Constants.RET_INST;
    }
    ...
    public boolean isPipe() {
        return CpioUtil.fileType(this.mode) == Constants.NEGATABLE;
    }

    public boolean isRegularFile() {
        return CpioUtil.fileType(this.mode) == Constants.RET_INST;
    }
