...
/* loaded from: commons-compress-1.19.jar:org/apache/commons/compress/archivers/sevenz/SevenZArchiveEntry.class */
public class SevenZArchiveEntry implements ArchiveEntry {
    ...
    public static Date ntfsTimeToJavaTime(long ntfsTime) {
        ...
        ntfsEpoch.set(MysqlErrorNumbers.ER_SR_INVALID_CREATION_CTX, 0, 1, 0, 0, 0);
        ntfsEpoch.set(14, 0);
        long realTime = ntfsEpoch.getTimeInMillis() + (ntfsTime / 10000);
