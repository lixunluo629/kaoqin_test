...
/* loaded from: commons-compress-1.19.jar:org/apache/commons/compress/archivers/dump/DumpArchiveSummary.class */
public class DumpArchiveSummary {
    ...
    DumpArchiveSummary(byte[] buffer, ZipEncoding encoding) throws IOException {
        ...
        this.filesys = DumpArchiveUtil.decode(encoding, buffer, IptcDirectory.TAG_JOB_ID, 64).trim();
        ...
        this.firstrec = DumpArchiveUtil.convert32(buffer, EscherProperties.CALLOUT__CALLOUTMINUSX);
        this.ntrec = DumpArchiveUtil.convert32(buffer, EscherProperties.GROUPSHAPE__SHAPENAME);
    }
