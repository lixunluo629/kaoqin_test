...
/* loaded from: commons-io-2.18.0.jar:org/apache/commons/io/IOUtils.class */
public class IOUtils {
    ...
    public static long copy(URL url, File file) throws IOException {
        ...
        try {
            long jCopy = copy(url, outputStream);
    ...
    public static long copy(URL url, OutputStream outputStream) throws IOException {
        InputStream inputStream = ((URL) Objects.requireNonNull(url, RtspHeaders.Values.URL)).openStream();
        try {
    ...
    public static int read(InputStream input, byte[] buffer, int offset, int length) throws IOException {
        ...
        return read((IOTriFunction<byte[], Integer, Integer, Integer>) (v1, v2, v3) -> {
    ...
    static int read(IOTriFunction<byte[], Integer, Integer, Integer> input, byte[] buffer, int offset, int length) throws IOException {
        ...
        while (true) {
            ...
            int count = input.apply(buffer, Integer.valueOf(offset + location), Integer.valueOf(remaining)).intValue();
            if (-1 == count) {
                break;
            }
            i = remaining - count;
    ...
    public static byte[] toByteArray(InputStream input, int size) throws IOException {
        ...
        return toByteArray((IOTriFunction<byte[], Integer, Integer, Integer>) (v1, v2, v3) -> {
            return r0.read(v1, v2, v3);
        }, size);
    }
    ...
    static byte[] toByteArray(IOTriFunction<byte[], Integer, Integer, Integer> input, int size) throws IOException {
        ...
        while (true) {
            offset = i;
            if (offset >= size || (read = input.apply(data, Integer.valueOf(offset), Integer.valueOf(size - offset)).intValue()) == -1) {
                break;
            }
            i = offset + read;
        }
    ...
    public static String toString(IOSupplier<InputStream> input, Charset charset, IOSupplier<String> defaultString) throws IOException {
        ...
        try {
            String string = inputStream != null ? toString(inputStream, charset) : defaultString.get();
            if (inputStream != null) {
                inputStream.close();
            }
            return string;
