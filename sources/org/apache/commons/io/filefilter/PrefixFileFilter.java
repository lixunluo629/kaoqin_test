...
/* loaded from: commons-io-2.18.0.jar:org/apache/commons/io/filefilter/PrefixFileFilter.class */
public class PrefixFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public FileVisitResult accept(Path file, BasicFileAttributes attributes) {
        return toFileVisitResult(accept((File) PathUtils.getFileName(file, (v0) -> {
            return v0.toFile();
        })));
    }

    private boolean accept(String name) {
        return Stream.of((Object[]) this.prefixes).anyMatch(prefix -> {
