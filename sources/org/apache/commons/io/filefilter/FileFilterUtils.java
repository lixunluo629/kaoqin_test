...
/* loaded from: commons-io-2.18.0.jar:org/apache/commons/io/filefilter/FileFilterUtils.class */
public class FileFilterUtils {
    ...
    private static <R, A> R filterFiles(IOFileFilter iOFileFilter, Stream<File> stream, Collector<? super File, A, R> collector) {
        ...
        return (R) stream.filter(iOFileFilter::accept).collect(collector);
    }
    ...
    public static List<IOFileFilter> toList(IOFileFilter... filters) {
        return (List) Stream.of((Object[]) Objects.requireNonNull(filters, "filters")).map((v0) -> {
