...
/* loaded from: commons-io-2.18.0.jar:org/apache/commons/io/file/FilesUncheck.class */
public final class FilesUncheck {
    public static long copy(InputStream in, Path target, CopyOption... options) {
        return ((Long) Uncheck.apply(Files::copy, in, target, options)).longValue();
    }

    public static long copy(Path source, OutputStream out) {
        return ((Long) Uncheck.apply(Files::copy, source, out)).longValue();
    }
    ...
    public static void delete(Path path) {
        Uncheck.accept((IOConsumer<Path>) Files::delete, path);
    }
