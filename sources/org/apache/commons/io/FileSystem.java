...
/* loaded from: commons-io-2.18.0.jar:org/apache/commons/io/FileSystem.class */
public enum FileSystem {
    ...
    private static final boolean IS_OS_LINUX = getOsMatchesName(OperatingSystem.NAME_LINUX);
    ...
    public String toLegalFileName(String candidate, char replacement) {
        ...
        int[] array = truncated.chars().map(i -> {
