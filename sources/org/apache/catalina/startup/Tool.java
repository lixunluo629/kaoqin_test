...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/startup/Tool.class */
public final class Tool {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (shared) {
                unpacked.add(new File(catalinaHome, SimpleCache.IMPL_NAME + File.separator + "classes"));
                packed.add(new File(catalinaHome, SimpleCache.IMPL_NAME + File.separator + "lib"));
            }
