...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/startup/WebAnnotationSet.class */
public class WebAnnotationSet {
    ...
    protected static void loadClassAnnotation(Context context, Class<?> clazz) {
        ...
        if (resourcesAnnotation != null && resourcesAnnotation.value() != null) {
            Resource[] arr$ = resourcesAnnotation.value();
        ...
        if (declareRolesAnnotation != null && declareRolesAnnotation.value() != null) {
            String[] arr$2 = declareRolesAnnotation.value();
            for (String role : arr$2) {
    ...
    protected static void addResource(Context context, Resource annotation, String defaultName, Class<?> defaultType) {
        ...
        if (type.equals("javax.sql.DataSource") || type.equals("javax.jms.ConnectionFactory") || type.equals("javax.jms.QueueConnectionFactory") || type.equals("javax.jms.TopicConnectionFactory") || type.equals("javax.mail.Session") || type.equals("java.net.URL") || type.equals("javax.resource.cci.ConnectionFactory") || type.equals("org.omg.CORBA_2_3.ORB") || type.endsWith("ConnectionFactory")) {
            ...
            if (annotation.authenticationType() == Resource.AuthenticationType.CONTAINER) {
                ...
                resource2.setAuth(EventLog.APPLICATION);
            }
