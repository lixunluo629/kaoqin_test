...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/rewrite/RewriteRule.class */
public class RewriteRule {
    ...
    public String toString() {
        return "RewriteRule " + this.patternString + SymbolConstants.SPACE_SYMBOL + this.substitutionString + (this.flagsString != null ? SymbolConstants.SPACE_SYMBOL + this.flagsString : "");
    }
