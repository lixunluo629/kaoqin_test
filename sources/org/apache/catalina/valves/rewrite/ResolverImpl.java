...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/rewrite/ResolverImpl.class */
public class ResolverImpl extends Resolver {
    ...
    public String resolve(String key) {
        ...
        if (key.equals("THE_REQUEST")) {
            return this.request.getMethod() + SymbolConstants.SPACE_SYMBOL + this.request.getRequestURI() + SymbolConstants.SPACE_SYMBOL + this.request.getProtocol();
        }
