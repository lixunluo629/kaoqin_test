...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve.class */
public class ExtendedAccessLogValve extends AccessLogValve {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$DateElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement.class */
    protected static class TimeElement implements AbstractAccessLogValve.AccessLogElement {
        ...
        private static final ThreadLocal<ElementTimestampStruct> currentTime = new ThreadLocal<ElementTimestampStruct>() { // from class: org.apache.catalina.valves.ExtendedAccessLogValve.TimeElement.1
            ...
            @Override // java.lang.ThreadLocal
            public ElementTimestampStruct initialValue() {
                return new ElementTimestampStruct(DateFormatConstants.TIME_FOR_COLON);
            }
        };
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestHeaderElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ResponseHeaderElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ServletContextElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$CookieElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ResponseAllHeaderElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestAttributeElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$SessionAttributeElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestParameterElement.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$PatternTokenizer.class */
    ...
    protected AbstractAccessLogValve.AccessLogElement getLogElement(String token, PatternTokenizer tokenizer) throws IOException {
        ...
        if (RtspHeaders.Values.TIME.equals(token)) {
            ...
            if (ExcelXmlConstants.CELL_TAG.equals(token)) {
            ...
            } else if (ExcelXmlConstants.CELL_DATA_FORMAT_TAG.equals(token)) {
    ...
    protected AbstractAccessLogValve.AccessLogElement getClientToServerElement(PatternTokenizer tokenizer) throws IOException {
        if (tokenizer.hasSubToken()) {
            ...
            if (JamXmlElements.METHOD.equals(token)) {
    ...
    protected AbstractAccessLogValve.AccessLogElement getXParameterElement(PatternTokenizer tokenizer) throws IOException {
        ...
        if (StandardRoles.H.equals(token)) {
    ...
    protected AbstractAccessLogValve.AccessLogElement getServletRequestElement(String parameter) {
        ...
        if (Cookie2.SECURE.equals(parameter)) {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ElementTimestampStruct.class */
