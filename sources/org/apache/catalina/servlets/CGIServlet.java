...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/servlets/CGIServlet.class */
public final class CGIServlet extends HttpServlet {
    ...
    private void printServletEnvironment(HttpServletRequest req) throws IOException {
        ...
        while (params.hasMoreElements()) {
            ...
            String[] arr$ = req.getParameterValues(param);
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/servlets/CGIServlet$CGIEnvironment.class */
    protected class CGIEnvironment {
        ...
        public String toString() {
            ...
            if (isValid()) {
                ...
                sb.append(System.lineSeparator());
                Iterator i$ = this.cmdLineParameters.iterator();
                while (i$.hasNext()) {
                    String param = i$.next();
                    sb.append("  [");
                    sb.append(param);
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/servlets/CGIServlet$CGIRunner.class */
    protected class CGIRunner {
        ...
        protected String[] hashToStringArray(Hashtable<String, ?> h) throws NullPointerException {
            ...
            while (e.hasMoreElements()) {
                ...
                v.add(k + SymbolConstants.EQUAL_SYMBOL + h.get(k).toString());
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void sendToLog(BufferedReader rdr) throws IOException {
            int lineCount = 0;
            while (true) {
                try {
                    try {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/servlets/CGIServlet$HTTPHeaderInputStream.class */
