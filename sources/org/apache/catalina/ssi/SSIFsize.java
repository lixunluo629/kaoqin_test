...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/SSIFsize.class */
    ...
    protected String formatSize(long size, String format) {
        ...
        if (format.equalsIgnoreCase("bytes")) {
            ...
            if (size < 0) {
                ...
                String retString3 = Long.toString((size + 512) / 1024);
                ...
                String retString4 = Long.toString((size + 541696) / 1048576);
