...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree.class */
public class ExpressionParseTree {
            ...
            switch (token) {
                case 0:
                    if (currStringNode == null) {
                        ...
                        currStringNode.value.append(SymbolConstants.SPACE_SYMBOL);
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$Node.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$StringNode.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$OppNode.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$NotNode.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$AndNode.class */
    private final class AndNode extends OppNode {
        ...
        public String toString() {
            return this.left + SymbolConstants.SPACE_SYMBOL + this.right + " AND";
        }
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$OrNode.class */
    private final class OrNode extends OppNode {
        ...
        public String toString() {
            return this.left + SymbolConstants.SPACE_SYMBOL + this.right + " OR";
        }
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$CompareNode.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$EqualNode.class */
    private final class EqualNode extends CompareNode {
        ...
        public String toString() {
            return this.left + SymbolConstants.SPACE_SYMBOL + this.right + " EQ";
        }
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$GreaterThanNode.class */
    private final class GreaterThanNode extends CompareNode {
        ...
        public String toString() {
            return this.left + SymbolConstants.SPACE_SYMBOL + this.right + " GT";
        }
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/ExpressionParseTree$LessThanNode.class */
    private final class LessThanNode extends CompareNode {
        ...
        public String toString() {
            return this.left + SymbolConstants.SPACE_SYMBOL + this.right + " LT";
        }
    }
}
