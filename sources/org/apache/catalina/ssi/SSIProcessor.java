...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/SSIProcessor.class */
public class SSIProcessor {
    ...
    protected String[] parseParamNames(StringBuilder cmd, int start) {
        ...
        StringTokenizer str = new StringTokenizer(retBuf.toString(), SymbolConstants.EQUAL_SYMBOL);
