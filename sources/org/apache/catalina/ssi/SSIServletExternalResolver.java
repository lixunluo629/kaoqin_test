...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/SSIServletExternalResolver.class */
public class SSIServletExternalResolver implements SSIExternalResolver {
    ...
    protected String getCGIVariable(String name) {
        ...
        if (nameParts.length == 1) {
            if (nameParts[0].equals(NonRegisteringDriver.PATH_PROPERTY_KEY)) {
                requiredParts = 1;
            }
            ...
            } else if (nameParts[1].equals(NonRegisteringDriver.HOST_PROPERTY_KEY)) {
        ...
        } else if (nameParts[0].equals(NonRegisteringDriver.PATH_PROPERTY_KEY)) {
            ...
            if (nameParts[1].equals("ADDR")) {
                ...
                if (nameParts[1].equals(NonRegisteringDriver.PORT_PROPERTY_KEY)) {
            ...
            } else if (nameParts[1].equals(NonRegisteringDriver.PORT_PROPERTY_KEY)) {
                retVal = Integer.toString(this.req.getServerPort());
            } else if (nameParts[1].equals(NonRegisteringDriver.PROTOCOL_PROPERTY_KEY)) {
                retVal = this.req.getProtocol();
            } else if (nameParts[1].equals("SOFTWARE")) {
                retVal = this.context.getServerInfo() + SymbolConstants.SPACE_SYMBOL + System.getProperty("java.vm.name") + "/" + System.getProperty("java.vm.version") + SymbolConstants.SPACE_SYMBOL + System.getProperty("os.name");
            }
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/SSIServletExternalResolver$ServletContextAndPath.class */
