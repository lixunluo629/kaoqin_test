...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/ssi/SSIMediator.class */
public class SSIMediator {
    ...
    public String getVariableValue(String variableName, String encoding) throws IOException {
    ...
    public String substituteVariables(String val) {
        ...
        StringBuilder sb = new StringBuilder(val.replace("&lt;", "<").replace("&gt;", ">").replace("&quot;", SymbolConstants.QUOTES_SYMBOL).replace("&amp;", "&"));
        int iIndexOf = sb.indexOf("&#");
        while (true) {
            int charStart = iIndexOf;
            if (charStart <= -1 || (charEnd = sb.indexOf(ScriptUtils.DEFAULT_STATEMENT_SEPARATOR, charStart)) <= -1) {
                break;
            }
    ...
    protected String encode(String value, String encoding) throws IOException {
        String retVal;
