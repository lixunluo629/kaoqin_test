...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/realm/JAASRealm.class */
public class JAASRealm extends RealmBase {
    ...
    public void setAppName(String name2) {
        this.appName = name2;
    }
            ...
            try {
                try {
                    ...
                    try {
                        try {
                            try {
                                try {
                                    ...
                                    log.error(sm.getString("jaasRealm.unexpectedError"), e2);
                        ...
                        log.warn(sm.getString("jaasRealm.loginException", username), e5);
                        this.invocationSuccess = true;
                        return null;
                    }
                } catch (Throwable e6) {
