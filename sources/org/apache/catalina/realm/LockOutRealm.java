...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/realm/LockOutRealm.class */
public class LockOutRealm extends CombinedRealm {
    ...
    protected int cacheRemovalWarningTime = NikonType2MakernoteDirectory.TAG_NIKON_SCAN;
    ...
    public Principal authenticate(GSSContext gssContext, boolean storeCreds) {
        if (gssContext.isEstablished()) {
            try {
                GSSName name2 = gssContext.getSrcName();
                String username = name2.toString();
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/realm/LockOutRealm$LockRecord.class */
