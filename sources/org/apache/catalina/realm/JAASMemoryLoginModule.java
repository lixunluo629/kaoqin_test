...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/realm/JAASMemoryLoginModule.class */
public class JAASMemoryLoginModule extends MemoryRealm implements LoginModule {
    ...
    public boolean login() throws LoginException, UnsupportedCallbackException, FailedLoginException, IOException {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("login " + username + SymbolConstants.SPACE_SYMBOL + this.principal);
            }
            if (this.principal != null) {
                return true;
            }
