...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/loader/WebappLoader.class */
public class WebappLoader extends LifecycleMBeanBase implements Loader, PropertyChangeListener {
    ...
    private boolean buildClassPath(StringBuilder classpath, ClassLoader loader) {
        ...
        if (!(loader instanceof URLClassLoader)) {
            ...
            log.info("Unknown loader " + loader + SymbolConstants.SPACE_SYMBOL + loader.getClass());
            return false;
        }
