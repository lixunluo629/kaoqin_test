...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationDispatcher.class */
final class ApplicationDispatcher implements AsyncDispatcher, RequestDispatcher {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedForward.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedInclude.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationDispatcher$State.class */
        ...
        try {
            ...
            if (this.servletPath == null && this.pathInfo == null) {
                ...
                if (hrequest2.getAttribute("javax.servlet.forward.request_uri") == null) {
                    ...
                    if (hrequest2 instanceof org.apache.catalina.servlet4preview.http.HttpServletRequest) {
                        mapping = ((org.apache.catalina.servlet4preview.http.HttpServletRequest) hrequest2).getServletMapping();
                    } else {
                        mapping = new ApplicationMapping(null).getServletMapping();
                    }
                    wrequest2.setAttribute("javax.servlet.forward.mapping", mapping);
                }
    ...
    public void doInclude(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (this.mapping != null) {
            wrequest2.setAttribute("javax.servlet.include.mapping", this.mapping);
        }
    ...
    public void doDispatch(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (hrequest instanceof org.apache.catalina.servlet4preview.http.HttpServletRequest) {
            mapping = ((org.apache.catalina.servlet4preview.http.HttpServletRequest) hrequest).getServletMapping();
        } else {
            mapping = new ApplicationMapping(null).getServletMapping();
        }
        wrequest.setAttribute("javax.servlet.async.mapping", mapping);
