...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationFilterChain.class */
public final class ApplicationFilterChain implements FilterChain {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response) throws Exception {
    ...
    void addFilter(ApplicationFilterConfig filterConfig) {
        ApplicationFilterConfig[] arr$ = this.filters;
        for (ApplicationFilterConfig filter : arr$) {
