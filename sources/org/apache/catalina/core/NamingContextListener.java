...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/NamingContextListener.class */
public class NamingContextListener implements LifecycleListener, ContainerListener, PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent event) throws MalformedObjectNameException, NoSuchMethodException, ClassNotFoundException, SecurityException {
        if (!this.initialized) {
            return;
        }
    ...
    private void processGlobalResourcesChange(String name, Object oldValue, Object newValue) throws MalformedObjectNameException, NoSuchMethodException, ClassNotFoundException, SecurityException {
        if (name.equals("ejb")) {
            if (oldValue != null) {
    ...
    private void createNamingContext() throws MalformedObjectNameException, NoSuchMethodException, ClassNotFoundException, SecurityException, NamingException {
        if (this.container instanceof Server) {
