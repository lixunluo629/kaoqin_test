...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationFilterRegistration.class */
public class ApplicationFilterRegistration implements FilterRegistration.Dynamic {
    ...
    public void addMappingForServletNames(EnumSet<DispatcherType> dispatcherTypes, boolean isMatchAfter, String... servletNames) {
        ...
        if (dispatcherTypes != null) {
            Iterator i$ = dispatcherTypes.iterator();
            while (i$.hasNext()) {
                DispatcherType dispatcherType = (DispatcherType) i$.next();
