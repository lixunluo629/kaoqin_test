...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationContext.class */
public class ApplicationContext implements ServletContext {
    ...
    private final javax.servlet.ServletContext facade = new ApplicationContextFacade(this);
    ...
    public <T extends Filter> T createFilter(Class<T> c) throws ServletException {
        ...
        } catch (IllegalAccessException | NamingException | ClassNotFoundException | InstantiationException | NoSuchMethodException e) {
    ...
    public <T extends EventListener> T createListener(Class<T> c) throws ServletException {
        ...
        } catch (IllegalAccessException | NamingException | InstantiationException | NoSuchMethodException e2) {
            throw new ServletException(e2);
        }
    }
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationContext$DispatchData.class */
