...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationFilterFactory.class */
public final class ApplicationFilterFactory {
    ...
    private static boolean matchFiltersURL(String testPath, String requestPath) {
        ...
        if (testPath.equals(requestPath) || testPath.equals(ScriptUtils.DEFAULT_BLOCK_COMMENT_START_DELIMITER)) {
            return true;
        }
        if (testPath.endsWith(ScriptUtils.DEFAULT_BLOCK_COMMENT_START_DELIMITER)) {
