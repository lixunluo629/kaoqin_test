...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationFilterConfig.class */
public final class ApplicationFilterConfig implements FilterConfig, Serializable {
    private static final long serialVersionUID = 1;
    private final Log log = LogFactory.getLog((Class<?>) ApplicationFilterConfig.class);
    ...
    ApplicationFilterConfig(Context context, FilterDef filterDef) throws IllegalAccessException, ServletException, NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, NamingException, IllegalArgumentException, ClassCastException, InvocationTargetException {
        this.filter = null;
    ...
    Filter getFilter() throws IllegalAccessException, ServletException, NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, NamingException, IllegalArgumentException, ClassCastException, InvocationTargetException {
        if (this.filter != null) {
            return this.filter;
        }
