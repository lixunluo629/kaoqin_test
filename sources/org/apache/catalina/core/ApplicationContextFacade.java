...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationContextFacade.class */
public class ApplicationContextFacade implements ServletContext {
    ...
    public javax.servlet.ServletContext getContext(String uripath) {
        javax.servlet.ServletContext theContext;
        if (SecurityUtil.isPackageProtectionEnabled()) {
            theContext = (javax.servlet.ServletContext) doPrivileged("getContext", new Object[]{uripath});
        } else {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/core/ApplicationContextFacade$PrivilegedExecuteMethod.class */
