...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/util/ContextName.class */
public final class ContextName {
    ...
    public ContextName(String name, boolean stripFileExtension) {
        ...
        if (stripFileExtension && (tmp12.toLowerCase(Locale.ENGLISH).endsWith(".war") || tmp12.toLowerCase(Locale.ENGLISH).endsWith(".xml"))) {
