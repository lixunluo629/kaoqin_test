...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/util/ManifestResource.class */
public class ManifestResource {
    ...
    public boolean isFulfilled() {
        ...
        Iterator i$ = this.requiredExtensions.iterator();
        while (i$.hasNext()) {
    ...
    private ArrayList<Extension> getRequiredExtensions(Manifest manifest) {
        ...
        String names2 = names + SymbolConstants.SPACE_SYMBOL;
        while (true) {
