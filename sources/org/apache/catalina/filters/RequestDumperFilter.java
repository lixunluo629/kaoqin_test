...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/RequestDumperFilter.class */
public class RequestDumperFilter implements Filter {
    ...
    private final Log log = LogFactory.getLog((Class<?>) RequestDumperFilter.class);
        ...
        if (hRequest == null) {
            ...
            if (cookies != null) {
                for (int i = 0; i < cookies.length; i++) {
                    doLog("            cookie", cookies[i].getName() + SymbolConstants.EQUAL_SYMBOL + cookies[i].getValue());
                }
            }
            ...
            while (hnames.hasMoreElements()) {
                ...
                while (hvalues.hasMoreElements()) {
                    ...
                    doLog("            header", hname + SymbolConstants.EQUAL_SYMBOL + hvalue);
                }
            }
        }
        ...
        if (hResponse == null) {
            ...
            for (String rhname : rhnames) {
                ...
                for (String rhvalue : rhvalues) {
                    doLog("            header", rhname + SymbolConstants.EQUAL_SYMBOL + rhvalue);
                }
            }
        }
        if (hRequest == null) {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/RequestDumperFilter$Timestamp.class */
