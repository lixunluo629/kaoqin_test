...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter.class */
public class ExpiresFilter extends FilterBase {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$StartingPoint.class */
    protected enum StartingPoint {
        ACCESS_TIME,
        LAST_MODIFICATION_TIME
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$Duration.class */
    protected static class Duration {
        ...
        public String toString() {
            return this.amount + SymbolConstants.SPACE_SYMBOL + this.unit;
        }
    }

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$DurationUnit.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$ExpiresConfiguration.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$XHttpServletResponse.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$XPrintWriter.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/ExpiresFilter$XServletOutputStream.class */
    ...
    protected Date getExpirationDate(XHttpServletResponse response) {
        ...
        if (contains(contentType, ScriptUtils.DEFAULT_STATEMENT_SEPARATOR) && (configuration2 = this.expiresConfigurationByContentType.get((contentTypeWithoutCharset = substringBefore(contentType, ScriptUtils.DEFAULT_STATEMENT_SEPARATOR).trim()))) != null) {
    ...
    protected ExpiresConfiguration parseExpiresConfiguration(String inputLine) throws NumberFormatException {
        ...
        StringTokenizer tokenizer = new StringTokenizer(line, SymbolConstants.SPACE_SYMBOL);
        try {
            ...
            if ("access".equalsIgnoreCase(currentToken) || "now".equalsIgnoreCase(currentToken)) {
                ...
                startingPoint = StartingPoint.ACCESS_TIME;
                tokenizer = new StringTokenizer(currentToken.substring(1) + " seconds", SymbolConstants.SPACE_SYMBOL);
