...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/HttpHeaderSecurityFilter.class */
public class HttpHeaderSecurityFilter extends FilterBase {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        if (response instanceof HttpServletResponse) {
            ...
            if (this.blockContentTypeSniffingEnabled) {
                httpResponse.setHeader("X-Content-Type-Options", BLOCK_CONTENT_TYPE_SNIFFING_HEADER_VALUE);
            }
            if (this.xssProtectionEnabled) {
                httpResponse.setHeader("X-XSS-Protection", XSS_PROTECTION_HEADER_VALUE);
            }
        }
    ...
    public void setAntiClickJackingOption(String antiClickJackingOption) {
        XFrameOption[] arr$ = XFrameOption.values();
        for (XFrameOption option : arr$) {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/HttpHeaderSecurityFilter$XFrameOption.class */
