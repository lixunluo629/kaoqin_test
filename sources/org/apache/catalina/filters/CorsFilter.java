...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/CorsFilter.class */
public class CorsFilter implements Filter {
    ...
    private final Log log = LogFactory.getLog((Class<?>) CorsFilter.class);
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/filters/CorsFilter$CORSRequestType.class */
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        parseAndStore(getInitParameter(filterConfig, PARAM_CORS_ALLOWED_ORIGINS, ""), getInitParameter(filterConfig, PARAM_CORS_ALLOWED_METHODS, DEFAULT_ALLOWED_HTTP_METHODS), getInitParameter(filterConfig, PARAM_CORS_ALLOWED_HEADERS, DEFAULT_ALLOWED_HTTP_HEADERS), getInitParameter(filterConfig, PARAM_CORS_EXPOSED_HEADERS, ""), getInitParameter(filterConfig, PARAM_CORS_SUPPORT_CREDENTIALS, "false"), getInitParameter(filterConfig, PARAM_CORS_PREFLIGHT_MAXAGE, DEFAULT_PREFLIGHT_MAXAGE), getInitParameter(filterConfig, PARAM_CORS_REQUEST_DECORATE, "true"));
    }
    ...
    protected CORSRequestType checkRequestType(HttpServletRequest request) {
        ...
        if (originHeader != null) {
            if (originHeader.isEmpty() || !isValidOrigin(originHeader)) {
                ...
                if (isLocalOrigin(request, originHeader)) {
