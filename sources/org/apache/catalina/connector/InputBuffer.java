...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/InputBuffer.class */
public class InputBuffer extends Reader implements ByteChunk.ByteInputChannel, ApplicationBufferHandler {
    ...
    private static B2CConverter createConverter(final Charset charset) throws IOException {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            try {
                return (B2CConverter) AccessController.doPrivileged(new PrivilegedExceptionAction<B2CConverter>() { // from class: org.apache.catalina.connector.InputBuffer.1
