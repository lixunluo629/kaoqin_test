...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/CoyoteAdapter.class */
public class CoyoteAdapter implements Adapter {
    ...
    public void service(org.apache.coyote.Request req, org.apache.coyote.Response res) throws Exception {
        ...
        if (this.connector.getXpoweredBy()) {
            response.addHeader(HttpHeaders.X_POWERED_BY, POWERED_BY);
        }
        boolean async = false;
        req.getRequestProcessor().setWorkerThreadName(THREAD_NAME.get());
        try {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/CoyoteAdapter$RecycleRequiredException.class */
    ...
    protected boolean postParseRequest(org.apache.coyote.Request req, Request request, org.apache.coyote.Response res, Response response) throws InterruptedException, ServletException, IOException {
        ...
        if (!redirectPathMB.isNull()) {
            ...
            if (request.isRequestedSessionIdFromURL()) {
                redirectPath = redirectPath + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR + SessionConfig.getSessionUriParamName(request.getContext()) + SymbolConstants.EQUAL_SYMBOL + request.getRequestedSessionId();
            }
            if (query != null) {
