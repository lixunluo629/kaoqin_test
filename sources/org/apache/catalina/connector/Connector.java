...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/Connector.class */
public class Connector extends LifecycleMBeanBase {
    ...
    public Connector(String protocol) {
        ...
        this.protocolHandlerClassName = TomcatEmbeddedServletContainerFactory.DEFAULT_PROTOCOL;
        this.adapter = null;
    ...
    public String getProtocol() {
        if (TomcatEmbeddedServletContainerFactory.DEFAULT_PROTOCOL.equals(getProtocolHandlerClassName()) && (!AprLifecycleListener.isAprAvailable() || !AprLifecycleListener.getUseAprConnector())) {
    ...
    public void setProtocol(String protocol) {
        ...
        if (Constants.HTTP_11.equals(protocol) || protocol == null) {
            if (aprConnector) {
                ...
                setProtocolHandlerClassName(TomcatEmbeddedServletContainerFactory.DEFAULT_PROTOCOL);
                return;
            }
        }
    ...
    public void setSecure(boolean secure) {
        this.secure = secure;
        setProperty(Cookie2.SECURE, Boolean.toString(secure));
    }
