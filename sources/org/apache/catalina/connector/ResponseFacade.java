...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/ResponseFacade.class */
public class ResponseFacade implements HttpServletResponse {
    protected static final StringManager sm = StringManager.getManager((Class<?>) ResponseFacade.class);
    protected Response response;

    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/ResponseFacade$SetContentTypePrivilegedAction.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/connector/ResponseFacade$DateHeaderPrivilegedAction.class */
    ...
    public void flushBuffer() throws PrivilegedActionException, IOException {
        ...
        if (SecurityUtil.isPackageProtectionEnabled()) {
            try {
                AccessController.doPrivileged(new PrivilegedExceptionAction<Void>() { // from class: org.apache.catalina.connector.ResponseFacade.1
                    /* JADX WARN: Can't rename method to resolve collision */
