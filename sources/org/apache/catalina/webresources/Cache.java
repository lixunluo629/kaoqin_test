...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/webresources/Cache.class */
public class Cache {
    ...
    protected void backgroundProcess() {
        ...
        if (newSize > targetSize) {
            log.info(sm.getString("cache.backgroundEvictFail", Long.valueOf(TARGET_FREE_PERCENT_BACKGROUND), this.root.getContext().getName(), Long.valueOf(newSize / 1024)));
        }
    }
    ...
    public void setObjectMaxSize(int objectMaxSize) {
        if (objectMaxSize * 1024 > 2147483647L) {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/webresources/Cache$EvictionOrder.class */
