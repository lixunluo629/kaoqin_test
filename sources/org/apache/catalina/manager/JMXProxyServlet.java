...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/manager/JMXProxyServlet.class */
public class JMXProxyServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws MBeanException, OperationsException, ServletException, IOException, ReflectionException {
    ...
    private void invokeOperation(PrintWriter writer, String onameStr, String op, String[] valuesStr) throws MBeanException, OperationsException, ReflectionException {
        try {
    ...
    private Object invokeOperationInternal(String onameStr, String operation, String[] parameters) throws MBeanException, OperationsException, ReflectionException {
        ObjectName oname = new ObjectName(onameStr);
