...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/manager/HTMLManagerServlet.class */
public final class HTMLManagerServlet extends ManagerServlet {
    ...
    protected void doSessions(ContextName cn, HttpServletRequest req, HttpServletResponse resp, StringManager smClient) throws ServletException, IOException {
        req.setAttribute(Cookie2.PATH, cn.getPath());
        req.setAttribute("version", cn.getVersion());
        String action = req.getParameter(ParameterMethodNameResolver.DEFAULT_PARAM_NAME);
        if (this.debug >= 1) {
