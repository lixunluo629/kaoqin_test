...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/manager/StatusManagerServlet.class */
public class StatusManagerServlet extends HttpServlet implements NotificationListener {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            ObjectName objectName3 = new ObjectName("*:type=ThreadPool,*,subType=SocketProperties");
            Set<ObjectInstance> set22 = this.mBeanServer.queryMBeans(objectName3, (QueryExp) null);
            for (ObjectInstance oi2 : set2) {
                if (!set22.contains(oi2)) {
                    this.threadPools.addElement(oi2.getObjectName());
                }
            }
            ObjectName objectName4 = new ObjectName("*:type=GlobalRequestProcessor,*");
            Set<ObjectInstance> set3 = this.mBeanServer.queryMBeans(objectName4, (QueryExp) null);
            for (ObjectInstance oi3 : set3) {
                this.globalRequestProcessors.addElement(oi3.getObjectName());
            }
            ObjectName objectName5 = new ObjectName("*:type=RequestProcessor,*");
            Set<ObjectInstance> set4 = this.mBeanServer.queryMBeans(objectName5, (QueryExp) null);
            for (ObjectInstance oi4 : set4) {
                this.requestProcessors.addElement(oi4.getObjectName());
            }
            ObjectName objectName6 = new ObjectName("JMImplementation:type=MBeanServerDelegate");
            this.mBeanServer.addNotificationListener(objectName6, this, (NotificationFilter) null, (Object) null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
