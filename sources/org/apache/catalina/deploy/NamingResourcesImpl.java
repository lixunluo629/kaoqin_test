...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/deploy/NamingResourcesImpl.class */
public class NamingResourcesImpl extends LifecycleMBeanBase implements Serializable, NamingResources {
    ...
    public void addResource(ContextResource resource) {
        ...
        this.support.firePropertyChange("resource", (Object) null, resource);
        if (this.resourceRequireExplicitRegistration) {
            try {
    ...
    public void removeResource(String name) {
        ...
        if (resource != null) {
            this.support.firePropertyChange("resource", resource, (Object) null);
            if (this.resourceRequireExplicitRegistration) {
                try {
