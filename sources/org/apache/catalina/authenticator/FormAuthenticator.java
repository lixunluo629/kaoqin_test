...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/authenticator/FormAuthenticator.class */
public class FormAuthenticator extends AuthenticatorBase {
    ...
    protected boolean doAuthenticate(Request request, HttpServletResponse response) throws IOException, NumberFormatException {
        ...
        if (matchRequest(request)) {
            ...
            register(request, response, (Principal) session2.getNote(Constants.FORM_PRINCIPAL_NOTE), "FORM", (String) session2.getNote(Constants.SESS_USERNAME_NOTE), (String) session2.getNote(Constants.SESS_PASSWORD_NOTE));
            if (this.cache) {
