...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/authenticator/AuthenticatorBase.class */
public abstract class AuthenticatorBase extends ValveBase implements Authenticator, RegistrationListener {
    ...
    public void invoke(Request request, Response response) throws IllegalStateException, ServletException, IOException, ClassNotFoundException {
        String[] roles;
        Session session;
        Principal principal;
        if (this.log.isDebugEnabled()) {
            this.log.debug("Security checking request " + request.getMethod() + SymbolConstants.SPACE_SYMBOL + request.getRequestURI());
        }
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        this.jaspicAppContextID = servletContext.getVirtualServerName() + SymbolConstants.SPACE_SYMBOL + servletContext.getContextPath();
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/authenticator/AuthenticatorBase$JaspicState.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/authenticator/AuthenticatorBase$NoOpAuthConfigProvider.class */
    private static class NoOpAuthConfigProvider implements AuthConfigProvider {
        private NoOpAuthConfigProvider() {
        }
