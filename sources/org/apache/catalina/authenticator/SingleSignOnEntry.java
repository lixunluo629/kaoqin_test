...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/catalina/authenticator/SingleSignOnEntry.class */
public class SingleSignOnEntry implements Serializable {
    ...
    public synchronized void updateCredentials(Principal principal, String authType, String username, String password) {
        ...
        this.canReauthenticate = HttpServletRequest.BASIC_AUTH.equals(authType) || "FORM".equals(authType);
    }
