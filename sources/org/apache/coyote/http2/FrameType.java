...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/http2/FrameType.class */
public enum FrameType {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/http2/FrameType$IntPredicate.class */
    ...
    private static IntPredicate greaterOrEquals(final int y) {
        return new IntPredicate() { // from class: org.apache.coyote.http2.FrameType.1
            @Override // org.apache.coyote.http2.FrameType.IntPredicate
    ...
    private static IntPredicate equals(final int y) {
        return new IntPredicate() { // from class: org.apache.coyote.http2.FrameType.2
            @Override // org.apache.coyote.http2.FrameType.IntPredicate
            public boolean test(int x) {
                return x == y;
            }
    ...
    private static IntPredicate dividableBy(final int y) {
        return new IntPredicate() { // from class: org.apache.coyote.http2.FrameType.3
            @Override // org.apache.coyote.http2.FrameType.IntPredicate
            public boolean test(int x) {
                return x % y == 0;
            }
