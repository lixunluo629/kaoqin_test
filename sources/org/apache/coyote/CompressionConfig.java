...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/CompressionConfig.class */
public class CompressionConfig {
    ...
    public boolean useCompression(Request request, Response response) {
        ...
        if (contentEncodingMB != null && (contentEncodingMB.indexOf("gzip") != -1 || contentEncodingMB.indexOf(CompressorStreamFactory.BROTLI) != -1)) {
            return false;
        }
