...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/Request.class */
public final class Request {
    ...
    public int doRead(ByteChunk chunk) throws IOException {
        int n = this.inputBuffer.doRead(chunk);
        if (n > 0) {
            this.bytesRead += n;
        }
        return n;
    ...
    private static String getCharsetFromContentType(String contentType) {
        ...
        if (encoding2.length() > 2 && encoding2.startsWith(SymbolConstants.QUOTES_SYMBOL) && encoding2.endsWith(SymbolConstants.QUOTES_SYMBOL)) {
