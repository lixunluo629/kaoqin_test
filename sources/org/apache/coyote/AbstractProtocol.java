...
/* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/AbstractProtocol.class */
public abstract class AbstractProtocol<S> implements ProtocolHandler, MBeanRegistration {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/AbstractProtocol$ConnectionHandler.class */
                    ...
                    try {
                        try {
                            try {
                                ...
                                getLog().error(AbstractProtocol.sm.getString("abstractConnectionHandler.error"), e2);
                                ContainerThreadMarker.clear();
                                this.connections.remove(socket);
                                release(processor);
                                return AbstractEndpoint.Handler.SocketState.CLOSED;
                            ...
                            getLog().debug(AbstractProtocol.sm.getString("abstractConnectionHandler.socketexception.debug"), e3);
                            ContainerThreadMarker.clear();
                            this.connections.remove(socket);
                            release(processor);
                            return AbstractEndpoint.Handler.SocketState.CLOSED;
                        ...
                        getLog().debug(AbstractProtocol.sm.getString("abstractConnectionHandler.ioexception.debug"), e4);
                        ContainerThreadMarker.clear();
                        this.connections.remove(socket);
                        release(processor);
                        return AbstractEndpoint.Handler.SocketState.CLOSED;
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/AbstractProtocol$RecycledProcessors.class */
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:org/apache/coyote/AbstractProtocol$AsyncTimeout.class */
