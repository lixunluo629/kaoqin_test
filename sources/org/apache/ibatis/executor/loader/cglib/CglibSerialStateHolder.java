...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/executor/loader/cglib/CglibSerialStateHolder.class */
class CglibSerialStateHolder extends AbstractSerialStateHolder {
    ...
    public CglibSerialStateHolder(Object userBean, Map<String, ResultLoaderMap.LoadPair> unloadedProperties, ObjectFactory objectFactory, List<Class<?>> constructorArgTypes, List<Object> constructorArgs) {
