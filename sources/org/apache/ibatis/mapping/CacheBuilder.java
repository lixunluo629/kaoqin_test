...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/mapping/CacheBuilder.class */
public class CacheBuilder {
    ...
    private Cache setStandardDecorators(Cache cache) {
        try {
            ...
            if (this.size != null && metaCache.hasSetter(InputTag.SIZE_ATTRIBUTE)) {
                metaCache.setValue(InputTag.SIZE_ATTRIBUTE, this.size);
            }
            ...
            Cache cache2 = new SynchronizedCache(new LoggingCache(cache));
            if (this.blocking) {
