...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/session/Configuration.class */
public class Configuration {
    ...
    public ParameterHandler newParameterHandler(MappedStatement mappedStatement, Object parameterObject, BoundSql boundSql) {
        ...
        return (ParameterHandler) this.interceptorChain.pluginAll(parameterHandler);
    }
    ...
    public Executor newExecutor(Transaction transaction, ExecutorType executorType) {
        ...
        if (ExecutorType.BATCH == executorType3) {
            executor = new BatchExecutor(this, transaction);
        } else if (ExecutorType.REUSE == executorType3) {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/session/Configuration$StrictMap.class */
    protected static class StrictMap<V> extends HashMap<String, V> {
        ...
        /* JADX WARN: Type inference failed for: r2v1, types: [java.lang.Object, org.apache.ibatis.session.Configuration$StrictMap$Ambiguity] */
        ...
        /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/session/Configuration$StrictMap$Ambiguity.class */
