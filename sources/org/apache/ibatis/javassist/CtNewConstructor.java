...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/CtNewConstructor.class */
public class CtNewConstructor {
    ...
    public static CtConstructor make(CtClass[] parameters, CtClass[] exceptions, String body, CtClass declaring) throws RuntimeException, CannotCompileException {
        try {
