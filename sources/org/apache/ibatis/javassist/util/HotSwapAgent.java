package org.apache.ibatis.javassist.util;
...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/util/HotSwapAgent.class */
public class HotSwapAgent {
    ...
    public static void redefine(Class oldClass, CtClass newClass) throws InterruptedException, NotFoundException, IOException, CannotCompileException {
        Class[] old = {oldClass};
        CtClass[] newClasses = {newClass};
        redefine(old, newClasses);
    }

    public static void redefine(Class[] oldClasses, CtClass[] newClasses) throws InterruptedException, NotFoundException, IOException, CannotCompileException {
        startAgent();
    ...
    private static void startAgent() throws InterruptedException, NotFoundException {
    ...
    public static File createAgentJarFile(String fileName) throws IOException, NotFoundException, CannotCompileException {
        return createJarFile(new File(fileName));
    }

    private static File createJarFile() throws IOException, NotFoundException, CannotCompileException {
        File jar = File.createTempFile("agent", ".jar");
        jar.deleteOnExit();
        return createJarFile(jar);
    }

    private static File createJarFile(File jar) throws IOException, NotFoundException, CannotCompileException {
        ...
        try {
            ...
            JarEntry e = new JarEntry(cname.replace('.', '/') + ClassUtils.CLASS_FILE_SUFFIX);
            jos.putNextEntry(e);
