...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
    ...
    public static SerializedProxy makeSerializedProxy(Object proxy) throws InvalidClassException, IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
