...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/util/proxy/SerializedProxy.class */
class SerializedProxy implements Serializable {
    ...
    protected Class loadClass(final String className) throws ClassNotFoundException {
        try {
            return (Class) AccessController.doPrivileged(new PrivilegedExceptionAction() { // from class: org.apache.ibatis.javassist.util.proxy.SerializedProxy.1
