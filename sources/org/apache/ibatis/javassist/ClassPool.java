...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/ClassPool.class */
public class ClassPool {
    private static Method definePackage = null;
    ...
    static {
        if (ClassFile.MAJOR_VERSION < 53) {
            try {
                AccessController.doPrivileged(new PrivilegedExceptionAction() { // from class: org.apache.ibatis.javassist.ClassPool.1
                    @Override // java.security.PrivilegedExceptionAction
                    public Object run() throws Exception {
                        Class cl = Class.forName("java.lang.ClassLoader");
                        Method unused = ClassPool.definePackage = cl.getDeclaredMethod("definePackage", String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class);
                        return null;
                    }
                });
    ...
    synchronized void classNameChanged(String oldname, CtClass clazz) throws RuntimeException {
    ...
    synchronized CtClass makeNestedClass(String classname) throws RuntimeException {
        checkNotFrozen(classname);
    ...
    public void makePackage(ClassLoader loader, String name) throws CannotCompileException {
        ...
        Object[] args = {name, null, null, null, null, null, null, null};
        try {
    ...
    private static synchronized Object makePackage2(Method method, ClassLoader loader, Object[] args) throws Exception {
        method.setAccessible(true);
        try {
            Object objInvoke = method.invoke(loader, args);
