...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/CtBehavior.class */
public abstract class CtBehavior extends CtMember {
    ...
    public MethodInfo getMethodInfo() throws RuntimeException {
    ...
    public void setExceptionTypes(CtClass[] types) throws NotFoundException, RuntimeException {
        this.declaringClass.checkModify();
    ...
    public void setBody(String src) throws RuntimeException, CannotCompileException {
        setBody(src, null, null);
    }

    public void setBody(String src, String delegateObj, String delegateMethod) throws RuntimeException, CannotCompileException {
    ...
    static void setBody0(CtClass srcClass, MethodInfo srcInfo, CtClass destClass, MethodInfo destInfo, ClassMap map) throws RuntimeException, CannotCompileException {
    ...
    public void useCflow(String name) throws RuntimeException, CannotCompileException {
        CtClass cc = this.declaringClass;
        cc.checkModify();
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    CtClass type = pool.get("org.apache.ibatis.javassist.runtime.Cflow");
    ...
    public void addLocalVariable(String name, CtClass type) throws RuntimeException, CannotCompileException {
        this.declaringClass.checkModify();
    ...
    public void insertParameter(CtClass type) throws RuntimeException, CannotCompileException {
        this.declaringClass.checkModify();
    ...
    public void addParameter(CtClass type) throws RuntimeException, CannotCompileException {
        this.declaringClass.checkModify();
        String desc = this.methodInfo.getDescriptor();
    ...
    public void insertBefore(String src) throws RuntimeException, CannotCompileException {
        insertBefore(src, true);
    }

    private void insertBefore(String src, boolean rebuild) throws RuntimeException, CannotCompileException {
        CtClass cc = this.declaringClass;
        cc.checkModify();
        CodeAttribute ca = this.methodInfo.getCodeAttribute();
        if (ca == null) {
    ...
    public void insertAfter(String src) throws RuntimeException, CannotCompileException {
        insertAfter(src, false);
    }

    public void insertAfter(String src, boolean asFinally) throws RuntimeException, CannotCompileException {
        int pos;
        CtClass cc = this.declaringClass;
        cc.checkModify();
    ...
    public void addCatch(String src, CtClass exceptionType) throws RuntimeException, CannotCompileException {
        addCatch(src, exceptionType, "$e");
    }

    public void addCatch(String src, CtClass exceptionType, String exceptionName) throws RuntimeException, CannotCompileException {
        CtClass cc = this.declaringClass;
        cc.checkModify();
        ConstPool cp = this.methodInfo.getConstPool();
        CodeAttribute ca = this.methodInfo.getCodeAttribute();
    ...
    public int insertAt(int lineNum, boolean modify, String src) throws RuntimeException, CannotCompileException {
        CodeAttribute ca = this.methodInfo.getCodeAttribute();
        if (ca == null) {
            throw new CannotCompileException("no method body");
        }
