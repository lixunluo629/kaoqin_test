...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/CtClassType.class */
class CtClassType extends CtClass {
    ...
    @Override // org.apache.ibatis.javassist.CtClass
    ...
    public ClassFile getClassFile3(boolean doCompress) throws IOException {
        ...
        try {
            try {
                ...
                if (!cf2.getName().equals(this.qualifiedName)) {
                    throw new RuntimeException("cannot find " + this.qualifiedName + ": " + cf2.getName() + " found in " + this.qualifiedName.replace('.', '/') + ClassUtils.CLASS_FILE_SUFFIX);
                }
                ClassFile classFile = setClassFile(cf2);
                if (fin3 != null) {
                    try {
                        fin3.close();
    ...
    private synchronized void saveClassFile() throws IOException {
    ...
    public CtClass[] getNestedClasses() throws NotFoundException {
        ...
        String thisName = cf.getName() + PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX;
    ...
    @Override // org.apache.ibatis.javassist.CtClass
    public void setModifiers(int mod) throws RuntimeException {
        checkModify();
    ...
    private static void updateInnerEntry(int newMod, String name, CtClass clazz, boolean outer) throws RuntimeException {
        int isStatic;
    ...
    @Override // org.apache.ibatis.javassist.CtClass
    public CtClass makeNestedClass(String name, boolean isStatic) throws RuntimeException {
        if (!isStatic) {
            throw new RuntimeException("sorry, only nested static class is supported");
        }
        checkModify();
        CtClass c = this.classPool.makeNestedClass(getName() + PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX + name);
        ClassFile cf = getClassFile2();
    ...
    */
    protected synchronized org.apache.ibatis.javassist.CtMember.Cache getMembers() {
        /*
            r5 = this;
            r0 = 0
            r6 = r0
            ...
            org.apache.ibatis.javassist.CtMember$Cache r0 = (org.apache.ibatis.javassist.CtMember.Cache) r0
            r1 = r0
            r6 = r1
            if (r0 != 0) goto L37
        L18:
            org.apache.ibatis.javassist.CtMember$Cache r0 = new org.apache.ibatis.javassist.CtMember$Cache
            r1 = r0
            r2 = r5
            r1.<init>(r2)
            r6 = r0
        ...
        L37:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.ibatis.javassist.CtClassType.getMembers():org.apache.ibatis.javassist.CtMember$Cache");
    }
    ...
    CtField getField2(String name, String desc) {
        ...
        try {
            ...
            for (CtClass ctClass : ifs) {
                CtField f = ctClass.getField2(name, desc);
                if (f != null) {
                    return f;
                }
            }
    ...
    private static CtMethod getMethod0(CtClass cc, String name, String desc) {
        ...
        try {
            CtClass[] ifs = cc.getInterfaces();
            for (CtClass ctClass : ifs) {
                CtMethod m2 = getMethod0(ctClass, name, desc);
                if (m2 != null) {
                    return m2;
                }
            }
    ...
    @Override // org.apache.ibatis.javassist.CtClass
    public CtConstructor makeClassInitializer() throws RuntimeException, CannotCompileException {
    ...
    @Override // org.apache.ibatis.javassist.CtClass
    public void removeConstructor(CtConstructor m) throws NotFoundException, RuntimeException {
        checkModify();
    ...
    private void modifyClassConstructor(ClassFile cf) throws NotFoundException, CannotCompileException {
    ...
    private void modifyConstructors(ClassFile cf) throws NotFoundException, CannotCompileException {
    ...
    private int makeFieldInitializer(Bytecode code, CtClass[] parameters) throws NotFoundException, CannotCompileException {
        int s;
        int stacksize = 0;
        Javac jv = new Javac(code, this);
        try {
    ...
    private void makeMemberList(HashMap table) {
        ...
        List list2 = getClassFile2().getFields();
        int n2 = list2.size();
