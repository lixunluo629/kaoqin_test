...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/compiler/Javac.class */
public class Javac {
    JvstCodeGen gen;
    SymbolTable stable;
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/compiler/Javac$CtFieldWithInit.class */
    public static class CtFieldWithInit extends CtField {
        ...
        @Override // org.apache.ibatis.javassist.CtField
    ...
    public int recordParams(CtClass[] params, boolean isStatic) throws CompileError {
        return this.gen.recordParams(params, isStatic, PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX, "$args", ClassUtils.CGLIB_CLASS_SEPARATOR, this.stable);
    }

    public int recordParams(String target, CtClass[] params, boolean use0, int varNo, boolean isStatic) throws CompileError {
        return this.gen.recordParams(params, isStatic, PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX, "$args", ClassUtils.CGLIB_CLASS_SEPARATOR, use0, varNo, target, this.stable);
    }
    ...
    public void recordProceed(String target, final String method) throws CompileError {
        ...
        ProceedHandler h = new ProceedHandler() { // from class: org.apache.ibatis.javassist.compiler.Javac.1
    ...
    public void recordStaticProceed(final String targetClass, final String method) throws CompileError {
        ProceedHandler h = new ProceedHandler() { // from class: org.apache.ibatis.javassist.compiler.Javac.2
            @Override // org.apache.ibatis.javassist.compiler.ProceedHandler
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args) throws CompileError {
    ...
    public void recordSpecialProceed(String target, final String classname, final String methodname, final String descriptor, final int methodIndex) throws CompileError {
        Parser p = new Parser(new Lex(target));
        final ASTree texpr = p.parseExpression(this.stable);
        ProceedHandler h = new ProceedHandler() { // from class: org.apache.ibatis.javassist.compiler.Javac.3
            @Override // org.apache.ibatis.javassist.compiler.ProceedHandler
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args) throws CompileError {
