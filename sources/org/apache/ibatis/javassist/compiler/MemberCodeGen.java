...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/compiler/MemberCodeGen.class */
public class MemberCodeGen extends CodeGen {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/compiler/MemberCodeGen$JsrHook.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/compiler/MemberCodeGen$JsrHook2.class */
    ...
    private void atFieldAssignCore(CtField f, boolean is_static, int fi, boolean is2byte) throws CompileError, RuntimeException {
        if (fi != 0) {
            if (is_static) {
    ...
    @Override // org.apache.ibatis.javassist.compiler.CodeGen
    protected void atFieldRead(ASTree expr) throws CompileError, RuntimeException {
    ...
    private int atFieldRead(CtField f, boolean isStatic) throws CompileError, RuntimeException {
        FieldInfo finfo = f.getFieldInfo2();
    ...
    @Override // org.apache.ibatis.javassist.compiler.CodeGen
    protected void atFieldPlusPlus(int token, boolean isPost, ASTree oprand, Expr expr, boolean doDup) throws CompileError, RuntimeException {
        int dup_code;
