...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable.class */
public class StackMapTable extends AttributeInfo {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$RuntimeCopyException.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$Walker.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$SimpleCopy.class */
    static class SimpleCopy extends Walker {
        ...
        @Override // org.apache.ibatis.javassist.bytecode.StackMapTable.Walker
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$Copier.class */
    static class Copier extends SimpleCopy {
        ...
        @Override // org.apache.ibatis.javassist.bytecode.StackMapTable.SimpleCopy
        protected int copyData(int tag, int data) {
            if (tag == 7) {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$InsertLocal.class */
    static class InsertLocal extends SimpleCopy {
        ...
        @Override // org.apache.ibatis.javassist.bytecode.StackMapTable.SimpleCopy, org.apache.ibatis.javassist.bytecode.StackMapTable.Walker
        public void fullFrame(int pos, int offsetDelta, int[] localTags, int[] localData, int[] stackTags, int[] stackData) {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$Writer.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$Printer.class */
        ...
        private void printTypeInfo(int tag, int data) {
            ...
            switch (tag) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    msg = XmlErrorCodes.FLOAT;
                    break;
                case 3:
                    msg = XmlErrorCodes.DOUBLE;
                    break;
                case 4:
                    msg = XmlErrorCodes.LONG;
                    break;
                case 5:
                    msg = "null";
                    break;
                case 6:
                    msg = OgnlContext.THIS_CONTEXT_KEY;
                    break;
                case 7:
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$OffsetShifter.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$Shifter.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$SwitchShifter.class */
    static class SwitchShifter extends Shifter {
        SwitchShifter(StackMapTable smt, int where, int gap) {
            super(smt, where, gap, false);
        }

        @Override // org.apache.ibatis.javassist.bytecode.StackMapTable.Shifter
        void update(int pos, int offsetDelta, int base, int entry) {
            int newDelta;
            int oldPos = this.position;
            this.position = oldPos + offsetDelta + (oldPos == 0 ? 0 : 1);
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/StackMapTable$NewRemover.class */
