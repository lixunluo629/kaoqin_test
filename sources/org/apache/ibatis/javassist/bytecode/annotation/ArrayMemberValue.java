...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/annotation/ArrayMemberValue.class */
public class ArrayMemberValue extends MemberValue {
    ...
    Object getValue(ClassLoader cl, ClassPool cp, Method method) throws ClassNotFoundException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        Class clazz;
        if (this.values == null) {
        ...
        Object a = Array.newInstance((Class<?>) clazz, size);
    ...
    @Override // org.apache.ibatis.javassist.bytecode.annotation.MemberValue
    Class getType(ClassLoader cl) throws ClassNotFoundException, NegativeArraySizeException {
        if (this.type == null) {
            throw new ClassNotFoundException("no array type specified");
        }
        Object a = Array.newInstance((Class<?>) this.type.getType(cl), 0);
        return a.getClass();
    }
