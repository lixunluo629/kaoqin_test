...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/annotation/TypeAnnotationsWriter.class */
public class TypeAnnotationsWriter extends AnnotationsWriter {
    public TypeAnnotationsWriter(OutputStream os, ConstPool cp) {
        super(os, cp);
    }

    @Override // org.apache.ibatis.javassist.bytecode.annotation.AnnotationsWriter
