...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/Descriptor.class */
public class Descriptor {
    ...
    public static String toClassName(String descriptor) {
        ...
        if (c == 'L') {
            ...
            name = XmlErrorCodes.DOUBLE;
        } else if (c == 'F') {
            name = XmlErrorCodes.FLOAT;
        } else if (c == 'C') {
            name = "char";
        } else if (c == 'S') {
            name = "short";
    ...
    public static String of(String classname) {
        ...
        return StandardRoles.L + toJvmName(classname) + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR;
    }
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/Descriptor$PrettyPrinter.class */
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/Descriptor$Iterator.class */
