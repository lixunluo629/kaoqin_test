...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/stackmap/Tracer.class */
    ...
    private int doOpcode148_201(int pos, byte[] code, int op) throws BadBytecode {
        ...
        switch (op) {
            ...
            case 189:
                ...
                if (type2.charAt(0) == '[') {
                    type = PropertyAccessor.PROPERTY_KEY_PREFIX + type2;
                } else {
                    type = "[L" + type2 + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR;
                }
