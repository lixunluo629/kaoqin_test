...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/InstructionPrinter.class */
public class InstructionPrinter implements Opcode {
    ...
    public static String instructionString(CodeIterator iter, int pos, ConstPool pool) {
        ...
        switch (opcode) {
            case 16:
                return opstring + SymbolConstants.SPACE_SYMBOL + iter.byteAt(pos + 1);
            case 17:
                return opstring + SymbolConstants.SPACE_SYMBOL + iter.s16bitAt(pos + 1);
            case 18:
                return opstring + SymbolConstants.SPACE_SYMBOL + ldc(pool, iter.byteAt(pos + 1));
            case 19:
            case 20:
                return opstring + SymbolConstants.SPACE_SYMBOL + ldc(pool, iter.u16bitAt(pos + 1));
            case 21:
            case 22:
            case 23:
            case 24:
            ...
            default:
                return opstring;
            case 132:
                return opstring + SymbolConstants.SPACE_SYMBOL + iter.byteAt(pos + 1) + ", " + iter.signedByteAt(pos + 2);
            case 153:
            case 154:
            case 155:
            case 156:
            ...
            case 198:
            case 199:
                return opstring + SymbolConstants.SPACE_SYMBOL + (iter.s16bitAt(pos + 1) + pos);
            case 167:
            case 168:
                return opstring + SymbolConstants.SPACE_SYMBOL + (iter.s16bitAt(pos + 1) + pos);
            case 169:
            ...
            case 180:
            case 181:
                return opstring + SymbolConstants.SPACE_SYMBOL + fieldInfo(pool, iter.u16bitAt(pos + 1));
            case 182:
            case 183:
            case 184:
                return opstring + SymbolConstants.SPACE_SYMBOL + methodInfo(pool, iter.u16bitAt(pos + 1));
            case 185:
                return opstring + SymbolConstants.SPACE_SYMBOL + interfaceMethodInfo(pool, iter.u16bitAt(pos + 1));
            case 186:
                return opstring + SymbolConstants.SPACE_SYMBOL + iter.u16bitAt(pos + 1);
            case 187:
                return opstring + SymbolConstants.SPACE_SYMBOL + classInfo(pool, iter.u16bitAt(pos + 1));
            case 188:
                return opstring + SymbolConstants.SPACE_SYMBOL + arrayInfo(iter.byteAt(pos + 1));
            case 189:
            case 192:
                return opstring + SymbolConstants.SPACE_SYMBOL + classInfo(pool, iter.u16bitAt(pos + 1));
            case 196:
            ...
            case 200:
            case 201:
                return opstring + SymbolConstants.SPACE_SYMBOL + (iter.s32bitAt(pos + 1) + pos);
        }
    }
    ...
    private static String wide(CodeIterator iter, int pos) {
        ...
        switch (opcode) {
            ...
            case 132:
            case 169:
                return opcodes[opcode] + SymbolConstants.SPACE_SYMBOL + index;
            default:
    ...
    private static String lookupSwitch(CodeIterator iter, int pos) {
        ...
        int index = (pos & (-4)) + 4;
        buffer.append("\t\tdefault: ").append(pos + iter.s32bitAt(index)).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        int index2 = index + 4;
        ...
        while (index3 < end) {
            ...
            buffer.append("\t\t").append(match).append(": ").append(target).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
            index3 += 8;
        }
    ...
    private static String tableSwitch(CodeIterator iter, int pos) {
        ...
        while (index4 < end) {
            ...
            buffer.append("\t\t").append(key).append(": ").append(target).append(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
            index4 += 4;
            key++;
        }
        buffer.setCharAt(buffer.length() - 1, '}');
    ...
    private static String ldc(ConstPool pool, int index) {
        ...
        switch (tag) {
            ...
            case 8:
                return "#" + index + " = \"" + pool.getStringInfo(index) + SymbolConstants.QUOTES_SYMBOL;
            default:
