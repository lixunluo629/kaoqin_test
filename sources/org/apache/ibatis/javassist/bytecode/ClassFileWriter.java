...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/ClassFileWriter.class */
public class ClassFileWriter {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/ClassFileWriter$AttributeWriter.class */
    ...
    public byte[] end(int accessFlags, int thisClass, int superClass, int[] interfaces, AttributeWriter aw) throws IOException {
        this.constPool.end();
    ...
    static void writeAttribute(ByteStream bs, AttributeWriter aw, int attrCount) throws IOException {
        if (aw == null) {
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/ClassFileWriter$FieldWriter.class */
    public static final class FieldWriter {
        ...
        public void add(int accessFlags, String name, String descriptor, AttributeWriter aw) throws IOException {
        ...
        public void add(int accessFlags, int name, int descriptor, AttributeWriter aw) throws IOException {
            this.fieldCount++;
            this.output.writeShort(accessFlags);
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/ClassFileWriter$MethodWriter.class */
    public static final class MethodWriter {
        ...
        public void begin(int accessFlags, String name, String descriptor, String[] exceptions, AttributeWriter aw) throws IOException {
            int[] intfs;
            int nameIndex = this.constPool.addUtf8Info(name);
            int descIndex = this.constPool.addUtf8Info(descriptor);
            if (exceptions == null) {
        ...
        public void begin(int accessFlags, int name, int descriptor, int[] exceptions, AttributeWriter aw) throws IOException {
            this.methodCount++;
            this.output.writeShort(accessFlags);
            this.output.writeShort(name);
            this.output.writeShort(descriptor);
        ...
        public void end(StackMapTable.Writer smap, AttributeWriter aw) throws IOException {
            if (this.isAbstract) {
                return;
            }
    ...
    /* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/bytecode/ClassFileWriter$ConstPoolWriter.class */
