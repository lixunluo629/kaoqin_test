...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/CtNewMethod.class */
public class CtNewMethod {
    ...
    public static CtMethod copy(CtMethod src, String name, CtClass declaring, ClassMap map) throws RuntimeException, CannotCompileException {
    ...
    private static CtMethod delegator0(CtMethod delegate, CtClass declaring) throws NotFoundException, CannotCompileException {
        int s;
