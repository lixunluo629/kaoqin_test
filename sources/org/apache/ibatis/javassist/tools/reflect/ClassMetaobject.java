...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/reflect/ClassMetaobject.class */
public class ClassMetaobject implements Serializable {
    ...
    public void trapFieldWrite(String name, Object value) throws IllegalAccessException, IllegalArgumentException {
        Class jc = getJavaClass();
        try {
    ...
    public final Method[] getReflectiveMethods() throws SecurityException {
    ...
    public final int getMethodIndex(String originalName, Class[] argTypes) throws NoSuchMethodException, SecurityException {
