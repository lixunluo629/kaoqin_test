...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/reflect/Compiler.class */
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (entries[i].metaobject != null || entries[i].classobject != null) {
                if (entries[i].metaobject == null) {
                    metaobj = "org.apache.ibatis.javassist.tools.reflect.Metaobject";
                } else {
                    metaobj = entries[i].metaobject;
                }
                if (entries[i].classobject == null) {
                    classobj = "org.apache.ibatis.javassist.tools.reflect.ClassMetaobject";
                } else {
