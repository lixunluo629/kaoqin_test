...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/rmi/StubGenerator.class */
public class StubGenerator implements Translator {
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        this.proxyConstructorParamTypes = pool.get(new String[]{"org.apache.ibatis.javassist.tools.rmi.ObjectImporter", XmlErrorCodes.INT});
        this.interfacesForProxy = pool.get(new String[]{"java.io.Serializable", "org.apache.ibatis.javassist.tools.rmi.Proxy"});
        this.exceptionForProxy = new CtClass[]{pool.get("org.apache.ibatis.javassist.tools.rmi.RemoteException")};
    }
    ...
    public synchronized boolean makeProxyClass(Class clazz) throws NotFoundException, RuntimeException, CannotCompileException {
    ...
    private CtClass produceProxyClass(CtClass orgclass, Class orgRtClass) throws NotFoundException, RuntimeException, CannotCompileException {
        ...
        CtField f = new CtField(this.classPool.get("org.apache.ibatis.javassist.tools.rmi.ObjectImporter"), fieldImporter, proxy);
        f.setModifiers(2);
    ...
    private void addMethods(CtClass proxy, Method[] ms) throws NotFoundException, RuntimeException, CannotCompileException {
        CtMethod body;
    ...
    private void modifySuperclass(CtClass orgclass) throws NotFoundException, RuntimeException, CannotCompileException {
        while (true) {
