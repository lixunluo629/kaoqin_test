...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/rmi/AppletServer.class */
public class AppletServer extends Webserver {
    ...
    @Override // org.apache.ibatis.javassist.tools.web.Webserver
    public void run() {
        super.run();
    }

    public synchronized int exportObject(String name, Object obj) throws RuntimeException, CannotCompileException {
    ...
    @Override // org.apache.ibatis.javassist.tools.web.Webserver
    public void doReply(InputStream in, OutputStream out, String cmd) throws BadHttpRequest, IOException {
    ...
    private void lookupName(String cmd, InputStream ins, OutputStream outs) throws IOException {
        ...
        if (found == null) {
            ...
            out.writeInt(-1);
            out.writeUTF(AsmRelationshipUtils.DECLARE_ERROR);
        } else {
            logging2(name);
