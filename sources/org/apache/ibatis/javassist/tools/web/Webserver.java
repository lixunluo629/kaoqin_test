...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/web/Webserver.class */
public class Webserver {
    ...
    private boolean letUsersSendClassfile(OutputStream out, String filename, int length) throws BadHttpRequest, IOException {
