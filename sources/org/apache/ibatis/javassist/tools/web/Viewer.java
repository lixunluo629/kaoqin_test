...
/* loaded from: mybatis-3.4.6.jar:org/apache/ibatis/javassist/tools/web/Viewer.class */
public class Viewer extends ClassLoader {
    ...
    protected Class findClass(String name) throws ClassNotFoundException {
        Class c = null;
        if (name.startsWith("java.") || name.startsWith("javax.") || name.equals("org.apache.ibatis.javassist.tools.web.Viewer")) {
    ...
    protected byte[] fetchClass(String classname) throws Exception {
        byte[] b;
        URL url = new URL("http", this.server, this.port, "/" + classname.replace('.', '/') + ClassUtils.CLASS_FILE_SUFFIX);
