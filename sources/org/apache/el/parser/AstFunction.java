...
/* loaded from: tomcat-embed-el-8.5.43.jar:org/apache/el/parser/AstFunction.class */
public final class AstFunction extends SimpleNode {
    ...
    public Object getValue(EvaluationContext ctx) throws IllegalAccessException, ELException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        if (m == null && this.prefix.length() == 0) {
            ...
            if (obj2 != null) {
                return ctx.getELResolver().invoke(ctx, new ELClass((Class) obj2), "<init>", null, ((AstMethodParameters) this.children[0]).getParameters(ctx));
            }
