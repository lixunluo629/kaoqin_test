...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STSlideLayoutType.class */
public interface STSlideLayoutType extends XmlToken {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STSlideLayoutType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STSlideLayoutType$Factory.class */
    public static final class Factory {
        ...
        public static STSlideLayoutType newInstance(XmlOptions xmlOptions) {
            return (STSlideLayoutType) POIXMLTypeLoader.newInstance(STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(String str) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(str, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(str, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(File file) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(file, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(file, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(URL url) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(url, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(url, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(InputStream inputStream) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(inputStream, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(inputStream, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(Reader reader) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(reader, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(reader, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(xMLStreamReader, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(xMLStreamReader, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(Node node) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(node, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(node, STSlideLayoutType.type, xmlOptions);
        }

        public static STSlideLayoutType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(xMLInputStream, STSlideLayoutType.type, (XmlOptions) null);
        }

        public static STSlideLayoutType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STSlideLayoutType) POIXMLTypeLoader.parse(xMLInputStream, STSlideLayoutType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STSlideLayoutType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STSlideLayoutType.type, xmlOptions);
        }
