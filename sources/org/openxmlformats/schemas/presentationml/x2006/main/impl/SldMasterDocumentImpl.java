...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/SldMasterDocumentImpl.class */
public class SldMasterDocumentImpl extends XmlComplexContentImpl implements SldMasterDocument {
    ...
    public void setSldMaster(CTSlideMaster cTSlideMaster) {
        synchronized (monitor()) {
            check_orphaned();
            CTSlideMaster cTSlideMaster2 = (CTSlideMaster) get_store().find_element_user(SLDMASTER$0, 0);
            if (cTSlideMaster2 == null) {
                cTSlideMaster2 = (CTSlideMaster) get_store().add_element_user(SLDMASTER$0);
            }
