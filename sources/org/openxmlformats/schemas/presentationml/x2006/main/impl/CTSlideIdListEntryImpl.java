...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/CTSlideIdListEntryImpl.class */
public class CTSlideIdListEntryImpl extends XmlComplexContentImpl implements CTSlideIdListEntry {
    ...
    public void xsetId(STSlideId sTSlideId) {
        synchronized (monitor()) {
            check_orphaned();
            STSlideId sTSlideId2 = (STSlideId) get_store().find_attribute_user(ID$2);
            if (sTSlideId2 == null) {
                sTSlideId2 = (STSlideId) get_store().add_attribute_user(ID$2);
            }
