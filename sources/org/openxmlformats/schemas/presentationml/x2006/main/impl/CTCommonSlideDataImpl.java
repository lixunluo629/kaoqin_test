...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/CTCommonSlideDataImpl.class */
public class CTCommonSlideDataImpl extends XmlComplexContentImpl implements CTCommonSlideData {
    ...
    public void setBg(CTBackground cTBackground) {
        synchronized (monitor()) {
            check_orphaned();
            CTBackground cTBackground2 = (CTBackground) get_store().find_element_user(BG$0, 0);
            if (cTBackground2 == null) {
                cTBackground2 = (CTBackground) get_store().add_element_user(BG$0);
            }
    ...
    public void setSpTree(CTGroupShape cTGroupShape) {
        synchronized (monitor()) {
            check_orphaned();
            CTGroupShape cTGroupShape2 = (CTGroupShape) get_store().find_element_user(SPTREE$2, 0);
            if (cTGroupShape2 == null) {
                cTGroupShape2 = (CTGroupShape) get_store().add_element_user(SPTREE$2);
            }
    ...
    public void setCustDataLst(CTCustomerDataList cTCustomerDataList) {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomerDataList cTCustomerDataList2 = (CTCustomerDataList) get_store().find_element_user(CUSTDATALST$4, 0);
            if (cTCustomerDataList2 == null) {
                cTCustomerDataList2 = (CTCustomerDataList) get_store().add_element_user(CUSTDATALST$4);
            }
    ...
    public CTControlList getControls() {
        synchronized (monitor()) {
            check_orphaned();
            CTControlList cTControlListFind_element_user = get_store().find_element_user(CONTROLS$6, 0);
    ...
    public void setControls(CTControlList cTControlList) {
        synchronized (monitor()) {
            ...
            CTControlList cTControlListFind_element_user = get_store().find_element_user(CONTROLS$6, 0);
            if (cTControlListFind_element_user == null) {
                cTControlListFind_element_user = (CTControlList) get_store().add_element_user(CONTROLS$6);
            }
            cTControlListFind_element_user.set(cTControlList);
        }
    }
    ...
    public CTControlList addNewControls() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTControlListAdd_element_user = get_store().add_element_user(CONTROLS$6);
        }
