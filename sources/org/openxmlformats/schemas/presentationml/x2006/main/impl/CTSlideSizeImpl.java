...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/CTSlideSizeImpl.class */
public class CTSlideSizeImpl extends XmlComplexContentImpl implements CTSlideSize {
    ...
    public void xsetCx(STSlideSizeCoordinate sTSlideSizeCoordinate) {
        synchronized (monitor()) {
            check_orphaned();
            STSlideSizeCoordinate sTSlideSizeCoordinate2 = (STSlideSizeCoordinate) get_store().find_attribute_user(CX$0);
            if (sTSlideSizeCoordinate2 == null) {
                sTSlideSizeCoordinate2 = (STSlideSizeCoordinate) get_store().add_attribute_user(CX$0);
            }
    ...
    public void xsetCy(STSlideSizeCoordinate sTSlideSizeCoordinate) {
        synchronized (monitor()) {
            check_orphaned();
            STSlideSizeCoordinate sTSlideSizeCoordinate2 = (STSlideSizeCoordinate) get_store().find_attribute_user(CY$2);
            if (sTSlideSizeCoordinate2 == null) {
                sTSlideSizeCoordinate2 = (STSlideSizeCoordinate) get_store().add_attribute_user(CY$2);
            }
            sTSlideSizeCoordinate2.set(sTSlideSizeCoordinate);
        }
    }
    ...
    public STSlideSizeType xgetType() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STSlideSizeType sTSlideSizeTypeFind_attribute_user = get_store().find_attribute_user(TYPE$4);
            if (sTSlideSizeTypeFind_attribute_user == null) {
                sTSlideSizeTypeFind_attribute_user = (STSlideSizeType) get_default_attribute_value(TYPE$4);
            }
            sTSlideSizeType = sTSlideSizeTypeFind_attribute_user;
        }
    ...
    public void xsetType(STSlideSizeType sTSlideSizeType) {
        synchronized (monitor()) {
            ...
            STSlideSizeType sTSlideSizeTypeFind_attribute_user = get_store().find_attribute_user(TYPE$4);
            if (sTSlideSizeTypeFind_attribute_user == null) {
                sTSlideSizeTypeFind_attribute_user = (STSlideSizeType) get_store().add_attribute_user(TYPE$4);
            }
            sTSlideSizeTypeFind_attribute_user.set(sTSlideSizeType);
        }
    }
