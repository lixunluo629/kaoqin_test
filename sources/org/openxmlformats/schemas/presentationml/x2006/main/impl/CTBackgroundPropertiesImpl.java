...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/CTBackgroundPropertiesImpl.class */
public class CTBackgroundPropertiesImpl extends XmlComplexContentImpl implements CTBackgroundProperties {
    ...
    public CTExtensionList getExtLst() {
        synchronized (monitor()) {
            check_orphaned();
            CTExtensionList cTExtensionListFind_element_user = get_store().find_element_user(EXTLST$16, 0);
    ...
    public void setExtLst(CTExtensionList cTExtensionList) {
        synchronized (monitor()) {
            ...
            CTExtensionList cTExtensionListFind_element_user = get_store().find_element_user(EXTLST$16, 0);
            if (cTExtensionListFind_element_user == null) {
                cTExtensionListFind_element_user = (CTExtensionList) get_store().add_element_user(EXTLST$16);
            }
    ...
    public CTExtensionList addNewExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTExtensionListAdd_element_user = get_store().add_element_user(EXTLST$16);
        }
    ...
    public boolean getShadeToTitle() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(SHADETOTITLE$18);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetShadeToTitle() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(SHADETOTITLE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(SHADETOTITLE$18);
            }
    ...
    public void xsetShadeToTitle(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(SHADETOTITLE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(SHADETOTITLE$18);
            }
