...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/impl/PresentationDocumentImpl.class */
public class PresentationDocumentImpl extends XmlComplexContentImpl implements PresentationDocument {
    ...
    public void setPresentation(CTPresentation cTPresentation) {
        synchronized (monitor()) {
            check_orphaned();
            CTPresentation cTPresentation2 = (CTPresentation) get_store().find_element_user(PRESENTATION$0, 0);
            if (cTPresentation2 == null) {
                cTPresentation2 = (CTPresentation) get_store().add_element_user(PRESENTATION$0);
            }
