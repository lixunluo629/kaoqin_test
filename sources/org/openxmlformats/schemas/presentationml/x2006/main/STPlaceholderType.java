...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STPlaceholderType.class */
public interface STPlaceholderType extends XmlToken {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STPlaceholderType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/presentationml/x2006/main/STPlaceholderType$Factory.class */
    public static final class Factory {
        ...
        public static STPlaceholderType newInstance(XmlOptions xmlOptions) {
            return (STPlaceholderType) POIXMLTypeLoader.newInstance(STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(String str) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(str, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(str, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(File file) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(file, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(file, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(URL url) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(url, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(url, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(InputStream inputStream) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(inputStream, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(inputStream, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(Reader reader) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(reader, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(reader, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(xMLStreamReader, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(xMLStreamReader, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(Node node) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(node, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(node, STPlaceholderType.type, xmlOptions);
        }

        public static STPlaceholderType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(xMLInputStream, STPlaceholderType.type, (XmlOptions) null);
        }

        public static STPlaceholderType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STPlaceholderType) POIXMLTypeLoader.parse(xMLInputStream, STPlaceholderType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPlaceholderType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPlaceholderType.type, xmlOptions);
        }
