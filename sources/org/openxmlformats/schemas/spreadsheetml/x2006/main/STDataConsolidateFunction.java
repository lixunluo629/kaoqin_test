...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataConsolidateFunction.class */
public interface STDataConsolidateFunction extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataConsolidateFunction$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataConsolidateFunction$Factory.class */
    public static final class Factory {
        ...
        public static STDataConsolidateFunction newInstance(XmlOptions xmlOptions) {
            return (STDataConsolidateFunction) POIXMLTypeLoader.newInstance(STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(String str) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(str, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(str, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(File file) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(file, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(file, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(URL url) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(url, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(url, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(InputStream inputStream) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(inputStream, STDataConsolidateFunction.type, (XmlOptions) null);
        }
        ...
        public static STDataConsolidateFunction parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(inputStream, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(Reader reader) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(reader, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(reader, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(xMLStreamReader, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(xMLStreamReader, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(Node node) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(node, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(node, STDataConsolidateFunction.type, xmlOptions);
        }

        public static STDataConsolidateFunction parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(xMLInputStream, STDataConsolidateFunction.type, (XmlOptions) null);
        }

        public static STDataConsolidateFunction parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STDataConsolidateFunction) POIXMLTypeLoader.parse(xMLInputStream, STDataConsolidateFunction.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STDataConsolidateFunction.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STDataConsolidateFunction.type, xmlOptions);
        }
