...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STTableStyleType.class */
public interface STTableStyleType extends XmlString {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(STTableStyleType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("sttablestyletype9936type");
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STTableStyleType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STTableStyleType$Factory.class */
    public static final class Factory {
        public static STTableStyleType newValue(Object obj) {
            return (STTableStyleType) STTableStyleType.type.newValue(obj);
        }

        public static STTableStyleType newInstance() {
            return (STTableStyleType) POIXMLTypeLoader.newInstance(STTableStyleType.type, null);
        }

        public static STTableStyleType newInstance(XmlOptions xmlOptions) {
            return (STTableStyleType) POIXMLTypeLoader.newInstance(STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(String str) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(str, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(str, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(File file) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(file, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(file, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(URL url) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(url, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(url, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(InputStream inputStream) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(inputStream, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(inputStream, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(Reader reader) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(reader, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTableStyleType) POIXMLTypeLoader.parse(reader, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(xMLStreamReader, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(xMLStreamReader, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(Node node) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(node, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(node, STTableStyleType.type, xmlOptions);
        }

        public static STTableStyleType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(xMLInputStream, STTableStyleType.type, (XmlOptions) null);
        }

        public static STTableStyleType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STTableStyleType) POIXMLTypeLoader.parse(xMLInputStream, STTableStyleType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTableStyleType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTableStyleType.type, xmlOptions);
        }
