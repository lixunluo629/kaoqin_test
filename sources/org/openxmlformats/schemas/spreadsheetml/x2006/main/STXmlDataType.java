...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STXmlDataType.class */
public interface STXmlDataType extends XmlString {
    ...
    public static final Enum STRING = Enum.forString(StringProperty.TYPE);
    ...
    public static final Enum DURATION = Enum.forString(XmlErrorCodes.DURATION);
    ...
    public static final Enum LANGUAGE = Enum.forString(PdfConst.Language);
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STXmlDataType$Enum.class */
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum(StringProperty.TYPE, 1), new Enum("normalizedString", 2), new Enum("token", 3), new Enum("byte", 4), new Enum("unsignedByte", 5), new Enum(XmlErrorCodes.BASE64BINARY, 6), new Enum(XmlErrorCodes.HEXBINARY, 7), new Enum("integer", 8), new Enum("positiveInteger", 9), new Enum("negativeInteger", 10), new Enum("nonPositiveInteger", 11), new Enum("nonNegativeInteger", 12), new Enum(XmlErrorCodes.INT, 13), new Enum("unsignedInt", 14), new Enum(XmlErrorCodes.LONG, 15), new Enum("unsignedLong", 16), new Enum("short", 17), new Enum("unsignedShort", 18), new Enum(XmlErrorCodes.DECIMAL, 19), new Enum(XmlErrorCodes.FLOAT, 20), new Enum(XmlErrorCodes.DOUBLE, 21), new Enum("boolean", 22), new Enum(RtspHeaders.Values.TIME, 23), new Enum("dateTime", 24), new Enum(XmlErrorCodes.DURATION, 25), new Enum("date", 26), new Enum("gMonth", 27), new Enum("gYear", 28), new Enum("gYearMonth", 29), new Enum("gDay", 30), new Enum("gMonthDay", 31), new Enum("Name", 32), new Enum(XmlErrorCodes.QNAME, 33), new Enum(XmlErrorCodes.NCNAME, 34), new Enum(XmlErrorCodes.ANYURI, 35), new Enum(PdfConst.Language, 36), new Enum("ID", 37), new Enum("IDREF", 38), new Enum("IDREFS", 39), new Enum("ENTITY", 40), new Enum("ENTITIES", 41), new Enum("NOTATION", 42), new Enum(XmlErrorCodes.NMTOKEN, 43), new Enum("NMTOKENS", 44), new Enum("anyType", 45)});
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STXmlDataType$Factory.class */
    public static final class Factory {
        ...
        public static STXmlDataType newInstance(XmlOptions xmlOptions) {
            return (STXmlDataType) POIXMLTypeLoader.newInstance(STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(String str) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(str, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(str, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(File file) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(file, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(file, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(URL url) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(url, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(url, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(InputStream inputStream) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(inputStream, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(inputStream, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(Reader reader) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(reader, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STXmlDataType) POIXMLTypeLoader.parse(reader, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(xMLStreamReader, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(xMLStreamReader, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(Node node) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(node, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(node, STXmlDataType.type, xmlOptions);
        }

        public static STXmlDataType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(xMLInputStream, STXmlDataType.type, (XmlOptions) null);
        }

        public static STXmlDataType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STXmlDataType) POIXMLTypeLoader.parse(xMLInputStream, STXmlDataType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STXmlDataType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STXmlDataType.type, xmlOptions);
        }
