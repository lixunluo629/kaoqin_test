...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTCellAlignmentImpl.class */
public class CTCellAlignmentImpl extends XmlComplexContentImpl implements CTCellAlignment {
    ...
    public void xsetHorizontal(STHorizontalAlignment sTHorizontalAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            STHorizontalAlignment sTHorizontalAlignment2 = (STHorizontalAlignment) get_store().find_attribute_user(HORIZONTAL$0);
            if (sTHorizontalAlignment2 == null) {
                sTHorizontalAlignment2 = (STHorizontalAlignment) get_store().add_attribute_user(HORIZONTAL$0);
            }
    ...
    public void xsetVertical(STVerticalAlignment sTVerticalAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            STVerticalAlignment sTVerticalAlignment2 = (STVerticalAlignment) get_store().find_attribute_user(VERTICAL$2);
            if (sTVerticalAlignment2 == null) {
                sTVerticalAlignment2 = (STVerticalAlignment) get_store().add_attribute_user(VERTICAL$2);
            }
    ...
    public void xsetTextRotation(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(TEXTROTATION$4);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(TEXTROTATION$4);
            }
    ...
    public void xsetWrapText(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(WRAPTEXT$6);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(WRAPTEXT$6);
            }
    ...
    public void xsetIndent(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(INDENT$8);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(INDENT$8);
            }
            xmlUnsignedInt2.set(xmlUnsignedInt);
        }
    }
    ...
    public void xsetRelativeIndent(XmlInt xmlInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(RELATIVEINDENT$10);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_attribute_user(RELATIVEINDENT$10);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public void xsetJustifyLastLine(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(JUSTIFYLASTLINE$12);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(JUSTIFYLASTLINE$12);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetShrinkToFit(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(SHRINKTOFIT$14);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(SHRINKTOFIT$14);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetReadingOrder(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(READINGORDER$16);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(READINGORDER$16);
            }
            xmlUnsignedInt2.set(xmlUnsignedInt);
        }
    }
