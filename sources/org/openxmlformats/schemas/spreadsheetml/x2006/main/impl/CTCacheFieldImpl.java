...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTCacheFieldImpl.class */
public class CTCacheFieldImpl extends XmlComplexContentImpl implements CTCacheField {
    private static final QName SHAREDITEMS$0 = new QName(XSSFRelation.NS_SPREADSHEETML, "sharedItems");
    private static final QName FIELDGROUP$2 = new QName(XSSFRelation.NS_SPREADSHEETML, "fieldGroup");
    private static final QName MPMAP$4 = new QName(XSSFRelation.NS_SPREADSHEETML, "mpMap");
    ...
    public void setSharedItems(CTSharedItems cTSharedItems) {
        synchronized (monitor()) {
            check_orphaned();
            CTSharedItems cTSharedItems2 = (CTSharedItems) get_store().find_element_user(SHAREDITEMS$0, 0);
            if (cTSharedItems2 == null) {
                cTSharedItems2 = (CTSharedItems) get_store().add_element_user(SHAREDITEMS$0);
            }
    ...
    public CTFieldGroup getFieldGroup() {
        synchronized (monitor()) {
            check_orphaned();
            CTFieldGroup cTFieldGroupFind_element_user = get_store().find_element_user(FIELDGROUP$2, 0);
    ...
    public void setFieldGroup(CTFieldGroup cTFieldGroup) {
        synchronized (monitor()) {
            ...
            CTFieldGroup cTFieldGroupFind_element_user = get_store().find_element_user(FIELDGROUP$2, 0);
            if (cTFieldGroupFind_element_user == null) {
                cTFieldGroupFind_element_user = (CTFieldGroup) get_store().add_element_user(FIELDGROUP$2);
            }
            cTFieldGroupFind_element_user.set(cTFieldGroup);
        }
    }
    ...
    public CTFieldGroup addNewFieldGroup() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTFieldGroupAdd_element_user = get_store().add_element_user(FIELDGROUP$2);
        }
    ...
    public CTX getMpMapArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            ctxFind_element_user = get_store().find_element_user(MPMAP$4, i);
    ...
    public int sizeOfMpMapArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MPMAP$4);
        }
    ...
    public void setMpMapArray(int i, CTX ctx) {
        synchronized (monitor()) {
            check_orphaned();
            CTX ctxFind_element_user = get_store().find_element_user(MPMAP$4, i);
            if (ctxFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            ctxFind_element_user.set(ctx);
        }
    }
    ...
    public CTX insertNewMpMap(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            ctxInsert_element_user = get_store().insert_element_user(MPMAP$4, i);
        }
    ...
    public CTX addNewMpMap() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            ctxAdd_element_user = get_store().add_element_user(MPMAP$4);
        }
    ...
    public void xsetCaption(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(CAPTION$10);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(CAPTION$10);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetPropertyName(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(PROPERTYNAME$12);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(PROPERTYNAME$12);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public boolean getServerField() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(SERVERFIELD$14);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetServerField() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(SERVERFIELD$14);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(SERVERFIELD$14);
            }
    ...
    public void xsetServerField(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(SERVERFIELD$14);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(SERVERFIELD$14);
            }
    ...
    public boolean getUniqueList() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(UNIQUELIST$16);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetUniqueList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(UNIQUELIST$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(UNIQUELIST$16);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetUniqueList(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(UNIQUELIST$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(UNIQUELIST$16);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetNumFmtId(STNumFmtId sTNumFmtId) {
        synchronized (monitor()) {
            check_orphaned();
            STNumFmtId sTNumFmtId2 = (STNumFmtId) get_store().find_attribute_user(NUMFMTID$18);
            if (sTNumFmtId2 == null) {
                sTNumFmtId2 = (STNumFmtId) get_store().add_attribute_user(NUMFMTID$18);
            }
    ...
    public void xsetFormula(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(FORMULA$20);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(FORMULA$20);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public int getSqlType() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(SQLTYPE$22);
            if (simpleValue == null) {
    ...
    public XmlInt xgetSqlType() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(SQLTYPE$22);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_default_attribute_value(SQLTYPE$22);
            }
            xmlInt = xmlInt2;
        }
        return xmlInt;
    ...
    public void xsetSqlType(XmlInt xmlInt) {
        synchronized (monitor()) {
            ...
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(SQLTYPE$22);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_attribute_user(SQLTYPE$22);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public int getHierarchy() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(HIERARCHY$24);
            if (simpleValue == null) {
    ...
    public XmlInt xgetHierarchy() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(HIERARCHY$24);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_default_attribute_value(HIERARCHY$24);
            }
            xmlInt = xmlInt2;
        }
        return xmlInt;
    ...
    public void xsetHierarchy(XmlInt xmlInt) {
        synchronized (monitor()) {
            ...
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(HIERARCHY$24);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_attribute_user(HIERARCHY$24);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public long getLevel() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(LEVEL$26);
            if (simpleValue == null) {
    ...
    public XmlUnsignedInt xgetLevel() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(LEVEL$26);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_default_attribute_value(LEVEL$26);
            }
    ...
    public void xsetLevel(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            ...
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(LEVEL$26);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(LEVEL$26);
            }
    ...
    public boolean getDatabaseField() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(DATABASEFIELD$28);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetDatabaseField() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DATABASEFIELD$28);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(DATABASEFIELD$28);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetDatabaseField(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DATABASEFIELD$28);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(DATABASEFIELD$28);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetMappingCount(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(MAPPINGCOUNT$30);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(MAPPINGCOUNT$30);
            }
            xmlUnsignedInt2.set(xmlUnsignedInt);
        }
    }
    ...
    public boolean getMemberPropertyField() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(MEMBERPROPERTYFIELD$32);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetMemberPropertyField() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(MEMBERPROPERTYFIELD$32);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(MEMBERPROPERTYFIELD$32);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetMemberPropertyField(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(MEMBERPROPERTYFIELD$32);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(MEMBERPROPERTYFIELD$32);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
