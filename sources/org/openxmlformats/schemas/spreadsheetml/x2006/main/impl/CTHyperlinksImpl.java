...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTHyperlinksImpl.class */
public class CTHyperlinksImpl extends XmlComplexContentImpl implements CTHyperlinks {
    private static final QName HYPERLINK$0 = new QName(XSSFRelation.NS_SPREADSHEETML, "hyperlink");
    ...
    public int sizeOfHyperlinkArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(HYPERLINK$0);
        }
