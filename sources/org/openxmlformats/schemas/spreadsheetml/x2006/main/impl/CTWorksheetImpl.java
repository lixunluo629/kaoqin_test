...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTWorksheetImpl.class */
public class CTWorksheetImpl extends XmlComplexContentImpl implements CTWorksheet {
    ...
    private static final QName DIMENSION$2 = new QName(XSSFRelation.NS_SPREADSHEETML, ExcelXmlConstants.DIMENSION);
    private static final QName SHEETVIEWS$4 = new QName(XSSFRelation.NS_SPREADSHEETML, "sheetViews");
    private static final QName SHEETFORMATPR$6 = new QName(XSSFRelation.NS_SPREADSHEETML, "sheetFormatPr");
    private static final QName COLS$8 = new QName(XSSFRelation.NS_SPREADSHEETML, TextareaTag.COLS_ATTRIBUTE);
    private static final QName SHEETDATA$10 = new QName(XSSFRelation.NS_SPREADSHEETML, "sheetData");
    private static final QName SHEETCALCPR$12 = new QName(XSSFRelation.NS_SPREADSHEETML, "sheetCalcPr");
    private static final QName SHEETPROTECTION$14 = new QName(XSSFRelation.NS_SPREADSHEETML, "sheetProtection");
    private static final QName PROTECTEDRANGES$16 = new QName(XSSFRelation.NS_SPREADSHEETML, "protectedRanges");
    private static final QName SCENARIOS$18 = new QName(XSSFRelation.NS_SPREADSHEETML, "scenarios");
    private static final QName AUTOFILTER$20 = new QName(XSSFRelation.NS_SPREADSHEETML, "autoFilter");
    private static final QName SORTSTATE$22 = new QName(XSSFRelation.NS_SPREADSHEETML, "sortState");
    private static final QName DATACONSOLIDATE$24 = new QName(XSSFRelation.NS_SPREADSHEETML, "dataConsolidate");
    private static final QName CUSTOMSHEETVIEWS$26 = new QName(XSSFRelation.NS_SPREADSHEETML, "customSheetViews");
    private static final QName MERGECELLS$28 = new QName(XSSFRelation.NS_SPREADSHEETML, "mergeCells");
    private static final QName PHONETICPR$30 = new QName(XSSFRelation.NS_SPREADSHEETML, "phoneticPr");
    private static final QName CONDITIONALFORMATTING$32 = new QName(XSSFRelation.NS_SPREADSHEETML, "conditionalFormatting");
    private static final QName DATAVALIDATIONS$34 = new QName(XSSFRelation.NS_SPREADSHEETML, "dataValidations");
    private static final QName HYPERLINKS$36 = new QName(XSSFRelation.NS_SPREADSHEETML, "hyperlinks");
    private static final QName PRINTOPTIONS$38 = new QName(XSSFRelation.NS_SPREADSHEETML, "printOptions");
    private static final QName PAGEMARGINS$40 = new QName(XSSFRelation.NS_SPREADSHEETML, "pageMargins");
    private static final QName PAGESETUP$42 = new QName(XSSFRelation.NS_SPREADSHEETML, "pageSetup");
    private static final QName HEADERFOOTER$44 = new QName(XSSFRelation.NS_SPREADSHEETML, "headerFooter");
    private static final QName ROWBREAKS$46 = new QName(XSSFRelation.NS_SPREADSHEETML, "rowBreaks");
    private static final QName COLBREAKS$48 = new QName(XSSFRelation.NS_SPREADSHEETML, "colBreaks");
    private static final QName CUSTOMPROPERTIES$50 = new QName(XSSFRelation.NS_SPREADSHEETML, "customProperties");
    private static final QName CELLWATCHES$52 = new QName(XSSFRelation.NS_SPREADSHEETML, "cellWatches");
    private static final QName IGNOREDERRORS$54 = new QName(XSSFRelation.NS_SPREADSHEETML, "ignoredErrors");
    private static final QName SMARTTAGS$56 = new QName(XSSFRelation.NS_SPREADSHEETML, "smartTags");
    private static final QName DRAWING$58 = new QName(XSSFRelation.NS_SPREADSHEETML, "drawing");
    private static final QName LEGACYDRAWING$60 = new QName(XSSFRelation.NS_SPREADSHEETML, "legacyDrawing");
    private static final QName LEGACYDRAWINGHF$62 = new QName(XSSFRelation.NS_SPREADSHEETML, "legacyDrawingHF");
    private static final QName PICTURE$64 = new QName(XSSFRelation.NS_SPREADSHEETML, "picture");
    private static final QName OLEOBJECTS$66 = new QName(XSSFRelation.NS_SPREADSHEETML, "oleObjects");
    private static final QName CONTROLS$68 = new QName(XSSFRelation.NS_SPREADSHEETML, "controls");
    private static final QName WEBPUBLISHITEMS$70 = new QName(XSSFRelation.NS_SPREADSHEETML, "webPublishItems");
    private static final QName TABLEPARTS$72 = new QName(XSSFRelation.NS_SPREADSHEETML, "tableParts");
    private static final QName EXTLST$74 = new QName(XSSFRelation.NS_SPREADSHEETML, "extLst");
    ...
    public void setDimension(CTSheetDimension cTSheetDimension) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetDimension cTSheetDimension2 = (CTSheetDimension) get_store().find_element_user(DIMENSION$2, 0);
            if (cTSheetDimension2 == null) {
                cTSheetDimension2 = (CTSheetDimension) get_store().add_element_user(DIMENSION$2);
            }
    ...
    public void setSheetViews(CTSheetViews cTSheetViews) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetViews cTSheetViews2 = (CTSheetViews) get_store().find_element_user(SHEETVIEWS$4, 0);
            if (cTSheetViews2 == null) {
                cTSheetViews2 = (CTSheetViews) get_store().add_element_user(SHEETVIEWS$4);
            }
    ...
    public void setSheetFormatPr(CTSheetFormatPr cTSheetFormatPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetFormatPr cTSheetFormatPr2 = (CTSheetFormatPr) get_store().find_element_user(SHEETFORMATPR$6, 0);
            if (cTSheetFormatPr2 == null) {
                cTSheetFormatPr2 = (CTSheetFormatPr) get_store().add_element_user(SHEETFORMATPR$6);
            }
    ...
    public int sizeOfColsArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(COLS$8);
        }
    ...
    public void setSheetData(CTSheetData cTSheetData) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetData cTSheetData2 = (CTSheetData) get_store().find_element_user(SHEETDATA$10, 0);
            if (cTSheetData2 == null) {
                cTSheetData2 = (CTSheetData) get_store().add_element_user(SHEETDATA$10);
            }
    ...
    public void setSheetCalcPr(CTSheetCalcPr cTSheetCalcPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetCalcPr cTSheetCalcPr2 = (CTSheetCalcPr) get_store().find_element_user(SHEETCALCPR$12, 0);
            if (cTSheetCalcPr2 == null) {
                cTSheetCalcPr2 = (CTSheetCalcPr) get_store().add_element_user(SHEETCALCPR$12);
            }
    ...
    public void setSheetProtection(CTSheetProtection cTSheetProtection) {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetProtection cTSheetProtection2 = (CTSheetProtection) get_store().find_element_user(SHEETPROTECTION$14, 0);
            if (cTSheetProtection2 == null) {
                cTSheetProtection2 = (CTSheetProtection) get_store().add_element_user(SHEETPROTECTION$14);
            }
    ...
    public CTProtectedRanges getProtectedRanges() {
        synchronized (monitor()) {
            check_orphaned();
            CTProtectedRanges cTProtectedRangesFind_element_user = get_store().find_element_user(PROTECTEDRANGES$16, 0);
            if (cTProtectedRangesFind_element_user == null) {
                return null;
            }
            return cTProtectedRangesFind_element_user;
        }
    }
    ...
    public void setProtectedRanges(CTProtectedRanges cTProtectedRanges) {
        synchronized (monitor()) {
            ...
            CTProtectedRanges cTProtectedRangesFind_element_user = get_store().find_element_user(PROTECTEDRANGES$16, 0);
            if (cTProtectedRangesFind_element_user == null) {
                cTProtectedRangesFind_element_user = (CTProtectedRanges) get_store().add_element_user(PROTECTEDRANGES$16);
            }
            cTProtectedRangesFind_element_user.set(cTProtectedRanges);
        }
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWorksheet
    public CTProtectedRanges addNewProtectedRanges() {
        CTProtectedRanges cTProtectedRangesAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTProtectedRangesAdd_element_user = get_store().add_element_user(PROTECTEDRANGES$16);
        }
        return cTProtectedRangesAdd_element_user;
    }
    ...
    public CTScenarios getScenarios() {
        synchronized (monitor()) {
            check_orphaned();
            CTScenarios cTScenariosFind_element_user = get_store().find_element_user(SCENARIOS$18, 0);
    ...
    public void setScenarios(CTScenarios cTScenarios) {
        synchronized (monitor()) {
            ...
            CTScenarios cTScenariosFind_element_user = get_store().find_element_user(SCENARIOS$18, 0);
            if (cTScenariosFind_element_user == null) {
                cTScenariosFind_element_user = (CTScenarios) get_store().add_element_user(SCENARIOS$18);
            }
            cTScenariosFind_element_user.set(cTScenarios);
        }
    }
    ...
    public CTScenarios addNewScenarios() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTScenariosAdd_element_user = get_store().add_element_user(SCENARIOS$18);
        }
    ...
    public void setAutoFilter(CTAutoFilter cTAutoFilter) {
        synchronized (monitor()) {
            check_orphaned();
            CTAutoFilter cTAutoFilter2 = (CTAutoFilter) get_store().find_element_user(AUTOFILTER$20, 0);
            if (cTAutoFilter2 == null) {
                cTAutoFilter2 = (CTAutoFilter) get_store().add_element_user(AUTOFILTER$20);
            }
    ...
    public CTSortState getSortState() {
        synchronized (monitor()) {
            check_orphaned();
            CTSortState cTSortStateFind_element_user = get_store().find_element_user(SORTSTATE$22, 0);
    ...
    public void setSortState(CTSortState cTSortState) {
        synchronized (monitor()) {
            ...
            CTSortState cTSortStateFind_element_user = get_store().find_element_user(SORTSTATE$22, 0);
            if (cTSortStateFind_element_user == null) {
                cTSortStateFind_element_user = (CTSortState) get_store().add_element_user(SORTSTATE$22);
            }
    ...
    public CTSortState addNewSortState() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTSortStateAdd_element_user = get_store().add_element_user(SORTSTATE$22);
        }
    ...
    public CTDataConsolidate getDataConsolidate() {
        synchronized (monitor()) {
            check_orphaned();
            CTDataConsolidate cTDataConsolidateFind_element_user = get_store().find_element_user(DATACONSOLIDATE$24, 0);
            if (cTDataConsolidateFind_element_user == null) {
                return null;
            }
            return cTDataConsolidateFind_element_user;
        }
    }
    ...
    public void setDataConsolidate(CTDataConsolidate cTDataConsolidate) {
        synchronized (monitor()) {
            ...
            CTDataConsolidate cTDataConsolidateFind_element_user = get_store().find_element_user(DATACONSOLIDATE$24, 0);
            if (cTDataConsolidateFind_element_user == null) {
                cTDataConsolidateFind_element_user = (CTDataConsolidate) get_store().add_element_user(DATACONSOLIDATE$24);
            }
            cTDataConsolidateFind_element_user.set(cTDataConsolidate);
        }
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWorksheet
    public CTDataConsolidate addNewDataConsolidate() {
        CTDataConsolidate cTDataConsolidateAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTDataConsolidateAdd_element_user = get_store().add_element_user(DATACONSOLIDATE$24);
        }
        return cTDataConsolidateAdd_element_user;
    }
    ...
    public CTCustomSheetViews getCustomSheetViews() {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomSheetViews cTCustomSheetViewsFind_element_user = get_store().find_element_user(CUSTOMSHEETVIEWS$26, 0);
    ...
    public void setCustomSheetViews(CTCustomSheetViews cTCustomSheetViews) {
        synchronized (monitor()) {
            ...
            CTCustomSheetViews cTCustomSheetViewsFind_element_user = get_store().find_element_user(CUSTOMSHEETVIEWS$26, 0);
            if (cTCustomSheetViewsFind_element_user == null) {
                cTCustomSheetViewsFind_element_user = (CTCustomSheetViews) get_store().add_element_user(CUSTOMSHEETVIEWS$26);
            }
    ...
    public CTCustomSheetViews addNewCustomSheetViews() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomSheetViewsAdd_element_user = get_store().add_element_user(CUSTOMSHEETVIEWS$26);
        }
    ...
    public void setMergeCells(CTMergeCells cTMergeCells) {
        synchronized (monitor()) {
            check_orphaned();
            CTMergeCells cTMergeCells2 = (CTMergeCells) get_store().find_element_user(MERGECELLS$28, 0);
            if (cTMergeCells2 == null) {
                cTMergeCells2 = (CTMergeCells) get_store().add_element_user(MERGECELLS$28);
            }
    ...
    public void setPhoneticPr(CTPhoneticPr cTPhoneticPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTPhoneticPr cTPhoneticPr2 = (CTPhoneticPr) get_store().find_element_user(PHONETICPR$30, 0);
            if (cTPhoneticPr2 == null) {
                cTPhoneticPr2 = (CTPhoneticPr) get_store().add_element_user(PHONETICPR$30);
            }
    ...
    public List<CTConditionalFormatting> getConditionalFormattingList() {
        1ConditionalFormattingList r0;
        synchronized (monitor()) {
            check_orphaned();
            r0 = new 1ConditionalFormattingList(this);
        }
        return r0;
    }
    ...
    public int sizeOfConditionalFormattingArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CONDITIONALFORMATTING$32);
        }
        return iCount_elements;
    }
    ...
    public void setDataValidations(CTDataValidations cTDataValidations) {
        synchronized (monitor()) {
            check_orphaned();
            CTDataValidations cTDataValidations2 = (CTDataValidations) get_store().find_element_user(DATAVALIDATIONS$34, 0);
            if (cTDataValidations2 == null) {
                cTDataValidations2 = (CTDataValidations) get_store().add_element_user(DATAVALIDATIONS$34);
            }
    ...
    public void setHyperlinks(CTHyperlinks cTHyperlinks) {
        synchronized (monitor()) {
            check_orphaned();
            CTHyperlinks cTHyperlinks2 = (CTHyperlinks) get_store().find_element_user(HYPERLINKS$36, 0);
            if (cTHyperlinks2 == null) {
                cTHyperlinks2 = (CTHyperlinks) get_store().add_element_user(HYPERLINKS$36);
            }
    ...
    public void setPrintOptions(CTPrintOptions cTPrintOptions) {
        synchronized (monitor()) {
            check_orphaned();
            CTPrintOptions cTPrintOptions2 = (CTPrintOptions) get_store().find_element_user(PRINTOPTIONS$38, 0);
            if (cTPrintOptions2 == null) {
                cTPrintOptions2 = (CTPrintOptions) get_store().add_element_user(PRINTOPTIONS$38);
            }
    ...
    public void setPageMargins(CTPageMargins cTPageMargins) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageMargins cTPageMargins2 = (CTPageMargins) get_store().find_element_user(PAGEMARGINS$40, 0);
            if (cTPageMargins2 == null) {
                cTPageMargins2 = (CTPageMargins) get_store().add_element_user(PAGEMARGINS$40);
            }
    ...
    public void setPageSetup(CTPageSetup cTPageSetup) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageSetup cTPageSetup2 = (CTPageSetup) get_store().find_element_user(PAGESETUP$42, 0);
            if (cTPageSetup2 == null) {
                cTPageSetup2 = (CTPageSetup) get_store().add_element_user(PAGESETUP$42);
            }
    ...
    public void setHeaderFooter(CTHeaderFooter cTHeaderFooter) {
        synchronized (monitor()) {
            check_orphaned();
            CTHeaderFooter cTHeaderFooter2 = (CTHeaderFooter) get_store().find_element_user(HEADERFOOTER$44, 0);
            if (cTHeaderFooter2 == null) {
                cTHeaderFooter2 = (CTHeaderFooter) get_store().add_element_user(HEADERFOOTER$44);
            }
    ...
    public void setRowBreaks(CTPageBreak cTPageBreak) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageBreak cTPageBreak2 = (CTPageBreak) get_store().find_element_user(ROWBREAKS$46, 0);
            if (cTPageBreak2 == null) {
                cTPageBreak2 = (CTPageBreak) get_store().add_element_user(ROWBREAKS$46);
            }
    ...
    public void setColBreaks(CTPageBreak cTPageBreak) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageBreak cTPageBreak2 = (CTPageBreak) get_store().find_element_user(COLBREAKS$48, 0);
            if (cTPageBreak2 == null) {
                cTPageBreak2 = (CTPageBreak) get_store().add_element_user(COLBREAKS$48);
            }
            cTPageBreak2.set(cTPageBreak);
        }
    }
    ...
    public CTCustomProperties getCustomProperties() {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomProperties cTCustomPropertiesFind_element_user = get_store().find_element_user(CUSTOMPROPERTIES$50, 0);
            if (cTCustomPropertiesFind_element_user == null) {
                return null;
            }
            return cTCustomPropertiesFind_element_user;
        }
    }
    ...
    public void setCustomProperties(CTCustomProperties cTCustomProperties) {
        synchronized (monitor()) {
            ...
            CTCustomProperties cTCustomPropertiesFind_element_user = get_store().find_element_user(CUSTOMPROPERTIES$50, 0);
            if (cTCustomPropertiesFind_element_user == null) {
                cTCustomPropertiesFind_element_user = (CTCustomProperties) get_store().add_element_user(CUSTOMPROPERTIES$50);
            }
            cTCustomPropertiesFind_element_user.set(cTCustomProperties);
        }
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWorksheet
    public CTCustomProperties addNewCustomProperties() {
        CTCustomProperties cTCustomPropertiesAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTCustomPropertiesAdd_element_user = get_store().add_element_user(CUSTOMPROPERTIES$50);
        }
        return cTCustomPropertiesAdd_element_user;
    }
    ...
    public CTCellWatches getCellWatches() {
        synchronized (monitor()) {
            check_orphaned();
            CTCellWatches cTCellWatchesFind_element_user = get_store().find_element_user(CELLWATCHES$52, 0);
            if (cTCellWatchesFind_element_user == null) {
                return null;
            }
            return cTCellWatchesFind_element_user;
        }
    }
    ...
    public void setCellWatches(CTCellWatches cTCellWatches) {
        synchronized (monitor()) {
            ...
            CTCellWatches cTCellWatchesFind_element_user = get_store().find_element_user(CELLWATCHES$52, 0);
            if (cTCellWatchesFind_element_user == null) {
                cTCellWatchesFind_element_user = (CTCellWatches) get_store().add_element_user(CELLWATCHES$52);
            }
            cTCellWatchesFind_element_user.set(cTCellWatches);
        }
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWorksheet
    public CTCellWatches addNewCellWatches() {
        CTCellWatches cTCellWatchesAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTCellWatchesAdd_element_user = get_store().add_element_user(CELLWATCHES$52);
        }
        return cTCellWatchesAdd_element_user;
    }
    ...
    public CTIgnoredErrors getIgnoredErrors() {
        synchronized (monitor()) {
            check_orphaned();
            CTIgnoredErrors cTIgnoredErrors = (CTIgnoredErrors) get_store().find_element_user(IGNOREDERRORS$54, 0);
    ...
    public void setIgnoredErrors(CTIgnoredErrors cTIgnoredErrors) {
        synchronized (monitor()) {
            check_orphaned();
            CTIgnoredErrors cTIgnoredErrors2 = (CTIgnoredErrors) get_store().find_element_user(IGNOREDERRORS$54, 0);
            if (cTIgnoredErrors2 == null) {
                cTIgnoredErrors2 = (CTIgnoredErrors) get_store().add_element_user(IGNOREDERRORS$54);
            }
            cTIgnoredErrors2.set(cTIgnoredErrors);
        }
    }
    ...
    public CTSmartTags getSmartTags() {
        synchronized (monitor()) {
            check_orphaned();
            CTSmartTags cTSmartTagsFind_element_user = get_store().find_element_user(SMARTTAGS$56, 0);
    ...
    public void setSmartTags(CTSmartTags cTSmartTags) {
        synchronized (monitor()) {
            ...
            CTSmartTags cTSmartTagsFind_element_user = get_store().find_element_user(SMARTTAGS$56, 0);
            if (cTSmartTagsFind_element_user == null) {
                cTSmartTagsFind_element_user = (CTSmartTags) get_store().add_element_user(SMARTTAGS$56);
            }
    ...
    public CTSmartTags addNewSmartTags() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTSmartTagsAdd_element_user = get_store().add_element_user(SMARTTAGS$56);
        }
    ...
    public void setDrawing(CTDrawing cTDrawing) {
        synchronized (monitor()) {
            check_orphaned();
            CTDrawing cTDrawing2 = (CTDrawing) get_store().find_element_user(DRAWING$58, 0);
            if (cTDrawing2 == null) {
                cTDrawing2 = (CTDrawing) get_store().add_element_user(DRAWING$58);
            }
    ...
    public void setLegacyDrawing(CTLegacyDrawing cTLegacyDrawing) {
        synchronized (monitor()) {
            check_orphaned();
            CTLegacyDrawing cTLegacyDrawing2 = (CTLegacyDrawing) get_store().find_element_user(LEGACYDRAWING$60, 0);
            if (cTLegacyDrawing2 == null) {
                cTLegacyDrawing2 = (CTLegacyDrawing) get_store().add_element_user(LEGACYDRAWING$60);
            }
    ...
    public void setLegacyDrawingHF(CTLegacyDrawing cTLegacyDrawing) {
        synchronized (monitor()) {
            check_orphaned();
            CTLegacyDrawing cTLegacyDrawing2 = (CTLegacyDrawing) get_store().find_element_user(LEGACYDRAWINGHF$62, 0);
            if (cTLegacyDrawing2 == null) {
                cTLegacyDrawing2 = (CTLegacyDrawing) get_store().add_element_user(LEGACYDRAWINGHF$62);
            }
            cTLegacyDrawing2.set(cTLegacyDrawing);
        }
    }
    ...
    public CTSheetBackgroundPicture getPicture() {
        synchronized (monitor()) {
            check_orphaned();
            CTSheetBackgroundPicture cTSheetBackgroundPictureFind_element_user = get_store().find_element_user(PICTURE$64, 0);
    ...
    public void setPicture(CTSheetBackgroundPicture cTSheetBackgroundPicture) {
        synchronized (monitor()) {
            ...
            CTSheetBackgroundPicture cTSheetBackgroundPictureFind_element_user = get_store().find_element_user(PICTURE$64, 0);
            if (cTSheetBackgroundPictureFind_element_user == null) {
                cTSheetBackgroundPictureFind_element_user = (CTSheetBackgroundPicture) get_store().add_element_user(PICTURE$64);
            }
    ...
    public CTSheetBackgroundPicture addNewPicture() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTSheetBackgroundPictureAdd_element_user = get_store().add_element_user(PICTURE$64);
        }
    ...
    public CTOleObjects getOleObjects() {
        synchronized (monitor()) {
            check_orphaned();
            CTOleObjects cTOleObjects = (CTOleObjects) get_store().find_element_user(OLEOBJECTS$66, 0);
    ...
    public void setOleObjects(CTOleObjects cTOleObjects) {
        synchronized (monitor()) {
            check_orphaned();
            CTOleObjects cTOleObjects2 = (CTOleObjects) get_store().find_element_user(OLEOBJECTS$66, 0);
            if (cTOleObjects2 == null) {
                cTOleObjects2 = (CTOleObjects) get_store().add_element_user(OLEOBJECTS$66);
            }
    ...
    public CTControls getControls() {
        synchronized (monitor()) {
            check_orphaned();
            CTControls cTControlsFind_element_user = get_store().find_element_user(CONTROLS$68, 0);
            if (cTControlsFind_element_user == null) {
                return null;
            }
            return cTControlsFind_element_user;
        }
    }
    ...
    public void setControls(CTControls cTControls) {
        synchronized (monitor()) {
            ...
            CTControls cTControlsFind_element_user = get_store().find_element_user(CONTROLS$68, 0);
            if (cTControlsFind_element_user == null) {
                cTControlsFind_element_user = (CTControls) get_store().add_element_user(CONTROLS$68);
            }
            cTControlsFind_element_user.set(cTControls);
        }
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWorksheet
    public CTControls addNewControls() {
        CTControls cTControlsAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTControlsAdd_element_user = get_store().add_element_user(CONTROLS$68);
        }
        return cTControlsAdd_element_user;
    }
    ...
    public CTWebPublishItems getWebPublishItems() {
        synchronized (monitor()) {
            check_orphaned();
            CTWebPublishItems cTWebPublishItemsFind_element_user = get_store().find_element_user(WEBPUBLISHITEMS$70, 0);
    ...
    public void setWebPublishItems(CTWebPublishItems cTWebPublishItems) {
        synchronized (monitor()) {
            ...
            CTWebPublishItems cTWebPublishItemsFind_element_user = get_store().find_element_user(WEBPUBLISHITEMS$70, 0);
            if (cTWebPublishItemsFind_element_user == null) {
                cTWebPublishItemsFind_element_user = (CTWebPublishItems) get_store().add_element_user(WEBPUBLISHITEMS$70);
            }
    ...
    public CTWebPublishItems addNewWebPublishItems() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTWebPublishItemsAdd_element_user = get_store().add_element_user(WEBPUBLISHITEMS$70);
        }
    ...
    public void setTableParts(CTTableParts cTTableParts) {
        synchronized (monitor()) {
            check_orphaned();
            CTTableParts cTTableParts2 = (CTTableParts) get_store().find_element_user(TABLEPARTS$72, 0);
            if (cTTableParts2 == null) {
                cTTableParts2 = (CTTableParts) get_store().add_element_user(TABLEPARTS$72);
            }
    ...
    public CTExtensionList getExtLst() {
        synchronized (monitor()) {
            check_orphaned();
            CTExtensionList cTExtensionListFind_element_user = get_store().find_element_user(EXTLST$74, 0);
    ...
    public void setExtLst(CTExtensionList cTExtensionList) {
        synchronized (monitor()) {
            ...
            CTExtensionList cTExtensionListFind_element_user = get_store().find_element_user(EXTLST$74, 0);
            if (cTExtensionListFind_element_user == null) {
                cTExtensionListFind_element_user = (CTExtensionList) get_store().add_element_user(EXTLST$74);
            }
    ...
    public CTExtensionList addNewExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTExtensionListAdd_element_user = get_store().add_element_user(EXTLST$74);
        }
