...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTCellStyleXfsImpl.class */
public class CTCellStyleXfsImpl extends XmlComplexContentImpl implements CTCellStyleXfs {
    ...
    public int sizeOfXfArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(XF$0);
        }
