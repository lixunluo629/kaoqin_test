...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTDxfImpl.class */
public class CTDxfImpl extends XmlComplexContentImpl implements CTDxf {
    ...
    public void setFont(CTFont cTFont) {
        synchronized (monitor()) {
            check_orphaned();
            CTFont cTFont2 = (CTFont) get_store().find_element_user(FONT$0, 0);
            if (cTFont2 == null) {
                cTFont2 = (CTFont) get_store().add_element_user(FONT$0);
            }
            cTFont2.set(cTFont);
        }
    }
    ...
    public void setFill(CTFill cTFill) {
        synchronized (monitor()) {
            check_orphaned();
            CTFill cTFill2 = (CTFill) get_store().find_element_user(FILL$4, 0);
            if (cTFill2 == null) {
                cTFill2 = (CTFill) get_store().add_element_user(FILL$4);
            }
            cTFill2.set(cTFill);
        }
    }
    ...
    public void setAlignment(CTCellAlignment cTCellAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            CTCellAlignment cTCellAlignment2 = (CTCellAlignment) get_store().find_element_user(ALIGNMENT$6, 0);
            if (cTCellAlignment2 == null) {
                cTCellAlignment2 = (CTCellAlignment) get_store().add_element_user(ALIGNMENT$6);
            }
    ...
    public void setBorder(CTBorder cTBorder) {
        synchronized (monitor()) {
            check_orphaned();
            CTBorder cTBorder2 = (CTBorder) get_store().find_element_user(BORDER$8, 0);
            if (cTBorder2 == null) {
                cTBorder2 = (CTBorder) get_store().add_element_user(BORDER$8);
            }
    ...
    public void setProtection(CTCellProtection cTCellProtection) {
        synchronized (monitor()) {
            check_orphaned();
            CTCellProtection cTCellProtection2 = (CTCellProtection) get_store().find_element_user(PROTECTION$10, 0);
            if (cTCellProtection2 == null) {
                cTCellProtection2 = (CTCellProtection) get_store().add_element_user(PROTECTION$10);
            }
