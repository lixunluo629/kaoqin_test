...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTDefinedNameImpl.class */
public class CTDefinedNameImpl extends JavaStringHolderEx implements CTDefinedName {
    ...
    public void xsetComment(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(COMMENT$2);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(COMMENT$2);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetCustomMenu(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(CUSTOMMENU$4);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(CUSTOMMENU$4);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetDescription(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(DESCRIPTION$6);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(DESCRIPTION$6);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetHelp(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(HELP$8);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(HELP$8);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetStatusBar(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(STATUSBAR$10);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(STATUSBAR$10);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public void xsetLocalSheetId(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(LOCALSHEETID$12);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(LOCALSHEETID$12);
            }
    ...
    public boolean getFunction() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FUNCTION$16);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFunction() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FUNCTION$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FUNCTION$16);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetFunction(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FUNCTION$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FUNCTION$16);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getVbProcedure() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(VBPROCEDURE$18);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetVbProcedure() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(VBPROCEDURE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(VBPROCEDURE$18);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetVbProcedure(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(VBPROCEDURE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(VBPROCEDURE$18);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getXlm() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(XLM$20);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetXlm() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(XLM$20);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(XLM$20);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetXlm(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(XLM$20);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(XLM$20);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetFunctionGroupId(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_attribute_user(FUNCTIONGROUPID$22);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_attribute_user(FUNCTIONGROUPID$22);
            }
            xmlUnsignedInt2.set(xmlUnsignedInt);
        }
    }
    ...
    public void xsetShortcutKey(STXstring sTXstring) {
        synchronized (monitor()) {
            check_orphaned();
            STXstring sTXstring2 = (STXstring) get_store().find_attribute_user(SHORTCUTKEY$24);
            if (sTXstring2 == null) {
                sTXstring2 = (STXstring) get_store().add_attribute_user(SHORTCUTKEY$24);
            }
            sTXstring2.set(sTXstring);
        }
    }
    ...
    public boolean getPublishToServer() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(PUBLISHTOSERVER$26);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetPublishToServer() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(PUBLISHTOSERVER$26);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(PUBLISHTOSERVER$26);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetPublishToServer(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(PUBLISHTOSERVER$26);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(PUBLISHTOSERVER$26);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getWorkbookParameter() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(WORKBOOKPARAMETER$28);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetWorkbookParameter() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(WORKBOOKPARAMETER$28);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(WORKBOOKPARAMETER$28);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetWorkbookParameter(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(WORKBOOKPARAMETER$28);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(WORKBOOKPARAMETER$28);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
