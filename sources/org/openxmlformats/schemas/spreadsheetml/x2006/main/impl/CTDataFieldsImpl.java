...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTDataFieldsImpl.class */
public class CTDataFieldsImpl extends XmlComplexContentImpl implements CTDataFields {
    private static final QName DATAFIELD$0 = new QName(XSSFRelation.NS_SPREADSHEETML, "dataField");
    ...
    public int sizeOfDataFieldArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(DATAFIELD$0);
        }
