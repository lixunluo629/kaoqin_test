...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTXfImpl.class */
public class CTXfImpl extends XmlComplexContentImpl implements CTXf {
    ...
    public void setAlignment(CTCellAlignment cTCellAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            CTCellAlignment cTCellAlignment2 = (CTCellAlignment) get_store().find_element_user(ALIGNMENT$0, 0);
            if (cTCellAlignment2 == null) {
                cTCellAlignment2 = (CTCellAlignment) get_store().add_element_user(ALIGNMENT$0);
            }
    ...
    public void setProtection(CTCellProtection cTCellProtection) {
        synchronized (monitor()) {
            check_orphaned();
            CTCellProtection cTCellProtection2 = (CTCellProtection) get_store().find_element_user(PROTECTION$2, 0);
            if (cTCellProtection2 == null) {
                cTCellProtection2 = (CTCellProtection) get_store().add_element_user(PROTECTION$2);
            }
    ...
    public void xsetNumFmtId(STNumFmtId sTNumFmtId) {
        synchronized (monitor()) {
            check_orphaned();
            STNumFmtId sTNumFmtId2 = (STNumFmtId) get_store().find_attribute_user(NUMFMTID$6);
            if (sTNumFmtId2 == null) {
                sTNumFmtId2 = (STNumFmtId) get_store().add_attribute_user(NUMFMTID$6);
            }
    ...
    public void xsetFontId(STFontId sTFontId) {
        synchronized (monitor()) {
            check_orphaned();
            STFontId sTFontId2 = (STFontId) get_store().find_attribute_user(FONTID$8);
            if (sTFontId2 == null) {
                sTFontId2 = (STFontId) get_store().add_attribute_user(FONTID$8);
            }
    ...
    public void xsetFillId(STFillId sTFillId) {
        synchronized (monitor()) {
            check_orphaned();
            STFillId sTFillId2 = (STFillId) get_store().find_attribute_user(FILLID$10);
            if (sTFillId2 == null) {
                sTFillId2 = (STFillId) get_store().add_attribute_user(FILLID$10);
            }
    ...
    public void xsetBorderId(STBorderId sTBorderId) {
        synchronized (monitor()) {
            check_orphaned();
            STBorderId sTBorderId2 = (STBorderId) get_store().find_attribute_user(BORDERID$12);
            if (sTBorderId2 == null) {
                sTBorderId2 = (STBorderId) get_store().add_attribute_user(BORDERID$12);
            }
    ...
    public void xsetXfId(STCellStyleXfId sTCellStyleXfId) {
        synchronized (monitor()) {
            check_orphaned();
            STCellStyleXfId sTCellStyleXfId2 = (STCellStyleXfId) get_store().find_attribute_user(XFID$14);
            if (sTCellStyleXfId2 == null) {
                sTCellStyleXfId2 = (STCellStyleXfId) get_store().add_attribute_user(XFID$14);
            }
    ...
    public boolean getQuotePrefix() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(QUOTEPREFIX$16);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetQuotePrefix() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(QUOTEPREFIX$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(QUOTEPREFIX$16);
            }
    ...
    public void xsetQuotePrefix(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(QUOTEPREFIX$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(QUOTEPREFIX$16);
            }
    ...
    public boolean getPivotButton() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(PIVOTBUTTON$18);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetPivotButton() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(PIVOTBUTTON$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(PIVOTBUTTON$18);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetPivotButton(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(PIVOTBUTTON$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(PIVOTBUTTON$18);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyNumberFormat(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYNUMBERFORMAT$20);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYNUMBERFORMAT$20);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyFont(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYFONT$22);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYFONT$22);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyFill(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYFILL$24);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYFILL$24);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyBorder(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYBORDER$26);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYBORDER$26);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyAlignment(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYALIGNMENT$28);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYALIGNMENT$28);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetApplyProtection(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(APPLYPROTECTION$30);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(APPLYPROTECTION$30);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
