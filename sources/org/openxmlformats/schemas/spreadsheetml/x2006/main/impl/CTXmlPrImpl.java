...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTXmlPrImpl.class */
public class CTXmlPrImpl extends XmlComplexContentImpl implements CTXmlPr {
    ...
    public void xsetXmlDataType(STXmlDataType sTXmlDataType) {
        synchronized (monitor()) {
            check_orphaned();
            STXmlDataType sTXmlDataType2 = (STXmlDataType) get_store().find_attribute_user(XMLDATATYPE$6);
            if (sTXmlDataType2 == null) {
                sTXmlDataType2 = (STXmlDataType) get_store().add_attribute_user(XMLDATATYPE$6);
            }
