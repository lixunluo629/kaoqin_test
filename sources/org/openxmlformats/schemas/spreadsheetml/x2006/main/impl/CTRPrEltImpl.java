...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/impl/CTRPrEltImpl.class */
public class CTRPrEltImpl extends XmlComplexContentImpl implements CTRPrElt {
    private static final QName RFONT$0 = new QName(XSSFRelation.NS_SPREADSHEETML, "rFont");
    private static final QName CHARSET$2 = new QName(XSSFRelation.NS_SPREADSHEETML, "charset");
    private static final QName FAMILY$4 = new QName(XSSFRelation.NS_SPREADSHEETML, "family");
    private static final QName B$6 = new QName(XSSFRelation.NS_SPREADSHEETML, "b");
    ...
    private static final QName COLOR$20 = new QName(XSSFRelation.NS_SPREADSHEETML, "color");
    ...
    public int sizeOfRFontArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(RFONT$0);
        }
    ...
    public int sizeOfCharsetArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CHARSET$2);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfFamilyArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(FAMILY$4);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfBArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(B$6);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfIArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(I$8);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfStrikeArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(STRIKE$10);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfOutlineArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(OUTLINE$12);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfShadowArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(SHADOW$14);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCondenseArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CONDENSE$16);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfExtendArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(EXTEND$18);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfColorArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(COLOR$20);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfSzArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(SZ$22);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfUArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(U$24);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfVertAlignArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(VERTALIGN$26);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfSchemeArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(SCHEME$28);
        }
        return iCount_elements;
    }
