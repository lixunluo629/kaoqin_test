...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataValidationType.class */
public interface STDataValidationType extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataValidationType$Enum.class */
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("none", 1), new Enum("whole", 2), new Enum(XmlErrorCodes.DECIMAL, 3), new Enum("list", 4), new Enum("date", 5), new Enum(RtspHeaders.Values.TIME, 6), new Enum("textLength", 7), new Enum("custom", 8)});
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STDataValidationType$Factory.class */
    public static final class Factory {
        ...
        public static STDataValidationType newInstance(XmlOptions xmlOptions) {
            return (STDataValidationType) POIXMLTypeLoader.newInstance(STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(String str) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(str, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(str, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(File file) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(file, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(file, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(URL url) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(url, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(url, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(InputStream inputStream) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(inputStream, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(inputStream, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(Reader reader) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(reader, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationType) POIXMLTypeLoader.parse(reader, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(xMLStreamReader, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(xMLStreamReader, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(Node node) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(node, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(node, STDataValidationType.type, xmlOptions);
        }

        public static STDataValidationType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(xMLInputStream, STDataValidationType.type, (XmlOptions) null);
        }

        public static STDataValidationType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STDataValidationType) POIXMLTypeLoader.parse(xMLInputStream, STDataValidationType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STDataValidationType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STDataValidationType.type, xmlOptions);
        }
