...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STCfType.class */
public interface STCfType extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STCfType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STCfType$Factory.class */
    public static final class Factory {
        ...
        public static STCfType newInstance(XmlOptions xmlOptions) {
            return (STCfType) POIXMLTypeLoader.newInstance(STCfType.type, xmlOptions);
        }

        public static STCfType parse(String str) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(str, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(str, STCfType.type, xmlOptions);
        }

        public static STCfType parse(File file) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(file, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(file, STCfType.type, xmlOptions);
        }

        public static STCfType parse(URL url) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(url, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(url, STCfType.type, xmlOptions);
        }

        public static STCfType parse(InputStream inputStream) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(inputStream, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(inputStream, STCfType.type, xmlOptions);
        }

        public static STCfType parse(Reader reader) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(reader, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCfType) POIXMLTypeLoader.parse(reader, STCfType.type, xmlOptions);
        }

        public static STCfType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(xMLStreamReader, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(xMLStreamReader, STCfType.type, xmlOptions);
        }

        public static STCfType parse(Node node) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(node, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STCfType) POIXMLTypeLoader.parse(node, STCfType.type, xmlOptions);
        }

        public static STCfType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STCfType) POIXMLTypeLoader.parse(xMLInputStream, STCfType.type, (XmlOptions) null);
        }

        public static STCfType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STCfType) POIXMLTypeLoader.parse(xMLInputStream, STCfType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STCfType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STCfType.type, xmlOptions);
        }
