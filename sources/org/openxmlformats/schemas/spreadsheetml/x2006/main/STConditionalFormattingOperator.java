...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STConditionalFormattingOperator.class */
public interface STConditionalFormattingOperator extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STConditionalFormattingOperator$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STConditionalFormattingOperator$Factory.class */
    public static final class Factory {
        ...
        public static STConditionalFormattingOperator newInstance(XmlOptions xmlOptions) {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.newInstance(STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(String str) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(str, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(str, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(File file) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(file, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(file, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(URL url) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(url, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(url, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(InputStream inputStream) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(inputStream, STConditionalFormattingOperator.type, (XmlOptions) null);
        }
        ...
        public static STConditionalFormattingOperator parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(inputStream, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(Reader reader) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(reader, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(reader, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(xMLStreamReader, STConditionalFormattingOperator.type, (XmlOptions) null);
        }
        ...
        public static STConditionalFormattingOperator parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(xMLStreamReader, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(Node node) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(node, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(node, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static STConditionalFormattingOperator parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(xMLInputStream, STConditionalFormattingOperator.type, (XmlOptions) null);
        }

        public static STConditionalFormattingOperator parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STConditionalFormattingOperator) POIXMLTypeLoader.parse(xMLInputStream, STConditionalFormattingOperator.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STConditionalFormattingOperator.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STConditionalFormattingOperator.type, xmlOptions);
        }
