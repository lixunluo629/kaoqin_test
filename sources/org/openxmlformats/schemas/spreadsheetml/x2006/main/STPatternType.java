...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STPatternType.class */
public interface STPatternType extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STPatternType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/spreadsheetml/x2006/main/STPatternType$Factory.class */
    public static final class Factory {
        ...
        public static STPatternType newInstance(XmlOptions xmlOptions) {
            return (STPatternType) POIXMLTypeLoader.newInstance(STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(String str) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(str, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(str, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(File file) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(file, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(file, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(URL url) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(url, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(url, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(InputStream inputStream) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(inputStream, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(inputStream, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(Reader reader) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(reader, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPatternType) POIXMLTypeLoader.parse(reader, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(xMLStreamReader, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(xMLStreamReader, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(Node node) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(node, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(node, STPatternType.type, xmlOptions);
        }

        public static STPatternType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(xMLInputStream, STPatternType.type, (XmlOptions) null);
        }

        public static STPatternType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STPatternType) POIXMLTypeLoader.parse(xMLInputStream, STPatternType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPatternType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPatternType.type, xmlOptions);
        }
