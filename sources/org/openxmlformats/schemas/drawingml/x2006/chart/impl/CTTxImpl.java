...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTTxImpl.class */
public class CTTxImpl extends XmlComplexContentImpl implements CTTx {
    ...
    private static final QName RICH$2 = new QName(XSSFRelation.NS_CHART, "rich");
    ...
    public void setRich(CTTextBody cTTextBody) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBody cTTextBody2 = (CTTextBody) get_store().find_element_user(RICH$2, 0);
            if (cTTextBody2 == null) {
                cTTextBody2 = (CTTextBody) get_store().add_element_user(RICH$2);
            }
