...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTNumRefImpl.class */
public class CTNumRefImpl extends XmlComplexContentImpl implements CTNumRef {
    ...
    private static final QName NUMCACHE$2 = new QName(XSSFRelation.NS_CHART, "numCache");
    ...
    public void setNumCache(CTNumData cTNumData) {
        synchronized (monitor()) {
            check_orphaned();
            CTNumData cTNumData2 = (CTNumData) get_store().find_element_user(NUMCACHE$2, 0);
            if (cTNumData2 == null) {
                cTNumData2 = (CTNumData) get_store().add_element_user(NUMCACHE$2);
            }
