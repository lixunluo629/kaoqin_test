...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTHeaderFooterImpl.class */
public class CTHeaderFooterImpl extends XmlComplexContentImpl implements CTHeaderFooter {
    private static final QName ODDHEADER$0 = new QName(XSSFRelation.NS_CHART, "oddHeader");
    private static final QName ODDFOOTER$2 = new QName(XSSFRelation.NS_CHART, "oddFooter");
    private static final QName EVENHEADER$4 = new QName(XSSFRelation.NS_CHART, "evenHeader");
    private static final QName EVENFOOTER$6 = new QName(XSSFRelation.NS_CHART, "evenFooter");
    private static final QName FIRSTHEADER$8 = new QName(XSSFRelation.NS_CHART, "firstHeader");
    private static final QName FIRSTFOOTER$10 = new QName(XSSFRelation.NS_CHART, "firstFooter");
    ...
    public boolean getAlignWithMargins() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(ALIGNWITHMARGINS$12);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetAlignWithMargins() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(ALIGNWITHMARGINS$12);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(ALIGNWITHMARGINS$12);
            }
    ...
    public void xsetAlignWithMargins(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(ALIGNWITHMARGINS$12);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(ALIGNWITHMARGINS$12);
            }
    ...
    public boolean getDifferentOddEven() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(DIFFERENTODDEVEN$14);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetDifferentOddEven() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DIFFERENTODDEVEN$14);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(DIFFERENTODDEVEN$14);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetDifferentOddEven(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DIFFERENTODDEVEN$14);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(DIFFERENTODDEVEN$14);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getDifferentFirst() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(DIFFERENTFIRST$16);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetDifferentFirst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DIFFERENTFIRST$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(DIFFERENTFIRST$16);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetDifferentFirst(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(DIFFERENTFIRST$16);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(DIFFERENTFIRST$16);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
