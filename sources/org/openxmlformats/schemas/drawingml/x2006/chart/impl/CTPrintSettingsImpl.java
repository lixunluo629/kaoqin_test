...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTPrintSettingsImpl.class */
public class CTPrintSettingsImpl extends XmlComplexContentImpl implements CTPrintSettings {
    private static final QName HEADERFOOTER$0 = new QName(XSSFRelation.NS_CHART, "headerFooter");
    private static final QName PAGEMARGINS$2 = new QName(XSSFRelation.NS_CHART, "pageMargins");
    private static final QName PAGESETUP$4 = new QName(XSSFRelation.NS_CHART, "pageSetup");
    private static final QName LEGACYDRAWINGHF$6 = new QName(XSSFRelation.NS_CHART, "legacyDrawingHF");
    ...
    public void setHeaderFooter(CTHeaderFooter cTHeaderFooter) {
        synchronized (monitor()) {
            check_orphaned();
            CTHeaderFooter cTHeaderFooter2 = (CTHeaderFooter) get_store().find_element_user(HEADERFOOTER$0, 0);
            if (cTHeaderFooter2 == null) {
                cTHeaderFooter2 = (CTHeaderFooter) get_store().add_element_user(HEADERFOOTER$0);
            }
    ...
    public void setPageMargins(CTPageMargins cTPageMargins) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageMargins cTPageMargins2 = (CTPageMargins) get_store().find_element_user(PAGEMARGINS$2, 0);
            if (cTPageMargins2 == null) {
                cTPageMargins2 = (CTPageMargins) get_store().add_element_user(PAGEMARGINS$2);
            }
    ...
    public void setPageSetup(CTPageSetup cTPageSetup) {
        synchronized (monitor()) {
            check_orphaned();
            CTPageSetup cTPageSetup2 = (CTPageSetup) get_store().find_element_user(PAGESETUP$4, 0);
            if (cTPageSetup2 == null) {
                cTPageSetup2 = (CTPageSetup) get_store().add_element_user(PAGESETUP$4);
            }
    ...
    public CTRelId getLegacyDrawingHF() {
        synchronized (monitor()) {
            check_orphaned();
            CTRelId cTRelIdFind_element_user = get_store().find_element_user(LEGACYDRAWINGHF$6, 0);
    ...
    public void setLegacyDrawingHF(CTRelId cTRelId) {
        synchronized (monitor()) {
            ...
            CTRelId cTRelIdFind_element_user = get_store().find_element_user(LEGACYDRAWINGHF$6, 0);
            if (cTRelIdFind_element_user == null) {
                cTRelIdFind_element_user = (CTRelId) get_store().add_element_user(LEGACYDRAWINGHF$6);
            }
    ...
    public CTRelId addNewLegacyDrawingHF() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTRelIdAdd_element_user = get_store().add_element_user(LEGACYDRAWINGHF$6);
        }
