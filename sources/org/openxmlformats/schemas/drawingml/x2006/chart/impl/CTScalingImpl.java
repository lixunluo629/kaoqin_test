...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTScalingImpl.class */
public class CTScalingImpl extends XmlComplexContentImpl implements CTScaling {
    private static final QName LOGBASE$0 = new QName(XSSFRelation.NS_CHART, "logBase");
    private static final QName ORIENTATION$2 = new QName(XSSFRelation.NS_CHART, "orientation");
    private static final QName MAX$4 = new QName(XSSFRelation.NS_CHART, "max");
    private static final QName MIN$6 = new QName(XSSFRelation.NS_CHART, "min");
    ...
    public void setLogBase(CTLogBase cTLogBase) {
        synchronized (monitor()) {
            check_orphaned();
            CTLogBase cTLogBase2 = (CTLogBase) get_store().find_element_user(LOGBASE$0, 0);
            if (cTLogBase2 == null) {
                cTLogBase2 = (CTLogBase) get_store().add_element_user(LOGBASE$0);
            }
    ...
    public void setOrientation(CTOrientation cTOrientation) {
        synchronized (monitor()) {
            check_orphaned();
            CTOrientation cTOrientation2 = (CTOrientation) get_store().find_element_user(ORIENTATION$2, 0);
            if (cTOrientation2 == null) {
                cTOrientation2 = (CTOrientation) get_store().add_element_user(ORIENTATION$2);
            }
    ...
    public void setMax(CTDouble cTDouble) {
        synchronized (monitor()) {
            check_orphaned();
            CTDouble cTDouble2 = (CTDouble) get_store().find_element_user(MAX$4, 0);
            if (cTDouble2 == null) {
                cTDouble2 = (CTDouble) get_store().add_element_user(MAX$4);
            }
    ...
    public void setMin(CTDouble cTDouble) {
        synchronized (monitor()) {
            check_orphaned();
            CTDouble cTDouble2 = (CTDouble) get_store().find_element_user(MIN$6, 0);
            if (cTDouble2 == null) {
                cTDouble2 = (CTDouble) get_store().add_element_user(MIN$6);
            }
            cTDouble2.set(cTDouble);
        }
    }
