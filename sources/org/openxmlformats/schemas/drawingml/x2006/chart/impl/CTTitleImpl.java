...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTTitleImpl.class */
public class CTTitleImpl extends XmlComplexContentImpl implements CTTitle {
    private static final QName TX$0 = new QName(XSSFRelation.NS_CHART, "tx");
    private static final QName LAYOUT$2 = new QName(XSSFRelation.NS_CHART, VelocityLayoutView.DEFAULT_LAYOUT_KEY);
    private static final QName OVERLAY$4 = new QName(XSSFRelation.NS_CHART, "overlay");
    private static final QName SPPR$6 = new QName(XSSFRelation.NS_CHART, "spPr");
    private static final QName TXPR$8 = new QName(XSSFRelation.NS_CHART, "txPr");
    ...
    public void setTx(CTTx cTTx) {
        synchronized (monitor()) {
            check_orphaned();
            CTTx cTTx2 = (CTTx) get_store().find_element_user(TX$0, 0);
            if (cTTx2 == null) {
                cTTx2 = (CTTx) get_store().add_element_user(TX$0);
            }
            cTTx2.set(cTTx);
        }
    }
    ...
    public void setLayout(CTLayout cTLayout) {
        synchronized (monitor()) {
            check_orphaned();
            CTLayout cTLayout2 = (CTLayout) get_store().find_element_user(LAYOUT$2, 0);
            if (cTLayout2 == null) {
                cTLayout2 = (CTLayout) get_store().add_element_user(LAYOUT$2);
            }
    ...
    public void setOverlay(CTBoolean cTBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            CTBoolean cTBoolean2 = (CTBoolean) get_store().find_element_user(OVERLAY$4, 0);
            if (cTBoolean2 == null) {
                cTBoolean2 = (CTBoolean) get_store().add_element_user(OVERLAY$4);
            }
    ...
    public void setTxPr(CTTextBody cTTextBody) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBody cTTextBody2 = (CTTextBody) get_store().find_element_user(TXPR$8, 0);
            if (cTTextBody2 == null) {
                cTTextBody2 = (CTTextBody) get_store().add_element_user(TXPR$8);
            }
