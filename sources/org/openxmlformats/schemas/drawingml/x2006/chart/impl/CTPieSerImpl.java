...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/chart/impl/CTPieSerImpl.class */
public class CTPieSerImpl extends XmlComplexContentImpl implements CTPieSer {
    ...
    private static final QName EXPLOSION$8 = new QName(XSSFRelation.NS_CHART, "explosion");
    ...
    private static final QName CAT$14 = new QName(XSSFRelation.NS_CHART, "cat");
    private static final QName VAL$16 = new QName(XSSFRelation.NS_CHART, "val");
    ...
    public void setExplosion(CTUnsignedInt cTUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            CTUnsignedInt cTUnsignedInt2 = (CTUnsignedInt) get_store().find_element_user(EXPLOSION$8, 0);
            if (cTUnsignedInt2 == null) {
                cTUnsignedInt2 = (CTUnsignedInt) get_store().add_element_user(EXPLOSION$8);
            }
            cTUnsignedInt2.set(cTUnsignedInt);
        }
    }
    ...
    public void setCat(CTAxDataSource cTAxDataSource) {
        synchronized (monitor()) {
            check_orphaned();
            CTAxDataSource cTAxDataSource2 = (CTAxDataSource) get_store().find_element_user(CAT$14, 0);
            if (cTAxDataSource2 == null) {
                cTAxDataSource2 = (CTAxDataSource) get_store().add_element_user(CAT$14);
            }
    ...
    public void setVal(CTNumDataSource cTNumDataSource) {
        synchronized (monitor()) {
            check_orphaned();
            CTNumDataSource cTNumDataSource2 = (CTNumDataSource) get_store().find_element_user(VAL$16, 0);
            if (cTNumDataSource2 == null) {
                cTNumDataSource2 = (CTNumDataSource) get_store().add_element_user(VAL$16);
            }
