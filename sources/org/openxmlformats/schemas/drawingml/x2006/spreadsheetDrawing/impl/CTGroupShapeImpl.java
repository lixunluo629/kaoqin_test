...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/impl/CTGroupShapeImpl.class */
public class CTGroupShapeImpl extends XmlComplexContentImpl implements CTGroupShape {
    ...
    public List<CTGraphicalObjectFrame> getGraphicFrameList() {
        1GraphicFrameList r0;
        synchronized (monitor()) {
            check_orphaned();
            r0 = new 1GraphicFrameList(this);
        }
        return r0;
    }
