...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/impl/CTAnchorClientDataImpl.class */
public class CTAnchorClientDataImpl extends XmlComplexContentImpl implements CTAnchorClientData {
    ...
    public boolean getFLocksWithSheet() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLOCKSWITHSHEET$0);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFLocksWithSheet() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLOCKSWITHSHEET$0);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FLOCKSWITHSHEET$0);
            }
    ...
    public void xsetFLocksWithSheet(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLOCKSWITHSHEET$0);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FLOCKSWITHSHEET$0);
            }
    ...
    public boolean getFPrintsWithSheet() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FPRINTSWITHSHEET$2);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFPrintsWithSheet() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FPRINTSWITHSHEET$2);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FPRINTSWITHSHEET$2);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetFPrintsWithSheet(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FPRINTSWITHSHEET$2);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FPRINTSWITHSHEET$2);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
