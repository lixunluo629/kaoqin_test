...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/impl/CTPictureImpl.class */
public class CTPictureImpl extends XmlComplexContentImpl implements CTPicture {
    ...
    private static final QName STYLE$6 = new QName("http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing", AbstractHtmlElementTag.STYLE_ATTRIBUTE);
    ...
    public XmlString xgetMacro() {
        ...
        synchronized (monitor()) {
            ...
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_default_attribute_value(MACRO$8);
            }
    ...
    public boolean getFPublished() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FPUBLISHED$10);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFPublished() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FPUBLISHED$10);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FPUBLISHED$10);
            }
    ...
    public void xsetFPublished(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FPUBLISHED$10);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FPUBLISHED$10);
            }
