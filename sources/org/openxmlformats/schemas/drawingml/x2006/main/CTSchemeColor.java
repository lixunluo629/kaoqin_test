...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSchemeColor.class */
public interface CTSchemeColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSchemeColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctschemecolor5feftype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSchemeColor$Factory.class */
    public static final class Factory {
        public static CTSchemeColor newInstance() {
            return (CTSchemeColor) POIXMLTypeLoader.newInstance(CTSchemeColor.type, null);
        }

        public static CTSchemeColor newInstance(XmlOptions xmlOptions) {
            return (CTSchemeColor) POIXMLTypeLoader.newInstance(CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(String str) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(str, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(str, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(File file) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(file, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(file, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(URL url) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(url, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(url, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(inputStream, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(inputStream, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(Reader reader) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(reader, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(reader, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(Node node) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(node, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(node, CTSchemeColor.type, xmlOptions);
        }

        public static CTSchemeColor parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(xMLInputStream, CTSchemeColor.type, (XmlOptions) null);
        }

        public static CTSchemeColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSchemeColor) POIXMLTypeLoader.parse(xMLInputStream, CTSchemeColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSchemeColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSchemeColor.type, xmlOptions);
        }
