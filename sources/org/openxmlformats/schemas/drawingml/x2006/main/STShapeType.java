...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STShapeType.class */
public interface STShapeType extends XmlToken {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(STShapeType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("stshapetype069ctype");
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STShapeType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STShapeType$Factory.class */
    public static final class Factory {
        ...
        public static STShapeType newInstance() {
            return (STShapeType) POIXMLTypeLoader.newInstance(STShapeType.type, null);
        }

        public static STShapeType newInstance(XmlOptions xmlOptions) {
            return (STShapeType) POIXMLTypeLoader.newInstance(STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(String str) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(str, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(str, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(File file) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(file, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(file, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(URL url) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(url, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(url, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(InputStream inputStream) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(inputStream, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(inputStream, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(Reader reader) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(reader, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType) POIXMLTypeLoader.parse(reader, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(xMLStreamReader, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(xMLStreamReader, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(Node node) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(node, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(node, STShapeType.type, xmlOptions);
        }

        public static STShapeType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(xMLInputStream, STShapeType.type, (XmlOptions) null);
        }

        public static STShapeType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STShapeType) POIXMLTypeLoader.parse(xMLInputStream, STShapeType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STShapeType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STShapeType.type, xmlOptions);
        }
