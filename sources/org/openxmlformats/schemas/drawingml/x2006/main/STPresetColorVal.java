...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STPresetColorVal.class */
public interface STPresetColorVal extends XmlToken {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(STPresetColorVal.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("stpresetcolorval55e8type");
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STPresetColorVal$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STPresetColorVal$Factory.class */
    public static final class Factory {
        ...
        public static STPresetColorVal newInstance() {
            return (STPresetColorVal) POIXMLTypeLoader.newInstance(STPresetColorVal.type, null);
        }

        public static STPresetColorVal newInstance(XmlOptions xmlOptions) {
            return (STPresetColorVal) POIXMLTypeLoader.newInstance(STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(String str) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(str, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(str, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(File file) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(file, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(file, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(URL url) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(url, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(url, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(InputStream inputStream) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(inputStream, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(inputStream, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(Reader reader) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(reader, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(reader, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(xMLStreamReader, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(xMLStreamReader, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(Node node) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(node, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(node, STPresetColorVal.type, xmlOptions);
        }

        public static STPresetColorVal parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(xMLInputStream, STPresetColorVal.type, (XmlOptions) null);
        }

        public static STPresetColorVal parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STPresetColorVal) POIXMLTypeLoader.parse(xMLInputStream, STPresetColorVal.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPresetColorVal.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STPresetColorVal.type, xmlOptions);
        }
