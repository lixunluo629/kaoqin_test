...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTHslColor.class */
public interface CTHslColor extends XmlObject {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTHslColor$Factory.class */
    public static final class Factory {
        ...
        public static CTHslColor newInstance(XmlOptions xmlOptions) {
            return (CTHslColor) POIXMLTypeLoader.newInstance(CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(String str) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(str, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(str, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(File file) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(file, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(file, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(URL url) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(url, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(url, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(inputStream, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(inputStream, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(Reader reader) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(reader, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor) POIXMLTypeLoader.parse(reader, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(xMLStreamReader, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(xMLStreamReader, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(Node node) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(node, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(node, CTHslColor.type, xmlOptions);
        }

        public static CTHslColor parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(xMLInputStream, CTHslColor.type, (XmlOptions) null);
        }

        public static CTHslColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTHslColor) POIXMLTypeLoader.parse(xMLInputStream, CTHslColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTHslColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTHslColor.type, xmlOptions);
        }
