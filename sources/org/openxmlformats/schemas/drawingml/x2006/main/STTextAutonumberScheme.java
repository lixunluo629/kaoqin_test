...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextAutonumberScheme.class */
public interface STTextAutonumberScheme extends XmlToken {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextAutonumberScheme$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextAutonumberScheme$Factory.class */
    public static final class Factory {
        ...
        public static STTextAutonumberScheme newInstance(XmlOptions xmlOptions) {
            return (STTextAutonumberScheme) POIXMLTypeLoader.newInstance(STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(String str) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(str, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(str, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(File file) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(file, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(file, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(URL url) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(url, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(url, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(InputStream inputStream) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(inputStream, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(inputStream, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(Reader reader) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(reader, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(reader, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(xMLStreamReader, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(xMLStreamReader, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(Node node) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(node, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(node, STTextAutonumberScheme.type, xmlOptions);
        }

        public static STTextAutonumberScheme parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(xMLInputStream, STTextAutonumberScheme.type, (XmlOptions) null);
        }

        public static STTextAutonumberScheme parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STTextAutonumberScheme) POIXMLTypeLoader.parse(xMLInputStream, STTextAutonumberScheme.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextAutonumberScheme.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextAutonumberScheme.type, xmlOptions);
        }
