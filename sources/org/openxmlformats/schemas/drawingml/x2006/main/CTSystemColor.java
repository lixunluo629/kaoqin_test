...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSystemColor.class */
public interface CTSystemColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSystemColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsystemcolor4525type");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSystemColor$Factory.class */
    public static final class Factory {
        public static CTSystemColor newInstance() {
            return (CTSystemColor) POIXMLTypeLoader.newInstance(CTSystemColor.type, null);
        }

        public static CTSystemColor newInstance(XmlOptions xmlOptions) {
            return (CTSystemColor) POIXMLTypeLoader.newInstance(CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(String str) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(str, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(str, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(File file) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(file, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(file, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(URL url) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(url, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(url, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(inputStream, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(inputStream, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(Reader reader) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(reader, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor) POIXMLTypeLoader.parse(reader, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(Node node) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(node, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(node, CTSystemColor.type, xmlOptions);
        }

        public static CTSystemColor parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(xMLInputStream, CTSystemColor.type, (XmlOptions) null);
        }

        public static CTSystemColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSystemColor) POIXMLTypeLoader.parse(xMLInputStream, CTSystemColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSystemColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSystemColor.type, xmlOptions);
        }
