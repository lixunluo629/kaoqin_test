...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTTextSpacingImpl.class */
public class CTTextSpacingImpl extends XmlComplexContentImpl implements CTTextSpacing {
    private static final QName SPCPCT$0 = new QName(XSSFRelation.NS_DRAWINGML, "spcPct");
    private static final QName SPCPTS$2 = new QName(XSSFRelation.NS_DRAWINGML, "spcPts");
