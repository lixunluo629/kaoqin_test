...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTSystemColorImpl.class */
public class CTSystemColorImpl extends XmlComplexContentImpl implements CTSystemColor {
    ...
    public void xsetVal(STSystemColorVal sTSystemColorVal) {
        synchronized (monitor()) {
            check_orphaned();
            STSystemColorVal sTSystemColorVal2 = (STSystemColorVal) get_store().find_attribute_user(VAL$56);
            if (sTSystemColorVal2 == null) {
                sTSystemColorVal2 = (STSystemColorVal) get_store().add_attribute_user(VAL$56);
            }
    ...
    public void setLastClr(byte[] bArr) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(LASTCLR$58);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(LASTCLR$58);
            }
    ...
    public void xsetLastClr(STHexBinary3 sTHexBinary3) {
        synchronized (monitor()) {
            check_orphaned();
            STHexBinary3 sTHexBinary32 = (STHexBinary3) get_store().find_attribute_user(LASTCLR$58);
            if (sTHexBinary32 == null) {
                sTHexBinary32 = (STHexBinary3) get_store().add_attribute_user(LASTCLR$58);
            }
