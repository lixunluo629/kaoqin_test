...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTTextParagraphPropertiesImpl.class */
public class CTTextParagraphPropertiesImpl extends XmlComplexContentImpl implements CTTextParagraphProperties {
    ...
    public void setLnSpc(CTTextSpacing cTTextSpacing) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextSpacing cTTextSpacing2 = (CTTextSpacing) get_store().find_element_user(LNSPC$0, 0);
            if (cTTextSpacing2 == null) {
                cTTextSpacing2 = (CTTextSpacing) get_store().add_element_user(LNSPC$0);
            }
    ...
    public void setSpcBef(CTTextSpacing cTTextSpacing) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextSpacing cTTextSpacing2 = (CTTextSpacing) get_store().find_element_user(SPCBEF$2, 0);
            if (cTTextSpacing2 == null) {
                cTTextSpacing2 = (CTTextSpacing) get_store().add_element_user(SPCBEF$2);
            }
            cTTextSpacing2.set(cTTextSpacing);
        }
    }
    ...
    public void setSpcAft(CTTextSpacing cTTextSpacing) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextSpacing cTTextSpacing2 = (CTTextSpacing) get_store().find_element_user(SPCAFT$4, 0);
            if (cTTextSpacing2 == null) {
                cTTextSpacing2 = (CTTextSpacing) get_store().add_element_user(SPCAFT$4);
            }
            cTTextSpacing2.set(cTTextSpacing);
        }
    }
    ...
    public CTTextBulletColorFollowText getBuClrTx() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBulletColorFollowText cTTextBulletColorFollowTextFind_element_user = get_store().find_element_user(BUCLRTX$6, 0);
            if (cTTextBulletColorFollowTextFind_element_user == null) {
                return null;
            }
            return cTTextBulletColorFollowTextFind_element_user;
        }
    }
    ...
    public void setBuClrTx(CTTextBulletColorFollowText cTTextBulletColorFollowText) {
        synchronized (monitor()) {
            ...
            CTTextBulletColorFollowText cTTextBulletColorFollowTextFind_element_user = get_store().find_element_user(BUCLRTX$6, 0);
            if (cTTextBulletColorFollowTextFind_element_user == null) {
                cTTextBulletColorFollowTextFind_element_user = (CTTextBulletColorFollowText) get_store().add_element_user(BUCLRTX$6);
            }
            cTTextBulletColorFollowTextFind_element_user.set(cTTextBulletColorFollowText);
        }
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTTextParagraphProperties
    public CTTextBulletColorFollowText addNewBuClrTx() {
        CTTextBulletColorFollowText cTTextBulletColorFollowTextAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTextBulletColorFollowTextAdd_element_user = get_store().add_element_user(BUCLRTX$6);
        }
        return cTTextBulletColorFollowTextAdd_element_user;
    }
    ...
    public void setBuClr(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(BUCLR$8, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(BUCLR$8);
            }
    ...
    public CTTextBulletSizeFollowText getBuSzTx() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBulletSizeFollowText cTTextBulletSizeFollowTextFind_element_user = get_store().find_element_user(BUSZTX$10, 0);
            if (cTTextBulletSizeFollowTextFind_element_user == null) {
                return null;
            }
            return cTTextBulletSizeFollowTextFind_element_user;
        }
    }
    ...
    public void setBuSzTx(CTTextBulletSizeFollowText cTTextBulletSizeFollowText) {
        synchronized (monitor()) {
            ...
            CTTextBulletSizeFollowText cTTextBulletSizeFollowTextFind_element_user = get_store().find_element_user(BUSZTX$10, 0);
            if (cTTextBulletSizeFollowTextFind_element_user == null) {
                cTTextBulletSizeFollowTextFind_element_user = (CTTextBulletSizeFollowText) get_store().add_element_user(BUSZTX$10);
            }
            cTTextBulletSizeFollowTextFind_element_user.set(cTTextBulletSizeFollowText);
        }
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTTextParagraphProperties
    public CTTextBulletSizeFollowText addNewBuSzTx() {
        CTTextBulletSizeFollowText cTTextBulletSizeFollowTextAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTextBulletSizeFollowTextAdd_element_user = get_store().add_element_user(BUSZTX$10);
        }
        return cTTextBulletSizeFollowTextAdd_element_user;
    }
    ...
    public void setBuSzPct(CTTextBulletSizePercent cTTextBulletSizePercent) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBulletSizePercent cTTextBulletSizePercent2 = (CTTextBulletSizePercent) get_store().find_element_user(BUSZPCT$12, 0);
            if (cTTextBulletSizePercent2 == null) {
                cTTextBulletSizePercent2 = (CTTextBulletSizePercent) get_store().add_element_user(BUSZPCT$12);
            }
    ...
    public void setBuSzPts(CTTextBulletSizePoint cTTextBulletSizePoint) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBulletSizePoint cTTextBulletSizePoint2 = (CTTextBulletSizePoint) get_store().find_element_user(BUSZPTS$14, 0);
            if (cTTextBulletSizePoint2 == null) {
                cTTextBulletSizePoint2 = (CTTextBulletSizePoint) get_store().add_element_user(BUSZPTS$14);
            }
    ...
    public CTTextBulletTypefaceFollowText getBuFontTx() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBulletTypefaceFollowText cTTextBulletTypefaceFollowTextFind_element_user = get_store().find_element_user(BUFONTTX$16, 0);
            if (cTTextBulletTypefaceFollowTextFind_element_user == null) {
                return null;
            }
            return cTTextBulletTypefaceFollowTextFind_element_user;
        }
    }
    ...
    public void setBuFontTx(CTTextBulletTypefaceFollowText cTTextBulletTypefaceFollowText) {
        synchronized (monitor()) {
            ...
            CTTextBulletTypefaceFollowText cTTextBulletTypefaceFollowTextFind_element_user = get_store().find_element_user(BUFONTTX$16, 0);
            if (cTTextBulletTypefaceFollowTextFind_element_user == null) {
                cTTextBulletTypefaceFollowTextFind_element_user = (CTTextBulletTypefaceFollowText) get_store().add_element_user(BUFONTTX$16);
            }
            cTTextBulletTypefaceFollowTextFind_element_user.set(cTTextBulletTypefaceFollowText);
        }
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTTextParagraphProperties
    public CTTextBulletTypefaceFollowText addNewBuFontTx() {
        CTTextBulletTypefaceFollowText cTTextBulletTypefaceFollowTextAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTextBulletTypefaceFollowTextAdd_element_user = get_store().add_element_user(BUFONTTX$16);
        }
        return cTTextBulletTypefaceFollowTextAdd_element_user;
    }
    ...
    public void setBuFont(CTTextFont cTTextFont) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextFont cTTextFont2 = (CTTextFont) get_store().find_element_user(BUFONT$18, 0);
            if (cTTextFont2 == null) {
                cTTextFont2 = (CTTextFont) get_store().add_element_user(BUFONT$18);
            }
    ...
    public void setBuNone(CTTextNoBullet cTTextNoBullet) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextNoBullet cTTextNoBullet2 = (CTTextNoBullet) get_store().find_element_user(BUNONE$20, 0);
            if (cTTextNoBullet2 == null) {
                cTTextNoBullet2 = (CTTextNoBullet) get_store().add_element_user(BUNONE$20);
            }
    ...
    public void setBuAutoNum(CTTextAutonumberBullet cTTextAutonumberBullet) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextAutonumberBullet cTTextAutonumberBullet2 = (CTTextAutonumberBullet) get_store().find_element_user(BUAUTONUM$22, 0);
            if (cTTextAutonumberBullet2 == null) {
                cTTextAutonumberBullet2 = (CTTextAutonumberBullet) get_store().add_element_user(BUAUTONUM$22);
            }
    ...
    public void setBuChar(CTTextCharBullet cTTextCharBullet) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextCharBullet cTTextCharBullet2 = (CTTextCharBullet) get_store().find_element_user(BUCHAR$24, 0);
            if (cTTextCharBullet2 == null) {
                cTTextCharBullet2 = (CTTextCharBullet) get_store().add_element_user(BUCHAR$24);
            }
    ...
    public CTTextBlipBullet getBuBlip() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextBlipBullet cTTextBlipBulletFind_element_user = get_store().find_element_user(BUBLIP$26, 0);
            if (cTTextBlipBulletFind_element_user == null) {
                return null;
            }
            return cTTextBlipBulletFind_element_user;
        }
    }
    ...
    public void setBuBlip(CTTextBlipBullet cTTextBlipBullet) {
        synchronized (monitor()) {
            ...
            CTTextBlipBullet cTTextBlipBulletFind_element_user = get_store().find_element_user(BUBLIP$26, 0);
            if (cTTextBlipBulletFind_element_user == null) {
                cTTextBlipBulletFind_element_user = (CTTextBlipBullet) get_store().add_element_user(BUBLIP$26);
            }
            cTTextBlipBulletFind_element_user.set(cTTextBlipBullet);
        }
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTTextParagraphProperties
    public CTTextBlipBullet addNewBuBlip() {
        CTTextBlipBullet cTTextBlipBulletAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTextBlipBulletAdd_element_user = get_store().add_element_user(BUBLIP$26);
        }
        return cTTextBlipBulletAdd_element_user;
    }
    ...
    public void setTabLst(CTTextTabStopList cTTextTabStopList) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextTabStopList cTTextTabStopList2 = (CTTextTabStopList) get_store().find_element_user(TABLST$28, 0);
            if (cTTextTabStopList2 == null) {
                cTTextTabStopList2 = (CTTextTabStopList) get_store().add_element_user(TABLST$28);
            }
    ...
    public void setDefRPr(CTTextCharacterProperties cTTextCharacterProperties) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextCharacterProperties cTTextCharacterProperties2 = (CTTextCharacterProperties) get_store().find_element_user(DEFRPR$30, 0);
            if (cTTextCharacterProperties2 == null) {
                cTTextCharacterProperties2 = (CTTextCharacterProperties) get_store().add_element_user(DEFRPR$30);
            }
    ...
    public void setExtLst(CTOfficeArtExtensionList cTOfficeArtExtensionList) {
        synchronized (monitor()) {
            check_orphaned();
            CTOfficeArtExtensionList cTOfficeArtExtensionList2 = (CTOfficeArtExtensionList) get_store().find_element_user(EXTLST$32, 0);
            if (cTOfficeArtExtensionList2 == null) {
                cTOfficeArtExtensionList2 = (CTOfficeArtExtensionList) get_store().add_element_user(EXTLST$32);
            }
    ...
    public void xsetMarL(STTextMargin sTTextMargin) {
        synchronized (monitor()) {
            check_orphaned();
            STTextMargin sTTextMargin2 = (STTextMargin) get_store().find_attribute_user(MARL$34);
            if (sTTextMargin2 == null) {
                sTTextMargin2 = (STTextMargin) get_store().add_attribute_user(MARL$34);
            }
    ...
    public void xsetMarR(STTextMargin sTTextMargin) {
        synchronized (monitor()) {
            check_orphaned();
            STTextMargin sTTextMargin2 = (STTextMargin) get_store().find_attribute_user(MARR$36);
            if (sTTextMargin2 == null) {
                sTTextMargin2 = (STTextMargin) get_store().add_attribute_user(MARR$36);
            }
            sTTextMargin2.set(sTTextMargin);
        }
    }
    ...
    public void xsetLvl(STTextIndentLevelType sTTextIndentLevelType) {
        synchronized (monitor()) {
            check_orphaned();
            STTextIndentLevelType sTTextIndentLevelType2 = (STTextIndentLevelType) get_store().find_attribute_user(LVL$38);
            if (sTTextIndentLevelType2 == null) {
                sTTextIndentLevelType2 = (STTextIndentLevelType) get_store().add_attribute_user(LVL$38);
            }
    ...
    public void xsetIndent(STTextIndent sTTextIndent) {
        synchronized (monitor()) {
            check_orphaned();
            STTextIndent sTTextIndent2 = (STTextIndent) get_store().find_attribute_user(INDENT$40);
            if (sTTextIndent2 == null) {
                sTTextIndent2 = (STTextIndent) get_store().add_attribute_user(INDENT$40);
            }
    ...
    public void xsetDefTabSz(STCoordinate32 sTCoordinate32) {
        synchronized (monitor()) {
            check_orphaned();
            STCoordinate32 sTCoordinate322 = (STCoordinate32) get_store().find_attribute_user(DEFTABSZ$44);
            if (sTCoordinate322 == null) {
                sTCoordinate322 = (STCoordinate32) get_store().add_attribute_user(DEFTABSZ$44);
            }
    ...
    public void xsetRtl(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(RTL$46);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(RTL$46);
            }
    ...
    public void xsetEaLnBrk(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(EALNBRK$48);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(EALNBRK$48);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetLatinLnBrk(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(LATINLNBRK$52);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(LATINLNBRK$52);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public void xsetHangingPunct(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(HANGINGPUNCT$54);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(HANGINGPUNCT$54);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
