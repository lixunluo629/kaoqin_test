...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTColorSchemeImpl.class */
public class CTColorSchemeImpl extends XmlComplexContentImpl implements CTColorScheme {
    ...
    public void setDk1(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(DK1$0, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(DK1$0);
            }
    ...
    public void setLt1(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(LT1$2, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(LT1$2);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setDk2(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(DK2$4, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(DK2$4);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setLt2(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(LT2$6, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(LT2$6);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent1(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT1$8, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT1$8);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent2(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT2$10, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT2$10);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent3(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT3$12, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT3$12);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent4(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT4$14, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT4$14);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent5(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT5$16, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT5$16);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setAccent6(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(ACCENT6$18, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(ACCENT6$18);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setHlink(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(HLINK$20, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(HLINK$20);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setFolHlink(CTColor cTColor) {
        synchronized (monitor()) {
            check_orphaned();
            CTColor cTColor2 = (CTColor) get_store().find_element_user(FOLHLINK$22, 0);
            if (cTColor2 == null) {
                cTColor2 = (CTColor) get_store().add_element_user(FOLHLINK$22);
            }
            cTColor2.set(cTColor);
        }
    }
    ...
    public void setExtLst(CTOfficeArtExtensionList cTOfficeArtExtensionList) {
        synchronized (monitor()) {
            check_orphaned();
            CTOfficeArtExtensionList cTOfficeArtExtensionList2 = (CTOfficeArtExtensionList) get_store().find_element_user(EXTLST$24, 0);
            if (cTOfficeArtExtensionList2 == null) {
                cTOfficeArtExtensionList2 = (CTOfficeArtExtensionList) get_store().add_element_user(EXTLST$24);
            }
