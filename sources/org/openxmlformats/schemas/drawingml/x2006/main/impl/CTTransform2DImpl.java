...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTTransform2DImpl.class */
public class CTTransform2DImpl extends XmlComplexContentImpl implements CTTransform2D {
    ...
    public int getRot() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(ROT$4);
            if (simpleValue == null) {
    ...
    public STAngle xgetRot() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STAngle sTAngle2 = (STAngle) get_store().find_attribute_user(ROT$4);
            if (sTAngle2 == null) {
                sTAngle2 = (STAngle) get_default_attribute_value(ROT$4);
            }
            sTAngle = sTAngle2;
        }
        return sTAngle;
    ...
    public void xsetRot(STAngle sTAngle) {
        synchronized (monitor()) {
            ...
            STAngle sTAngle2 = (STAngle) get_store().find_attribute_user(ROT$4);
            if (sTAngle2 == null) {
                sTAngle2 = (STAngle) get_store().add_attribute_user(ROT$4);
            }
    ...
    public boolean getFlipH() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLIPH$6);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFlipH() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPH$6);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FLIPH$6);
            }
    ...
    public void xsetFlipH(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPH$6);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FLIPH$6);
            }
    ...
    public boolean getFlipV() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLIPV$8);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFlipV() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPV$8);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FLIPV$8);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetFlipV(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPV$8);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FLIPV$8);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
