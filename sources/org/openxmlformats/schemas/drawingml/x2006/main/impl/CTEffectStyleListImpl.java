...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTEffectStyleListImpl.class */
public class CTEffectStyleListImpl extends XmlComplexContentImpl implements CTEffectStyleList {
    private static final QName EFFECTSTYLE$0 = new QName(XSSFRelation.NS_DRAWINGML, "effectStyle");
    ...
    public int sizeOfEffectStyleArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(EFFECTSTYLE$0);
        }
