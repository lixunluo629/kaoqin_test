...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTGroupTransform2DImpl.class */
public class CTGroupTransform2DImpl extends XmlComplexContentImpl implements CTGroupTransform2D {
    private static final QName OFF$0 = new QName(XSSFRelation.NS_DRAWINGML, CustomBooleanEditor.VALUE_OFF);
    private static final QName EXT$2 = new QName(XSSFRelation.NS_DRAWINGML, "ext");
    private static final QName CHOFF$4 = new QName(XSSFRelation.NS_DRAWINGML, "chOff");
    private static final QName CHEXT$6 = new QName(XSSFRelation.NS_DRAWINGML, "chExt");
    ...
    public void setOff(CTPoint2D cTPoint2D) {
        synchronized (monitor()) {
            check_orphaned();
            CTPoint2D cTPoint2D2 = (CTPoint2D) get_store().find_element_user(OFF$0, 0);
            if (cTPoint2D2 == null) {
                cTPoint2D2 = (CTPoint2D) get_store().add_element_user(OFF$0);
            }
    ...
    public void setChOff(CTPoint2D cTPoint2D) {
        synchronized (monitor()) {
            check_orphaned();
            CTPoint2D cTPoint2D2 = (CTPoint2D) get_store().find_element_user(CHOFF$4, 0);
            if (cTPoint2D2 == null) {
                cTPoint2D2 = (CTPoint2D) get_store().add_element_user(CHOFF$4);
            }
            cTPoint2D2.set(cTPoint2D);
        }
    }
    ...
    public void setChExt(CTPositiveSize2D cTPositiveSize2D) {
        synchronized (monitor()) {
            check_orphaned();
            CTPositiveSize2D cTPositiveSize2D2 = (CTPositiveSize2D) get_store().find_element_user(CHEXT$6, 0);
            if (cTPositiveSize2D2 == null) {
                cTPositiveSize2D2 = (CTPositiveSize2D) get_store().add_element_user(CHEXT$6);
            }
            cTPositiveSize2D2.set(cTPositiveSize2D);
        }
    }
    ...
    public int getRot() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(ROT$8);
            if (simpleValue == null) {
    ...
    public STAngle xgetRot() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STAngle sTAngle2 = (STAngle) get_store().find_attribute_user(ROT$8);
            if (sTAngle2 == null) {
                sTAngle2 = (STAngle) get_default_attribute_value(ROT$8);
            }
            sTAngle = sTAngle2;
        }
        return sTAngle;
    ...
    public void xsetRot(STAngle sTAngle) {
        synchronized (monitor()) {
            ...
            STAngle sTAngle2 = (STAngle) get_store().find_attribute_user(ROT$8);
            if (sTAngle2 == null) {
                sTAngle2 = (STAngle) get_store().add_attribute_user(ROT$8);
            }
    ...
    public boolean getFlipH() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLIPH$10);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFlipH() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPH$10);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FLIPH$10);
            }
    ...
    public void xsetFlipH(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPH$10);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FLIPH$10);
            }
    ...
    public boolean getFlipV() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLIPV$12);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetFlipV() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPV$12);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(FLIPV$12);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetFlipV(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(FLIPV$12);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(FLIPV$12);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
