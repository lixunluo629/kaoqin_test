...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTCustomGeometry2DImpl.class */
public class CTCustomGeometry2DImpl extends XmlComplexContentImpl implements CTCustomGeometry2D {
    ...
    private static final QName GDLST$2 = new QName(XSSFRelation.NS_DRAWINGML, "gdLst");
    private static final QName AHLST$4 = new QName(XSSFRelation.NS_DRAWINGML, "ahLst");
    private static final QName CXNLST$6 = new QName(XSSFRelation.NS_DRAWINGML, "cxnLst");
    private static final QName RECT$8 = new QName(XSSFRelation.NS_DRAWINGML, "rect");
    private static final QName PATHLST$10 = new QName(XSSFRelation.NS_DRAWINGML, "pathLst");
    ...
    public void setGdLst(CTGeomGuideList cTGeomGuideList) {
        synchronized (monitor()) {
            check_orphaned();
            CTGeomGuideList cTGeomGuideList2 = (CTGeomGuideList) get_store().find_element_user(GDLST$2, 0);
            if (cTGeomGuideList2 == null) {
                cTGeomGuideList2 = (CTGeomGuideList) get_store().add_element_user(GDLST$2);
            }
            cTGeomGuideList2.set(cTGeomGuideList);
        }
    }
    ...
    public void setAhLst(CTAdjustHandleList cTAdjustHandleList) {
        synchronized (monitor()) {
            check_orphaned();
            CTAdjustHandleList cTAdjustHandleList2 = (CTAdjustHandleList) get_store().find_element_user(AHLST$4, 0);
            if (cTAdjustHandleList2 == null) {
                cTAdjustHandleList2 = (CTAdjustHandleList) get_store().add_element_user(AHLST$4);
            }
    ...
    public void setCxnLst(CTConnectionSiteList cTConnectionSiteList) {
        synchronized (monitor()) {
            check_orphaned();
            CTConnectionSiteList cTConnectionSiteList2 = (CTConnectionSiteList) get_store().find_element_user(CXNLST$6, 0);
            if (cTConnectionSiteList2 == null) {
                cTConnectionSiteList2 = (CTConnectionSiteList) get_store().add_element_user(CXNLST$6);
            }
    ...
    public void setRect(CTGeomRect cTGeomRect) {
        synchronized (monitor()) {
            check_orphaned();
            CTGeomRect cTGeomRect2 = (CTGeomRect) get_store().find_element_user(RECT$8, 0);
            if (cTGeomRect2 == null) {
                cTGeomRect2 = (CTGeomRect) get_store().add_element_user(RECT$8);
            }
    ...
    public void setPathLst(CTPath2DList cTPath2DList) {
        synchronized (monitor()) {
            check_orphaned();
            CTPath2DList cTPath2DList2 = (CTPath2DList) get_store().find_element_user(PATHLST$10, 0);
            if (cTPath2DList2 == null) {
                cTPath2DList2 = (CTPath2DList) get_store().add_element_user(PATHLST$10);
            }
