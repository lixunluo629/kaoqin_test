...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTBaseStylesImpl.class */
public class CTBaseStylesImpl extends XmlComplexContentImpl implements CTBaseStyles {
    ...
    public void setFontScheme(CTFontScheme cTFontScheme) {
        synchronized (monitor()) {
            check_orphaned();
            CTFontScheme cTFontScheme2 = (CTFontScheme) get_store().find_element_user(FONTSCHEME$2, 0);
            if (cTFontScheme2 == null) {
                cTFontScheme2 = (CTFontScheme) get_store().add_element_user(FONTSCHEME$2);
            }
    ...
    public void setFmtScheme(CTStyleMatrix cTStyleMatrix) {
        synchronized (monitor()) {
            check_orphaned();
            CTStyleMatrix cTStyleMatrix2 = (CTStyleMatrix) get_store().find_element_user(FMTSCHEME$4, 0);
            if (cTStyleMatrix2 == null) {
                cTStyleMatrix2 = (CTStyleMatrix) get_store().add_element_user(FMTSCHEME$4);
            }
