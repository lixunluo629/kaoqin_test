...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTFontReferenceImpl.class */
public class CTFontReferenceImpl extends XmlComplexContentImpl implements CTFontReference {
    ...
    public void xsetIdx(STFontCollectionIndex sTFontCollectionIndex) {
        synchronized (monitor()) {
            check_orphaned();
            STFontCollectionIndex sTFontCollectionIndex2 = (STFontCollectionIndex) get_store().find_attribute_user(IDX$12);
            if (sTFontCollectionIndex2 == null) {
                sTFontCollectionIndex2 = (STFontCollectionIndex) get_store().add_attribute_user(IDX$12);
            }
