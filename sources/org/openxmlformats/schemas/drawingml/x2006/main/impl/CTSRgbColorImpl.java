...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTSRgbColorImpl.class */
public class CTSRgbColorImpl extends XmlComplexContentImpl implements CTSRgbColor {
    ...
    public void xsetVal(STHexBinary3 sTHexBinary3) {
        synchronized (monitor()) {
            check_orphaned();
            STHexBinary3 sTHexBinary32 = (STHexBinary3) get_store().find_attribute_user(VAL$56);
            if (sTHexBinary32 == null) {
                sTHexBinary32 = (STHexBinary3) get_store().add_attribute_user(VAL$56);
            }
