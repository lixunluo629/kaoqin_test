...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTPresetColorImpl.class */
public class CTPresetColorImpl extends XmlComplexContentImpl implements CTPresetColor {
    ...
    public void xsetVal(STPresetColorVal sTPresetColorVal) {
        synchronized (monitor()) {
            check_orphaned();
            STPresetColorVal sTPresetColorVal2 = (STPresetColorVal) get_store().find_attribute_user(VAL$56);
            if (sTPresetColorVal2 == null) {
                sTPresetColorVal2 = (STPresetColorVal) get_store().add_attribute_user(VAL$56);
            }
