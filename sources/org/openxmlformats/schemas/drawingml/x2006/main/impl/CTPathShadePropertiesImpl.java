...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTPathShadePropertiesImpl.class */
public class CTPathShadePropertiesImpl extends XmlComplexContentImpl implements CTPathShadeProperties {
    private static final QName FILLTORECT$0 = new QName(XSSFRelation.NS_DRAWINGML, "fillToRect");
    private static final QName PATH$2 = new QName("", Cookie2.PATH);
    ...
    public void setFillToRect(CTRelativeRect cTRelativeRect) {
        synchronized (monitor()) {
            check_orphaned();
            CTRelativeRect cTRelativeRect2 = (CTRelativeRect) get_store().find_element_user(FILLTORECT$0, 0);
            if (cTRelativeRect2 == null) {
                cTRelativeRect2 = (CTRelativeRect) get_store().add_element_user(FILLTORECT$0);
            }
    ...
    public void xsetPath(STPathShadeType sTPathShadeType) {
        synchronized (monitor()) {
            check_orphaned();
            STPathShadeType sTPathShadeType2 = (STPathShadeType) get_store().find_attribute_user(PATH$2);
            if (sTPathShadeType2 == null) {
                sTPathShadeType2 = (STPathShadeType) get_store().add_attribute_user(PATH$2);
            }
