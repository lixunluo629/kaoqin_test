...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTSchemeColorImpl.class */
public class CTSchemeColorImpl extends XmlComplexContentImpl implements CTSchemeColor {
    ...
    public void xsetVal(STSchemeColorVal sTSchemeColorVal) {
        synchronized (monitor()) {
            check_orphaned();
            STSchemeColorVal sTSchemeColorVal2 = (STSchemeColorVal) get_store().find_attribute_user(VAL$56);
            if (sTSchemeColorVal2 == null) {
                sTSchemeColorVal2 = (STSchemeColorVal) get_store().add_attribute_user(VAL$56);
            }
