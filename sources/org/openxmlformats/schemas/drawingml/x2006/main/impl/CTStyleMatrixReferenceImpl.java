...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTStyleMatrixReferenceImpl.class */
public class CTStyleMatrixReferenceImpl extends XmlComplexContentImpl implements CTStyleMatrixReference {
    ...
    public void xsetIdx(STStyleMatrixColumnIndex sTStyleMatrixColumnIndex) {
        synchronized (monitor()) {
            check_orphaned();
            STStyleMatrixColumnIndex sTStyleMatrixColumnIndex2 = (STStyleMatrixColumnIndex) get_store().find_attribute_user(IDX$12);
            if (sTStyleMatrixColumnIndex2 == null) {
                sTStyleMatrixColumnIndex2 = (STStyleMatrixColumnIndex) get_store().add_attribute_user(IDX$12);
            }
