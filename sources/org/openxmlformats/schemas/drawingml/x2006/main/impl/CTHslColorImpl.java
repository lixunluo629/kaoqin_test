...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTHslColorImpl.class */
public class CTHslColorImpl extends XmlComplexContentImpl implements CTHslColor {
    ...
    public void setHue2(int i) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(HUE2$56);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(HUE2$56);
            }
    ...
    public void xsetHue2(STPositiveFixedAngle sTPositiveFixedAngle) {
        synchronized (monitor()) {
            check_orphaned();
            STPositiveFixedAngle sTPositiveFixedAngle2 = (STPositiveFixedAngle) get_store().find_attribute_user(HUE2$56);
            if (sTPositiveFixedAngle2 == null) {
                sTPositiveFixedAngle2 = (STPositiveFixedAngle) get_store().add_attribute_user(HUE2$56);
            }
    ...
    public void setSat2(int i) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(SAT2$58);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(SAT2$58);
            }
            simpleValue.setIntValue(i);
        }
    }
    ...
    public void xsetSat2(STPercentage sTPercentage) {
        synchronized (monitor()) {
            check_orphaned();
            STPercentage sTPercentage2 = (STPercentage) get_store().find_attribute_user(SAT2$58);
            if (sTPercentage2 == null) {
                sTPercentage2 = (STPercentage) get_store().add_attribute_user(SAT2$58);
            }
    ...
    public void setLum2(int i) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(LUM2$60);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(LUM2$60);
            }
            simpleValue.setIntValue(i);
        }
    }
    ...
    public void xsetLum2(STPercentage sTPercentage) {
        synchronized (monitor()) {
            check_orphaned();
            STPercentage sTPercentage2 = (STPercentage) get_store().find_attribute_user(LUM2$60);
            if (sTPercentage2 == null) {
                sTPercentage2 = (STPercentage) get_store().add_attribute_user(LUM2$60);
            }
            sTPercentage2.set(sTPercentage);
        }
    }
