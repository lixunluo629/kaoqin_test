...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/impl/CTPath2DImpl.class */
public class CTPath2DImpl extends XmlComplexContentImpl implements CTPath2D {
    private static final QName CLOSE$0 = new QName(XSSFRelation.NS_DRAWINGML, "close");
    private static final QName MOVETO$2 = new QName(XSSFRelation.NS_DRAWINGML, "moveTo");
    private static final QName LNTO$4 = new QName(XSSFRelation.NS_DRAWINGML, "lnTo");
    private static final QName ARCTO$6 = new QName(XSSFRelation.NS_DRAWINGML, "arcTo");
    private static final QName QUADBEZTO$8 = new QName(XSSFRelation.NS_DRAWINGML, "quadBezTo");
    private static final QName CUBICBEZTO$10 = new QName(XSSFRelation.NS_DRAWINGML, "cubicBezTo");
    ...
    public int sizeOfCloseArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CLOSE$0);
        }
    ...
    public int sizeOfMoveToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVETO$2);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfLnToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(LNTO$4);
        }
        return iCount_elements;
    }
    ...
    public CTPath2DArcTo getArcToArray(int i) {
        CTPath2DArcTo cTPath2DArcToFind_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTPath2DArcToFind_element_user = get_store().find_element_user(ARCTO$6, i);
            if (cTPath2DArcToFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
        }
        return cTPath2DArcToFind_element_user;
    }
    ...
    public int sizeOfArcToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(ARCTO$6);
        }
        return iCount_elements;
    }
    ...
    public void setArcToArray(CTPath2DArcTo[] cTPath2DArcToArr) {
        synchronized (monitor()) {
            check_orphaned();
            arraySetterHelper((XmlObject[]) cTPath2DArcToArr, ARCTO$6);
        }
    }
    ...
    public void setArcToArray(int i, CTPath2DArcTo cTPath2DArcTo) {
        synchronized (monitor()) {
            check_orphaned();
            CTPath2DArcTo cTPath2DArcToFind_element_user = get_store().find_element_user(ARCTO$6, i);
            if (cTPath2DArcToFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            cTPath2DArcToFind_element_user.set(cTPath2DArcTo);
        }
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTPath2D
    public CTPath2DArcTo insertNewArcTo(int i) {
        CTPath2DArcTo cTPath2DArcToInsert_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTPath2DArcToInsert_element_user = get_store().insert_element_user(ARCTO$6, i);
        }
        return cTPath2DArcToInsert_element_user;
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTPath2D
    public CTPath2DArcTo addNewArcTo() {
        CTPath2DArcTo cTPath2DArcToAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTPath2DArcToAdd_element_user = get_store().add_element_user(ARCTO$6);
        }
        return cTPath2DArcToAdd_element_user;
    }
    ...
    public int sizeOfQuadBezToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(QUADBEZTO$8);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCubicBezToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUBICBEZTO$10);
        }
        return iCount_elements;
    }
    ...
    public long getW() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(W$12);
            if (simpleValue == null) {
    ...
    public STPositiveCoordinate xgetW() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STPositiveCoordinate sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().find_attribute_user(W$12);
            if (sTPositiveCoordinate2 == null) {
                sTPositiveCoordinate2 = (STPositiveCoordinate) get_default_attribute_value(W$12);
            }
    ...
    public void xsetW(STPositiveCoordinate sTPositiveCoordinate) {
        synchronized (monitor()) {
            ...
            STPositiveCoordinate sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().find_attribute_user(W$12);
            if (sTPositiveCoordinate2 == null) {
                sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().add_attribute_user(W$12);
            }
    ...
    public long getH() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(H$14);
            if (simpleValue == null) {
    ...
    public STPositiveCoordinate xgetH() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STPositiveCoordinate sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().find_attribute_user(H$14);
            if (sTPositiveCoordinate2 == null) {
                sTPositiveCoordinate2 = (STPositiveCoordinate) get_default_attribute_value(H$14);
            }
            sTPositiveCoordinate = sTPositiveCoordinate2;
        }
        return sTPositiveCoordinate;
    ...
    public void xsetH(STPositiveCoordinate sTPositiveCoordinate) {
        synchronized (monitor()) {
            ...
            STPositiveCoordinate sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().find_attribute_user(H$14);
            if (sTPositiveCoordinate2 == null) {
                sTPositiveCoordinate2 = (STPositiveCoordinate) get_store().add_attribute_user(H$14);
            }
            sTPositiveCoordinate2.set(sTPositiveCoordinate);
        }
    }
    ...
    public STPathFillMode$Enum getFill() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FILL$16);
            if (simpleValue == null) {
    ...
    public STPathFillMode xgetFill() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            STPathFillMode sTPathFillModeFind_attribute_user = get_store().find_attribute_user(FILL$16);
            if (sTPathFillModeFind_attribute_user == null) {
                sTPathFillModeFind_attribute_user = (STPathFillMode) get_default_attribute_value(FILL$16);
            }
            sTPathFillMode = sTPathFillModeFind_attribute_user;
        }
    ...
    public void setFill(STPathFillMode$Enum sTPathFillMode$Enum) {
        synchronized (monitor()) {
            ...
            simpleValue.setEnumValue(sTPathFillMode$Enum);
        }
    }
    ...
    public void xsetFill(STPathFillMode sTPathFillMode) {
        synchronized (monitor()) {
            ...
            STPathFillMode sTPathFillModeFind_attribute_user = get_store().find_attribute_user(FILL$16);
            if (sTPathFillModeFind_attribute_user == null) {
                sTPathFillModeFind_attribute_user = (STPathFillMode) get_store().add_attribute_user(FILL$16);
            }
            sTPathFillModeFind_attribute_user.set(sTPathFillMode);
        }
    }
    ...
    public boolean getStroke() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(STROKE$18);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetStroke() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(STROKE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(STROKE$18);
            }
    ...
    public void xsetStroke(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(STROKE$18);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(STROKE$18);
            }
    ...
    public boolean getExtrusionOk() {
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(EXTRUSIONOK$20);
            if (simpleValue == null) {
    ...
    public XmlBoolean xgetExtrusionOk() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(EXTRUSIONOK$20);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_default_attribute_value(EXTRUSIONOK$20);
            }
            xmlBoolean = xmlBoolean2;
        }
        return xmlBoolean;
    ...
    public void xsetExtrusionOk(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            ...
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_attribute_user(EXTRUSIONOK$20);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_attribute_user(EXTRUSIONOK$20);
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
