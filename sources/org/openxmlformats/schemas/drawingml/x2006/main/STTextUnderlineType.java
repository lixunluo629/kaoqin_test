...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextUnderlineType.class */
public interface STTextUnderlineType extends XmlToken {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextUnderlineType$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STTextUnderlineType$Factory.class */
    public static final class Factory {
        ...
        public static STTextUnderlineType newInstance(XmlOptions xmlOptions) {
            return (STTextUnderlineType) POIXMLTypeLoader.newInstance(STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(String str) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(str, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(str, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(File file) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(file, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(file, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(URL url) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(url, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(url, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(InputStream inputStream) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(inputStream, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(inputStream, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(Reader reader) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(reader, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(reader, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(xMLStreamReader, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(xMLStreamReader, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(Node node) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(node, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(node, STTextUnderlineType.type, xmlOptions);
        }

        public static STTextUnderlineType parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(xMLInputStream, STTextUnderlineType.type, (XmlOptions) null);
        }

        public static STTextUnderlineType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STTextUnderlineType) POIXMLTypeLoader.parse(xMLInputStream, STTextUnderlineType.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextUnderlineType.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextUnderlineType.type, xmlOptions);
        }
