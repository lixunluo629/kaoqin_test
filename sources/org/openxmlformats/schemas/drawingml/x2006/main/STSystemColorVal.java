...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STSystemColorVal.class */
public interface STSystemColorVal extends XmlToken {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STSystemColorVal$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/STSystemColorVal$Factory.class */
    public static final class Factory {
        ...
        public static STSystemColorVal newInstance(XmlOptions xmlOptions) {
            return (STSystemColorVal) POIXMLTypeLoader.newInstance(STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(String str) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(str, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(str, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(File file) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(file, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(file, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(URL url) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(url, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(url, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(InputStream inputStream) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(inputStream, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(inputStream, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(Reader reader) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(reader, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(reader, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(xMLStreamReader, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(xMLStreamReader, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(Node node) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(node, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(node, STSystemColorVal.type, xmlOptions);
        }

        public static STSystemColorVal parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(xMLInputStream, STSystemColorVal.type, (XmlOptions) null);
        }

        public static STSystemColorVal parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STSystemColorVal) POIXMLTypeLoader.parse(xMLInputStream, STSystemColorVal.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STSystemColorVal.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STSystemColorVal.type, xmlOptions);
        }
