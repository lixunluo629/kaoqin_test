...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSRgbColor.class */
public interface CTSRgbColor extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSRgbColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsrgbcolor5bdatype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/drawingml/x2006/main/CTSRgbColor$Factory.class */
    public static final class Factory {
        public static CTSRgbColor newInstance() {
            return (CTSRgbColor) POIXMLTypeLoader.newInstance(CTSRgbColor.type, null);
        }

        public static CTSRgbColor newInstance(XmlOptions xmlOptions) {
            return (CTSRgbColor) POIXMLTypeLoader.newInstance(CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(String str) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(str, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(str, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(File file) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(file, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(file, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(URL url) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(url, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(url, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(inputStream, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(inputStream, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(Reader reader) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(reader, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(reader, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(xMLStreamReader, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(Node node) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(node, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(node, CTSRgbColor.type, xmlOptions);
        }

        public static CTSRgbColor parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(xMLInputStream, CTSRgbColor.type, (XmlOptions) null);
        }

        public static CTSRgbColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSRgbColor) POIXMLTypeLoader.parse(xMLInputStream, CTSRgbColor.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSRgbColor.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSRgbColor.type, xmlOptions);
        }
