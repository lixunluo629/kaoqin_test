...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/officeDocument/x2006/customProperties/impl/CTPropertyImpl.class */
public class CTPropertyImpl extends XmlComplexContentImpl implements CTProperty {
    ...
    private static final QName ERROR$52 = new QName("http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes", AsmRelationshipUtils.DECLARE_ERROR);
    ...
    public void setVector(CTVector cTVector) {
        synchronized (monitor()) {
            check_orphaned();
            CTVector cTVector2 = (CTVector) get_store().find_element_user(VECTOR$0, 0);
            if (cTVector2 == null) {
                cTVector2 = (CTVector) get_store().add_element_user(VECTOR$0);
            }
    ...
    public CTArray getArray() {
        synchronized (monitor()) {
            check_orphaned();
            CTArray cTArrayFind_element_user = get_store().find_element_user(ARRAY$2, 0);
    ...
    public void setArray(CTArray cTArray) {
        synchronized (monitor()) {
            ...
            CTArray cTArrayFind_element_user = get_store().find_element_user(ARRAY$2, 0);
            if (cTArrayFind_element_user == null) {
                cTArrayFind_element_user = (CTArray) get_store().add_element_user(ARRAY$2);
            }
            cTArrayFind_element_user.set(cTArray);
        }
    }
    ...
    public CTArray addNewArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTArrayAdd_element_user = get_store().add_element_user(ARRAY$2);
        }
    ...
    public void xsetBlob(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(BLOB$4, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(BLOB$4);
            }
    ...
    public void xsetOblob(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(OBLOB$6, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(OBLOB$6);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public CTEmpty getEmpty() {
        synchronized (monitor()) {
            check_orphaned();
            CTEmpty cTEmptyFind_element_user = get_store().find_element_user(EMPTY$8, 0);
    ...
    public void setEmpty(CTEmpty cTEmpty) {
        synchronized (monitor()) {
            ...
            CTEmpty cTEmptyFind_element_user = get_store().find_element_user(EMPTY$8, 0);
            if (cTEmptyFind_element_user == null) {
                cTEmptyFind_element_user = (CTEmpty) get_store().add_element_user(EMPTY$8);
            }
    ...
    public CTEmpty addNewEmpty() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTEmptyAdd_element_user = get_store().add_element_user(EMPTY$8);
        }
    ...
    public CTNull getNull() {
        synchronized (monitor()) {
            check_orphaned();
            CTNull cTNullFind_element_user = get_store().find_element_user(NULL$10, 0);
    ...
    public void setNull(CTNull cTNull) {
        synchronized (monitor()) {
            ...
            CTNull cTNullFind_element_user = get_store().find_element_user(NULL$10, 0);
            if (cTNullFind_element_user == null) {
                cTNullFind_element_user = (CTNull) get_store().add_element_user(NULL$10);
            }
            cTNullFind_element_user.set(cTNull);
        }
    }
    ...
    public CTNull addNewNull() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTNullAdd_element_user = get_store().add_element_user(NULL$10);
        }
    ...
    public void xsetI1(XmlByte xmlByte) {
        synchronized (monitor()) {
            check_orphaned();
            XmlByte xmlByte2 = (XmlByte) get_store().find_element_user(I1$12, 0);
            if (xmlByte2 == null) {
                xmlByte2 = (XmlByte) get_store().add_element_user(I1$12);
            }
    ...
    public void xsetI2(XmlShort xmlShort) {
        synchronized (monitor()) {
            check_orphaned();
            XmlShort xmlShort2 = (XmlShort) get_store().find_element_user(I2$14, 0);
            if (xmlShort2 == null) {
                xmlShort2 = (XmlShort) get_store().add_element_user(I2$14);
            }
    ...
    public void xsetI4(XmlInt xmlInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_element_user(I4$16, 0);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_element_user(I4$16);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public void xsetI8(XmlLong xmlLong) {
        synchronized (monitor()) {
            check_orphaned();
            XmlLong xmlLong2 = (XmlLong) get_store().find_element_user(I8$18, 0);
            if (xmlLong2 == null) {
                xmlLong2 = (XmlLong) get_store().add_element_user(I8$18);
            }
    ...
    public void xsetInt(XmlInt xmlInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_element_user(INT$20, 0);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_element_user(INT$20);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public void xsetUi1(XmlUnsignedByte xmlUnsignedByte) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedByte xmlUnsignedByte2 = (XmlUnsignedByte) get_store().find_element_user(UI1$22, 0);
            if (xmlUnsignedByte2 == null) {
                xmlUnsignedByte2 = (XmlUnsignedByte) get_store().add_element_user(UI1$22);
            }
    ...
    public void xsetUi2(XmlUnsignedShort xmlUnsignedShort) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedShort xmlUnsignedShort2 = (XmlUnsignedShort) get_store().find_element_user(UI2$24, 0);
            if (xmlUnsignedShort2 == null) {
                xmlUnsignedShort2 = (XmlUnsignedShort) get_store().add_element_user(UI2$24);
            }
    ...
    public void xsetUi4(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_element_user(UI4$26, 0);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_element_user(UI4$26);
            }
    ...
    public void xsetUi8(XmlUnsignedLong xmlUnsignedLong) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedLong xmlUnsignedLong2 = (XmlUnsignedLong) get_store().find_element_user(UI8$28, 0);
            if (xmlUnsignedLong2 == null) {
                xmlUnsignedLong2 = (XmlUnsignedLong) get_store().add_element_user(UI8$28);
            }
    ...
    public void xsetUint(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlUnsignedInt xmlUnsignedInt2 = (XmlUnsignedInt) get_store().find_element_user(UINT$30, 0);
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt) get_store().add_element_user(UINT$30);
            }
            xmlUnsignedInt2.set(xmlUnsignedInt);
        }
    }
    ...
    public void xsetR4(XmlFloat xmlFloat) {
        synchronized (monitor()) {
            check_orphaned();
            XmlFloat xmlFloat2 = (XmlFloat) get_store().find_element_user(R4$32, 0);
            if (xmlFloat2 == null) {
                xmlFloat2 = (XmlFloat) get_store().add_element_user(R4$32);
            }
    ...
    public void xsetR8(XmlDouble xmlDouble) {
        synchronized (monitor()) {
            check_orphaned();
            XmlDouble xmlDouble2 = (XmlDouble) get_store().find_element_user(R8$34, 0);
            if (xmlDouble2 == null) {
                xmlDouble2 = (XmlDouble) get_store().add_element_user(R8$34);
            }
    ...
    public void xsetDecimal(XmlDecimal xmlDecimal) {
        synchronized (monitor()) {
            check_orphaned();
            XmlDecimal xmlDecimal2 = (XmlDecimal) get_store().find_element_user(DECIMAL$36, 0);
            if (xmlDecimal2 == null) {
                xmlDecimal2 = (XmlDecimal) get_store().add_element_user(DECIMAL$36);
            }
    ...
    public void xsetLpstr(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_element_user(LPSTR$38, 0);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_element_user(LPSTR$38);
            }
    ...
    public void xsetLpwstr(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_element_user(LPWSTR$40, 0);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_element_user(LPWSTR$40);
            }
            xmlString2.set(xmlString);
        }
    }
    ...
    public void xsetBstr(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_element_user(BSTR$42, 0);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_element_user(BSTR$42);
            }
            xmlString2.set(xmlString);
        }
    }
    ...
    public void xsetDate(XmlDateTime xmlDateTime) {
        synchronized (monitor()) {
            check_orphaned();
            XmlDateTime xmlDateTime2 = (XmlDateTime) get_store().find_element_user(DATE$44, 0);
            if (xmlDateTime2 == null) {
                xmlDateTime2 = (XmlDateTime) get_store().add_element_user(DATE$44);
            }
    ...
    public void xsetFiletime(XmlDateTime xmlDateTime) {
        synchronized (monitor()) {
            check_orphaned();
            XmlDateTime xmlDateTime2 = (XmlDateTime) get_store().find_element_user(FILETIME$46, 0);
            if (xmlDateTime2 == null) {
                xmlDateTime2 = (XmlDateTime) get_store().add_element_user(FILETIME$46);
            }
            xmlDateTime2.set(xmlDateTime);
        }
    }
    ...
    public void xsetBool(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBoolean xmlBoolean2 = (XmlBoolean) get_store().find_element_user(BOOL$48, 0);
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean) get_store().add_element_user(BOOL$48);
            }
    ...
    public STCy xgetCy() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTCyFind_element_user = get_store().find_element_user(CY$50, 0);
        }
    ...
    public void xsetCy(STCy sTCy) {
        synchronized (monitor()) {
            check_orphaned();
            STCy sTCyFind_element_user = get_store().find_element_user(CY$50, 0);
            if (sTCyFind_element_user == null) {
                sTCyFind_element_user = (STCy) get_store().add_element_user(CY$50);
            }
    ...
    public STError xgetError() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTErrorFind_element_user = get_store().find_element_user(ERROR$52, 0);
        }
    ...
    public void xsetError(STError sTError) {
        synchronized (monitor()) {
            check_orphaned();
            STError sTErrorFind_element_user = get_store().find_element_user(ERROR$52, 0);
            if (sTErrorFind_element_user == null) {
                sTErrorFind_element_user = (STError) get_store().add_element_user(ERROR$52);
            }
    ...
    public void xsetStream(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(STREAM$54, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(STREAM$54);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public void xsetOstream(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(OSTREAM$56, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(OSTREAM$56);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public void xsetStorage(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(STORAGE$58, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(STORAGE$58);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public void xsetOstorage(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_element_user(OSTORAGE$60, 0);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_element_user(OSTORAGE$60);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public CTVstream getVstream() {
        synchronized (monitor()) {
            check_orphaned();
            CTVstream cTVstreamFind_element_user = get_store().find_element_user(VSTREAM$62, 0);
    ...
    public void setVstream(CTVstream cTVstream) {
        synchronized (monitor()) {
            ...
            CTVstream cTVstreamFind_element_user = get_store().find_element_user(VSTREAM$62, 0);
            if (cTVstreamFind_element_user == null) {
                cTVstreamFind_element_user = (CTVstream) get_store().add_element_user(VSTREAM$62);
            }
            cTVstreamFind_element_user.set(cTVstream);
        }
    }
    ...
    public CTVstream addNewVstream() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTVstreamAdd_element_user = get_store().add_element_user(VSTREAM$62);
        }
    ...
    public void xsetClsid(STClsid sTClsid) {
        synchronized (monitor()) {
            check_orphaned();
            STClsid sTClsid2 = (STClsid) get_store().find_element_user(CLSID$64, 0);
            if (sTClsid2 == null) {
                sTClsid2 = (STClsid) get_store().add_element_user(CLSID$64);
            }
    ...
    public CTCf getCf() {
        synchronized (monitor()) {
            check_orphaned();
            CTCf cTCfFind_element_user = get_store().find_element_user(CF$66, 0);
            if (cTCfFind_element_user == null) {
                return null;
            }
            return cTCfFind_element_user;
        }
    }
    ...
    public void setCf(CTCf cTCf) {
        synchronized (monitor()) {
            ...
            CTCf cTCfFind_element_user = get_store().find_element_user(CF$66, 0);
            if (cTCfFind_element_user == null) {
                cTCfFind_element_user = (CTCf) get_store().add_element_user(CF$66);
            }
            cTCfFind_element_user.set(cTCf);
        }
    }

    @Override // org.openxmlformats.schemas.officeDocument.x2006.customProperties.CTProperty
    public CTCf addNewCf() {
        CTCf cTCfAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTCfAdd_element_user = get_store().add_element_user(CF$66);
        }
        return cTCfAdd_element_user;
    }
    ...
    public void xsetFmtid(STClsid sTClsid) {
        synchronized (monitor()) {
            check_orphaned();
            STClsid sTClsid2 = (STClsid) get_store().find_attribute_user(FMTID$68);
            if (sTClsid2 == null) {
                sTClsid2 = (STClsid) get_store().add_attribute_user(FMTID$68);
            }
            sTClsid2.set(sTClsid);
        }
    }
    ...
    public void xsetPid(XmlInt xmlInt) {
        synchronized (monitor()) {
            check_orphaned();
            XmlInt xmlInt2 = (XmlInt) get_store().find_attribute_user(PID$70);
            if (xmlInt2 == null) {
                xmlInt2 = (XmlInt) get_store().add_attribute_user(PID$70);
            }
            xmlInt2.set(xmlInt);
        }
    }
    ...
    public void xsetName(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_attribute_user(NAME$72);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_attribute_user(NAME$72);
            }
            xmlString2.set(xmlString);
        }
    }
    ...
    public void xsetLinkTarget(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_attribute_user(LINKTARGET$74);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_attribute_user(LINKTARGET$74);
            }
            xmlString2.set(xmlString);
        }
    }
