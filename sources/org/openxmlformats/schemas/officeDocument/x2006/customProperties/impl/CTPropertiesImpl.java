...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/officeDocument/x2006/customProperties/impl/CTPropertiesImpl.class */
public class CTPropertiesImpl extends XmlComplexContentImpl implements CTProperties {
    private static final QName PROPERTY$0 = new QName("http://schemas.openxmlformats.org/officeDocument/2006/custom-properties", BeanDefinitionParserDelegate.PROPERTY_ELEMENT);
    ...
    public int sizeOfPropertyArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(PROPERTY$0);
        }
