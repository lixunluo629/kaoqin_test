...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSimpleField.class */
public interface CTSimpleField extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSimpleField.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsimplefieldacaatype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSimpleField$Factory.class */
    public static final class Factory {
        public static CTSimpleField newInstance() {
            return (CTSimpleField) POIXMLTypeLoader.newInstance(CTSimpleField.type, null);
        }

        public static CTSimpleField newInstance(XmlOptions xmlOptions) {
            return (CTSimpleField) POIXMLTypeLoader.newInstance(CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(String str) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(str, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(str, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(File file) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(file, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(file, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(URL url) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(url, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(url, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(inputStream, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(inputStream, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(Reader reader) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(reader, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField) POIXMLTypeLoader.parse(reader, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(xMLStreamReader, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(xMLStreamReader, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(Node node) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(node, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(node, CTSimpleField.type, xmlOptions);
        }

        public static CTSimpleField parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(xMLInputStream, CTSimpleField.type, (XmlOptions) null);
        }

        public static CTSimpleField parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSimpleField) POIXMLTypeLoader.parse(xMLInputStream, CTSimpleField.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSimpleField.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSimpleField.type, xmlOptions);
        }
