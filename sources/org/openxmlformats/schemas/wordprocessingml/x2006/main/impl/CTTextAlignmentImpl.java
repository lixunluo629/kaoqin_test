...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTextAlignmentImpl.class */
public class CTTextAlignmentImpl extends XmlComplexContentImpl implements CTTextAlignment {
    ...
    public void xsetVal(STTextAlignment sTTextAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            STTextAlignment sTTextAlignment2 = (STTextAlignment) get_store().find_attribute_user(VAL$0);
            if (sTTextAlignment2 == null) {
                sTTextAlignment2 = (STTextAlignment) get_store().add_attribute_user(VAL$0);
            }
