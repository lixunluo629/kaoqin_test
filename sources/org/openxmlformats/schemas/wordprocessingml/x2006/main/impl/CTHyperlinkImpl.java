...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTHyperlinkImpl.class */
public class CTHyperlinkImpl extends XmlComplexContentImpl implements CTHyperlink {
    ...
    private static final QName ID$74 = new QName(PackageRelationshipTypes.CORE_PROPERTIES_ECMA376_NS, "id");
    ...
    public int sizeOfFldSimpleArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(FLDSIMPLE$58);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfHyperlinkArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(HYPERLINK$60);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfSubDocArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(SUBDOC$62);
        }
        return iCount_elements;
    }
    ...
    public void xsetTgtFrame(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(TGTFRAME$64);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(TGTFRAME$64);
            }
    ...
    public void xsetTooltip(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(TOOLTIP$66);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(TOOLTIP$66);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetDocLocation(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(DOCLOCATION$68);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(DOCLOCATION$68);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetHistory(STOnOff sTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            STOnOff sTOnOff2 = (STOnOff) get_store().find_attribute_user(HISTORY$70);
            if (sTOnOff2 == null) {
                sTOnOff2 = (STOnOff) get_store().add_attribute_user(HISTORY$70);
            }
    ...
    public void xsetAnchor(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(ANCHOR$72);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(ANCHOR$72);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetId(STRelationshipId sTRelationshipId) {
        synchronized (monitor()) {
            check_orphaned();
            STRelationshipId sTRelationshipId2 = (STRelationshipId) get_store().find_attribute_user(ID$74);
            if (sTRelationshipId2 == null) {
                sTRelationshipId2 = (STRelationshipId) get_store().add_attribute_user(ID$74);
            }
