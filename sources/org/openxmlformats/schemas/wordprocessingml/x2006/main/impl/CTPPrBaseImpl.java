...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTPPrBaseImpl.class */
public class CTPPrBaseImpl extends XmlComplexContentImpl implements CTPPrBase {
    ...
    public void setPStyle(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(PSTYLE$0, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(PSTYLE$0);
            }
    ...
    public void setKeepNext(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(KEEPNEXT$2, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(KEEPNEXT$2);
            }
    ...
    public void setKeepLines(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(KEEPLINES$4, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(KEEPLINES$4);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setPageBreakBefore(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(PAGEBREAKBEFORE$6, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(PAGEBREAKBEFORE$6);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public CTFramePr getFramePr() {
        synchronized (monitor()) {
            check_orphaned();
            CTFramePr cTFramePrFind_element_user = get_store().find_element_user(FRAMEPR$8, 0);
            if (cTFramePrFind_element_user == null) {
                return null;
            }
            return cTFramePrFind_element_user;
        }
    }
    ...
    public void setFramePr(CTFramePr cTFramePr) {
        synchronized (monitor()) {
            ...
            CTFramePr cTFramePrFind_element_user = get_store().find_element_user(FRAMEPR$8, 0);
            if (cTFramePrFind_element_user == null) {
                cTFramePrFind_element_user = (CTFramePr) get_store().add_element_user(FRAMEPR$8);
            }
            cTFramePrFind_element_user.set(cTFramePr);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTPPrBase
    public CTFramePr addNewFramePr() {
        CTFramePr cTFramePrAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTFramePrAdd_element_user = get_store().add_element_user(FRAMEPR$8);
        }
        return cTFramePrAdd_element_user;
    }
    ...
    public void setWidowControl(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(WIDOWCONTROL$10, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(WIDOWCONTROL$10);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setNumPr(CTNumPr cTNumPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTNumPr cTNumPr2 = (CTNumPr) get_store().find_element_user(NUMPR$12, 0);
            if (cTNumPr2 == null) {
                cTNumPr2 = (CTNumPr) get_store().add_element_user(NUMPR$12);
            }
    ...
    public void setSuppressLineNumbers(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(SUPPRESSLINENUMBERS$14, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(SUPPRESSLINENUMBERS$14);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setPBdr(CTPBdr cTPBdr) {
        synchronized (monitor()) {
            check_orphaned();
            CTPBdr cTPBdr2 = (CTPBdr) get_store().find_element_user(PBDR$16, 0);
            if (cTPBdr2 == null) {
                cTPBdr2 = (CTPBdr) get_store().add_element_user(PBDR$16);
            }
            cTPBdr2.set(cTPBdr);
        }
    }
    ...
    public void setShd(CTShd cTShd) {
        synchronized (monitor()) {
            check_orphaned();
            CTShd cTShd2 = (CTShd) get_store().find_element_user(SHD$18, 0);
            if (cTShd2 == null) {
                cTShd2 = (CTShd) get_store().add_element_user(SHD$18);
            }
            cTShd2.set(cTShd);
        }
    }
    ...
    public void setTabs(CTTabs cTTabs) {
        synchronized (monitor()) {
            check_orphaned();
            CTTabs cTTabs2 = (CTTabs) get_store().find_element_user(TABS$20, 0);
            if (cTTabs2 == null) {
                cTTabs2 = (CTTabs) get_store().add_element_user(TABS$20);
            }
            cTTabs2.set(cTTabs);
        }
    }
    ...
    public void setSuppressAutoHyphens(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(SUPPRESSAUTOHYPHENS$22, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(SUPPRESSAUTOHYPHENS$22);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setKinsoku(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(KINSOKU$24, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(KINSOKU$24);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setWordWrap(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(WORDWRAP$26, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(WORDWRAP$26);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setOverflowPunct(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(OVERFLOWPUNCT$28, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(OVERFLOWPUNCT$28);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setTopLinePunct(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(TOPLINEPUNCT$30, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(TOPLINEPUNCT$30);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setAutoSpaceDE(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(AUTOSPACEDE$32, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(AUTOSPACEDE$32);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setAutoSpaceDN(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(AUTOSPACEDN$34, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(AUTOSPACEDN$34);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setBidi(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(BIDI$36, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(BIDI$36);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setAdjustRightInd(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(ADJUSTRIGHTIND$38, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(ADJUSTRIGHTIND$38);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setSnapToGrid(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(SNAPTOGRID$40, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(SNAPTOGRID$40);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setSpacing(CTSpacing cTSpacing) {
        synchronized (monitor()) {
            check_orphaned();
            CTSpacing cTSpacing2 = (CTSpacing) get_store().find_element_user(SPACING$42, 0);
            if (cTSpacing2 == null) {
                cTSpacing2 = (CTSpacing) get_store().add_element_user(SPACING$42);
            }
    ...
    public void setInd(CTInd cTInd) {
        synchronized (monitor()) {
            check_orphaned();
            CTInd cTInd2 = (CTInd) get_store().find_element_user(IND$44, 0);
            if (cTInd2 == null) {
                cTInd2 = (CTInd) get_store().add_element_user(IND$44);
            }
            cTInd2.set(cTInd);
        }
    }
    ...
    public void setContextualSpacing(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(CONTEXTUALSPACING$46, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(CONTEXTUALSPACING$46);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setMirrorIndents(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(MIRRORINDENTS$48, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(MIRRORINDENTS$48);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setSuppressOverlap(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(SUPPRESSOVERLAP$50, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(SUPPRESSOVERLAP$50);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setJc(CTJc cTJc) {
        synchronized (monitor()) {
            check_orphaned();
            CTJc cTJc2 = (CTJc) get_store().find_element_user(JC$52, 0);
            if (cTJc2 == null) {
                cTJc2 = (CTJc) get_store().add_element_user(JC$52);
            }
            cTJc2.set(cTJc);
        }
    }
    ...
    public CTTextDirection getTextDirection() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextDirection cTTextDirectionFind_element_user = get_store().find_element_user(TEXTDIRECTION$54, 0);
    ...
    public void setTextDirection(CTTextDirection cTTextDirection) {
        synchronized (monitor()) {
            ...
            CTTextDirection cTTextDirectionFind_element_user = get_store().find_element_user(TEXTDIRECTION$54, 0);
            if (cTTextDirectionFind_element_user == null) {
                cTTextDirectionFind_element_user = (CTTextDirection) get_store().add_element_user(TEXTDIRECTION$54);
            }
    ...
    public CTTextDirection addNewTextDirection() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTextDirectionAdd_element_user = get_store().add_element_user(TEXTDIRECTION$54);
        }
    ...
    public void setTextAlignment(CTTextAlignment cTTextAlignment) {
        synchronized (monitor()) {
            check_orphaned();
            CTTextAlignment cTTextAlignment2 = (CTTextAlignment) get_store().find_element_user(TEXTALIGNMENT$56, 0);
            if (cTTextAlignment2 == null) {
                cTTextAlignment2 = (CTTextAlignment) get_store().add_element_user(TEXTALIGNMENT$56);
            }
    ...
    public CTTextboxTightWrap getTextboxTightWrap() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextboxTightWrap cTTextboxTightWrapFind_element_user = get_store().find_element_user(TEXTBOXTIGHTWRAP$58, 0);
    ...
    public void setTextboxTightWrap(CTTextboxTightWrap cTTextboxTightWrap) {
        synchronized (monitor()) {
            ...
            CTTextboxTightWrap cTTextboxTightWrapFind_element_user = get_store().find_element_user(TEXTBOXTIGHTWRAP$58, 0);
            if (cTTextboxTightWrapFind_element_user == null) {
                cTTextboxTightWrapFind_element_user = (CTTextboxTightWrap) get_store().add_element_user(TEXTBOXTIGHTWRAP$58);
            }
            cTTextboxTightWrapFind_element_user.set(cTTextboxTightWrap);
        }
    }
    ...
    public CTTextboxTightWrap addNewTextboxTightWrap() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTextboxTightWrapAdd_element_user = get_store().add_element_user(TEXTBOXTIGHTWRAP$58);
        }
    ...
    public void setOutlineLvl(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(OUTLINELVL$60, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(OUTLINELVL$60);
            }
    ...
    public void setDivId(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(DIVID$62, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(DIVID$62);
            }
            cTDecimalNumber2.set(cTDecimalNumber);
        }
    }
    ...
    public CTCnf getCnfStyle() {
        synchronized (monitor()) {
            check_orphaned();
            CTCnf cTCnfFind_element_user = get_store().find_element_user(CNFSTYLE$64, 0);
            if (cTCnfFind_element_user == null) {
                return null;
            }
            return cTCnfFind_element_user;
        }
    }
    ...
    public void setCnfStyle(CTCnf cTCnf) {
        synchronized (monitor()) {
            ...
            CTCnf cTCnfFind_element_user = get_store().find_element_user(CNFSTYLE$64, 0);
            if (cTCnfFind_element_user == null) {
                cTCnfFind_element_user = (CTCnf) get_store().add_element_user(CNFSTYLE$64);
            }
            cTCnfFind_element_user.set(cTCnf);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTPPrBase
    public CTCnf addNewCnfStyle() {
        CTCnf cTCnfAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTCnfAdd_element_user = get_store().add_element_user(CNFSTYLE$64);
        }
        return cTCnfAdd_element_user;
    }
