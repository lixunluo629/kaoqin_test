...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTPBdrImpl.class */
public class CTPBdrImpl extends XmlComplexContentImpl implements CTPBdr {
    ...
    public void setBetween(CTBorder cTBorder) {
        synchronized (monitor()) {
            check_orphaned();
            CTBorder cTBorder2 = (CTBorder) get_store().find_element_user(BETWEEN$8, 0);
            if (cTBorder2 == null) {
                cTBorder2 = (CTBorder) get_store().add_element_user(BETWEEN$8);
            }
            cTBorder2.set(cTBorder);
        }
    }
    ...
    public void setBar(CTBorder cTBorder) {
        synchronized (monitor()) {
            check_orphaned();
            CTBorder cTBorder2 = (CTBorder) get_store().find_element_user(BAR$10, 0);
            if (cTBorder2 == null) {
                cTBorder2 = (CTBorder) get_store().add_element_user(BAR$10);
            }
            cTBorder2.set(cTBorder);
        }
    }
