...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTFldCharImpl.class */
public class CTFldCharImpl extends XmlComplexContentImpl implements CTFldChar {
    ...
    public void setFfData(CTFFData cTFFData) {
        synchronized (monitor()) {
            check_orphaned();
            CTFFData cTFFData2 = (CTFFData) get_store().find_element_user(FFDATA$2, 0);
            if (cTFFData2 == null) {
                cTFFData2 = (CTFFData) get_store().add_element_user(FFDATA$2);
            }
