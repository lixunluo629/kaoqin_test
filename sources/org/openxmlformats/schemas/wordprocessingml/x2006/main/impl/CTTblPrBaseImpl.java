...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTblPrBaseImpl.class */
public class CTTblPrBaseImpl extends XmlComplexContentImpl implements CTTblPrBase {
    ...
    public void setTblStyle(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(TBLSTYLE$0, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(TBLSTYLE$0);
            }
    ...
    public CTTblPPr getTblpPr() {
        synchronized (monitor()) {
            check_orphaned();
            CTTblPPr cTTblPPrFind_element_user = get_store().find_element_user(TBLPPR$2, 0);
            if (cTTblPPrFind_element_user == null) {
                return null;
            }
            return cTTblPPrFind_element_user;
        }
    }
    ...
    public void setTblpPr(CTTblPPr cTTblPPr) {
        synchronized (monitor()) {
            ...
            CTTblPPr cTTblPPrFind_element_user = get_store().find_element_user(TBLPPR$2, 0);
            if (cTTblPPrFind_element_user == null) {
                cTTblPPrFind_element_user = (CTTblPPr) get_store().add_element_user(TBLPPR$2);
            }
            cTTblPPrFind_element_user.set(cTTblPPr);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblPrBase
    public CTTblPPr addNewTblpPr() {
        CTTblPPr cTTblPPrAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTblPPrAdd_element_user = get_store().add_element_user(TBLPPR$2);
        }
        return cTTblPPrAdd_element_user;
    }
    ...
    public CTTblOverlap getTblOverlap() {
        synchronized (monitor()) {
            check_orphaned();
            CTTblOverlap cTTblOverlapFind_element_user = get_store().find_element_user(TBLOVERLAP$4, 0);
            if (cTTblOverlapFind_element_user == null) {
                return null;
            }
            return cTTblOverlapFind_element_user;
        }
    }
    ...
    public void setTblOverlap(CTTblOverlap cTTblOverlap) {
        synchronized (monitor()) {
            ...
            CTTblOverlap cTTblOverlapFind_element_user = get_store().find_element_user(TBLOVERLAP$4, 0);
            if (cTTblOverlapFind_element_user == null) {
                cTTblOverlapFind_element_user = (CTTblOverlap) get_store().add_element_user(TBLOVERLAP$4);
            }
            cTTblOverlapFind_element_user.set(cTTblOverlap);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblPrBase
    public CTTblOverlap addNewTblOverlap() {
        CTTblOverlap cTTblOverlapAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTblOverlapAdd_element_user = get_store().add_element_user(TBLOVERLAP$4);
        }
        return cTTblOverlapAdd_element_user;
    }
    ...
    public void setBidiVisual(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(BIDIVISUAL$6, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(BIDIVISUAL$6);
            }
    ...
    public void setTblStyleRowBandSize(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(TBLSTYLEROWBANDSIZE$8, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(TBLSTYLEROWBANDSIZE$8);
            }
    ...
    public void setTblStyleColBandSize(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(TBLSTYLECOLBANDSIZE$10, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(TBLSTYLECOLBANDSIZE$10);
            }
            cTDecimalNumber2.set(cTDecimalNumber);
        }
    }
    ...
    public void setTblW(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLW$12, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLW$12);
            }
    ...
    public void setJc(CTJc cTJc) {
        synchronized (monitor()) {
            check_orphaned();
            CTJc cTJc2 = (CTJc) get_store().find_element_user(JC$14, 0);
            if (cTJc2 == null) {
                cTJc2 = (CTJc) get_store().add_element_user(JC$14);
            }
            cTJc2.set(cTJc);
        }
    }
    ...
    public void setTblCellSpacing(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLCELLSPACING$16, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLCELLSPACING$16);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setTblInd(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLIND$18, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLIND$18);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setTblBorders(CTTblBorders cTTblBorders) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblBorders cTTblBorders2 = (CTTblBorders) get_store().find_element_user(TBLBORDERS$20, 0);
            if (cTTblBorders2 == null) {
                cTTblBorders2 = (CTTblBorders) get_store().add_element_user(TBLBORDERS$20);
            }
    ...
    public void setShd(CTShd cTShd) {
        synchronized (monitor()) {
            check_orphaned();
            CTShd cTShd2 = (CTShd) get_store().find_element_user(SHD$22, 0);
            if (cTShd2 == null) {
                cTShd2 = (CTShd) get_store().add_element_user(SHD$22);
            }
            cTShd2.set(cTShd);
        }
    }
    ...
    public CTTblLayoutType getTblLayout() {
        synchronized (monitor()) {
            check_orphaned();
            CTTblLayoutType cTTblLayoutTypeFind_element_user = get_store().find_element_user(TBLLAYOUT$24, 0);
            if (cTTblLayoutTypeFind_element_user == null) {
                return null;
            }
            return cTTblLayoutTypeFind_element_user;
        }
    }
    ...
    public void setTblLayout(CTTblLayoutType cTTblLayoutType) {
        synchronized (monitor()) {
            ...
            CTTblLayoutType cTTblLayoutTypeFind_element_user = get_store().find_element_user(TBLLAYOUT$24, 0);
            if (cTTblLayoutTypeFind_element_user == null) {
                cTTblLayoutTypeFind_element_user = (CTTblLayoutType) get_store().add_element_user(TBLLAYOUT$24);
            }
            cTTblLayoutTypeFind_element_user.set(cTTblLayoutType);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblPrBase
    public CTTblLayoutType addNewTblLayout() {
        CTTblLayoutType cTTblLayoutTypeAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTblLayoutTypeAdd_element_user = get_store().add_element_user(TBLLAYOUT$24);
        }
        return cTTblLayoutTypeAdd_element_user;
    }
    ...
    public void setTblCellMar(CTTblCellMar cTTblCellMar) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblCellMar cTTblCellMar2 = (CTTblCellMar) get_store().find_element_user(TBLCELLMAR$26, 0);
            if (cTTblCellMar2 == null) {
                cTTblCellMar2 = (CTTblCellMar) get_store().add_element_user(TBLCELLMAR$26);
            }
    ...
    public CTShortHexNumber getTblLook() {
        synchronized (monitor()) {
            check_orphaned();
            CTShortHexNumber cTShortHexNumberFind_element_user = get_store().find_element_user(TBLLOOK$28, 0);
    ...
    public void setTblLook(CTShortHexNumber cTShortHexNumber) {
        synchronized (monitor()) {
            ...
            CTShortHexNumber cTShortHexNumberFind_element_user = get_store().find_element_user(TBLLOOK$28, 0);
            if (cTShortHexNumberFind_element_user == null) {
                cTShortHexNumberFind_element_user = (CTShortHexNumber) get_store().add_element_user(TBLLOOK$28);
            }
    ...
    public CTShortHexNumber addNewTblLook() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTShortHexNumberAdd_element_user = get_store().add_element_user(TBLLOOK$28);
        }
