...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTcImpl.class */
public class CTTcImpl extends XmlComplexContentImpl implements CTTc {
    ...
    public void setTcPr(CTTcPr cTTcPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTTcPr cTTcPr2 = (CTTcPr) get_store().find_element_user(TCPR$0, 0);
            if (cTTcPr2 == null) {
                cTTcPr2 = (CTTcPr) get_store().add_element_user(TCPR$0);
            }
            cTTcPr2.set(cTTcPr);
        }
    }
    ...
    public CTCustomXmlBlock getCustomXmlArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlBlockFind_element_user = get_store().find_element_user(CUSTOMXML$2, i);
    ...
    public void setCustomXmlArray(int i, CTCustomXmlBlock cTCustomXmlBlock) {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomXmlBlock cTCustomXmlBlockFind_element_user = get_store().find_element_user(CUSTOMXML$2, i);
            if (cTCustomXmlBlockFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            cTCustomXmlBlockFind_element_user.set(cTCustomXmlBlock);
        }
    }
    ...
    public CTCustomXmlBlock insertNewCustomXml(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlBlockInsert_element_user = get_store().insert_element_user(CUSTOMXML$2, i);
        }
    ...
    public CTCustomXmlBlock addNewCustomXml() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlBlockAdd_element_user = get_store().add_element_user(CUSTOMXML$2);
        }
    ...
    public int sizeOfPArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(P$6);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfTblArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(TBL$8);
        }
        return iCount_elements;
    }
    ...
    public CTAltChunk getAltChunkArray(int i) {
        CTAltChunk cTAltChunkFind_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTAltChunkFind_element_user = get_store().find_element_user(ALTCHUNK$60, i);
            if (cTAltChunkFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
        }
        return cTAltChunkFind_element_user;
    }
    ...
    public int sizeOfAltChunkArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(ALTCHUNK$60);
        }
        return iCount_elements;
    }
    ...
    public void setAltChunkArray(int i, CTAltChunk cTAltChunk) {
        synchronized (monitor()) {
            check_orphaned();
            CTAltChunk cTAltChunkFind_element_user = get_store().find_element_user(ALTCHUNK$60, i);
            if (cTAltChunkFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            cTAltChunkFind_element_user.set(cTAltChunk);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTc
    public CTAltChunk insertNewAltChunk(int i) {
        CTAltChunk cTAltChunkInsert_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTAltChunkInsert_element_user = get_store().insert_element_user(ALTCHUNK$60, i);
        }
        return cTAltChunkInsert_element_user;
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTc
    public CTAltChunk addNewAltChunk() {
        CTAltChunk cTAltChunkAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTAltChunkAdd_element_user = get_store().add_element_user(ALTCHUNK$60);
        }
        return cTAltChunkAdd_element_user;
    }
