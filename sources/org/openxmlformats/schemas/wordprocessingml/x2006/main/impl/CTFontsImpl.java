...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTFontsImpl.class */
public class CTFontsImpl extends XmlComplexContentImpl implements CTFonts {
    ...
    public STHint xgetHint() {
        STHint sTHintFind_attribute_user;
        synchronized (monitor()) {
            check_orphaned();
            sTHintFind_attribute_user = get_store().find_attribute_user(HINT$0);
        }
        return sTHintFind_attribute_user;
    }
    ...
    public void xsetHint(STHint sTHint) {
        synchronized (monitor()) {
            check_orphaned();
            STHint sTHintFind_attribute_user = get_store().find_attribute_user(HINT$0);
            if (sTHintFind_attribute_user == null) {
                sTHintFind_attribute_user = (STHint) get_store().add_attribute_user(HINT$0);
            }
            sTHintFind_attribute_user.set(sTHint);
        }
    }
    ...
    public void xsetAscii(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(ASCII$2);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(ASCII$2);
            }
    ...
    public void xsetHAnsi(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(HANSI$4);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(HANSI$4);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetEastAsia(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(EASTASIA$6);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(EASTASIA$6);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetCs(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(CS$8);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(CS$8);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetAsciiTheme(STTheme sTTheme) {
        synchronized (monitor()) {
            check_orphaned();
            STTheme sTTheme2 = (STTheme) get_store().find_attribute_user(ASCIITHEME$10);
            if (sTTheme2 == null) {
                sTTheme2 = (STTheme) get_store().add_attribute_user(ASCIITHEME$10);
            }
    ...
    public void xsetHAnsiTheme(STTheme sTTheme) {
        synchronized (monitor()) {
            check_orphaned();
            STTheme sTTheme2 = (STTheme) get_store().find_attribute_user(HANSITHEME$12);
            if (sTTheme2 == null) {
                sTTheme2 = (STTheme) get_store().add_attribute_user(HANSITHEME$12);
            }
            sTTheme2.set(sTTheme);
        }
    }
    ...
    public void xsetEastAsiaTheme(STTheme sTTheme) {
        synchronized (monitor()) {
            check_orphaned();
            STTheme sTTheme2 = (STTheme) get_store().find_attribute_user(EASTASIATHEME$14);
            if (sTTheme2 == null) {
                sTTheme2 = (STTheme) get_store().add_attribute_user(EASTASIATHEME$14);
            }
            sTTheme2.set(sTTheme);
        }
    }
    ...
    public void xsetCstheme(STTheme sTTheme) {
        synchronized (monitor()) {
            check_orphaned();
            STTheme sTTheme2 = (STTheme) get_store().find_attribute_user(CSTHEME$16);
            if (sTTheme2 == null) {
                sTTheme2 = (STTheme) get_store().add_attribute_user(CSTHEME$16);
            }
            sTTheme2.set(sTTheme);
        }
    }
