...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTStyleImpl.class */
public class CTStyleImpl extends XmlComplexContentImpl implements CTStyle {
    ...
    private static final QName NEXT$6 = new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", Link.REL_NEXT);
    private static final QName LINK$8 = new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", EjbRef.LINK);
    ...
    public void setName(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(NAME$0, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(NAME$0);
            }
    ...
    public void setAliases(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(ALIASES$2, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(ALIASES$2);
            }
            cTString2.set(cTString);
        }
    }
    ...
    public void setBasedOn(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(BASEDON$4, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(BASEDON$4);
            }
            cTString2.set(cTString);
        }
    }
    ...
    public void setNext(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(NEXT$6, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(NEXT$6);
            }
            cTString2.set(cTString);
        }
    }
    ...
    public void setLink(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(LINK$8, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(LINK$8);
            }
            cTString2.set(cTString);
        }
    }
    ...
    public void setAutoRedefine(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(AUTOREDEFINE$10, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(AUTOREDEFINE$10);
            }
    ...
    public void setHidden(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(HIDDEN$12, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(HIDDEN$12);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setUiPriority(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(UIPRIORITY$14, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(UIPRIORITY$14);
            }
    ...
    public void setSemiHidden(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(SEMIHIDDEN$16, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(SEMIHIDDEN$16);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setUnhideWhenUsed(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(UNHIDEWHENUSED$18, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(UNHIDEWHENUSED$18);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setQFormat(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(QFORMAT$20, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(QFORMAT$20);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setLocked(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(LOCKED$22, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(LOCKED$22);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setPersonal(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(PERSONAL$24, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(PERSONAL$24);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setPersonalCompose(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(PERSONALCOMPOSE$26, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(PERSONALCOMPOSE$26);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setPersonalReply(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(PERSONALREPLY$28, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(PERSONALREPLY$28);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public CTLongHexNumber getRsid() {
        synchronized (monitor()) {
            check_orphaned();
            CTLongHexNumber cTLongHexNumberFind_element_user = get_store().find_element_user(RSID$30, 0);
    ...
    public void setRsid(CTLongHexNumber cTLongHexNumber) {
        synchronized (monitor()) {
            ...
            CTLongHexNumber cTLongHexNumberFind_element_user = get_store().find_element_user(RSID$30, 0);
            if (cTLongHexNumberFind_element_user == null) {
                cTLongHexNumberFind_element_user = (CTLongHexNumber) get_store().add_element_user(RSID$30);
            }
    ...
    public CTLongHexNumber addNewRsid() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTLongHexNumberAdd_element_user = get_store().add_element_user(RSID$30);
        }
    ...
    public void setPPr(CTPPr cTPPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTPPr cTPPr2 = (CTPPr) get_store().find_element_user(PPR$32, 0);
            if (cTPPr2 == null) {
                cTPPr2 = (CTPPr) get_store().add_element_user(PPR$32);
            }
            cTPPr2.set(cTPPr);
        }
    }
    ...
    public void setRPr(CTRPr cTRPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTRPr cTRPr2 = (CTRPr) get_store().find_element_user(RPR$34, 0);
            if (cTRPr2 == null) {
                cTRPr2 = (CTRPr) get_store().add_element_user(RPR$34);
            }
            cTRPr2.set(cTRPr);
        }
    }
    ...
    public void setTblPr(CTTblPrBase cTTblPrBase) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblPrBase cTTblPrBase2 = (CTTblPrBase) get_store().find_element_user(TBLPR$36, 0);
            if (cTTblPrBase2 == null) {
                cTTblPrBase2 = (CTTblPrBase) get_store().add_element_user(TBLPR$36);
            }
    ...
    public void setTrPr(CTTrPr cTTrPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTTrPr cTTrPr2 = (CTTrPr) get_store().find_element_user(TRPR$38, 0);
            if (cTTrPr2 == null) {
                cTTrPr2 = (CTTrPr) get_store().add_element_user(TRPR$38);
            }
            cTTrPr2.set(cTTrPr);
        }
    }
    ...
    public void setTcPr(CTTcPr cTTcPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTTcPr cTTcPr2 = (CTTcPr) get_store().find_element_user(TCPR$40, 0);
            if (cTTcPr2 == null) {
                cTTcPr2 = (CTTcPr) get_store().add_element_user(TCPR$40);
            }
            cTTcPr2.set(cTTcPr);
        }
    }
    ...
    public CTTblStylePr getTblStylePrArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTblStylePrFind_element_user = get_store().find_element_user(TBLSTYLEPR$42, i);
    ...
    public int sizeOfTblStylePrArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(TBLSTYLEPR$42);
        }
    ...
    public void setTblStylePrArray(int i, CTTblStylePr cTTblStylePr) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblStylePr cTTblStylePrFind_element_user = get_store().find_element_user(TBLSTYLEPR$42, i);
            if (cTTblStylePrFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            cTTblStylePrFind_element_user.set(cTTblStylePr);
        }
    }
    ...
    public CTTblStylePr insertNewTblStylePr(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTblStylePrInsert_element_user = get_store().insert_element_user(TBLSTYLEPR$42, i);
        }
    ...
    public CTTblStylePr addNewTblStylePr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTblStylePrAdd_element_user = get_store().add_element_user(TBLSTYLEPR$42);
        }
    ...
    public void xsetStyleId(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(STYLEID$46);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(STYLEID$46);
            }
