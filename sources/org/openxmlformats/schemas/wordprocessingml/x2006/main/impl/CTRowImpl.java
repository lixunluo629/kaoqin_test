...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTRowImpl.class */
public class CTRowImpl extends XmlComplexContentImpl implements CTRow {
    ...
    public void setTblPrEx(CTTblPrEx cTTblPrEx) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblPrEx cTTblPrEx2 = (CTTblPrEx) get_store().find_element_user(TBLPREX$0, 0);
            if (cTTblPrEx2 == null) {
                cTTblPrEx2 = (CTTblPrEx) get_store().add_element_user(TBLPREX$0);
            }
    ...
    public void setTrPr(CTTrPr cTTrPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTTrPr cTTrPr2 = (CTTrPr) get_store().find_element_user(TRPR$2, 0);
            if (cTTrPr2 == null) {
                cTTrPr2 = (CTTrPr) get_store().add_element_user(TRPR$2);
            }
            cTTrPr2.set(cTTrPr);
        }
    }
    ...
    public int sizeOfTcArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(TC$4);
        }
    ...
    public CTCustomXmlCell getCustomXmlArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellFind_element_user = get_store().find_element_user(CUSTOMXML$6, i);
    ...
    public int sizeOfCustomXmlArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXML$6);
        }
        return iCount_elements;
    }
    ...
    public void setCustomXmlArray(int i, CTCustomXmlCell cTCustomXmlCell) {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomXmlCell cTCustomXmlCellFind_element_user = get_store().find_element_user(CUSTOMXML$6, i);
            if (cTCustomXmlCellFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
            cTCustomXmlCellFind_element_user.set(cTCustomXmlCell);
        }
    }
    ...
    public CTCustomXmlCell insertNewCustomXml(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellInsert_element_user = get_store().insert_element_user(CUSTOMXML$6, i);
        }
    ...
    public CTCustomXmlCell addNewCustomXml() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellAdd_element_user = get_store().add_element_user(CUSTOMXML$6);
        }
    ...
    public int sizeOfSdtArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(SDT$8);
        }
        return iCount_elements;
    }
    ...
    public void xsetRsidRPr(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(RSIDRPR$60);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(RSIDRPR$60);
            }
    ...
    public void xsetRsidR(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(RSIDR$62);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(RSIDR$62);
            }
            sTLongHexNumber2.set(sTLongHexNumber);
        }
    }
    ...
    public void xsetRsidDel(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(RSIDDEL$64);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(RSIDDEL$64);
            }
            sTLongHexNumber2.set(sTLongHexNumber);
        }
    }
    ...
    public void xsetRsidTr(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(RSIDTR$66);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(RSIDTR$66);
            }
            sTLongHexNumber2.set(sTLongHexNumber);
        }
    }
