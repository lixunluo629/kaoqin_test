...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTcPrBaseImpl.class */
public class CTTcPrBaseImpl extends XmlComplexContentImpl implements CTTcPrBase {
    ...
    public CTCnf getCnfStyle() {
        synchronized (monitor()) {
            check_orphaned();
            CTCnf cTCnfFind_element_user = get_store().find_element_user(CNFSTYLE$0, 0);
    ...
    public void setCnfStyle(CTCnf cTCnf) {
        synchronized (monitor()) {
            ...
            CTCnf cTCnfFind_element_user = get_store().find_element_user(CNFSTYLE$0, 0);
            if (cTCnfFind_element_user == null) {
                cTCnfFind_element_user = (CTCnf) get_store().add_element_user(CNFSTYLE$0);
            }
    ...
    public CTCnf addNewCnfStyle() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCnfAdd_element_user = get_store().add_element_user(CNFSTYLE$0);
        }
    ...
    public void setTcW(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TCW$2, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TCW$2);
            }
    ...
    public void setGridSpan(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(GRIDSPAN$4, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(GRIDSPAN$4);
            }
    ...
    public void setHMerge(CTHMerge cTHMerge) {
        synchronized (monitor()) {
            check_orphaned();
            CTHMerge cTHMerge2 = (CTHMerge) get_store().find_element_user(HMERGE$6, 0);
            if (cTHMerge2 == null) {
                cTHMerge2 = (CTHMerge) get_store().add_element_user(HMERGE$6);
            }
    ...
    public void setVMerge(CTVMerge cTVMerge) {
        synchronized (monitor()) {
            check_orphaned();
            CTVMerge cTVMerge2 = (CTVMerge) get_store().find_element_user(VMERGE$8, 0);
            if (cTVMerge2 == null) {
                cTVMerge2 = (CTVMerge) get_store().add_element_user(VMERGE$8);
            }
    ...
    public void setTcBorders(CTTcBorders cTTcBorders) {
        synchronized (monitor()) {
            check_orphaned();
            CTTcBorders cTTcBorders2 = (CTTcBorders) get_store().find_element_user(TCBORDERS$10, 0);
            if (cTTcBorders2 == null) {
                cTTcBorders2 = (CTTcBorders) get_store().add_element_user(TCBORDERS$10);
            }
    ...
    public void setShd(CTShd cTShd) {
        synchronized (monitor()) {
            check_orphaned();
            CTShd cTShd2 = (CTShd) get_store().find_element_user(SHD$12, 0);
            if (cTShd2 == null) {
                cTShd2 = (CTShd) get_store().add_element_user(SHD$12);
            }
            cTShd2.set(cTShd);
        }
    }
    ...
    public void setNoWrap(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(NOWRAP$14, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(NOWRAP$14);
            }
    ...
    public CTTcMar getTcMar() {
        synchronized (monitor()) {
            check_orphaned();
            CTTcMar cTTcMarFind_element_user = get_store().find_element_user(TCMAR$16, 0);
            if (cTTcMarFind_element_user == null) {
                return null;
            }
            return cTTcMarFind_element_user;
        }
    }
    ...
    public void setTcMar(CTTcMar cTTcMar) {
        synchronized (monitor()) {
            ...
            CTTcMar cTTcMarFind_element_user = get_store().find_element_user(TCMAR$16, 0);
            if (cTTcMarFind_element_user == null) {
                cTTcMarFind_element_user = (CTTcMar) get_store().add_element_user(TCMAR$16);
            }
            cTTcMarFind_element_user.set(cTTcMar);
        }
    }

    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTcPrBase
    public CTTcMar addNewTcMar() {
        CTTcMar cTTcMarAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTTcMarAdd_element_user = get_store().add_element_user(TCMAR$16);
        }
        return cTTcMarAdd_element_user;
    }
    ...
    public CTTextDirection getTextDirection() {
        synchronized (monitor()) {
            check_orphaned();
            CTTextDirection cTTextDirectionFind_element_user = get_store().find_element_user(TEXTDIRECTION$18, 0);
    ...
    public void setTextDirection(CTTextDirection cTTextDirection) {
        synchronized (monitor()) {
            ...
            CTTextDirection cTTextDirectionFind_element_user = get_store().find_element_user(TEXTDIRECTION$18, 0);
            if (cTTextDirectionFind_element_user == null) {
                cTTextDirectionFind_element_user = (CTTextDirection) get_store().add_element_user(TEXTDIRECTION$18);
            }
    ...
    public CTTextDirection addNewTextDirection() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTextDirectionAdd_element_user = get_store().add_element_user(TEXTDIRECTION$18);
        }
    ...
    public void setTcFitText(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(TCFITTEXT$20, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(TCFITTEXT$20);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
    ...
    public void setVAlign(CTVerticalJc cTVerticalJc) {
        synchronized (monitor()) {
            check_orphaned();
            CTVerticalJc cTVerticalJc2 = (CTVerticalJc) get_store().find_element_user(VALIGN$22, 0);
            if (cTVerticalJc2 == null) {
                cTVerticalJc2 = (CTVerticalJc) get_store().add_element_user(VALIGN$22);
            }
    ...
    public void setHideMark(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(HIDEMARK$24, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(HIDEMARK$24);
            }
            cTOnOff2.set(cTOnOff);
        }
    }
