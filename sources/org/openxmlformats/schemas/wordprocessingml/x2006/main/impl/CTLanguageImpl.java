...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTLanguageImpl.class */
public class CTLanguageImpl extends XmlComplexContentImpl implements CTLanguage {
    ...
    public void xsetEastAsia(STLang sTLang) {
        synchronized (monitor()) {
            check_orphaned();
            STLang sTLang2 = (STLang) get_store().find_attribute_user(EASTASIA$2);
            if (sTLang2 == null) {
                sTLang2 = (STLang) get_store().add_attribute_user(EASTASIA$2);
            }
            sTLang2.set(sTLang);
        }
    }
    ...
    public void xsetBidi(STLang sTLang) {
        synchronized (monitor()) {
            check_orphaned();
            STLang sTLang2 = (STLang) get_store().find_attribute_user(BIDI$4);
            if (sTLang2 == null) {
                sTLang2 = (STLang) get_store().add_attribute_user(BIDI$4);
            }
            sTLang2.set(sTLang);
        }
    }
