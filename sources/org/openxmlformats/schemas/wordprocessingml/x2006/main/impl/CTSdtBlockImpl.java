...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSdtBlockImpl.class */
public class CTSdtBlockImpl extends XmlComplexContentImpl implements CTSdtBlock {
    ...
    public void setSdtContent(CTSdtContentBlock cTSdtContentBlock) {
        synchronized (monitor()) {
            check_orphaned();
            CTSdtContentBlock cTSdtContentBlock2 = (CTSdtContentBlock) get_store().find_element_user(SDTCONTENT$4, 0);
            if (cTSdtContentBlock2 == null) {
                cTSdtContentBlock2 = (CTSdtContentBlock) get_store().add_element_user(SDTCONTENT$4);
            }
