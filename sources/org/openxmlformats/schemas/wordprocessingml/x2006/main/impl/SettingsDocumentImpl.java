...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/SettingsDocumentImpl.class */
public class SettingsDocumentImpl extends XmlComplexContentImpl implements SettingsDocument {
    ...
    public void setSettings(CTSettings cTSettings) {
        synchronized (monitor()) {
            check_orphaned();
            CTSettings cTSettings2 = (CTSettings) get_store().find_element_user(SETTINGS$0, 0);
            if (cTSettings2 == null) {
                cTSettings2 = (CTSettings) get_store().add_element_user(SETTINGS$0);
            }
