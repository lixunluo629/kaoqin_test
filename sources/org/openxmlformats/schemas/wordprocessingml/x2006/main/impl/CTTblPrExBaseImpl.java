...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTblPrExBaseImpl.class */
public class CTTblPrExBaseImpl extends XmlComplexContentImpl implements CTTblPrExBase {
    ...
    public void setTblW(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLW$0, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLW$0);
            }
    ...
    public void setJc(CTJc cTJc) {
        synchronized (monitor()) {
            check_orphaned();
            CTJc cTJc2 = (CTJc) get_store().find_element_user(JC$2, 0);
            if (cTJc2 == null) {
                cTJc2 = (CTJc) get_store().add_element_user(JC$2);
            }
            cTJc2.set(cTJc);
        }
    }
    ...
    public void setTblCellSpacing(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLCELLSPACING$4, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLCELLSPACING$4);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setTblInd(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TBLIND$6, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TBLIND$6);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setTblBorders(CTTblBorders cTTblBorders) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblBorders cTTblBorders2 = (CTTblBorders) get_store().find_element_user(TBLBORDERS$8, 0);
            if (cTTblBorders2 == null) {
                cTTblBorders2 = (CTTblBorders) get_store().add_element_user(TBLBORDERS$8);
            }
    ...
    public void setShd(CTShd cTShd) {
        synchronized (monitor()) {
            check_orphaned();
            CTShd cTShd2 = (CTShd) get_store().find_element_user(SHD$10, 0);
            if (cTShd2 == null) {
                cTShd2 = (CTShd) get_store().add_element_user(SHD$10);
            }
            cTShd2.set(cTShd);
        }
    }
    ...
    public CTTblLayoutType getTblLayout() {
        synchronized (monitor()) {
            check_orphaned();
            CTTblLayoutType cTTblLayoutTypeFind_element_user = get_store().find_element_user(TBLLAYOUT$12, 0);
    ...
    public void setTblLayout(CTTblLayoutType cTTblLayoutType) {
        synchronized (monitor()) {
            ...
            CTTblLayoutType cTTblLayoutTypeFind_element_user = get_store().find_element_user(TBLLAYOUT$12, 0);
            if (cTTblLayoutTypeFind_element_user == null) {
                cTTblLayoutTypeFind_element_user = (CTTblLayoutType) get_store().add_element_user(TBLLAYOUT$12);
            }
    ...
    public CTTblLayoutType addNewTblLayout() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTblLayoutTypeAdd_element_user = get_store().add_element_user(TBLLAYOUT$12);
        }
    ...
    public void setTblCellMar(CTTblCellMar cTTblCellMar) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblCellMar cTTblCellMar2 = (CTTblCellMar) get_store().find_element_user(TBLCELLMAR$14, 0);
            if (cTTblCellMar2 == null) {
                cTTblCellMar2 = (CTTblCellMar) get_store().add_element_user(TBLCELLMAR$14);
            }
    ...
    public CTShortHexNumber getTblLook() {
        synchronized (monitor()) {
            check_orphaned();
            CTShortHexNumber cTShortHexNumberFind_element_user = get_store().find_element_user(TBLLOOK$16, 0);
    ...
    public void setTblLook(CTShortHexNumber cTShortHexNumber) {
        synchronized (monitor()) {
            ...
            CTShortHexNumber cTShortHexNumberFind_element_user = get_store().find_element_user(TBLLOOK$16, 0);
            if (cTShortHexNumberFind_element_user == null) {
                cTShortHexNumberFind_element_user = (CTShortHexNumber) get_store().add_element_user(TBLLOOK$16);
            }
    ...
    public CTShortHexNumber addNewTblLook() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTShortHexNumberAdd_element_user = get_store().add_element_user(TBLLOOK$16);
        }
