...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSdtDocPartImpl.class */
public class CTSdtDocPartImpl extends XmlComplexContentImpl implements CTSdtDocPart {
    ...
    public void setDocPartGallery(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(DOCPARTGALLERY$0, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(DOCPARTGALLERY$0);
            }
    ...
    public void setDocPartCategory(CTString cTString) {
        synchronized (monitor()) {
            check_orphaned();
            CTString cTString2 = (CTString) get_store().find_element_user(DOCPARTCATEGORY$2, 0);
            if (cTString2 == null) {
                cTString2 = (CTString) get_store().add_element_user(DOCPARTCATEGORY$2);
            }
            cTString2.set(cTString);
        }
    }
    ...
    public void setDocPartUnique(CTOnOff cTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            CTOnOff cTOnOff2 = (CTOnOff) get_store().find_element_user(DOCPARTUNIQUE$4, 0);
            if (cTOnOff2 == null) {
                cTOnOff2 = (CTOnOff) get_store().add_element_user(DOCPARTUNIQUE$4);
            }
