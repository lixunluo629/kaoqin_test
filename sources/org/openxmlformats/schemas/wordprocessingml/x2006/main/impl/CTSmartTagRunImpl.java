...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSmartTagRunImpl.class */
public class CTSmartTagRunImpl extends XmlComplexContentImpl implements CTSmartTagRun {
    ...
    public void setSmartTagPr(CTSmartTagPr cTSmartTagPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTSmartTagPr cTSmartTagPr2 = (CTSmartTagPr) get_store().find_element_user(SMARTTAGPR$0, 0);
            if (cTSmartTagPr2 == null) {
                cTSmartTagPr2 = (CTSmartTagPr) get_store().add_element_user(SMARTTAGPR$0);
            }
    ...
    public void setUri(String str) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(URI$66);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(URI$66);
            }
    ...
    public void xsetUri(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(URI$66);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(URI$66);
            }
    ...
    public void setElement(String str) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(ELEMENT$68);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(ELEMENT$68);
            }
            simpleValue.setStringValue(str);
        }
    }
    ...
    public void xsetElement(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(ELEMENT$68);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(ELEMENT$68);
            }
            sTString2.set(sTString);
        }
    }
