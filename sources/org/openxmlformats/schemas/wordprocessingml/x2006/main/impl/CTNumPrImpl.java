...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTNumPrImpl.class */
public class CTNumPrImpl extends XmlComplexContentImpl implements CTNumPr {
    ...
    public void setIlvl(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(ILVL$0, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(ILVL$0);
            }
    ...
    public void setNumId(CTDecimalNumber cTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            CTDecimalNumber cTDecimalNumber2 = (CTDecimalNumber) get_store().find_element_user(NUMID$2, 0);
            if (cTDecimalNumber2 == null) {
                cTDecimalNumber2 = (CTDecimalNumber) get_store().add_element_user(NUMID$2);
            }
            cTDecimalNumber2.set(cTDecimalNumber);
        }
    }
    ...
    public CTTrackChangeNumbering getNumberingChange() {
        synchronized (monitor()) {
            check_orphaned();
            CTTrackChangeNumbering cTTrackChangeNumberingFind_element_user = get_store().find_element_user(NUMBERINGCHANGE$4, 0);
    ...
    public void setNumberingChange(CTTrackChangeNumbering cTTrackChangeNumbering) {
        synchronized (monitor()) {
            ...
            CTTrackChangeNumbering cTTrackChangeNumberingFind_element_user = get_store().find_element_user(NUMBERINGCHANGE$4, 0);
            if (cTTrackChangeNumberingFind_element_user == null) {
                cTTrackChangeNumberingFind_element_user = (CTTrackChangeNumbering) get_store().add_element_user(NUMBERINGCHANGE$4);
            }
            cTTrackChangeNumberingFind_element_user.set(cTTrackChangeNumbering);
        }
    }
    ...
    public CTTrackChangeNumbering addNewNumberingChange() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTrackChangeNumberingAdd_element_user = get_store().add_element_user(NUMBERINGCHANGE$4);
        }
    ...
    public void setIns(CTTrackChange cTTrackChange) {
        synchronized (monitor()) {
            check_orphaned();
            CTTrackChange cTTrackChange2 = (CTTrackChange) get_store().find_element_user(INS$6, 0);
            if (cTTrackChange2 == null) {
                cTTrackChange2 = (CTTrackChange) get_store().add_element_user(INS$6);
            }
