...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSimpleFieldImpl.class */
public class CTSimpleFieldImpl extends XmlComplexContentImpl implements CTSimpleField {
    ...
    public void setFldData(CTText cTText) {
        synchronized (monitor()) {
            check_orphaned();
            CTText cTText2 = (CTText) get_store().find_element_user(FLDDATA$0, 0);
            if (cTText2 == null) {
                cTText2 = (CTText) get_store().add_element_user(FLDDATA$0);
            }
            cTText2.set(cTText);
        }
    }
    ...
    public void setInstr(String str) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(INSTR$66);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(INSTR$66);
            }
    ...
    public void xsetInstr(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(INSTR$66);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(INSTR$66);
            }
    ...
    public void setFldLock(STOnOff.Enum r4) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(FLDLOCK$68);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_attribute_user(FLDLOCK$68);
            }
    ...
    public void xsetFldLock(STOnOff sTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            STOnOff sTOnOff2 = (STOnOff) get_store().find_attribute_user(FLDLOCK$68);
            if (sTOnOff2 == null) {
                sTOnOff2 = (STOnOff) get_store().add_attribute_user(FLDLOCK$68);
            }
    ...
    public void xsetDirty(STOnOff sTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            STOnOff sTOnOff2 = (STOnOff) get_store().find_attribute_user(DIRTY$70);
            if (sTOnOff2 == null) {
                sTOnOff2 = (STOnOff) get_store().add_attribute_user(DIRTY$70);
            }
            sTOnOff2.set(sTOnOff);
        }
    }
