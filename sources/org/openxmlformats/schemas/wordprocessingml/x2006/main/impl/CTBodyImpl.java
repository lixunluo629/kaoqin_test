...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTBodyImpl.class */
public class CTBodyImpl extends XmlComplexContentImpl implements CTBody {
    ...
    public void setSectPr(CTSectPr cTSectPr) {
        synchronized (monitor()) {
            check_orphaned();
            CTSectPr cTSectPr2 = (CTSectPr) get_store().find_element_user(SECTPR$60, 0);
            if (cTSectPr2 == null) {
                cTSectPr2 = (CTSectPr) get_store().add_element_user(SECTPR$60);
            }
