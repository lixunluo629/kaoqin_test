...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTTblCellMarImpl.class */
public class CTTblCellMarImpl extends XmlComplexContentImpl implements CTTblCellMar {
    ...
    public void setTop(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(TOP$0, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(TOP$0);
            }
    ...
    public void setLeft(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(LEFT$2, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(LEFT$2);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setBottom(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(BOTTOM$4, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(BOTTOM$4);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
    ...
    public void setRight(CTTblWidth cTTblWidth) {
        synchronized (monitor()) {
            check_orphaned();
            CTTblWidth cTTblWidth2 = (CTTblWidth) get_store().find_element_user(RIGHT$6, 0);
            if (cTTblWidth2 == null) {
                cTTblWidth2 = (CTTblWidth) get_store().add_element_user(RIGHT$6);
            }
            cTTblWidth2.set(cTTblWidth);
        }
    }
