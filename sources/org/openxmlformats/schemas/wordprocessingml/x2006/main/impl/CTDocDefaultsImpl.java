...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTDocDefaultsImpl.class */
public class CTDocDefaultsImpl extends XmlComplexContentImpl implements CTDocDefaults {
    ...
    public void setRPrDefault(CTRPrDefault cTRPrDefault) {
        synchronized (monitor()) {
            check_orphaned();
            CTRPrDefault cTRPrDefault2 = (CTRPrDefault) get_store().find_element_user(RPRDEFAULT$0, 0);
            if (cTRPrDefault2 == null) {
                cTRPrDefault2 = (CTRPrDefault) get_store().add_element_user(RPRDEFAULT$0);
            }
    ...
    public void setPPrDefault(CTPPrDefault cTPPrDefault) {
        synchronized (monitor()) {
            check_orphaned();
            CTPPrDefault cTPPrDefault2 = (CTPPrDefault) get_store().find_element_user(PPRDEFAULT$2, 0);
            if (cTPPrDefault2 == null) {
                cTPPrDefault2 = (CTPPrDefault) get_store().add_element_user(PPRDEFAULT$2);
            }
