...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTBorderImpl.class */
public class CTBorderImpl extends XmlComplexContentImpl implements CTBorder {
    ...
    public void xsetVal(STBorder sTBorder) {
        synchronized (monitor()) {
            check_orphaned();
            STBorder sTBorder2 = (STBorder) get_store().find_attribute_user(VAL$0);
            if (sTBorder2 == null) {
                sTBorder2 = (STBorder) get_store().add_attribute_user(VAL$0);
            }
    ...
    public void xsetSz(STEighthPointMeasure sTEighthPointMeasure) {
        synchronized (monitor()) {
            check_orphaned();
            STEighthPointMeasure sTEighthPointMeasure2 = (STEighthPointMeasure) get_store().find_attribute_user(SZ$10);
            if (sTEighthPointMeasure2 == null) {
                sTEighthPointMeasure2 = (STEighthPointMeasure) get_store().add_attribute_user(SZ$10);
            }
    ...
    public void xsetSpace(STPointMeasure sTPointMeasure) {
        synchronized (monitor()) {
            check_orphaned();
            STPointMeasure sTPointMeasure2 = (STPointMeasure) get_store().find_attribute_user(SPACE$12);
            if (sTPointMeasure2 == null) {
                sTPointMeasure2 = (STPointMeasure) get_store().add_attribute_user(SPACE$12);
            }
    ...
    public void xsetShadow(STOnOff sTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            STOnOff sTOnOff2 = (STOnOff) get_store().find_attribute_user(SHADOW$14);
            if (sTOnOff2 == null) {
                sTOnOff2 = (STOnOff) get_store().add_attribute_user(SHADOW$14);
            }
    ...
    public void xsetFrame(STOnOff sTOnOff) {
        synchronized (monitor()) {
            check_orphaned();
            STOnOff sTOnOff2 = (STOnOff) get_store().find_attribute_user(FRAME$16);
            if (sTOnOff2 == null) {
                sTOnOff2 = (STOnOff) get_store().add_attribute_user(FRAME$16);
            }
            sTOnOff2.set(sTOnOff);
        }
    }
