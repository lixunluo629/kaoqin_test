...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSdtContentCellImpl.class */
public class CTSdtContentCellImpl extends XmlComplexContentImpl implements CTSdtContentCell {
    ...
    public CTCustomXmlCell getCustomXmlArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellFind_element_user = get_store().find_element_user(CUSTOMXML$2, i);
    ...
    public void setCustomXmlArray(int i, CTCustomXmlCell cTCustomXmlCell) {
        synchronized (monitor()) {
            check_orphaned();
            CTCustomXmlCell cTCustomXmlCellFind_element_user = get_store().find_element_user(CUSTOMXML$2, i);
            if (cTCustomXmlCellFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
    ...
    public CTCustomXmlCell insertNewCustomXml(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellInsert_element_user = get_store().insert_element_user(CUSTOMXML$2, i);
        }
    ...
    public CTCustomXmlCell addNewCustomXml() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCustomXmlCellAdd_element_user = get_store().add_element_user(CUSTOMXML$2);
        }
    ...
    public int sizeOfProofErrArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(PROOFERR$6);
        }
        return iCount_elements;
    }
    ...
    public CTPermStart getPermStartArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermStartFind_element_user = get_store().find_element_user(PERMSTART$8, i);
    ...
    public int sizeOfPermStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(PERMSTART$8);
        }
        return iCount_elements;
    }
    ...
    public void setPermStartArray(int i, CTPermStart cTPermStart) {
        synchronized (monitor()) {
            check_orphaned();
            CTPermStart cTPermStartFind_element_user = get_store().find_element_user(PERMSTART$8, i);
            if (cTPermStartFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
    ...
    public CTPermStart insertNewPermStart(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermStartInsert_element_user = get_store().insert_element_user(PERMSTART$8, i);
        }
    ...
    public CTPermStart addNewPermStart() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermStartAdd_element_user = get_store().add_element_user(PERMSTART$8);
        }
    ...
    public CTPerm getPermEndArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermFind_element_user = get_store().find_element_user(PERMEND$10, i);
    ...
    public int sizeOfPermEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(PERMEND$10);
        }
        return iCount_elements;
    }
    ...
    public void setPermEndArray(int i, CTPerm cTPerm) {
        synchronized (monitor()) {
            check_orphaned();
            CTPerm cTPermFind_element_user = get_store().find_element_user(PERMEND$10, i);
            if (cTPermFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
    ...
    public CTPerm insertNewPermEnd(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermInsert_element_user = get_store().insert_element_user(PERMEND$10, i);
        }
    ...
    public CTPerm addNewPermEnd() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPermAdd_element_user = get_store().add_element_user(PERMEND$10);
        }
    ...
    public int sizeOfBookmarkStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(BOOKMARKSTART$12);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfBookmarkEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(BOOKMARKEND$14);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveFromRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVEFROMRANGESTART$16);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveFromRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVEFROMRANGEEND$18);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveToRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVETORANGESTART$20);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveToRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVETORANGEEND$22);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCommentRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(COMMENTRANGESTART$24);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCommentRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(COMMENTRANGEEND$26);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlInsRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLINSRANGESTART$28);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlInsRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLINSRANGEEND$30);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlDelRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLDELRANGESTART$32);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlDelRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLDELRANGEEND$34);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlMoveFromRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLMOVEFROMRANGESTART$36);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlMoveFromRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLMOVEFROMRANGEEND$38);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlMoveToRangeStartArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLMOVETORANGESTART$40);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfCustomXmlMoveToRangeEndArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(CUSTOMXMLMOVETORANGEEND$42);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfInsArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(INS$44);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfDelArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(DEL$46);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveFromArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVEFROM$48);
        }
        return iCount_elements;
    }
    ...
    public int sizeOfMoveToArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(MOVETO$50);
        }
        return iCount_elements;
    }
    ...
    public CTOMathPara getOMathParaArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathParaFind_element_user = get_store().find_element_user(OMATHPARA$52, i);
    ...
    public int sizeOfOMathParaArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(OMATHPARA$52);
        }
        return iCount_elements;
    }
    ...
    public void setOMathParaArray(int i, CTOMathPara cTOMathPara) {
        synchronized (monitor()) {
            check_orphaned();
            CTOMathPara cTOMathParaFind_element_user = get_store().find_element_user(OMATHPARA$52, i);
            if (cTOMathParaFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
    ...
    public CTOMathPara insertNewOMathPara(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathParaInsert_element_user = get_store().insert_element_user(OMATHPARA$52, i);
        }
    ...
    public CTOMathPara addNewOMathPara() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathParaAdd_element_user = get_store().add_element_user(OMATHPARA$52);
        }
    ...
    public CTOMath getOMathArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathFind_element_user = get_store().find_element_user(OMATH$54, i);
    ...
    public int sizeOfOMathArray() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            iCount_elements = get_store().count_elements(OMATH$54);
        }
        return iCount_elements;
    }
    ...
    public void setOMathArray(int i, CTOMath cTOMath) {
        synchronized (monitor()) {
            check_orphaned();
            CTOMath cTOMathFind_element_user = get_store().find_element_user(OMATH$54, i);
            if (cTOMathFind_element_user == null) {
                throw new IndexOutOfBoundsException();
            }
    ...
    public CTOMath insertNewOMath(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathInsert_element_user = get_store().insert_element_user(OMATH$54, i);
        }
    ...
    public CTOMath addNewOMath() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOMathAdd_element_user = get_store().add_element_user(OMATH$54);
        }
