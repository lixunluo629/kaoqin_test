...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTSdtRunImpl.class */
public class CTSdtRunImpl extends XmlComplexContentImpl implements CTSdtRun {
    ...
    public void setSdtContent(CTSdtContentRun cTSdtContentRun) {
        synchronized (monitor()) {
            check_orphaned();
            CTSdtContentRun cTSdtContentRun2 = (CTSdtContentRun) get_store().find_element_user(SDTCONTENT$4, 0);
            if (cTSdtContentRun2 == null) {
                cTSdtContentRun2 = (CTSdtContentRun) get_store().add_element_user(SDTCONTENT$4);
            }
