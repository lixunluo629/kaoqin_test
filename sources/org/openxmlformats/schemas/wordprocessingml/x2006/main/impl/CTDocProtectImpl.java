...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/impl/CTDocProtectImpl.class */
public class CTDocProtectImpl extends XmlComplexContentImpl implements CTDocProtect {
    ...
    public void xsetCryptAlgorithmSid(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STDecimalNumber sTDecimalNumber2 = (STDecimalNumber) get_store().find_attribute_user(CRYPTALGORITHMSID$12);
            if (sTDecimalNumber2 == null) {
                sTDecimalNumber2 = (STDecimalNumber) get_store().add_attribute_user(CRYPTALGORITHMSID$12);
            }
    ...
    public void xsetCryptSpinCount(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STDecimalNumber sTDecimalNumber2 = (STDecimalNumber) get_store().find_attribute_user(CRYPTSPINCOUNT$14);
            if (sTDecimalNumber2 == null) {
                sTDecimalNumber2 = (STDecimalNumber) get_store().add_attribute_user(CRYPTSPINCOUNT$14);
            }
            sTDecimalNumber2.set(sTDecimalNumber);
        }
    }
    ...
    public void xsetCryptProvider(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(CRYPTPROVIDER$16);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(CRYPTPROVIDER$16);
            }
    ...
    public void xsetAlgIdExt(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(ALGIDEXT$18);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(ALGIDEXT$18);
            }
    ...
    public void xsetAlgIdExtSource(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(ALGIDEXTSOURCE$20);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(ALGIDEXTSOURCE$20);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetCryptProviderTypeExt(STLongHexNumber sTLongHexNumber) {
        synchronized (monitor()) {
            check_orphaned();
            STLongHexNumber sTLongHexNumber2 = (STLongHexNumber) get_store().find_attribute_user(CRYPTPROVIDERTYPEEXT$22);
            if (sTLongHexNumber2 == null) {
                sTLongHexNumber2 = (STLongHexNumber) get_store().add_attribute_user(CRYPTPROVIDERTYPEEXT$22);
            }
            sTLongHexNumber2.set(sTLongHexNumber);
        }
    }
    ...
    public void xsetCryptProviderTypeExtSource(STString sTString) {
        synchronized (monitor()) {
            check_orphaned();
            STString sTString2 = (STString) get_store().find_attribute_user(CRYPTPROVIDERTYPEEXTSOURCE$24);
            if (sTString2 == null) {
                sTString2 = (STString) get_store().add_attribute_user(CRYPTPROVIDERTYPEEXTSOURCE$24);
            }
            sTString2.set(sTString);
        }
    }
    ...
    public void xsetHash(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(HASH$26);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(HASH$26);
            }
    ...
    public void xsetSalt(XmlBase64Binary xmlBase64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = (XmlBase64Binary) get_store().find_attribute_user(SALT$28);
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary) get_store().add_attribute_user(SALT$28);
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
