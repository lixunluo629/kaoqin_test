...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STJc.class */
public interface STJc extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STJc$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STJc$Factory.class */
    public static final class Factory {
        ...
        public static STJc parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STJc) POIXMLTypeLoader.parse(xMLInputStream, STJc.type, (XmlOptions) null);
        }

        public static STJc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
