...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STTextAlignment.class */
public interface STTextAlignment extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STTextAlignment$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STTextAlignment$Factory.class */
    public static final class Factory {
        ...
        public static STTextAlignment newInstance(XmlOptions xmlOptions) {
            return (STTextAlignment) POIXMLTypeLoader.newInstance(STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(String str) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(str, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(str, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(File file) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(file, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(file, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(URL url) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(url, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(url, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(InputStream inputStream) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(inputStream, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(inputStream, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(Reader reader) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(reader, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextAlignment) POIXMLTypeLoader.parse(reader, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(xMLStreamReader, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(xMLStreamReader, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(Node node) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(node, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(node, STTextAlignment.type, xmlOptions);
        }

        public static STTextAlignment parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(xMLInputStream, STTextAlignment.type, (XmlOptions) null);
        }

        public static STTextAlignment parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STTextAlignment) POIXMLTypeLoader.parse(xMLInputStream, STTextAlignment.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextAlignment.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STTextAlignment.type, xmlOptions);
        }
