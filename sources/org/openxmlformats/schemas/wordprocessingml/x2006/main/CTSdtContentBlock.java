...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSdtContentBlock.class */
public interface CTSdtContentBlock extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSdtContentBlock.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsdtcontentblockb37btype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSdtContentBlock$Factory.class */
    public static final class Factory {
        public static CTSdtContentBlock newInstance() {
            return (CTSdtContentBlock) POIXMLTypeLoader.newInstance(CTSdtContentBlock.type, null);
        }

        public static CTSdtContentBlock newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentBlock) POIXMLTypeLoader.newInstance(CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(String str) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(str, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(str, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(File file) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(file, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(file, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(URL url) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(url, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(url, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(inputStream, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(inputStream, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(reader, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(reader, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(xMLStreamReader, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(xMLStreamReader, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Node node) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(node, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(node, CTSdtContentBlock.type, xmlOptions);
        }

        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(xMLInputStream, CTSdtContentBlock.type, (XmlOptions) null);
        }

        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSdtContentBlock) POIXMLTypeLoader.parse(xMLInputStream, CTSdtContentBlock.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSdtContentBlock.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSdtContentBlock.type, xmlOptions);
        }
