...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTxbxContent.class */
public interface CTTxbxContent extends XmlObject {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTxbxContent$Factory.class */
    public static final class Factory {
        ...
        public static CTTxbxContent newInstance(XmlOptions xmlOptions) {
            return (CTTxbxContent) POIXMLTypeLoader.newInstance(CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(String str) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(str, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(str, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(File file) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(file, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(file, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(URL url) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(url, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(url, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(inputStream, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(inputStream, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(Reader reader) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(reader, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(reader, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(xMLStreamReader, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(xMLStreamReader, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(Node node) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(node, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(node, CTTxbxContent.type, xmlOptions);
        }

        public static CTTxbxContent parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(xMLInputStream, CTTxbxContent.type, (XmlOptions) null);
        }

        public static CTTxbxContent parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTTxbxContent) POIXMLTypeLoader.parse(xMLInputStream, CTTxbxContent.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTxbxContent.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTxbxContent.type, xmlOptions);
        }
