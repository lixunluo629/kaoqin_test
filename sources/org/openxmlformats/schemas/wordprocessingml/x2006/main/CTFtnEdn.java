...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTFtnEdn.class */
public interface CTFtnEdn extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTFtnEdn.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctftnedncad9type");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTFtnEdn$Factory.class */
    public static final class Factory {
        public static CTFtnEdn newInstance() {
            return (CTFtnEdn) POIXMLTypeLoader.newInstance(CTFtnEdn.type, null);
        }

        public static CTFtnEdn newInstance(XmlOptions xmlOptions) {
            return (CTFtnEdn) POIXMLTypeLoader.newInstance(CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(String str) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(str, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(str, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(File file) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(file, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(file, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(URL url) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(url, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(url, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(inputStream, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(inputStream, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(Reader reader) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(reader, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(reader, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(xMLStreamReader, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(xMLStreamReader, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(Node node) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(node, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(node, CTFtnEdn.type, xmlOptions);
        }

        public static CTFtnEdn parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(xMLInputStream, CTFtnEdn.type, (XmlOptions) null);
        }

        public static CTFtnEdn parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTFtnEdn) POIXMLTypeLoader.parse(xMLInputStream, CTFtnEdn.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTFtnEdn.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTFtnEdn.type, xmlOptions);
        }
