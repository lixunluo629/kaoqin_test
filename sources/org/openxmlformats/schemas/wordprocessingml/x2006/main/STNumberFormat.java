...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STNumberFormat.class */
public interface STNumberFormat extends XmlString {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(STNumberFormat.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("stnumberformat0fb8type");
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STNumberFormat$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STNumberFormat$Factory.class */
    public static final class Factory {
        ...
        public static STNumberFormat newInstance() {
            return (STNumberFormat) POIXMLTypeLoader.newInstance(STNumberFormat.type, null);
        }

        public static STNumberFormat newInstance(XmlOptions xmlOptions) {
            return (STNumberFormat) POIXMLTypeLoader.newInstance(STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(String str) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(str, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(str, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(File file) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(file, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(file, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(URL url) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(url, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(url, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(InputStream inputStream) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(inputStream, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(inputStream, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(Reader reader) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(reader, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat) POIXMLTypeLoader.parse(reader, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(xMLStreamReader, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(xMLStreamReader, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(Node node) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(node, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(node, STNumberFormat.type, xmlOptions);
        }

        public static STNumberFormat parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(xMLInputStream, STNumberFormat.type, (XmlOptions) null);
        }

        public static STNumberFormat parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STNumberFormat) POIXMLTypeLoader.parse(xMLInputStream, STNumberFormat.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STNumberFormat.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STNumberFormat.type, xmlOptions);
        }
