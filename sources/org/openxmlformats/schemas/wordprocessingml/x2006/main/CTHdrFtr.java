...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTHdrFtr.class */
public interface CTHdrFtr extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTHdrFtr.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cthdrftr26datype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTHdrFtr$Factory.class */
    public static final class Factory {
        public static CTHdrFtr newInstance() {
            return (CTHdrFtr) POIXMLTypeLoader.newInstance(CTHdrFtr.type, null);
        }

        public static CTHdrFtr newInstance(XmlOptions xmlOptions) {
            return (CTHdrFtr) POIXMLTypeLoader.newInstance(CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(String str) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(str, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(str, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(File file) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(file, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(file, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(URL url) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(url, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(url, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(InputStream inputStream) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(inputStream, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(inputStream, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(Reader reader) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(reader, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(reader, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(xMLStreamReader, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(xMLStreamReader, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(Node node) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(node, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(node, CTHdrFtr.type, xmlOptions);
        }

        public static CTHdrFtr parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(xMLInputStream, CTHdrFtr.type, (XmlOptions) null);
        }

        public static CTHdrFtr parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTHdrFtr) POIXMLTypeLoader.parse(xMLInputStream, CTHdrFtr.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTHdrFtr.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTHdrFtr.type, xmlOptions);
        }
