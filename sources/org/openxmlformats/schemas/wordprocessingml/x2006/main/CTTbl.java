...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTbl.class */
public interface CTTbl extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTTbl.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cttblc014type");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTbl$Factory.class */
    public static final class Factory {
        public static CTTbl newInstance() {
            return (CTTbl) POIXMLTypeLoader.newInstance(CTTbl.type, null);
        }

        public static CTTbl newInstance(XmlOptions xmlOptions) {
            return (CTTbl) POIXMLTypeLoader.newInstance(CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(String str) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(str, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(str, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(File file) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(file, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(file, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(URL url) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(url, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(url, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(inputStream, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(inputStream, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(Reader reader) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(reader, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl) POIXMLTypeLoader.parse(reader, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(xMLStreamReader, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(xMLStreamReader, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(Node node) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(node, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(node, CTTbl.type, xmlOptions);
        }

        public static CTTbl parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(xMLInputStream, CTTbl.type, (XmlOptions) null);
        }

        public static CTTbl parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTTbl) POIXMLTypeLoader.parse(xMLInputStream, CTTbl.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTbl.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTbl.type, xmlOptions);
        }
