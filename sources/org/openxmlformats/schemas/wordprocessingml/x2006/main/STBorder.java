...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STBorder.class */
public interface STBorder extends XmlString {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(STBorder.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("stborderd7ectype");
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STBorder$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STBorder$Factory.class */
    public static final class Factory {
        ...
        public static STBorder newInstance() {
            return (STBorder) POIXMLTypeLoader.newInstance(STBorder.type, null);
        }

        public static STBorder newInstance(XmlOptions xmlOptions) {
            return (STBorder) POIXMLTypeLoader.newInstance(STBorder.type, xmlOptions);
        }

        public static STBorder parse(String str) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(str, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(str, STBorder.type, xmlOptions);
        }

        public static STBorder parse(File file) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(file, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(file, STBorder.type, xmlOptions);
        }

        public static STBorder parse(URL url) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(url, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(url, STBorder.type, xmlOptions);
        }

        public static STBorder parse(InputStream inputStream) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(inputStream, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(inputStream, STBorder.type, xmlOptions);
        }

        public static STBorder parse(Reader reader) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(reader, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder) POIXMLTypeLoader.parse(reader, STBorder.type, xmlOptions);
        }

        public static STBorder parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(xMLStreamReader, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(xMLStreamReader, STBorder.type, xmlOptions);
        }

        public static STBorder parse(Node node) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(node, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STBorder) POIXMLTypeLoader.parse(node, STBorder.type, xmlOptions);
        }

        public static STBorder parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STBorder) POIXMLTypeLoader.parse(xMLInputStream, STBorder.type, (XmlOptions) null);
        }

        public static STBorder parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STBorder) POIXMLTypeLoader.parse(xMLInputStream, STBorder.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STBorder.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STBorder.type, xmlOptions);
        }
