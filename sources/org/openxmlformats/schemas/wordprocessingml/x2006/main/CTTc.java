...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTc.class */
public interface CTTc extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTTc.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cttc4019type");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTTc$Factory.class */
    public static final class Factory {
        public static CTTc newInstance() {
            return (CTTc) POIXMLTypeLoader.newInstance(CTTc.type, null);
        }

        public static CTTc newInstance(XmlOptions xmlOptions) {
            return (CTTc) POIXMLTypeLoader.newInstance(CTTc.type, xmlOptions);
        }

        public static CTTc parse(String str) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(str, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(str, CTTc.type, xmlOptions);
        }

        public static CTTc parse(File file) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(file, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(file, CTTc.type, xmlOptions);
        }

        public static CTTc parse(URL url) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(url, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(url, CTTc.type, xmlOptions);
        }

        public static CTTc parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(inputStream, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(inputStream, CTTc.type, xmlOptions);
        }

        public static CTTc parse(Reader reader) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(reader, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc) POIXMLTypeLoader.parse(reader, CTTc.type, xmlOptions);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(xMLStreamReader, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(xMLStreamReader, CTTc.type, xmlOptions);
        }

        public static CTTc parse(Node node) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(node, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTc) POIXMLTypeLoader.parse(node, CTTc.type, xmlOptions);
        }

        public static CTTc parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTTc) POIXMLTypeLoader.parse(xMLInputStream, CTTc.type, (XmlOptions) null);
        }

        public static CTTc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTTc) POIXMLTypeLoader.parse(xMLInputStream, CTTc.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTc.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTTc.type, xmlOptions);
        }
