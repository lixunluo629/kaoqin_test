...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STUnderline.class */
public interface STUnderline extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STUnderline$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STUnderline$Factory.class */
    public static final class Factory {
        ...
        public static STUnderline newInstance(XmlOptions xmlOptions) {
            return (STUnderline) POIXMLTypeLoader.newInstance(STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(String str) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(str, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(str, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(File file) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(file, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(file, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(URL url) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(url, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(url, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(InputStream inputStream) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(inputStream, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(inputStream, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(Reader reader) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(reader, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderline) POIXMLTypeLoader.parse(reader, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(xMLStreamReader, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(xMLStreamReader, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(Node node) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(node, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(node, STUnderline.type, xmlOptions);
        }

        public static STUnderline parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(xMLInputStream, STUnderline.type, (XmlOptions) null);
        }

        public static STUnderline parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STUnderline) POIXMLTypeLoader.parse(xMLInputStream, STUnderline.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STUnderline.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STUnderline.type, xmlOptions);
        }
