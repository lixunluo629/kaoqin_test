...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSdtContentRun.class */
public interface CTSdtContentRun extends XmlObject {
    public static final SchemaType type = (SchemaType) XmlBeans.typeSystemForClassLoader(CTSdtContentRun.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsdtcontentruna0fdtype");

    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/CTSdtContentRun$Factory.class */
    public static final class Factory {
        public static CTSdtContentRun newInstance() {
            return (CTSdtContentRun) POIXMLTypeLoader.newInstance(CTSdtContentRun.type, null);
        }

        public static CTSdtContentRun newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentRun) POIXMLTypeLoader.newInstance(CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(String str) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(str, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(str, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(File file) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(file, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(file, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(URL url) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(url, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(url, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(inputStream, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(inputStream, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(reader, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(reader, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(xMLStreamReader, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(xMLStreamReader, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(Node node) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(node, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(node, CTSdtContentRun.type, xmlOptions);
        }

        public static CTSdtContentRun parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(xMLInputStream, CTSdtContentRun.type, (XmlOptions) null);
        }

        public static CTSdtContentRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (CTSdtContentRun) POIXMLTypeLoader.parse(xMLInputStream, CTSdtContentRun.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSdtContentRun.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, CTSdtContentRun.type, xmlOptions);
        }
