...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STShd.class */
public interface STShd extends XmlString {
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STShd$Enum.class */
    ...
    /* loaded from: poi-ooxml-schemas-3.17.jar:org/openxmlformats/schemas/wordprocessingml/x2006/main/STShd$Factory.class */
    public static final class Factory {
        ...
        public static STShd newInstance(XmlOptions xmlOptions) {
            return (STShd) POIXMLTypeLoader.newInstance(STShd.type, xmlOptions);
        }

        public static STShd parse(String str) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(str, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(str, STShd.type, xmlOptions);
        }

        public static STShd parse(File file) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(file, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(file, STShd.type, xmlOptions);
        }

        public static STShd parse(URL url) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(url, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(URL url, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(url, STShd.type, xmlOptions);
        }

        public static STShd parse(InputStream inputStream) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(inputStream, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(inputStream, STShd.type, xmlOptions);
        }

        public static STShd parse(Reader reader) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(reader, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShd) POIXMLTypeLoader.parse(reader, STShd.type, xmlOptions);
        }

        public static STShd parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(xMLStreamReader, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(xMLStreamReader, STShd.type, xmlOptions);
        }

        public static STShd parse(Node node) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(node, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STShd) POIXMLTypeLoader.parse(node, STShd.type, xmlOptions);
        }

        public static STShd parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (STShd) POIXMLTypeLoader.parse(xMLInputStream, STShd.type, (XmlOptions) null);
        }

        public static STShd parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return (STShd) POIXMLTypeLoader.parse(xMLInputStream, STShd.type, xmlOptions);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STShd.type, null);
        }

        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
            return POIXMLTypeLoader.newValidatingXMLInputStream(xMLInputStream, STShd.type, xmlOptions);
        }
