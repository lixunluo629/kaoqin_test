...
/* loaded from: mybatis-spring-boot-autoconfigure-1.3.2.jar:org/mybatis/spring/boot/autoconfigure/MybatisAutoConfiguration.class */
public class MybatisAutoConfiguration {
    ...
    /* loaded from: mybatis-spring-boot-autoconfigure-1.3.2.jar:org/mybatis/spring/boot/autoconfigure/MybatisAutoConfiguration$AutoConfiguredMapperScannerRegistrar.class */
    public static class AutoConfiguredMapperScannerRegistrar implements BeanFactoryAware, ImportBeanDefinitionRegistrar, ResourceLoaderAware {
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
            ...
            try {
                ...
                MybatisAutoConfiguration.logger.debug("Could not determine auto-configuration package, automatic mapper scanning disabled.", (Throwable) ex);
            }
        }
    ...
    /* loaded from: mybatis-spring-boot-autoconfigure-1.3.2.jar:org/mybatis/spring/boot/autoconfigure/MybatisAutoConfiguration$MapperScannerRegistrarNotFoundConfiguration.class */
