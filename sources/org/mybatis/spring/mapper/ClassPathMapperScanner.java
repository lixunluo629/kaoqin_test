...
/* loaded from: mybatis-spring-1.3.2.jar:org/mybatis/spring/mapper/ClassPathMapperScanner.class */
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    public void registerFilters() {
        ...
        if (acceptAllInterfaces) {
            addIncludeFilter(new TypeFilter() { // from class: org.mybatis.spring.mapper.ClassPathMapperScanner.2
        ...
        addExcludeFilter(new TypeFilter() { // from class: org.mybatis.spring.mapper.ClassPathMapperScanner.3
            @Override // org.springframework.core.type.filter.TypeFilter
            public boolean match(MetadataReader metadataReader, MetadataReaderFactory metadataReaderFactory) throws IOException {
