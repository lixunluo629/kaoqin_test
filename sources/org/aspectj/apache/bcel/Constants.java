...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/apache/bcel/Constants.class */
public interface Constants {
    ...
    public static final String[] ACCESS_NAMES = {"public", "private", "protected", "static", "final", "synchronized", "volatile", "transient", "native", JamXmlElements.INTERFACE, BeanDefinitionParserDelegate.ABSTRACT_ATTRIBUTE, "strictfp"};
    ...
    public static final String[] TYPE_NAMES = {ILLEGAL_TYPE, ILLEGAL_TYPE, ILLEGAL_TYPE, ILLEGAL_TYPE, "boolean", "char", XmlErrorCodes.FLOAT, XmlErrorCodes.DOUBLE, "byte", "short", XmlErrorCodes.INT, XmlErrorCodes.LONG, "void", "array", "object", "unknown"};
