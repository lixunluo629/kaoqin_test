...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/SignatureUtils.class */
public class SignatureUtils {
    ...
    protected static String makeString(UnresolvedType[] types) {
        ...
        StringBuffer buf = new StringBuffer();
        for (UnresolvedType unresolvedType : types) {
            buf.append(makeString(unresolvedType));
            buf.append(':');
        }
        return buf.toString();
    }
