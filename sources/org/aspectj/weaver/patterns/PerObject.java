...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/patterns/PerObject.class */
public class PerObject extends PerClause {
    ...
    protected Test findResidueInternal(Shadow shadow, ExposedState state) {
        Expr myInstance = Expr.makeCallExpr(AjcMemberMaker.perObjectAspectOfMethod(this.inAspect), new Expr[]{getVar(shadow)}, this.inAspect);
    ...
    public String toString() {
        return "per" + (this.isThis ? OgnlContext.THIS_CONTEXT_KEY : DataBinder.DEFAULT_OBJECT_NAME) + "(" + this.entry + ")";
    }
    ...
    public boolean equals(Object other) {
        ...
        return pc.isThis && this.isThis && (pc.inAspect != null ? pc.inAspect.equals(this.inAspect) : this.inAspect == null) && (pc.entry != null ? pc.entry.equals(this.entry) : this.entry == null);
    }
