...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/AjcMemberMaker.class */
public class AjcMemberMaker {
    ...
    public static ResolvedMember ajcPreClinitMethod(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, 10, NameMangler.AJC_PRE_CLINIT_NAME, "()V");
    }

    public static ResolvedMember ajcPostClinitMethod(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, 10, NameMangler.AJC_POST_CLINIT_NAME, "()V");
    }
    ...
    public static ResolvedMember perCflowPush(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, 9, NameMangler.PERCFLOW_PUSH_METHOD, "()V");
    }

    public static ResolvedMember perCflowField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, 25, NameMangler.PERCFLOW_FIELD_NAME, CFLOW_STACK_TYPE.getSignature());
    }

    public static ResolvedMember perSingletonField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, 25, NameMangler.PERSINGLETON_FIELD_NAME, declaringType.getSignature());
    }

    public static ResolvedMember initFailureCauseField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, 10, NameMangler.INITFAILURECAUSE_FIELD_NAME, UnresolvedType.THROWABLE.getSignature());
    }
    ...
    public static ResolvedMember perTypeWithinWithinTypeField(UnresolvedType declaringType, ResolvedType aspectType) {
        ...
        return new ResolvedMemberImpl(Member.FIELD, declaringType, modifiers, UnresolvedType.JL_STRING, NameMangler.PERTYPEWITHIN_WITHINTYPEFIELD, UnresolvedType.NONE);
    }
    ...
    public static ResolvedMember perObjectBind(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, 41, NameMangler.PEROBJECT_BIND_METHOD, "(Ljava/lang/Object;)V");
    }

    public static ResolvedMember perTypeWithinGetInstance(UnresolvedType declaringType) {
        ResolvedMemberImpl rm = new ResolvedMemberImpl(Member.METHOD, declaringType, 10, declaringType, NameMangler.PERTYPEWITHIN_GETINSTANCE_METHOD, new UnresolvedType[]{UnresolvedType.JL_CLASS});
        return rm;
    }

    public static ResolvedMember perTypeWithinGetWithinTypeNameMethod(UnresolvedType declaringType, boolean inJava5Mode) {
        ResolvedMemberImpl rm = new ResolvedMemberImpl(Member.METHOD, declaringType, 1, UnresolvedType.JL_STRING, NameMangler.PERTYPEWITHIN_GETWITHINTYPENAME_METHOD, UnresolvedType.NONE);
        return rm;
    }

    public static ResolvedMember perTypeWithinCreateAspectInstance(UnresolvedType declaringType) {
        ResolvedMemberImpl rm = new ResolvedMemberImpl(Member.METHOD, declaringType, 9, declaringType, NameMangler.PERTYPEWITHIN_CREATEASPECTINSTANCE_METHOD, new UnresolvedType[]{UnresolvedType.forSignature("Ljava/lang/String;")}, new UnresolvedType[0]);
        return rm;
    }
    ...
    public static ResolvedMember itdAtDeclareParentsField(ResolvedType targetType, UnresolvedType itdType, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.FIELD, targetType, 2, itdType, NameMangler.itdAtDeclareParentsField(aspectType, itdType), null);
    }
    ...
    public static ResolvedMember interConstructor(ResolvedType targetType, ResolvedMember constructor, UnresolvedType aspectType) {
        ...
        } while (targetType.lookupMemberNoSupers(ret) != null);
        return ret;
    }
