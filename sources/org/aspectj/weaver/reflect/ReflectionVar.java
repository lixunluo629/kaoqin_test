...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/reflect/ReflectionVar.class */
        ...
        switch (this.varType) {
            ...
            case 3:
                if (this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotation(getType(), thisObject);
                }
                return null;
            case 4:
                if (this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotation(getType(), targetObject);
                }
                return null;
            case 5:
                if (this.argsIndex <= args.length - 1 && this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotation(getType(), args[this.argsIndex]);
                }
                return null;
            case 6:
                if (this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotationFromClass(getType(), withinType);
                }
                return null;
            case 7:
                if (this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotationFromMember(getType(), withinCode);
                }
                return null;
            case 8:
                if (this.annotationFinder != null) {
                    return this.annotationFinder.getAnnotationFromMember(getType(), subject);
                }
                return null;
            default:
                return null;
