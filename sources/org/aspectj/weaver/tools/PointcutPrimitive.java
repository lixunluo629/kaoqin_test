...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/tools/PointcutPrimitive.class */
public final class PointcutPrimitive extends TypeSafeEnum {
    ...
    public static final PointcutPrimitive GET = new PointcutPrimitive(BeanUtil.PREFIX_GETTER_GET, 3);
    ...
    public static final PointcutPrimitive THIS = new PointcutPrimitive(OgnlContext.THIS_CONTEXT_KEY, 15);
