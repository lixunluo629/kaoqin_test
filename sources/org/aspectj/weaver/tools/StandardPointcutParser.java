...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/tools/StandardPointcutParser.class */
public class StandardPointcutParser {
    ...
    public StandardPointcutExpression parsePointcutExpression(String expression, Class inScope, PointcutParameter[] formalParameters) throws UnsupportedPointcutPrimitiveException, IllegalArgumentException {
        try {
            ...
            StandardPointcutExpressionImpl pcExpr = new StandardPointcutExpressionImpl(pc, expression, formalParameters, getWorld());
            return pcExpr;
    ...
    private IScope buildResolutionScope(Class inScope, PointcutParameter[] formalParameters) {
        ...
        ISourceContext sourceContext = new ISourceContext() { // from class: org.aspectj.weaver.tools.StandardPointcutParser.1
