...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/weaver/tools/cache/WeavedClassCache.class */
public class WeavedClassCache {
    ...
    public static WeavedClassCache createCache(ClassLoader loader, List<String> aspects, GeneratedClassHandler existingClassHandler, IMessageHandler messageHandler) {
        ...
        if (name != null && (backing = DEFAULT_FACTORY.createBacking(name)) != null) {
    ...
    protected void error(String message, Throwable th) throws AbortException {
