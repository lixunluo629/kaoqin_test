...
/* JADX WARN: Classes with same name are omitted:
  aspectjrt-1.8.14.jar:org/aspectj/internal/lang/reflect/AjTypeImpl.class
 */
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/internal/lang/reflect/AjTypeImpl.class */
public class AjTypeImpl<T> implements AjType<T> {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Method getDeclaredMethod(String name, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Method getMethod(String name, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Pointcut getDeclaredPointcut(String name) throws NoSuchPointcutException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Pointcut getPointcut(String name) throws NoSuchPointcutException, SecurityException {
    ...
    private Pointcut asPointcut(Method method) {
        ...
        if (pcAnn != null) {
            ...
            if (name.startsWith("ajc$")) {
                int nameStart = name.indexOf(ClassUtils.CGLIB_CLASS_SEPARATOR);
                name = name.substring(nameStart + 2, name.length());
                int nextDollar = name.indexOf(PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX);
                if (nextDollar != -1) {
    ...
    private Advice[] getDeclaredAdvice(Set ofAdviceTypes) throws SecurityException {
    ...
    private Advice[] getAdvice(Set ofAdviceTypes) throws SecurityException {
        if (this.advice == null) {
            initAdvice();
        }
        List<Advice> adviceList = new ArrayList<>();
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Advice getAdvice(String name) throws SecurityException, NoSuchAdviceException {
        if (name.equals("")) {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public Advice getDeclaredAdvice(String name) throws SecurityException, NoSuchAdviceException {
        if (name.equals("")) {
            throw new IllegalArgumentException("use getAdvice(AdviceType...) instead for un-named advice");
        }
        if (this.declaredAdvice == null) {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeMethodDeclaration getDeclaredITDMethod(String name, AjType<?> target, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeMethodDeclaration getITDMethod(String name, AjType<?> target, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    private void addAnnotationStyleITDMethods(List<InterTypeMethodDeclaration> toList, boolean publicOnly) throws SecurityException {
        if (isAspect()) {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeConstructorDeclaration getDeclaredITDConstructor(AjType<?> target, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeConstructorDeclaration getITDConstructor(AjType<?> target, AjType<?>... parameterTypes) throws NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeFieldDeclaration getDeclaredITDField(String name, AjType<?> target) throws NoSuchFieldException, NoSuchMethodException, SecurityException {
    ...
    @Override // org.aspectj.lang.reflect.AjType
    public InterTypeFieldDeclaration getITDField(String name, AjType<?> target) throws NoSuchFieldException, NoSuchMethodException, SecurityException {
