...
/* JADX WARN: Classes with same name are omitted:
  aspectjrt-1.8.14.jar:org/aspectj/internal/lang/reflect/StringToType.class
 */
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/internal/lang/reflect/StringToType.class */
public class StringToType {
    public static Type[] commaSeparatedListToTypeArray(String typeNames, Class classScope) throws ClassNotFoundException {
        ...
        while (strTok.hasMoreTokens()) {
            ...
            int i = index;
            index++;
            ret[i] = stringToType(typeName, classScope);
        }
        return ret;
    }
