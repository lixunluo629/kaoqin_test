...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/bridge/AbortException.class */
public class AbortException extends RuntimeException {
    ...
    private static String extractMessage(IMessage message) {
        String m;
        if (null == message || null == (m = message.getMessage())) {
    ...
    public String getMessage() {
        ...
        if (null == message || NO_MESSAGE_TEXT == message) {
            ...
            if (null != m) {
                ...
                if (null == message && null != (thrown = m.getThrown())) {
