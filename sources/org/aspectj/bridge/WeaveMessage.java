...
/* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/bridge/WeaveMessage.class */
public class WeaveMessage extends Message {
    ...
    public static WeaveMessage constructWeavingMessage(WeaveMessageKind kind, String[] inserts) {
        ...
        while (true) {
            int pos = new String(str).indexOf(QuickTargetSourceCreator.PREFIX_THREAD_LOCAL);
            if (pos != -1) {
    ...
    /* loaded from: aspectjweaver-1.8.14.jar:org/aspectj/bridge/WeaveMessage$WeaveMessageKind.class */
