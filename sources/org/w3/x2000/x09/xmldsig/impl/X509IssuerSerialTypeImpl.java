...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/w3/x2000/x09/xmldsig/impl/X509IssuerSerialTypeImpl.class */
public class X509IssuerSerialTypeImpl extends XmlComplexContentImpl implements X509IssuerSerialType {
    ...
    public void setX509IssuerName(String str) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_element_user(X509ISSUERNAME$0, 0);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_element_user(X509ISSUERNAME$0);
            }
    ...
    public void xsetX509IssuerName(XmlString xmlString) {
        synchronized (monitor()) {
            check_orphaned();
            XmlString xmlString2 = (XmlString) get_store().find_element_user(X509ISSUERNAME$0, 0);
            if (xmlString2 == null) {
                xmlString2 = (XmlString) get_store().add_element_user(X509ISSUERNAME$0);
            }
    ...
    public void setX509SerialNumber(BigInteger bigInteger) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_element_user(X509SERIALNUMBER$2, 0);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_element_user(X509SERIALNUMBER$2);
            }
    ...
    public void xsetX509SerialNumber(XmlInteger xmlInteger) {
        synchronized (monitor()) {
            check_orphaned();
            XmlInteger xmlInteger2 = (XmlInteger) get_store().find_element_user(X509SERIALNUMBER$2, 0);
            if (xmlInteger2 == null) {
                xmlInteger2 = (XmlInteger) get_store().add_element_user(X509SERIALNUMBER$2);
            }
