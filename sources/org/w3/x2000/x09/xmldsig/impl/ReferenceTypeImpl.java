...
/* loaded from: poi-ooxml-schemas-3.17.jar:org/w3/x2000/x09/xmldsig/impl/ReferenceTypeImpl.class */
public class ReferenceTypeImpl extends XmlComplexContentImpl implements ReferenceType {
    ...
    public TransformsType getTransforms() {
        synchronized (monitor()) {
            check_orphaned();
            TransformsType transformsTypeFind_element_user = get_store().find_element_user(TRANSFORMS$0, 0);
            if (transformsTypeFind_element_user == null) {
                return null;
            }
            return transformsTypeFind_element_user;
        }
    }
    ...
    public void setTransforms(TransformsType transformsType) {
        synchronized (monitor()) {
            ...
            TransformsType transformsTypeFind_element_user = get_store().find_element_user(TRANSFORMS$0, 0);
            if (transformsTypeFind_element_user == null) {
                transformsTypeFind_element_user = (TransformsType) get_store().add_element_user(TRANSFORMS$0);
            }
            transformsTypeFind_element_user.set(transformsType);
        }
    }

    @Override // org.w3.x2000.x09.xmldsig.ReferenceType
    public TransformsType addNewTransforms() {
        TransformsType transformsTypeAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            transformsTypeAdd_element_user = get_store().add_element_user(TRANSFORMS$0);
        }
        return transformsTypeAdd_element_user;
    }
    ...
    public void setDigestMethod(DigestMethodType digestMethodType) {
        synchronized (monitor()) {
            check_orphaned();
            DigestMethodType digestMethodType2 = (DigestMethodType) get_store().find_element_user(DIGESTMETHOD$2, 0);
            if (digestMethodType2 == null) {
                digestMethodType2 = (DigestMethodType) get_store().add_element_user(DIGESTMETHOD$2);
            }
    ...
    public void setDigestValue(byte[] bArr) {
        synchronized (monitor()) {
            ...
            SimpleValue simpleValue = (SimpleValue) get_store().find_element_user(DIGESTVALUE$4, 0);
            if (simpleValue == null) {
                simpleValue = (SimpleValue) get_store().add_element_user(DIGESTVALUE$4);
            }
    ...
    public void xsetDigestValue(DigestValueType digestValueType) {
        synchronized (monitor()) {
            check_orphaned();
            DigestValueType digestValueType2 = (DigestValueType) get_store().find_element_user(DIGESTVALUE$4, 0);
            if (digestValueType2 == null) {
                digestValueType2 = (DigestValueType) get_store().add_element_user(DIGESTVALUE$4);
            }
    ...
    public void xsetType(XmlAnyURI xmlAnyURI) {
        synchronized (monitor()) {
            check_orphaned();
            XmlAnyURI xmlAnyURI2 = (XmlAnyURI) get_store().find_attribute_user(TYPE$10);
            if (xmlAnyURI2 == null) {
                xmlAnyURI2 = (XmlAnyURI) get_store().add_attribute_user(TYPE$10);
            }
            xmlAnyURI2.set(xmlAnyURI);
        }
    }
