...
/* loaded from: tomcat-embed-core-8.5.43.jar:javax/servlet/http/HttpServlet.class */
public abstract class HttpServlet extends GenericServlet {
    ...
    protected void doTrace(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        StringBuilder buffer = new StringBuilder("TRACE ").append(req.getRequestURI()).append(SymbolConstants.SPACE_SYMBOL).append(req.getProtocol());
