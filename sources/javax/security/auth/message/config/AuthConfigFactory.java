...
/* loaded from: tomcat-embed-core-8.5.43.jar:javax/security/auth/message/config/AuthConfigFactory.class */
public abstract class AuthConfigFactory {
    ...
    /* loaded from: tomcat-embed-core-8.5.43.jar:javax/security/auth/message/config/AuthConfigFactory$RegistrationContext.class */
            ...
            if (factory == null) {
                ...
                try {
                    factory = (AuthConfigFactory) AccessController.doPrivileged(new PrivilegedExceptionAction<AuthConfigFactory>() { // from class: javax.security.auth.message.config.AuthConfigFactory.1
                        ...
                        public AuthConfigFactory run() throws IllegalAccessException, NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
