...
/* loaded from: jsqlparser-0.9.1.jar:net/sf/jsqlparser/parser/ParseException.class */
public class ParseException extends Exception {
    private static final long serialVersionUID = 1;
    protected static String EOL = System.getProperty("line.separator", ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
    ...
    private static String initialise(Token currentToken, int[][] expectedTokenSequences, String[] tokenImage) {
        ...
        while (true) {
            ...
            retval2 = (((retval2 + SymbolConstants.SPACE_SYMBOL + tokenImage[tok.kind]) + " \"") + add_escapes(tok.image)) + " \"";
            tok = tok.next;
            i2++;
        }
