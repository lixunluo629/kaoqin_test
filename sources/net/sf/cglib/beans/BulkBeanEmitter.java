...
/* loaded from: cglib-3.1.jar:net/sf/cglib/beans/BulkBeanEmitter.class */
            ...
            try {
                if (getters[i] != null) {
                    ...
                    if (method.getReturnType() != types[i]) {
                        throw new BulkBeanException(new StringBuffer().append("Specified type ").append(types[i]).append(" does not match declared type ").append(method.getReturnType()).toString(), i);
                    }
