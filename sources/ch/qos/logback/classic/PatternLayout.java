...
/* JADX WARN: Classes with same name are omitted:
  logback-classic-1.2.3.jar:ch/qos/logback/classic/PatternLayout.class
 */
/* loaded from: logback-classic-1.2.3.jar.bak:ch/qos/logback/classic/PatternLayout.class */
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put(ExcelXmlConstants.POSITION, RelativeTimeConverter.class.getName());
        ...
        defaultConverterMap.put(ExcelXmlConstants.CELL_TAG, LoggerConverter.class.getName());
        ...
        defaultConverterMap.put(JamXmlElements.METHOD, MethodOfCallerConverter.class.getName());
        defaultConverterMap.put(StandardRoles.L, LineOfCallerConverter.class.getName());
        defaultConverterMap.put(JamXmlElements.LINE, LineOfCallerConverter.class.getName());
