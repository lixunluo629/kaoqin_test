...
/* JADX WARN: Classes with same name are omitted:
  logback-classic-1.2.3.jar:ch/qos/logback/classic/boolex/JaninoEventEvaluator.class
 */
/* loaded from: logback-classic-1.2.3.jar.bak:ch/qos/logback/classic/boolex/JaninoEventEvaluator.class */
public class JaninoEventEvaluator extends JaninoEventEvaluatorBase<ILoggingEvent> {
    ...
    protected String getDecoratedExpression() {
        ...
        if (!expression.contains("return")) {
            expression = "return " + expression + ScriptUtils.DEFAULT_STATEMENT_SEPARATOR;
