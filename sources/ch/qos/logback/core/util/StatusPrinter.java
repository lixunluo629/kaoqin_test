...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/util/StatusPrinter.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/util/StatusPrinter.class */
public class StatusPrinter {
    ...
    public static void buildStr(StringBuilder sb, String indentation, Status s) {
        ...
        if (cachingDateFormat != null) {
            ...
            sb.append(dateStr).append(SymbolConstants.SPACE_SYMBOL);
        }
