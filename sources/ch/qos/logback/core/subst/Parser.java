...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/subst/Parser.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/subst/Parser.class */
public class Parser {
    ...
    void expectNotNull(Token t, String expected) {
        if (t == null) {
            throw new IllegalArgumentException("All tokens consumed but was expecting \"" + expected + SymbolConstants.QUOTES_SYMBOL);
        }
    }
