...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/subst/Token.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/subst/Token.class */
public class Token {
    ...
    /* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/subst/Token$Type.class
 */
    /* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/subst/Token$Type.class */
    public enum Type {
        LITERAL,
        START,
        CURLY_LEFT,
