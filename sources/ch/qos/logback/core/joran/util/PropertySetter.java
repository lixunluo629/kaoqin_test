...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/joran/util/PropertySetter.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/joran/util/PropertySetter.class */
public class PropertySetter extends ContextAwareBase {
    ...
    private boolean isSanityCheckSuccessful(String name, Method method, Class<?>[] params, Object complexProperty) {
        ...
        if (!params[0].isAssignableFrom(complexProperty.getClass())) {
            ...
            addError(SymbolConstants.QUOTES_SYMBOL + ccc.getName() + "\" was loaded by [" + ccc.getClassLoader() + "].");
            return false;
        }
        return true;
    }
