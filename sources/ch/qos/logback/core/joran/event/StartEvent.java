...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/joran/event/StartEvent.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/joran/event/StartEvent.class */
    ...
    public String toString() {
        ...
        if (this.attributes != null) {
            for (int i = 0; i < this.attributes.getLength(); i++) {
                ...
                b.append(this.attributes.getLocalName(i)).append("=\"").append(this.attributes.getValue(i)).append(SymbolConstants.QUOTES_SYMBOL);
            }
        }
        b.append(")  [");
