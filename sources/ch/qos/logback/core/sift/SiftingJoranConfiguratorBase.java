...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/sift/SiftingJoranConfiguratorBase.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/sift/SiftingJoranConfiguratorBase.class */
public abstract class SiftingJoranConfiguratorBase<E> extends GenericConfigurator {
    ...
    public String toString() {
        return getClass().getName() + "{" + this.key + SymbolConstants.EQUAL_SYMBOL + this.value + '}';
    }
}
