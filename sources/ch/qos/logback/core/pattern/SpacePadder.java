...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/pattern/SpacePadder.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/pattern/SpacePadder.class */
public class SpacePadder {
    static final String[] SPACES = {SymbolConstants.SPACE_SYMBOL, "  ", "    ", "        ", "                ", "                                "};
