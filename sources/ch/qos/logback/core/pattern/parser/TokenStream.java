...
/* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/pattern/parser/TokenStream.class
 */
/* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/pattern/parser/TokenStream.class */
class TokenStream {
    ...
    /* JADX WARN: Classes with same name are omitted:
  logback-core-1.2.3.jar:ch/qos/logback/core/pattern/parser/TokenStream$TokenizerState.class
 */
    /* loaded from: logback-core-1.2.3.jar.bak:ch/qos/logback/core/pattern/parser/TokenStream$TokenizerState.class */
    enum TokenizerState {
        LITERAL_STATE,
    ...
    List tokenize() throws ScanException {
        ...
        switch (this.state) {
            ...
            case KEYWORD_STATE:
                tokenList.add(new Token(MysqlErrorNumbers.ER_CANT_CREATE_FILE, buf.toString()));
                break;
            case RIGHT_PARENTHESIS_STATE:
    ...
    private void handleKeywordState(char c, List<Token> tokenList, StringBuffer buf) {
        ...
        if (c == '{') {
            addValuedToken(MysqlErrorNumbers.ER_CANT_CREATE_FILE, buf, tokenList);
            this.state = TokenizerState.OPTION_STATE;
            return;
        }
        if (c == '(') {
