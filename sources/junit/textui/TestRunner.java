...
/* loaded from: junit-4.12.jar:junit/textui/TestRunner.class */
public class TestRunner extends BaseTestRunner {
    ...
    public static void runAndWait(Test suite) throws IOException {
    ...
    public TestResult doRun(Test suite, boolean wait) throws IOException {
    ...
    protected void pause(boolean wait) throws IOException {
        if (wait) {
