...
/* loaded from: junit-4.12.jar:junit/framework/TestSuite.class */
public class TestSuite implements Test {
    private String fName;
    private Vector<Test> fTests;

    public static Test createTest(Class<?> theClass, String name) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        Object test;
        try {
    ...
    public static Test warning(final String message) {
        return new TestCase(AsmRelationshipUtils.DECLARE_WARNING) { // from class: junit.framework.TestSuite.1
    ...
    public TestSuite(Class<?> theClass) throws SecurityException {
        this.fTests = new Vector<>(10);
        addTestsFromTestCase(theClass);
    }

    private void addTestsFromTestCase(Class<?> theClass) throws SecurityException {
