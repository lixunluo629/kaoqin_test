...
/* loaded from: lombok-1.16.22.jar:lombok/javac/CommentCatcher.SCL.lombok */
public class CommentCatcher {
    ...
    public static CommentCatcher create(Context context) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
    ...
    private static void registerCommentsCollectingScannerFactory(Context context) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
