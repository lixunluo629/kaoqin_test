...
/* loaded from: lombok-1.16.22.jar:lombok/javac/JavacTreeMaker.SCL.lombok */
public class JavacTreeMaker {
    private final TreeMaker tm;
    private static final ConcurrentHashMap<MethodId<?>, Method> METHOD_CACHE = new ConcurrentHashMap<>();
    ...
    private static final MethodId<JCTree.JCCase> Case = MethodId("Case");
    ...
    private static final MethodId<JCTree.JCBreak> Break = MethodId("Break");
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/JavacTreeMaker$MethodId.SCL.lombok */
    private static class MethodId<J> {
        ...
        public String toString() {
            ...
            out.append(this.returnType.getName()).append(SymbolConstants.SPACE_SYMBOL).append(this.owner.getName()).append(".").append(this.name).append("(");
            boolean f = true;
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/JavacTreeMaker$SchroedingerType.SCL.lombok */
    static class SchroedingerType {
        ...
        static Object getFieldCached(ConcurrentMap<String, Object> cache, String className, String fieldName) throws IllegalAccessException, IllegalArgumentException {
            ...
            try {
                Object value2 = Class.forName(className).getField(fieldName).get(null);
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/JavacTreeMaker$TypeTag.SCL.lombok */
    public static class TypeTag extends SchroedingerType {
        ...
        static {
            Method m = null;
            try {
                m = Type.class.getDeclaredMethod("getTag", new Class[0]);
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/JavacTreeMaker$TreeTag.SCL.lombok */
    ...
    public static <J> J invokeAny(Object obj, MethodId<J> methodId, Object... objArr) throws SecurityException {
        Method methodAddToCache = METHOD_CACHE.get(methodId);
        if (methodAddToCache == null) {
            methodAddToCache = addToCache(methodId);
        }
        try {
            if (!((MethodId) methodId).returnType.isPrimitive()) {
                return (J) ((MethodId) methodId).returnType.cast(methodAddToCache.invoke(obj, objArr));
            }
            J j = (J) methodAddToCache.invoke(obj, objArr);
            ...
            System.err.println(methodAddToCache);
            throw Javac.sneakyThrow(e2);
    ...
    private static Method addToCache(MethodId<?> m) throws SecurityException {
        Method found = null;
        ...
        return marker == null ? found : METHOD_CACHE.get(m);
    }
    ...
    public JCTree.JCCase Case(JCTree.JCExpression pat, List<JCTree.JCStatement> stats) {
        return (JCTree.JCCase) invoke(Case, pat, stats);
    }
    ...
    public JCTree.JCBreak Break(Name label) {
        return (JCTree.JCBreak) invoke(Break, label);
    }
