...
/* loaded from: lombok-1.16.22.jar:lombok/javac/HandlerLibrary.SCL.lombok */
public class HandlerLibrary {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/HandlerLibrary$VisitorContainer.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/javac/HandlerLibrary$AnnotationHandlerContainer.SCL.lombok */
    ...
    public void handleAnnotation(JCTree.JCCompilationUnit unit, JavacNode node, JCTree.JCAnnotation annotation, long priority) {
        ...
        if (fqn == null || (container = this.annotationHandlers.get(fqn)) == null) {
            return;
        }
        try {
            if (container.getPriority() == priority && checkAndSetHandled(annotation)) {
