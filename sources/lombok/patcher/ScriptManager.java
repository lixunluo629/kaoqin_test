...
/* loaded from: lombok-1.16.22.jar:lombok/patcher/ScriptManager.SCL.lombok */
public class ScriptManager {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/patcher/ScriptManager$OurClassFileTransformer.SCL.lombok */
    private class OurClassFileTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
            ...
            if (patched && ScriptManager.DEBUG_PATCHING != null) {
                try {
                    writeArray(ScriptManager.DEBUG_PATCHING, String.valueOf(className) + ClassUtils.CLASS_FILE_SUFFIX, byteCode);
