...
/* loaded from: lombok-1.16.22.jar:lombok/patcher/ClassRootFinder.SCL.lombok */
public class ClassRootFinder {
    ...
    public static String findClassRootOfClass(Class<?> context) {
        ...
        URL selfURL = context.getResource(String.valueOf(name) + ClassUtils.CLASS_FILE_SUFFIX);
        ...
        if (self2.startsWith("file:/")) {
            ...
            String suffix = "/" + packageBase.replace('.', '/') + "/" + name + ClassUtils.CLASS_FILE_SUFFIX;
