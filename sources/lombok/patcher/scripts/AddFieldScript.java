...
/* loaded from: lombok-1.16.22.jar:lombok/patcher/scripts/AddFieldScript.SCL.lombok */
public class AddFieldScript extends PatchScript {
    ...
    protected ClassVisitor createClassVisitor(ClassWriter writer, String classSpec, TransplantMapper transplantMapper) {
        return new ClassVisitor(262144, writer) { // from class: lombok.patcher.scripts.AddFieldScript.1
