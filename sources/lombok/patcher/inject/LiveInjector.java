...
/* loaded from: lombok-1.16.22.jar:lombok/patcher/inject/LiveInjector.SCL.lombok */
public class LiveInjector {

    /* loaded from: lombok-1.16.22.jar:lombok/patcher/inject/LiveInjector$LibInstrument.SCL.lombok */
    public interface LibInstrument extends Library {
        void Agent_OnAttach(Pointer pointer, String str, Pointer pointer2);
    }

    /* loaded from: lombok-1.16.22.jar:lombok/patcher/inject/LiveInjector$LibJVM.SCL.lombok */
