...
/* loaded from: lombok-1.16.22.jar:lombok/patcher/Hook.SCL.lombok */
public class Hook {
    ...
    static {
        ...
        m.put(XmlErrorCodes.INT, "I");
        m.put(XmlErrorCodes.LONG, "J");
        m.put("short", "S");
        m.put("byte", "B");
        m.put("char", "C");
        m.put(XmlErrorCodes.DOUBLE, "D");
        m.put(XmlErrorCodes.FLOAT, "F");
        m.put("void", "V");
        m.put("boolean", "Z");
