...
/* loaded from: lombok-1.16.22.jar:lombok/delombok/Delombok.SCL.lombok */
public class Delombok {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/delombok/Delombok$CmdArgs.SCL.lombok */
    private static class CmdArgs {
        ...
        @Shorthand({DateTokenConverter.CONVERTER_KEY})
        private String target;

        @Description("Classpath (analogous to javac -cp option)")
        @Shorthand({ExcelXmlConstants.CELL_TAG})
        private String classpath;

        @Description("Sourcepath (analogous to javac -sourcepath option)")
        @Shorthand({ExcelXmlConstants.CELL_DATA_FORMAT_TAG})
        private String sourcepath;
        ...
        @Shorthand({ExcelXmlConstants.CELL_FORMULA_TAG})
    ...
    public static void main(String[] rawArgs) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException {
        ...
        try {
            ...
            try {
                ...
                System.out.println(e4.getMessage() + " Try --format-help.");
                System.exit(1);
            }
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/delombok/Delombok$InvalidFormatOptionException.SCL.lombok */
    ...
    private static Field getModuleField() {
        try {
            return JCTree.JCCompilationUnit.class.getField("modle");
    ...
    private static Object callAttributeMethodOnJavaCompiler(JavaCompiler compiler, Todo arg) {
        if (attributeMethod == null) {
            try {
                attributeMethod = JavaCompiler.class.getDeclaredMethod(BeanDefinitionParserDelegate.QUALIFIER_ATTRIBUTE_ELEMENT, Queue.class);
            } catch (NoSuchMethodException e) {
                try {
                    attributeMethod = JavaCompiler.class.getDeclaredMethod(BeanDefinitionParserDelegate.QUALIFIER_ATTRIBUTE_ELEMENT, ListBuffer.class);
    ...
    private static void callFlowMethodOnJavaCompiler(JavaCompiler compiler, Object arg) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (flowMethod == null) {
            try {
                flowMethod = JavaCompiler.class.getDeclaredMethod("flow", Queue.class);
            } catch (NoSuchMethodException e) {
                try {
