...
/* loaded from: lombok-1.16.22.jar:lombok/delombok/DelombokApp.SCL.lombok */
public class DelombokApp extends LombokApp {
    ...
    public int runApp(List<String> args) throws Exception {
        try {
            ...
            try {
                loadDelombok(args).getMethod("main", String[].class).invoke(null, args.toArray(new String[0]));
                return 0;
    ...
    public static Class<?> loadDelombok(List<String> args) throws Exception {
        ...
        if (toolsJar == null) {
            ...
            for (String arg : args) {
                ...
                if (arg.contains(SymbolConstants.SPACE_SYMBOL)) {
        ...
        ClassLoader loader = new ClassLoader(DelombokApp.class.getClassLoader()) { // from class: lombok.delombok.DelombokApp.1
            ...
            protected synchronized Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
                ...
                String rawName = binName + ClassUtils.CLASS_FILE_SUFFIX;
