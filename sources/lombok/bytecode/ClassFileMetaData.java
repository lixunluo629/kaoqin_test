...
/* loaded from: lombok-1.16.22.jar:lombok/bytecode/ClassFileMetaData.SCL.lombok */
        ...
        for (int i = 1; i < this.maxPoolSize; i++) {
            ...
            switch (this.types[i]) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    result.append("String \"").append(this.utf8s[readValue(pos)]).append(SymbolConstants.QUOTES_SYMBOL);
                    break;
                case 9:
