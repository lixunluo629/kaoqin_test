...
/* loaded from: lombok-1.16.22.jar:lombok/bytecode/PreventNullAnalysisRemover.SCL.lombok */
public class PreventNullAnalysisRemover implements PostCompilerTransformation {
    ...
    public byte[] applyTransformations(byte[] original, String fileName, DiagnosticsReceiver diagnostics) {
        ...
        reader.accept(new ClassVisitor(393216, writer) { // from class: lombok.bytecode.PreventNullAnalysisRemover.1
