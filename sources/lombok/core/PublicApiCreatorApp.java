...
/* loaded from: lombok-1.16.22.jar:lombok/core/PublicApiCreatorApp.SCL.lombok */
public class PublicApiCreatorApp extends LombokApp {
    ...
    private int writeApiJar(File outFile) throws Exception {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (name.startsWith("lombok/") && !name.endsWith("/package-info.class") && name.endsWith(ClassUtils.CLASS_FILE_SUFFIX)) {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/PublicApiCreatorApp$Fail.SCL.lombok */
