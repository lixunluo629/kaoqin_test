...
/* loaded from: lombok-1.16.22.jar:lombok/core/AnnotationProcessor.SCL.lombok */
public class AnnotationProcessor extends AbstractProcessor {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/AnnotationProcessor$ProcessorDescriptor.SCL.lombok */
    ...
    public static ProcessingEnvironment getJavacProcessingEnvironment(ProcessingEnvironment procEnv, List<String> delayedWarnings) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Class<?> cls = procEnv.getClass();
        if (cls.getName().equals("org.gradle.api.internal.tasks.compile.processing.IncrementalProcessingEnvironment")) {
            try {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/AnnotationProcessor$JavacDescriptor.SCL.lombok */
    static class JavacDescriptor extends ProcessorDescriptor {
        ...
        @Override // lombok.core.AnnotationProcessor.ProcessorDescriptor
        boolean want(ProcessingEnvironment procEnv, List<String> delayedWarnings) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            ProcessingEnvironment javacProcEnv = AnnotationProcessor.getJavacProcessingEnvironment(procEnv, delayedWarnings);
            if (!javacProcEnv.getClass().getName().equals("com.sun.tools.javac.processing.JavacProcessingEnvironment")) {
                return false;
            }
            try {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/AnnotationProcessor$EcjDescriptor.SCL.lombok */
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (TypeElement elem : annotations) {
            ...
            if (n.length() <= 7 || !n.subSequence(0, 7).toString().equals("lombok.")) {
                onlyLombok = false;
            }
        }
