...
/* loaded from: lombok-1.16.22.jar:lombok/core/handlers/InclusionExclusionUtils.SCL.lombok */
public class InclusionExclusionUtils {
    private static List<Integer> createListOfNonExistentFields(List<String> list, LombokNode<?, ?, ?> type, boolean excludeStandard, boolean excludeTransient) {
        ...
        while (it.hasNext()) {
            ...
            if (child.getKind() == AST.Kind.FIELD && (!excludeStandard || (!child.isStatic() && !child.getName().startsWith(PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX)))) {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/handlers/InclusionExclusionUtils$Included.SCL.lombok */
    ...
    public static <A extends AST<A, L, N>, L extends LombokNode<A, L, N>, N, I extends Annotation> List<Included<L, I>> handleIncludeExcludeMarking(Class<I> inclType, String replaceName, Class<? extends Annotation> exclType, LombokNode<A, L, N> typeNode, AnnotationValues<?> annotation, LombokNode<A, L, N> annotationNode) {
        ...
        while (it.hasNext()) {
            ...
            if (markExclude) {
                ...
                } else if (name.startsWith(PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX)) {
                ...
                if (markInclude != null) {
                    ...
                    } else if (child.getKind() == AST.Kind.FIELD && !child.isStatic() && !name.startsWith(PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX) && !child.isEnumMember()) {
