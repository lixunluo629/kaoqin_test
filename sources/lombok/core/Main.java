...
/* loaded from: lombok-1.16.22.jar:lombok/core/Main.SCL.lombok */
public class Main {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/Main$VersionApp.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/core/Main$LicenseApp.SCL.lombok */
    ...
    public int go() {
        ...
        if (command.startsWith(ScriptUtils.DEFAULT_COMMENT_PREFIX)) {
    ...
    public void printHelp(String message, PrintStream out) {
        ...
        for (LombokApp app : this.apps) {
            if (!app.isDebugTool()) {
                String[] desc = app.getAppDescription().split(ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
                int i = 0;
                while (i < desc.length) {
