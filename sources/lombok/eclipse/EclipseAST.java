...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/EclipseAST.SCL.lombok */
public class EclipseAST extends AST<EclipseAST, EclipseNode, ASTNode> {
    ...
    public URI getAbsoluteFileLocation() {
        ...
        this.memoizedAbsoluteFileLocation = getAbsoluteFileLocation0();
        return this.memoizedAbsoluteFileLocation;
    }

    private URI getAbsoluteFileLocation0() {
        String fileName = getFileName();
        if (fileName != null && (fileName.startsWith(ResourceUtils.FILE_URL_PREFIX) || fileName.startsWith("sourcecontrol:"))) {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/EclipseAST$EclipseWorkspaceBasedFileResolver.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/EclipseAST$ParseProblem.SCL.lombok */
    class ParseProblem {
    ...
    public static void addProblemToCompilationResult(char[] fileNameArray, CompilationResult result, boolean isWarning, String message, int sourceStart, int sourceEnd) {
        try {
            ...
            if (!"false".equals(System.getProperty("lombok.debug.reflection", "false"))) {
                e2.initCause(EcjReflectionCheck.problem);
                throw e2;
            }
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/EclipseAST$EcjReflectionCheck.SCL.lombok */
    private static class EcjReflectionCheck {
        ...
        static {
            ...
            Method m = null;
            try {
                m = EclipseAstProblemView.class.getMethod("addProblemToCompilationResult", char[].class, Class.forName(COMPILATIONRESULT_TYPE), Boolean.TYPE, String.class, Integer.TYPE, Integer.TYPE);
            } catch (Throwable t) {
                problem_ = t;
            }
