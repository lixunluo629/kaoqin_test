...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/EclipseSingularsRecipes.SCL.lombok */
public class EclipseSingularsRecipes {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/EclipseSingularsRecipes$SingularData.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer.SCL.lombok */
    public static abstract class EclipseSingularizer {
        ...
        public abstract void generateMethods(SingularData singularData, boolean z, EclipseNode eclipseNode, boolean z2, boolean z3);

        public abstract void appendBuildCode(SingularData singularData, EclipseNode eclipseNode, List<Statement> list, char[] cArr);
        ...
        protected TypeReference[] createTypeArgs(int count, boolean addExtends, EclipseNode node, List<TypeReference> typeArgs) {
            ...
            return (TypeReference[]) arguments.toArray(new TypeReference[arguments.size()]);
        }
