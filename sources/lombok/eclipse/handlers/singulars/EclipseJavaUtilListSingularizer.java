...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/singulars/EclipseJavaUtilListSingularizer.SCL.lombok */
public class EclipseJavaUtilListSingularizer extends EclipseJavaUtilListSetSingularizer {
    ...
    public void appendBuildCode(EclipseSingularsRecipes.SingularData data, EclipseNode builderType, List<Statement> statements, char[] targetVariableName) {
        ...
        switchStat.statements = (Statement[]) switchContents.toArray(new Statement[switchContents.size()]);
