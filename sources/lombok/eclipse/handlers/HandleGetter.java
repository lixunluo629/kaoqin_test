...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/HandleGetter.SCL.lombok */
public class HandleGetter extends EclipseAnnotationHandler<Getter> {
    ...
    static {
        ...
        m.put(XmlErrorCodes.INT, Eclipse.fromQualifiedName("java.lang.Integer"));
        m.put(XmlErrorCodes.DOUBLE, Eclipse.fromQualifiedName("java.lang.Double"));
        m.put(XmlErrorCodes.FLOAT, Eclipse.fromQualifiedName("java.lang.Float"));
        m.put("short", Eclipse.fromQualifiedName("java.lang.Short"));
        m.put("byte", Eclipse.fromQualifiedName("java.lang.Byte"));
        m.put(XmlErrorCodes.LONG, Eclipse.fromQualifiedName("java.lang.Long"));
    ...
    public MethodDeclaration createGetter(TypeDeclaration parent, EclipseNode fieldNode, String name, int modifier, ASTNode source, boolean lazy, List<Annotation> onMethod) throws IllegalAccessException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        method.annotations = EclipseHandlerUtil.copyAnnotations(source, new Annotation[]{(Annotation[]) onMethod.toArray(new Annotation[0]), Eclipse.findAnnotations(field, HandlerUtil.NON_NULL_PATTERN), Eclipse.findAnnotations(field, HandlerUtil.NULLABLE_PATTERN), findDelegatesAndMarkAsHandled(fieldNode), deprecated});
