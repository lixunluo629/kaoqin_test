...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/HandleSneakyThrows.SCL.lombok */
public class HandleSneakyThrows extends EclipseAnnotationHandler<SneakyThrows> {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/handlers/HandleSneakyThrows$DeclaredException.SCL.lombok */
    ...
    public void handle(AnnotationValues<SneakyThrows> annotation, Annotation source, EclipseNode annotationNode) {
        ...
        if (memberValuePairs == null || memberValuePairs.length == 0) {
            ...
            for (String exceptionName : exceptionNames) {
                if (exceptionName.endsWith(ClassUtils.CLASS_FILE_SUFFIX)) {
