...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate.SCL.lombok */
public class PatchDelegate {
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$CantMakeDelegates.SCL.lombok */
    public static class CantMakeDelegates extends Exception {
        public Set<String> conflicted;
    }

    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$ClassScopeEntry.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$TypeVarFinder.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$EclipseTypeBindingScanner.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$Reflection.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$DelegateRecursion.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$BindingTuple.SCL.lombok */
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchDelegate$DelegateReceiver.SCL.lombok */
