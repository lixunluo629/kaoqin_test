...
/* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchExtensionMethodCompletionProposal.SCL.lombok */
public class PatchExtensionMethodCompletionProposal {
    ...
    private static void copyNameLookupAndCompletionEngine(CompletionProposalCollector completionProposalCollector, IJavaCompletionProposal proposal, InternalCompletionProposal newProposal) throws IllegalAccessException, IllegalArgumentException {
        try {
            InternalCompletionContext context = (InternalCompletionContext) Reflection.contextField.get(completionProposalCollector);
            InternalExtendedCompletionContext extendedContext = (InternalExtendedCompletionContext) Reflection.extendedContextField.get(context);
    ...
    /* loaded from: lombok-1.16.22.jar:lombok/eclipse/agent/PatchExtensionMethodCompletionProposal$Reflection.SCL.lombok */
    static class Reflection {
        ...
        private static <T extends AccessibleObject> T makeAccessible(T object) throws SecurityException {
